...
impl<T> Periph<T> {
  ...
  #[inline]
  pub fn ccmr_output_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 2);
     ((self.0 as usize) + 0x18 + (index << 2)) as *const u32
  }
  #[inline]
  pub fn ccmr_output_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 2);
  ...
  #[inline]
  pub fn set_ccmr_output(&self, index: usize, value: CcmrOutput) -> &Self {
     assert!(index < 2);
     unsafe {
  ...
  #[inline]
  pub fn with_ccmr_output<F: FnOnce(CcmrOutput) -> CcmrOutput>(&self, index: usize, f: F) -> &Self {
     let tmp = self.ccmr_output(index);
     self.set_ccmr_output(index, f(tmp))
  }

  #[inline]
  pub fn ccmr_input_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 2);
     ((self.0 as usize) + 0x18 + (index << 2)) as *const u32
  }
  #[inline]
  pub fn ccmr_input_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 2);
     ((self.0 as usize) + 0x18 + (index << 2)) as *mut u32
  }
  #[inline]
  ...
  #[inline]
  pub fn set_ccmr_input(&self, index: usize, value: CcmrInput) -> &Self {
     assert!(index < 2);
     unsafe {
       ::core::ptr::write_volatile(((self.0 as usize) + 0x18 + (index << 2)) as *mut u32, value.0);
     }
  ...
  #[inline]
  pub fn with_ccmr_input<F: FnOnce(CcmrInput) -> CcmrInput>(&self, index: usize, f: F) -> &Self {
