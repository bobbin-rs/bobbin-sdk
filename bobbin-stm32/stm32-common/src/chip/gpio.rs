...
// PeripheralGroup { name: "GPIO", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("GPIO"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: Some("General-purpose I/Os"), modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "MODER", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO port mode register"), fields: [Field { name: "MODER", bit_offset: 0, bit_width: 2, access: None, description: Some("Port x configuration bits (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(2), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "OTYPER", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO port output type register"), fields: [Field { name: "OT", bit_offset: 0, bit_width: 1, access: None, description: Some("Port x configuration bits (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "OSPEEDR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO port output speed register"), fields: [Field { name: "OSPEEDR", bit_offset: 0, bit_width: 2, access: None, description: Some("Port x configuration bits (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(2), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PUPDR", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO port pull-up/pull-down register"), fields: [Field { name: "PUPDR", bit_offset: 0, bit_width: 2, access: None, description: Some("Port x configuration bits (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(2), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "IDR", offset: 16, size: Some(32), access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("GPIO port input data register"), fields: [Field { name: "IDR", bit_offset: 0, bit_width: 1, access: None, description: Some("Port input data (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ODR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO port output data register"), fields: [Field { name: "ODR", bit_offset: 0, bit_width: 1, access: None, description: Some("Port output data (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BSRR", offset: 24, size: Some(32), access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("GPIO port bit set/reset register"), fields: [Field { name: "BR", bit_offset: 16, bit_width: 1, access: None, description: Some("Port x reset bit y (y = 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }, Field { name: "BS", bit_offset: 0, bit_width: 1, access: None, description: Some("Port x set bit y (y= 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "LCKR", offset: 28, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO port configuration lock register"), fields: [Field { name: "LCKK", bit_offset: 16, bit_width: 1, access: None, description: Some("Lock Key"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LCK", bit_offset: 0, bit_width: 1, access: None, description: Some("Port x lock bit y (y= 0..15)"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "AFRL", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO alternate function low register"), fields: [Field { name: "AFRL", bit_offset: 0, bit_width: 4, access: None, description: Some("Alternate function selection for port x bit y (y = 0..7)"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "AFRH", offset: 36, size: Some(32), access: Some(ReadWrite), reset_value: None, reset_mask: None, description: Some("GPIO alternate function high register"), fields: [Field { name: "AFRH", bit_offset: 0, bit_width: 4, access: None, description: Some("Alternate function selection for port x bit y (y = 8..15)"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BRR", offset: 40, size: Some(32), access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("Port bit reset register"), fields: [Field { name: "BR", bit_offset: 0, bit_width: 1, access: None, description: Some("Port x reset bit y"), enumerated_values: [], links: [], dim: Some(16), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: true, has_channels: false, description: None }
...
#[doc="Read the MODER register."]
   #[inline] pub fn moder(&self) -> Moder { 
      unsafe {
         Moder(::core::ptr::read_volatile((self.0 + 0x0) as *const u32))
      }
   }
...
#[doc="Read the OTYPER register."]
   #[inline] pub fn otyper(&self) -> Otyper { 
      unsafe {
         Otyper(::core::ptr::read_volatile((self.0 + 0x4) as *const u32))
      }
   }
...
#[doc="Read the OSPEEDR register."]
   #[inline] pub fn ospeedr(&self) -> Ospeedr { 
      unsafe {
         Ospeedr(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the PUPDR register."]
   #[inline] pub fn pupdr(&self) -> Pupdr { 
      unsafe {
         Pupdr(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the IDR register."]
   #[inline] pub fn idr(&self) -> Idr { 
      unsafe {
         Idr(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the ODR register."]
   #[inline] pub fn odr(&self) -> Odr { 
      unsafe {
         Odr(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the LCKR register."]
   #[inline] pub fn lckr(&self) -> Lckr { 
      unsafe {
         Lckr(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the AFRL register."]
   #[inline] pub fn afrl(&self) -> Afrl { 
      unsafe {
         Afrl(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the AFRH register."]
   #[inline] pub fn afrh(&self) -> Afrh { 
      unsafe {
         Afrh(::core::ptr::read_volatile((self.0 + 0x24) as *const u32))
      }
   }
