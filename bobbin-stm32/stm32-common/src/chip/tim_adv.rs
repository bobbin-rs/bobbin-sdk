...
// PeripheralGroup { name: "TIM_ADV", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("TIM_ADV"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CR1", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("control register 1"), fields: [Field { name: "CEN", bit_offset: 0, bit_width: 1, access: None, description: Some("Counter enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "UDIS", bit_offset: 1, bit_width: 1, access: None, description: Some("Update disable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "URS", bit_offset: 2, bit_width: 1, access: None, description: Some("Update request source"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OPM", bit_offset: 3, bit_width: 1, access: None, description: Some("One-pulse mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DIR", bit_offset: 4, bit_width: 1, access: None, description: Some("Direction"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMS", bit_offset: 5, bit_width: 2, access: None, description: Some("Center-aligned mode selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ARPE", bit_offset: 7, bit_width: 1, access: None, description: Some("Auto-reload preload enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CKD", bit_offset: 8, bit_width: 2, access: None, description: Some("Clock division"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "UIFREMAP", bit_offset: 11, bit_width: 1, access: None, description: Some("UIF status bit remapping"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR2", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("control register 2"), fields: [Field { name: "CCPC", bit_offset: 0, bit_width: 1, access: None, description: Some("Capture/compare preloaded control"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CCUS", bit_offset: 2, bit_width: 1, access: None, description: Some("Capture/compare control update selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CCDS", bit_offset: 3, bit_width: 1, access: None, description: Some("Capture/compare DMA selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MMS", bit_offset: 4, bit_width: 3, access: None, description: Some("Master mode selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TI1S", bit_offset: 7, bit_width: 1, access: None, description: Some("TI1 selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS1", bit_offset: 8, bit_width: 1, access: None, description: Some("Output Idle state 1"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS1N", bit_offset: 9, bit_width: 1, access: None, description: Some("Output Idle state 1"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS2", bit_offset: 10, bit_width: 1, access: None, description: Some("Output Idle state 2"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS2N", bit_offset: 11, bit_width: 1, access: None, description: Some("Output Idle state 2"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS3", bit_offset: 12, bit_width: 1, access: None, description: Some("Output Idle state 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS3N", bit_offset: 13, bit_width: 1, access: None, description: Some("Output Idle state 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS4", bit_offset: 14, bit_width: 1, access: None, description: Some("Output Idle state 4"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS5", bit_offset: 16, bit_width: 1, access: None, description: Some("Output Idle state 5"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OIS6", bit_offset: 18, bit_width: 1, access: None, description: Some("Output Idle state 6"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MMS2", bit_offset: 20, bit_width: 4, access: None, description: Some("Master mode selection 2"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SMCR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("slave mode control register"), fields: [Field { name: "SMS", bit_offset: 0, bit_width: 3, access: None, description: Some("Slave mode selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OCCS", bit_offset: 3, bit_width: 1, access: None, description: Some("OCREF clear selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TS", bit_offset: 4, bit_width: 3, access: None, description: Some("Trigger selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSM", bit_offset: 7, bit_width: 1, access: None, description: Some("Master/Slave mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ETF", bit_offset: 8, bit_width: 4, access: None, description: Some("External trigger filter"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ETPS", bit_offset: 12, bit_width: 2, access: None, description: Some("External trigger prescaler"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ECE", bit_offset: 14, bit_width: 1, access: None, description: Some("External clock enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ETP", bit_offset: 15, bit_width: 1, access: None, description: Some("External trigger polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SMS3", bit_offset: 16, bit_width: 1, access: None, description: Some("Slave mode selection bit 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DIER", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA/Interrupt enable register"), fields: [Field { name: "TDE", bit_offset: 14, bit_width: 1, access: None, description: Some("Trigger DMA request enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "COMDE", bit_offset: 13, bit_width: 1, access: None, description: Some("Reserved"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CCDE", bit_offset: 9, bit_width: 1, access: None, description: Some("Capture/Compare n DMA request enable"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }, Field { name: "UDE", bit_offset: 8, bit_width: 1, access: None, description: Some("Update DMA request enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BIE", bit_offset: 7, bit_width: 1, access: None, description: Some("Break interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TIE", bit_offset: 6, bit_width: 1, access: None, description: Some("Trigger interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "COMIE", bit_offset: 5, bit_width: 1, access: None, description: Some("COM interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CCIE", bit_offset: 1, bit_width: 1, access: None, description: Some("Capture/Compare n interrupt enable"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }, Field { name: "UIE", bit_offset: 0, bit_width: 1, access: None, description: Some("Update interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SR", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("status register"), fields: [Field { name: "UIF", bit_offset: 0, bit_width: 1, access: None, description: Some("Update interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC1IF", bit_offset: 1, bit_width: 1, access: None, description: Some("Capture/compare 1 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC2IF", bit_offset: 2, bit_width: 1, access: None, description: Some("Capture/Compare 2 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC3IF", bit_offset: 3, bit_width: 1, access: None, description: Some("Capture/Compare 3 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC4IF", bit_offset: 4, bit_width: 1, access: None, description: Some("Capture/Compare 4 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "COMIF", bit_offset: 5, bit_width: 1, access: None, description: Some("COM interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TIF", bit_offset: 6, bit_width: 1, access: None, description: Some("Trigger interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BIF", bit_offset: 7, bit_width: 1, access: None, description: Some("Break interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "B2IF", bit_offset: 8, bit_width: 1, access: None, description: Some("Break 2 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC1OF", bit_offset: 9, bit_width: 1, access: None, description: Some("Capture/Compare 1 overcapture flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC2OF", bit_offset: 10, bit_width: 1, access: None, description: Some("Capture/compare 2 overcapture flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC3OF", bit_offset: 11, bit_width: 1, access: None, description: Some("Capture/Compare 3 overcapture flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC4OF", bit_offset: 12, bit_width: 1, access: None, description: Some("Capture/Compare 4 overcapture flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC5IF", bit_offset: 16, bit_width: 1, access: None, description: Some("Capture/Compare 5 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC6IF", bit_offset: 17, bit_width: 1, access: None, description: Some("Capture/Compare 6 interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "EGR", offset: 20, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: None, description: Some("event generation register"), fields: [Field { name: "UG", bit_offset: 0, bit_width: 1, access: None, description: Some("Update generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC1G", bit_offset: 1, bit_width: 1, access: None, description: Some("Capture/compare 1 generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC2G", bit_offset: 2, bit_width: 1, access: None, description: Some("Capture/compare 2 generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC3G", bit_offset: 3, bit_width: 1, access: None, description: Some("Capture/compare 3 generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CC4G", bit_offset: 4, bit_width: 1, access: None, description: Some("Capture/compare 4 generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "COMG", bit_offset: 5, bit_width: 1, access: None, description: Some("Capture/Compare control update generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TG", bit_offset: 6, bit_width: 1, access: None, description: Some("Trigger generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BG", bit_offset: 7, bit_width: 1, access: None, description: Some("Break generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "B2G", bit_offset: 8, bit_width: 1, access: None, description: Some("Break 2 generation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCMR_OUTPUT", offset: 24, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare mode register (output mode)"), fields: [Field { name: "OCCE", bit_offset: 7, bit_width: 1, access: None, description: Some("Output Compare n clear enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "OCM", bit_offset: 4, bit_width: 3, access: None, description: Some("Output Compare n mode"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "OCPE", bit_offset: 3, bit_width: 1, access: None, description: Some("Output Compare n preload enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "OCFE", bit_offset: 2, bit_width: 1, access: None, description: Some("Output Compare n fast enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CCS", bit_offset: 0, bit_width: 2, access: None, description: Some("Capture/Compare n selection"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "CCMR_INPUT", offset: 24, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare mode register n (input mode)"), fields: [Field { name: "ICF", bit_offset: 4, bit_width: 4, access: None, description: Some("Input capture 1 filter"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "ICPCS", bit_offset: 2, bit_width: 2, access: None, description: Some("Input capture 1 prescaler"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CC1S", bit_offset: 0, bit_width: 2, access: None, description: Some("Capture/Compare 1 selection"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "CCER", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare enable register"), fields: [Field { name: "CCE", bit_offset: 0, bit_width: 1, access: None, description: Some("Capture/Compare n output enable"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(4), dim_index: None }, Field { name: "CCP", bit_offset: 1, bit_width: 1, access: None, description: Some("Capture/Compare n output Polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CCNE", bit_offset: 2, bit_width: 1, access: None, description: Some("Capture/Compare n complementary output enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CCNP", bit_offset: 3, bit_width: 1, access: None, description: Some("Capture/Compare n output Polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CNT", offset: 36, size: Some(32), access: None, reset_value: Some(0), reset_mask: None, description: Some("counter"), fields: [Field { name: "CNT", bit_offset: 0, bit_width: 16, access: Some(ReadWrite), description: Some("counter value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "UIFCPY", bit_offset: 31, bit_width: 1, access: Some(ReadOnly), description: Some("UIF copy"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PSC", offset: 40, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("prescaler"), fields: [Field { name: "PSC", bit_offset: 0, bit_width: 16, access: None, description: Some("Prescaler value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ARR", offset: 44, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("auto-reload register"), fields: [Field { name: "ARR", bit_offset: 0, bit_width: 16, access: None, description: Some("Auto-reload value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RCR", offset: 48, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("repetition counter register"), fields: [Field { name: "REP", bit_offset: 0, bit_width: 16, access: None, description: Some("Repetition counter value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCR", offset: 52, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare register n"), fields: [Field { name: "CCR", bit_offset: 0, bit_width: 16, access: None, description: Some("Capture/Compare n value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(4), dim_index: None }, Register { name: "BDTR", offset: 68, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("break and dead-time register"), fields: [Field { name: "DTG", bit_offset: 0, bit_width: 8, access: None, description: Some("Dead-time generator setup"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LOCK", bit_offset: 8, bit_width: 2, access: None, description: Some("Lock configuration"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OSSI", bit_offset: 10, bit_width: 1, access: None, description: Some("Off-state selection for Idle mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OSSR", bit_offset: 11, bit_width: 1, access: None, description: Some("Off-state selection for Run mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BKE", bit_offset: 12, bit_width: 1, access: None, description: Some("Break enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BKP", bit_offset: 13, bit_width: 1, access: None, description: Some("Break polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AOE", bit_offset: 14, bit_width: 1, access: None, description: Some("Automatic output enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MOE", bit_offset: 15, bit_width: 1, access: None, description: Some("Main output enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BKF", bit_offset: 16, bit_width: 4, access: None, description: Some("Break filter"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BK2F", bit_offset: 20, bit_width: 4, access: None, description: Some("Break 2 filter"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BK2E", bit_offset: 24, bit_width: 1, access: None, description: Some("Break 2 enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BK2P", bit_offset: 25, bit_width: 1, access: None, description: Some("Break 2 polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DCR", offset: 72, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA control register"), fields: [Field { name: "DBL", bit_offset: 8, bit_width: 5, access: None, description: Some("DMA burst length"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DBA", bit_offset: 0, bit_width: 5, access: None, description: Some("DMA base address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DMAR", offset: 76, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA address for full transfer"), fields: [Field { name: "DMAB", bit_offset: 0, bit_width: 16, access: None, description: Some("DMA register for burst accesses"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCMR3_Output", offset: 84, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare mode register 3 (output mode)"), fields: [Field { name: "OC5FE", bit_offset: 2, bit_width: 1, access: None, description: Some("Output compare 5 fast enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC5PE", bit_offset: 3, bit_width: 1, access: None, description: Some("Output compare 5 preload enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC5M", bit_offset: 4, bit_width: 3, access: None, description: Some("Output compare 5 mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC5CE", bit_offset: 7, bit_width: 1, access: None, description: Some("Output compare 5 clear enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC6FE", bit_offset: 10, bit_width: 1, access: None, description: Some("Output compare 6 fast enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC6PE", bit_offset: 11, bit_width: 1, access: None, description: Some("Output compare 6 preload enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC6M", bit_offset: 12, bit_width: 3, access: None, description: Some("Output compare 6 mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC6CE", bit_offset: 15, bit_width: 1, access: None, description: Some("Output compare 6 clear enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC5M_3", bit_offset: 16, bit_width: 1, access: None, description: Some("Outout Compare 5 mode bit 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OC6M_3", bit_offset: 24, bit_width: 1, access: None, description: Some("Outout Compare 6 mode bit 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCR5", offset: 88, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare register 5"), fields: [Field { name: "CCR5", bit_offset: 0, bit_width: 16, access: None, description: Some("Capture/Compare 5 value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "GC5C1", bit_offset: 29, bit_width: 1, access: None, description: Some("Group Channel 5 and Channel 1"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "GC5C2", bit_offset: 30, bit_width: 1, access: None, description: Some("Group Channel 5 and Channel 2"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "GC5C3", bit_offset: 31, bit_width: 1, access: None, description: Some("Group Channel 5 and Channel 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCR6", offset: 92, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("capture/compare register 6"), fields: [Field { name: "CCR6", bit_offset: 0, bit_width: 16, access: None, description: Some("Capture/Compare 6 value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "OR", offset: 96, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("option registers"), fields: [Field { name: "TIM1_ETR_ADC1_RMP", bit_offset: 0, bit_width: 2, access: None, description: Some("TIM1_ETR_ADC1 remapping capability"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TIM1_ETR_ADC4_RMP", bit_offset: 2, bit_width: 2, access: None, description: Some("TIM1_ETR_ADC4 remapping capability"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the SMCR register."]
   #[inline] pub fn smcr(&self) -> Smcr { 
      unsafe {
         Smcr(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the CCMR_OUTPUT register."]
   #[inline] pub fn ccmr_output<I: Into<bits::R2>>(&self, index: I) -> CcmrOutput { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         CcmrOutput(::core::ptr::read_volatile((self.0 + 0x18 + (index << 2)) as *const u32))
      }
   }
...
#[doc="Read the CCMR_INPUT register."]
   #[inline] pub fn ccmr_input<I: Into<bits::R2>>(&self, index: I) -> CcmrInput { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         CcmrInput(::core::ptr::read_volatile((self.0 + 0x18 + (index << 2)) as *const u32))
      }
   }
...
#[doc="Read the CCER register."]
   #[inline] pub fn ccer(&self) -> Ccer { 
      unsafe {
         Ccer(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the RCR register."]
   #[inline] pub fn rcr(&self) -> Rcr { 
      unsafe {
         Rcr(::core::ptr::read_volatile((self.0 + 0x30) as *const u32))
      }
   }
...
#[doc="Read the CCR register."]
   #[inline] pub fn ccr<I: Into<bits::R4>>(&self, index: I) -> Ccr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Ccr(::core::ptr::read_volatile((self.0 + 0x34 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the CCR register."]
   #[inline] pub fn set_ccr<I: Into<bits::R4>, F: FnOnce(Ccr) -> Ccr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Ccr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x34 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the BDTR register."]
   #[inline] pub fn bdtr(&self) -> Bdtr { 
      unsafe {
         Bdtr(::core::ptr::read_volatile((self.0 + 0x44) as *const u32))
      }
   }
...
#[doc="Read the DCR register."]
   #[inline] pub fn dcr(&self) -> Dcr { 
      unsafe {
         Dcr(::core::ptr::read_volatile((self.0 + 0x48) as *const u32))
      }
   }
...
#[doc="Read the DMAR register."]
   #[inline] pub fn dmar(&self) -> Dmar { 
      unsafe {
         Dmar(::core::ptr::read_volatile((self.0 + 0x4c) as *const u32))
      }
   }
...
#[doc="Read the CCMR3_OUTPUT register."]
   #[inline] pub fn ccmr3_output(&self) -> Ccmr3Output { 
      unsafe {
         Ccmr3Output(::core::ptr::read_volatile((self.0 + 0x54) as *const u32))
      }
   }
...
#[doc="Read the CCR5 register."]
   #[inline] pub fn ccr5(&self) -> Ccr5 { 
      unsafe {
         Ccr5(::core::ptr::read_volatile((self.0 + 0x58) as *const u32))
      }
   }
...
#[doc="Read the CCR6 register."]
   #[inline] pub fn ccr6(&self) -> Ccr6 { 
      unsafe {
         Ccr6(::core::ptr::read_volatile((self.0 + 0x5c) as *const u32))
      }
   }
...
#[doc="Read the OR register."]
   #[inline] pub fn or(&self) -> Or { 
      unsafe {
         Or(::core::ptr::read_volatile((self.0 + 0x60) as *const u32))
      }
   }
