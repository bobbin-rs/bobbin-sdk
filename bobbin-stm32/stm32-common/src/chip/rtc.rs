...
// PeripheralGroup { name: "RTC", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("RTC"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "TR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC time register"), fields: [Field { name: "PM", bit_offset: 22, bit_width: 1, access: None, description: Some("AM/PM notation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HT", bit_offset: 20, bit_width: 2, access: None, description: Some("Hour tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HU", bit_offset: 16, bit_width: 4, access: None, description: Some("Hour units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNT", bit_offset: 12, bit_width: 3, access: None, description: Some("Minute tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNU", bit_offset: 8, bit_width: 4, access: None, description: Some("Minute units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ST", bit_offset: 4, bit_width: 3, access: None, description: Some("Second tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SU", bit_offset: 0, bit_width: 4, access: None, description: Some("Second units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DR", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC date register"), fields: [Field { name: "YT", bit_offset: 20, bit_width: 4, access: None, description: Some("Year tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "YU", bit_offset: 16, bit_width: 4, access: None, description: Some("Year units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WDU", bit_offset: 13, bit_width: 3, access: None, description: Some("Week day units"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MT", bit_offset: 12, bit_width: 1, access: None, description: Some("Month tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MU", bit_offset: 8, bit_width: 4, access: None, description: Some("Month units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DT", bit_offset: 4, bit_width: 2, access: None, description: Some("Date tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DU", bit_offset: 0, bit_width: 4, access: None, description: Some("Date units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR", offset: 8, size: Some(32), access: None, reset_value: Some(0), reset_mask: None, description: Some("RTC control register"), fields: [Field { name: "COE", bit_offset: 23, bit_width: 1, access: Some(ReadWrite), description: Some("Calibration output enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OSEL", bit_offset: 21, bit_width: 2, access: Some(ReadWrite), description: Some("Output selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "POL", bit_offset: 20, bit_width: 1, access: Some(ReadWrite), description: Some("Output polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "COSEL", bit_offset: 19, bit_width: 1, access: Some(ReadWrite), description: Some("Calibration output selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BKP", bit_offset: 18, bit_width: 1, access: Some(ReadWrite), description: Some("Backup"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SUB1H", bit_offset: 17, bit_width: 1, access: Some(WriteOnly), description: Some("Subtract 1 hour (winter time change)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADD1H", bit_offset: 16, bit_width: 1, access: Some(WriteOnly), description: Some("Add 1 hour (summer time change)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSIE", bit_offset: 15, bit_width: 1, access: Some(ReadWrite), description: Some("Time-stamp interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUTIE", bit_offset: 14, bit_width: 1, access: Some(ReadWrite), description: Some("Wakeup timer interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRBIE", bit_offset: 13, bit_width: 1, access: Some(ReadWrite), description: Some("Alarm B interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRAIE", bit_offset: 12, bit_width: 1, access: Some(ReadWrite), description: Some("Alarm A interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSE", bit_offset: 11, bit_width: 1, access: Some(ReadWrite), description: Some("timestamp enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUTE", bit_offset: 10, bit_width: 1, access: Some(ReadWrite), description: Some("Wakeup timer enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRBE", bit_offset: 9, bit_width: 1, access: Some(ReadWrite), description: Some("Alarm B enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRAE", bit_offset: 8, bit_width: 1, access: Some(ReadWrite), description: Some("Alarm A enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FMT", bit_offset: 6, bit_width: 1, access: Some(ReadWrite), description: Some("Hour format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BYPSHAD", bit_offset: 5, bit_width: 1, access: Some(ReadWrite), description: Some("Bypass the shadow registers"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "REFCKON", bit_offset: 4, bit_width: 1, access: Some(ReadWrite), description: Some("RTC_REFIN reference clock detection enable (50 or 60 Hz)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSEDGE", bit_offset: 3, bit_width: 1, access: Some(ReadWrite), description: Some("Time-stamp event active edge"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUCKSEL", bit_offset: 0, bit_width: 3, access: Some(ReadWrite), description: Some("Wakeup clock selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ISR", offset: 12, size: Some(32), access: None, reset_value: Some(0), reset_mask: None, description: Some("RTC initialization and status register"), fields: [Field { name: "TAMP2F", bit_offset: 14, bit_width: 1, access: Some(ReadWrite), description: Some("RTC_TAMP2 detection flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP1F", bit_offset: 13, bit_width: 1, access: Some(ReadWrite), description: Some("RTC_TAMP1 detection flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSOVF", bit_offset: 12, bit_width: 1, access: Some(ReadWrite), description: Some("Time-stamp overflow flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSF", bit_offset: 11, bit_width: 1, access: Some(ReadWrite), description: Some("Time-stamp flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUTF", bit_offset: 10, bit_width: 1, access: Some(ReadWrite), description: Some("Wakeup timer flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRBF", bit_offset: 9, bit_width: 1, access: Some(ReadWrite), description: Some("Alarm B flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRAF", bit_offset: 8, bit_width: 1, access: Some(ReadWrite), description: Some("Alarm A flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INIT", bit_offset: 7, bit_width: 1, access: Some(ReadWrite), description: Some("Initialization mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INITF", bit_offset: 6, bit_width: 1, access: Some(ReadOnly), description: Some("Initialization flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RSF", bit_offset: 5, bit_width: 1, access: Some(ReadWrite), description: Some("Registers synchronization flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INITS", bit_offset: 4, bit_width: 1, access: Some(ReadOnly), description: Some("Initialization status flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SHPF", bit_offset: 3, bit_width: 1, access: Some(ReadOnly), description: Some("Shift operation pending"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUTWF", bit_offset: 2, bit_width: 1, access: Some(ReadOnly), description: Some("Wakeup timer write flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRBWF", bit_offset: 1, bit_width: 1, access: Some(ReadOnly), description: Some("Alarm B write flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALRAWF", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Alarm A write flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PRER", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC prescaler register"), fields: [Field { name: "PREDIV_A", bit_offset: 16, bit_width: 7, access: None, description: Some("Asynchronous prescaler factor"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PREDIV_S", bit_offset: 0, bit_width: 16, access: None, description: Some("Synchronous prescaler factor"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "WUTR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC wakeup timer register"), fields: [Field { name: "WUT", bit_offset: 0, bit_width: 16, access: None, description: Some("Wakeup auto-reload value bits"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALRMAR", offset: 28, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC alarm A register"), fields: [Field { name: "MSK4", bit_offset: 31, bit_width: 1, access: None, description: Some("Alarm A date mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WDSEL", bit_offset: 30, bit_width: 1, access: None, description: Some("Week day selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DT", bit_offset: 28, bit_width: 2, access: None, description: Some("Date tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DU", bit_offset: 24, bit_width: 4, access: None, description: Some("Date units or day in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSK3", bit_offset: 23, bit_width: 1, access: None, description: Some("Alarm A hours mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PM", bit_offset: 22, bit_width: 1, access: None, description: Some("AM/PM notation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HT", bit_offset: 20, bit_width: 2, access: None, description: Some("Hour tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HU", bit_offset: 16, bit_width: 4, access: None, description: Some("Hour units in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSK2", bit_offset: 15, bit_width: 1, access: None, description: Some("Alarm A minutes mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNT", bit_offset: 12, bit_width: 3, access: None, description: Some("Minute tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNU", bit_offset: 8, bit_width: 4, access: None, description: Some("Minute units in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSK1", bit_offset: 7, bit_width: 1, access: None, description: Some("Alarm A seconds mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ST", bit_offset: 4, bit_width: 3, access: None, description: Some("Second tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SU", bit_offset: 0, bit_width: 4, access: None, description: Some("Second units in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALRMBR", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC alarm B register"), fields: [Field { name: "MSK4", bit_offset: 31, bit_width: 1, access: None, description: Some("Alarm B date mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WDSEL", bit_offset: 30, bit_width: 1, access: None, description: Some("Week day selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DT", bit_offset: 28, bit_width: 2, access: None, description: Some("Date tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DU", bit_offset: 24, bit_width: 4, access: None, description: Some("Date units or day in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSK3", bit_offset: 23, bit_width: 1, access: None, description: Some("Alarm B hours mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PM", bit_offset: 22, bit_width: 1, access: None, description: Some("AM/PM notation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HT", bit_offset: 20, bit_width: 2, access: None, description: Some("Hour tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HU", bit_offset: 16, bit_width: 4, access: None, description: Some("Hour units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSK2", bit_offset: 15, bit_width: 1, access: None, description: Some("Alarm B minutes mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNT", bit_offset: 12, bit_width: 3, access: None, description: Some("Minute tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNU", bit_offset: 8, bit_width: 4, access: None, description: Some("Minute units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSK1", bit_offset: 7, bit_width: 1, access: None, description: Some("Alarm B seconds mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ST", bit_offset: 4, bit_width: 3, access: None, description: Some("Second tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SU", bit_offset: 0, bit_width: 4, access: None, description: Some("Second units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "WPR", offset: 36, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: None, description: Some("write protection register"), fields: [Field { name: "KEY", bit_offset: 0, bit_width: 8, access: None, description: Some("Write protection key"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SSR", offset: 40, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("RTC sub second register"), fields: [Field { name: "SS", bit_offset: 0, bit_width: 16, access: None, description: Some("Sub second value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SHIFTR", offset: 44, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: None, description: Some("RTC shift control register"), fields: [Field { name: "ADD1S", bit_offset: 31, bit_width: 1, access: None, description: Some("Add one second"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SUBFS", bit_offset: 0, bit_width: 15, access: None, description: Some("Subtract a fraction of a second"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TSTR", offset: 48, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("RTC timestamp time register"), fields: [Field { name: "PM", bit_offset: 22, bit_width: 1, access: None, description: Some("AM/PM notation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HT", bit_offset: 20, bit_width: 2, access: None, description: Some("Hour tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HU", bit_offset: 16, bit_width: 4, access: None, description: Some("Hour units in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNT", bit_offset: 12, bit_width: 3, access: None, description: Some("Minute tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MNU", bit_offset: 8, bit_width: 4, access: None, description: Some("Minute units in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ST", bit_offset: 4, bit_width: 3, access: None, description: Some("Second tens in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SU", bit_offset: 0, bit_width: 4, access: None, description: Some("Second units in BCD format."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TSDR", offset: 52, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("RTC timestamp date register"), fields: [Field { name: "WDU", bit_offset: 13, bit_width: 3, access: None, description: Some("Week day units"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MT", bit_offset: 12, bit_width: 1, access: None, description: Some("Month tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MU", bit_offset: 8, bit_width: 4, access: None, description: Some("Month units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DT", bit_offset: 4, bit_width: 2, access: None, description: Some("Date tens in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DU", bit_offset: 0, bit_width: 4, access: None, description: Some("Date units in BCD format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TSSSR", offset: 56, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("RTC time-stamp sub second register"), fields: [Field { name: "SS", bit_offset: 0, bit_width: 16, access: None, description: Some("Sub second value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CALR", offset: 60, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC calibration register"), fields: [Field { name: "CALP", bit_offset: 15, bit_width: 1, access: None, description: Some("Use an 8-second calibration cycle period"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CALW8", bit_offset: 14, bit_width: 1, access: None, description: Some("Use a 16-second calibration cycle period"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CALW16", bit_offset: 13, bit_width: 1, access: None, description: Some("Reserved"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CALM", bit_offset: 0, bit_width: 9, access: None, description: Some("Calibration minus"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TAMPCR", offset: 64, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC tamper configuration register"), fields: [Field { name: "TAMP2MF", bit_offset: 21, bit_width: 1, access: None, description: Some("Tamper 2 mask flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP2NOERASE", bit_offset: 20, bit_width: 1, access: None, description: Some("Tamper 2 no erase"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP2IE", bit_offset: 19, bit_width: 1, access: None, description: Some("Tamper 2 interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP1MF", bit_offset: 18, bit_width: 1, access: None, description: Some("Tamper 1 mask flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP1NOERASE", bit_offset: 17, bit_width: 1, access: None, description: Some("Tamper 1 no erase"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP1IE", bit_offset: 16, bit_width: 1, access: None, description: Some("Tamper 1 interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMPPUDIS", bit_offset: 15, bit_width: 1, access: None, description: Some("RTC_TAMPx pull-up disable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMPPRCH", bit_offset: 13, bit_width: 2, access: None, description: Some("RTC_TAMPx precharge duration"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMPFLT", bit_offset: 11, bit_width: 2, access: None, description: Some("RTC_TAMPx filter count"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMPFREQ", bit_offset: 8, bit_width: 3, access: None, description: Some("Tamper sampling frequency"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMPTS", bit_offset: 7, bit_width: 1, access: None, description: Some("Activate timestamp on tamper detection event"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP2_TRG", bit_offset: 4, bit_width: 1, access: None, description: Some("Active level for RTC_TAMP2 input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP2E", bit_offset: 3, bit_width: 1, access: None, description: Some("RTC_TAMP2 input detection enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMPIE", bit_offset: 2, bit_width: 1, access: None, description: Some("Tamper interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP1TRG", bit_offset: 1, bit_width: 1, access: None, description: Some("Active level for RTC_TAMP1 input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMP1E", bit_offset: 0, bit_width: 1, access: None, description: Some("RTC_TAMP1 input detection enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALRMASSR", offset: 68, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC alarm A sub second register"), fields: [Field { name: "MASKSS", bit_offset: 24, bit_width: 4, access: None, description: Some("Mask the most-significant bits starting at this bit"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SS", bit_offset: 0, bit_width: 15, access: None, description: Some("Sub seconds value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALRMBSSR", offset: 72, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC alarm B sub second register"), fields: [Field { name: "MASKSS", bit_offset: 24, bit_width: 4, access: None, description: Some("Mask the most-significant bits starting at this bit"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SS", bit_offset: 0, bit_width: 15, access: None, description: Some("Sub seconds value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "OR", offset: 76, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("option register"), fields: [Field { name: "RTC_OUT_RMP", bit_offset: 1, bit_width: 1, access: None, description: Some("RTC_ALARM on PC13 output type"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTC_ALARM_TYPE", bit_offset: 0, bit_width: 1, access: None, description: Some("RTC_ALARM on PC13 output type"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BKPR", offset: 80, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("RTC backup register n"), fields: [Field { name: "BKP", bit_offset: 0, bit_width: 32, access: None, description: Some("BKP"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(5), dim_increment: Some(4), dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
...
#[doc="Read the TR register."]
   #[inline] pub fn tr(&self) -> Tr { 
      unsafe {
         Tr(::core::ptr::read_volatile((self.0 + 0x0) as *const u32))
      }
   }
...
#[doc="Read the ISR register."]
   #[inline] pub fn isr(&self) -> Isr { 
      unsafe {
         Isr(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the PRER register."]
   #[inline] pub fn prer(&self) -> Prer { 
      unsafe {
         Prer(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the WUTR register."]
   #[inline] pub fn wutr(&self) -> Wutr { 
      unsafe {
         Wutr(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the ALRMAR register."]
   #[inline] pub fn alrmar(&self) -> Alrmar { 
      unsafe {
         Alrmar(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the ALRMBR register."]
   #[inline] pub fn alrmbr(&self) -> Alrmbr { 
      unsafe {
         Alrmbr(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the SSR register."]
   #[inline] pub fn ssr(&self) -> Ssr { 
      unsafe {
         Ssr(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
...
#[doc="Read the TSTR register."]
   #[inline] pub fn tstr(&self) -> Tstr { 
      unsafe {
         Tstr(::core::ptr::read_volatile((self.0 + 0x30) as *const u32))
      }
   }
...
#[doc="Read the TSDR register."]
   #[inline] pub fn tsdr(&self) -> Tsdr { 
      unsafe {
         Tsdr(::core::ptr::read_volatile((self.0 + 0x34) as *const u32))
      }
   }
...
#[doc="Read the TSSSR register."]
   #[inline] pub fn tsssr(&self) -> Tsssr { 
      unsafe {
         Tsssr(::core::ptr::read_volatile((self.0 + 0x38) as *const u32))
      }
   }
...
#[doc="Read the CALR register."]
   #[inline] pub fn calr(&self) -> Calr { 
      unsafe {
         Calr(::core::ptr::read_volatile((self.0 + 0x3c) as *const u32))
      }
   }
...
#[doc="Read the TAMPCR register."]
   #[inline] pub fn tampcr(&self) -> Tampcr { 
      unsafe {
         Tampcr(::core::ptr::read_volatile((self.0 + 0x40) as *const u32))
      }
   }
...
#[doc="Read the ALRMASSR register."]
   #[inline] pub fn alrmassr(&self) -> Alrmassr { 
      unsafe {
         Alrmassr(::core::ptr::read_volatile((self.0 + 0x44) as *const u32))
      }
   }
...
#[doc="Read the ALRMBSSR register."]
   #[inline] pub fn alrmbssr(&self) -> Alrmbssr { 
      unsafe {
         Alrmbssr(::core::ptr::read_volatile((self.0 + 0x48) as *const u32))
      }
   }
...
#[doc="Read the OR register."]
   #[inline] pub fn or(&self) -> Or { 
      unsafe {
         Or(::core::ptr::read_volatile((self.0 + 0x4c) as *const u32))
      }
   }
...
#[doc="Read the BKPR register."]
   #[inline] pub fn bkpr<I: Into<bits::R5>>(&self, index: I) -> Bkpr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Bkpr(::core::ptr::read_volatile((self.0 + 0x50 + (index << 2)) as *const u32))
      }
   }
