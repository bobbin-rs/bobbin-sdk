...
// PeripheralGroup { name: "CRC", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("CRC"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "DR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(4294967295), reset_mask: None, description: Some("Data register"), fields: [Field { name: "DR", bit_offset: 0, bit_width: 32, access: None, description: Some("Data register bits"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "IDR", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Independent data register"), fields: [Field { name: "IDR", bit_offset: 0, bit_width: 8, access: None, description: Some("General-purpose 8-bit data register bits"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR", offset: 8, size: Some(32), access: None, reset_value: Some(0), reset_mask: None, description: Some("Control register"), fields: [Field { name: "REV_OUT", bit_offset: 7, bit_width: 1, access: Some(ReadWrite), description: Some("Reverse output data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "REV_IN", bit_offset: 5, bit_width: 2, access: Some(ReadWrite), description: Some("Reverse input data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "POLYSIZE", bit_offset: 3, bit_width: 2, access: Some(ReadWrite), description: Some("Polynomial size"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RESET", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("RESET bit"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "INIT", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(4294967295), reset_mask: None, description: Some("Initial CRC value"), fields: [Field { name: "INIT", bit_offset: 0, bit_width: 32, access: None, description: Some("Programmable initial CRC value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "POL", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(79764919), reset_mask: None, description: Some("polynomial"), fields: [Field { name: "POL", bit_offset: 0, bit_width: 32, access: None, description: Some("Programmable polynomial"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
