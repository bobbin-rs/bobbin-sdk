...
// PeripheralGroup { name: "EXTI", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("EXTI"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: Some("External interrupt/event controller"), modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "IMR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Interrupt mask register (EXTI_IMR)"), fields: [Field { name: "MR", bit_offset: 0, bit_width: 1, access: None, description: Some("Interrupt Mask on line n = 0..32"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "EMR", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Event mask register (EXTI_EMR)"), fields: [Field { name: "MR", bit_offset: 0, bit_width: 1, access: None, description: Some("Event Mask on line n = 0..32"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RTSR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Rising Trigger selection register (EXTI_RTSR)"), fields: [Field { name: "TR", bit_offset: 0, bit_width: 1, access: None, description: Some("Rising trigger event configuration of line n = 0..32"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "FTSR", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Falling Trigger selection register (EXTI_FTSR)"), fields: [Field { name: "TR", bit_offset: 0, bit_width: 1, access: None, description: Some("Falling trigger event configuration of line n = 0..32"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SWIER", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Software interrupt event register (EXTI_SWIER)"), fields: [Field { name: "SWI", bit_offset: 0, bit_width: 1, access: None, description: Some("Software Interrupt on line n = 0..32"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Pending interrupt register (EXTI_PR)"), fields: [Field { name: "PR", bit_offset: 0, bit_width: 1, access: None, description: Some("Pending Interrupt bit n = 0..32"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
