...
// PeripheralGroup { name: "ADC_L0", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("ADC"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "ISR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("interrupt and status register"), fields: [Field { name: "ADRDY", bit_offset: 0, bit_width: 1, access: None, description: Some("ADC ready"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOSMP", bit_offset: 1, bit_width: 1, access: None, description: Some("End of sampling flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOC", bit_offset: 2, bit_width: 1, access: None, description: Some("End of conversion flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOS", bit_offset: 3, bit_width: 1, access: None, description: Some("End of sequence flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVR", bit_offset: 4, bit_width: 1, access: None, description: Some("ADC overrun"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AWD", bit_offset: 7, bit_width: 1, access: None, description: Some("Analog watchdog flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOCAL", bit_offset: 11, bit_width: 1, access: None, description: Some("End Of Calibration flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "IER", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("interrupt enable register"), fields: [Field { name: "ADRDYIE", bit_offset: 0, bit_width: 1, access: None, description: Some("ADC ready interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOSMPIE", bit_offset: 1, bit_width: 1, access: None, description: Some("End of sampling flag interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOCIE", bit_offset: 2, bit_width: 1, access: None, description: Some("End of conversion interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOSIE", bit_offset: 3, bit_width: 1, access: None, description: Some("End of conversion sequence interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVRIE", bit_offset: 4, bit_width: 1, access: None, description: Some("Overrun interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AWDIE", bit_offset: 7, bit_width: 1, access: None, description: Some("Analog watchdog interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOCALIE", bit_offset: 11, bit_width: 1, access: None, description: Some("End of calibration interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("control register"), fields: [Field { name: "ADEN", bit_offset: 0, bit_width: 1, access: None, description: Some("ADC enable command"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADDIS", bit_offset: 1, bit_width: 1, access: None, description: Some("ADC disable command"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADSTART", bit_offset: 2, bit_width: 1, access: None, description: Some("ADC start conversion command"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADSTP", bit_offset: 4, bit_width: 1, access: None, description: Some("ADC stop conversion command"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADVREGEN", bit_offset: 28, bit_width: 1, access: None, description: Some("ADC Voltage Regulator Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADCAL", bit_offset: 31, bit_width: 1, access: None, description: Some("ADC calibration"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CFGR1", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("configuration register 1"), fields: [Field { name: "AWDCH", bit_offset: 26, bit_width: 5, access: None, description: Some("Analog watchdog channel selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AWDEN", bit_offset: 23, bit_width: 1, access: None, description: Some("Analog watchdog enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AWDSGL", bit_offset: 22, bit_width: 1, access: None, description: Some("Enable the watchdog on a single channel or on all channels"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DISCEN", bit_offset: 16, bit_width: 1, access: None, description: Some("Discontinuous mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AUTOFF", bit_offset: 15, bit_width: 1, access: None, description: Some("Auto-off mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "AUTDLY", bit_offset: 14, bit_width: 1, access: None, description: Some("Auto-delayed conversion mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CONT", bit_offset: 13, bit_width: 1, access: None, description: Some("Single / continuous conversion mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVRMOD", bit_offset: 12, bit_width: 1, access: None, description: Some("Overrun management mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EXTEN", bit_offset: 10, bit_width: 2, access: None, description: Some("External trigger enable and polarity selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EXTSEL", bit_offset: 6, bit_width: 3, access: None, description: Some("External trigger selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALIGN", bit_offset: 5, bit_width: 1, access: None, description: Some("Data alignment"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RES", bit_offset: 3, bit_width: 2, access: None, description: Some("Data resolution"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SCANDIR", bit_offset: 2, bit_width: 1, access: None, description: Some("Scan sequence direction"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMACFG", bit_offset: 1, bit_width: 1, access: None, description: Some("Direct memery access configuration"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAEN", bit_offset: 0, bit_width: 1, access: None, description: Some("Direct memory access enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CFGR2", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("configuration register 2"), fields: [Field { name: "OVSE", bit_offset: 0, bit_width: 1, access: None, description: Some("Oversampler Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVSR", bit_offset: 2, bit_width: 3, access: None, description: Some("Oversampling ratio"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVSS", bit_offset: 5, bit_width: 4, access: None, description: Some("Oversampling shift"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TOVS", bit_offset: 9, bit_width: 1, access: None, description: Some("Triggered Oversampling"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CKMODE", bit_offset: 30, bit_width: 2, access: None, description: Some("ADC clock mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SMPR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("sampling time register"), fields: [Field { name: "SMPR", bit_offset: 0, bit_width: 3, access: None, description: Some("Sampling time selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TR", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(268369920), reset_mask: None, description: Some("watchdog threshold register"), fields: [Field { name: "HT", bit_offset: 16, bit_width: 12, access: None, description: Some("Analog watchdog higher threshold"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LT", bit_offset: 0, bit_width: 12, access: None, description: Some("Analog watchdog lower threshold"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHSELR", offset: 40, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel selection register"), fields: [Field { name: "CHSEL", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel-x selection"), enumerated_values: [], links: [], dim: Some(19), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DR", offset: 64, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("data register"), fields: [Field { name: "DATA", bit_offset: 0, bit_width: 16, access: None, description: Some("Converted data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DATA_12", bit_offset: 0, bit_width: 12, access: None, description: Some("DATA (12 bit)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DATA_10", bit_offset: 0, bit_width: 10, access: None, description: Some("DATA (10 bit)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DATA_8", bit_offset: 0, bit_width: 8, access: None, description: Some("DATA (8 bit)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DATA_6", bit_offset: 0, bit_width: 6, access: None, description: Some("DATA (6 bit)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CALFACT", offset: 180, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("ADC Calibration factor"), fields: [Field { name: "CALFACT", bit_offset: 0, bit_width: 7, access: None, description: Some("Calibration factor"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCR", offset: 776, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("ADC common configuration register"), fields: [Field { name: "PRESC", bit_offset: 18, bit_width: 4, access: None, description: Some("ADC prescaler"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "VREFEN", bit_offset: 22, bit_width: 1, access: None, description: Some("VREFINT enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSEN", bit_offset: 23, bit_width: 1, access: None, description: Some("Temperature sensor enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "VLCDEN", bit_offset: 24, bit_width: 1, access: None, description: Some("VLCD enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LFMEN", bit_offset: 25, bit_width: 1, access: None, description: Some("Low Frequency Mode enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the CFGR1 register."]
   #[inline] pub fn cfgr1(&self) -> Cfgr1 { 
      unsafe {
         Cfgr1(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the CFGR2 register."]
   #[inline] pub fn cfgr2(&self) -> Cfgr2 { 
      unsafe {
         Cfgr2(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the SMPR register."]
   #[inline] pub fn smpr_ptr(&self) -> *const u32 { 
      ((self.0 as usize) + 0x14) as *const u32
   }
#[doc="Get the *mut pointer for the SMPR register."]
   #[inline] pub fn smpr_mut(&self) -> *mut u32 { 
      ((self.0 as usize) + 0x14) as *mut u32
   }
#[doc="Read the SMPR register."]
   #[inline] pub fn smpr(&self) -> Smpr { 
      unsafe {
         Smpr(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the TR register."]
   #[inline] pub fn tr(&self) -> Tr { 
      unsafe {
         Tr(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the CHSELR register."]
   #[inline] pub fn chselr_ptr(&self) -> *const u32 { 
      ((self.0 as usize) + 0x28) as *const u32
   }
#[doc="Get the *mut pointer for the CHSELR register."]
   #[inline] pub fn chselr_mut(&self) -> *mut u32 { 
      ((self.0 as usize) + 0x28) as *mut u32
   }
#[doc="Read the CHSELR register."]
   #[inline] pub fn chselr(&self) -> Chselr { 
      unsafe {
         Chselr(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
...
#[doc="Read the CCR register."]
   #[inline] pub fn ccr(&self) -> Ccr { 
      unsafe {
         Ccr(::core::ptr::read_volatile((self.0 + 0x308) as *const u32))
      }
   }
