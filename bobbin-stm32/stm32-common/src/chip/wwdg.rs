...
// PeripheralGroup { name: "WWDG", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("WWDG"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(127), reset_mask: None, description: Some("Control register"), fields: [Field { name: "WDGA", bit_offset: 7, bit_width: 1, access: None, description: Some("Activation bit"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "T", bit_offset: 0, bit_width: 7, access: None, description: Some("7-bit counter (MSB to LSB)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CFR", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(127), reset_mask: None, description: Some("Configuration register"), fields: [Field { name: "EWI", bit_offset: 9, bit_width: 1, access: None, description: Some("Early wakeup interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WDGTB", bit_offset: 7, bit_width: 2, access: None, description: Some("Timer base"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "W", bit_offset: 0, bit_width: 7, access: None, description: Some("7-bit window value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SR", offset: 8, size: Some(32), access: Some(ReadWriteOnce), reset_value: Some(0), reset_mask: None, description: Some("Status register"), fields: [Field { name: "EWIF", bit_offset: 0, bit_width: 1, access: None, description: Some("Early wakeup interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
...
#[doc="Read the CFR register."]
   #[inline] pub fn cfr(&self) -> Cfr { 
      unsafe {
         Cfr(::core::ptr::read_volatile((self.0 + 0x4) as *const u32))
      }
   }
