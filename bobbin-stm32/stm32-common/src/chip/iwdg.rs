...
// PeripheralGroup { name: "IWDG", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("IWDG"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "KR", offset: 0, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: None, description: Some("Key register"), fields: [Field { name: "KEY", bit_offset: 0, bit_width: 16, access: None, description: Some("Key value (write only, read 0x0000)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PR", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Prescaler register"), fields: [Field { name: "PR", bit_offset: 0, bit_width: 3, access: None, description: Some("Prescaler divider"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RLR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(4095), reset_mask: None, description: Some("Reload register"), fields: [Field { name: "RL", bit_offset: 0, bit_width: 12, access: None, description: Some("Watchdog counter reload value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SR", offset: 12, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("Status register"), fields: [Field { name: "WVU", bit_offset: 2, bit_width: 1, access: None, description: Some("Watchdog counter window value update"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RVU", bit_offset: 1, bit_width: 1, access: None, description: Some("Watchdog counter reload value update"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PVU", bit_offset: 0, bit_width: 1, access: None, description: Some("Watchdog prescaler value update"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "WINR", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(4095), reset_mask: None, description: Some("Window register"), fields: [Field { name: "WIN", bit_offset: 0, bit_width: 12, access: None, description: Some("Watchdog counter window value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
