...
// PeripheralGroup { name: "USART", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("USART"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CR1", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Control register 1"), fields: [Field { name: "EOBIE", bit_offset: 27, bit_width: 1, access: None, description: Some("End of Block interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTOIE", bit_offset: 26, bit_width: 1, access: None, description: Some("Receiver timeout interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DEAT", bit_offset: 21, bit_width: 5, access: None, description: Some("Driver Enable assertion time"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DEDT", bit_offset: 16, bit_width: 5, access: None, description: Some("Driver Enable deassertion time"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVER8", bit_offset: 15, bit_width: 1, access: None, description: Some("Oversampling mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMIE", bit_offset: 14, bit_width: 1, access: None, description: Some("Character match interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MME", bit_offset: 13, bit_width: 1, access: None, description: Some("Mute mode enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "M", bit_offset: 12, bit_width: 1, access: None, description: Some("Word length"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WAKE", bit_offset: 11, bit_width: 1, access: None, description: Some("Receiver wakeup method"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PCE", bit_offset: 10, bit_width: 1, access: None, description: Some("Parity control enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PS", bit_offset: 9, bit_width: 1, access: None, description: Some("Parity selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PEIE", bit_offset: 8, bit_width: 1, access: None, description: Some("PE interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TXEIE", bit_offset: 7, bit_width: 1, access: None, description: Some("interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCIE", bit_offset: 6, bit_width: 1, access: None, description: Some("Transmission complete interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXNEIE", bit_offset: 5, bit_width: 1, access: None, description: Some("RXNE interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "IDLEIE", bit_offset: 4, bit_width: 1, access: None, description: Some("IDLE interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TE", bit_offset: 3, bit_width: 1, access: None, description: Some("Transmitter enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RE", bit_offset: 2, bit_width: 1, access: None, description: Some("Receiver enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "UESM", bit_offset: 1, bit_width: 1, access: None, description: Some("USART enable in Stop mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "UE", bit_offset: 0, bit_width: 1, access: None, description: Some("USART enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR2", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Control register 2"), fields: [Field { name: "ADD4", bit_offset: 28, bit_width: 4, access: None, description: Some("Address of the USART node"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADD0", bit_offset: 24, bit_width: 4, access: None, description: Some("Address of the USART node"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTOEN", bit_offset: 23, bit_width: 1, access: None, description: Some("Receiver timeout enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ABRMOD", bit_offset: 21, bit_width: 2, access: None, description: Some("Auto baud rate mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ABREN", bit_offset: 20, bit_width: 1, access: None, description: Some("Auto baud rate enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSBFIRST", bit_offset: 19, bit_width: 1, access: None, description: Some("Most significant bit first"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DATAINV", bit_offset: 18, bit_width: 1, access: None, description: Some("Binary data inversion"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TXINV", bit_offset: 17, bit_width: 1, access: None, description: Some("TX pin active level inversion"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXINV", bit_offset: 16, bit_width: 1, access: None, description: Some("RX pin active level inversion"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SWAP", bit_offset: 15, bit_width: 1, access: None, description: Some("Swap TX/RX pins"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LINEN", bit_offset: 14, bit_width: 1, access: None, description: Some("LIN mode enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "STOP", bit_offset: 12, bit_width: 2, access: None, description: Some("STOP bits"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CLKEN", bit_offset: 11, bit_width: 1, access: None, description: Some("Clock enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CPOL", bit_offset: 10, bit_width: 1, access: None, description: Some("Clock polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CPHA", bit_offset: 9, bit_width: 1, access: None, description: Some("Clock phase"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LBCL", bit_offset: 8, bit_width: 1, access: None, description: Some("Last bit clock pulse"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LBDIE", bit_offset: 6, bit_width: 1, access: None, description: Some("LIN break detection interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LBDL", bit_offset: 5, bit_width: 1, access: None, description: Some("LIN break detection length"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ADDM7", bit_offset: 4, bit_width: 1, access: None, description: Some("7-bit Address Detection/4-bit Address Detection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR3", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Control register 3"), fields: [Field { name: "WUFIE", bit_offset: 22, bit_width: 1, access: None, description: Some("Wakeup from Stop mode interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUS", bit_offset: 20, bit_width: 2, access: None, description: Some("Wakeup from Stop mode interrupt flag selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SCARCNT", bit_offset: 17, bit_width: 3, access: None, description: Some("Smartcard auto-retry count"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DEP", bit_offset: 15, bit_width: 1, access: None, description: Some("Driver enable polarity selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DEM", bit_offset: 14, bit_width: 1, access: None, description: Some("Driver enable mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DDRE", bit_offset: 13, bit_width: 1, access: None, description: Some("DMA Disable on Reception Error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVRDIS", bit_offset: 12, bit_width: 1, access: None, description: Some("Overrun Disable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ONEBIT", bit_offset: 11, bit_width: 1, access: None, description: Some("One sample bit method enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CTSIE", bit_offset: 10, bit_width: 1, access: None, description: Some("CTS interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CTSE", bit_offset: 9, bit_width: 1, access: None, description: Some("CTS enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTSE", bit_offset: 8, bit_width: 1, access: None, description: Some("RTS enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAT", bit_offset: 7, bit_width: 1, access: None, description: Some("DMA enable transmitter"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAR", bit_offset: 6, bit_width: 1, access: None, description: Some("DMA enable receiver"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SCEN", bit_offset: 5, bit_width: 1, access: None, description: Some("Smartcard mode enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "NACK", bit_offset: 4, bit_width: 1, access: None, description: Some("Smartcard NACK enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HDSEL", bit_offset: 3, bit_width: 1, access: None, description: Some("Half-duplex selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "IRLP", bit_offset: 2, bit_width: 1, access: None, description: Some("IrDA low-power"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "IREN", bit_offset: 1, bit_width: 1, access: None, description: Some("IrDA mode enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EIE", bit_offset: 0, bit_width: 1, access: None, description: Some("Error interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BRR", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Baud rate register"), fields: [Field { name: "DIV_Mantissa", bit_offset: 4, bit_width: 12, access: None, description: Some("mantissa of USARTDIV"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DIV_Fraction", bit_offset: 0, bit_width: 4, access: None, description: Some("fraction of USARTDIV"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "GTPR", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Guard time and prescaler register"), fields: [Field { name: "GT", bit_offset: 8, bit_width: 8, access: None, description: Some("Guard time value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PSC", bit_offset: 0, bit_width: 8, access: None, description: Some("Prescaler value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RTOR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Receiver timeout register"), fields: [Field { name: "BLEN", bit_offset: 24, bit_width: 8, access: None, description: Some("Block Length"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTO", bit_offset: 0, bit_width: 24, access: None, description: Some("Receiver timeout value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RQR", offset: 24, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Request register"), fields: [Field { name: "TXFRQ", bit_offset: 4, bit_width: 1, access: None, description: Some("Transmit data flush request"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXFRQ", bit_offset: 3, bit_width: 1, access: None, description: Some("Receive data flush request"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MMRQ", bit_offset: 2, bit_width: 1, access: None, description: Some("Mute mode request"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SBKRQ", bit_offset: 1, bit_width: 1, access: None, description: Some("Send break request"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ABRRQ", bit_offset: 0, bit_width: 1, access: None, description: Some("Auto baud rate request"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ISR", offset: 28, size: Some(32), access: Some(ReadOnly), reset_value: Some(192), reset_mask: None, description: Some("Interrupt & status register"), fields: [Field { name: "REACK", bit_offset: 22, bit_width: 1, access: None, description: Some("Receive enable acknowledge flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TEACK", bit_offset: 21, bit_width: 1, access: None, description: Some("Transmit enable acknowledge flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WUF", bit_offset: 20, bit_width: 1, access: None, description: Some("Wakeup from Stop mode flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RWU", bit_offset: 19, bit_width: 1, access: None, description: Some("Receiver wakeup from Mute mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SBKF", bit_offset: 18, bit_width: 1, access: None, description: Some("Send break flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMF", bit_offset: 17, bit_width: 1, access: None, description: Some("character match flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BUSY", bit_offset: 16, bit_width: 1, access: None, description: Some("Busy flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ABRF", bit_offset: 15, bit_width: 1, access: None, description: Some("Auto baud rate flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ABRE", bit_offset: 14, bit_width: 1, access: None, description: Some("Auto baud rate error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOBF", bit_offset: 12, bit_width: 1, access: None, description: Some("End of block flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTOF", bit_offset: 11, bit_width: 1, access: None, description: Some("Receiver timeout"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CTS", bit_offset: 10, bit_width: 1, access: None, description: Some("CTS flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CTSIF", bit_offset: 9, bit_width: 1, access: None, description: Some("CTS interrupt flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LBDF", bit_offset: 8, bit_width: 1, access: None, description: Some("LIN break detection flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TXE", bit_offset: 7, bit_width: 1, access: None, description: Some("Transmit data register empty"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TC", bit_offset: 6, bit_width: 1, access: None, description: Some("Transmission complete"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXNE", bit_offset: 5, bit_width: 1, access: None, description: Some("Read data register not empty"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "IDLE", bit_offset: 4, bit_width: 1, access: None, description: Some("Idle line detected"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ORE", bit_offset: 3, bit_width: 1, access: None, description: Some("Overrun error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "NF", bit_offset: 2, bit_width: 1, access: None, description: Some("Noise detected flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FE", bit_offset: 1, bit_width: 1, access: None, description: Some("Framing error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PE", bit_offset: 0, bit_width: 1, access: None, description: Some("Parity error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ICR", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Interrupt flag clear register"), fields: [Field { name: "WUCF", bit_offset: 20, bit_width: 1, access: None, description: Some("Wakeup from Stop mode clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMCF", bit_offset: 17, bit_width: 1, access: None, description: Some("Character match clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EOBCF", bit_offset: 12, bit_width: 1, access: None, description: Some("End of timeout clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RTOCF", bit_offset: 11, bit_width: 1, access: None, description: Some("Receiver timeout clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CTSCF", bit_offset: 9, bit_width: 1, access: None, description: Some("CTS clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LBDCF", bit_offset: 8, bit_width: 1, access: None, description: Some("LIN break detection clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCCF", bit_offset: 6, bit_width: 1, access: None, description: Some("Transmission complete clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "IDLECF", bit_offset: 4, bit_width: 1, access: None, description: Some("Idle line detected clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ORECF", bit_offset: 3, bit_width: 1, access: None, description: Some("Overrun error clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "NCF", bit_offset: 2, bit_width: 1, access: None, description: Some("Noise detected clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FECF", bit_offset: 1, bit_width: 1, access: None, description: Some("Framing error clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PECF", bit_offset: 0, bit_width: 1, access: None, description: Some("Parity error clear flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RDR", offset: 36, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("Receive data register"), fields: [Field { name: "RDR", bit_offset: 0, bit_width: 9, access: None, description: Some("Receive data value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TDR", offset: 40, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Transmit data register"), fields: [Field { name: "TDR", bit_offset: 0, bit_width: 9, access: None, description: Some("Transmit data value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
...
#[doc="Read the CR3 register."]
   #[inline] pub fn cr3(&self) -> Cr3 { 
      unsafe {
         Cr3(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the BRR register."]
   #[inline] pub fn brr(&self) -> Brr { 
      unsafe {
         Brr(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the GTPR register."]
   #[inline] pub fn gtpr(&self) -> Gtpr { 
      unsafe {
         Gtpr(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the RTOR register."]
   #[inline] pub fn rtor(&self) -> Rtor { 
      unsafe {
         Rtor(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the RQR register."]
   #[inline] pub fn rqr(&self) -> Rqr { 
      unsafe {
         Rqr(::core::ptr::read_volatile((self.0 + 0x18) as *const u32))
      }
   }
...
#[doc="Read the ISR register."]
   #[inline] pub fn isr(&self) -> Isr { 
      unsafe {
         Isr(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the ICR register."]
   #[inline] pub fn icr(&self) -> Icr { 
      unsafe {
         Icr(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the RDR register."]
   #[inline] pub fn rdr(&self) -> Rdr { 
      unsafe {
         Rdr(::core::ptr::read_volatile((self.0 + 0x24) as *const u32))
      }
   }
...
#[doc="Read the TDR register."]
   #[inline] pub fn tdr(&self) -> Tdr { 
      unsafe {
         Tdr(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
