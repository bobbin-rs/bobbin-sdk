...
#[doc="Get the *const pointer for the GTPR register."]
   #[inline] fn gtpr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Get the *mut pointer for the GTPR register."]
   #[inline] fn gtpr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Read the GTPR register."]
   #[inline] fn gtpr(&self) -> Gtpr { 
      unsafe {
         Gtpr(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      }
   }
#[doc="Write the GTPR register."]
   #[inline] fn set_gtpr<F: FnOnce(Gtpr) -> Gtpr>(&self, f: F) -> &Self {
      let value = f(Gtpr(0));
      unsafe {
...
#[doc="Modify the GTPR register."]
   #[inline] fn with_gtpr<F: FnOnce(Gtpr) -> Gtpr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Gtpr(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the RTOR register."]
   #[inline] fn rtor_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Get the *mut pointer for the RTOR register."]
   #[inline] fn rtor_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Read the RTOR register."]
   #[inline] fn rtor(&self) -> Rtor { 
      unsafe {
         Rtor(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      }
   }
#[doc="Write the RTOR register."]
   #[inline] fn set_rtor<F: FnOnce(Rtor) -> Rtor>(&self, f: F) -> &Self {
      let value = f(Rtor(0));
      unsafe {
...
#[doc="Modify the RTOR register."]
   #[inline] fn with_rtor<F: FnOnce(Rtor) -> Rtor>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Rtor(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the RQR register."]
   #[inline] fn rqr(&self) -> Rqr { 
      unsafe {
         Rqr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      }
   }
...
#[doc="Modify the RQR register."]
   #[inline] fn with_rqr<F: FnOnce(Rqr) -> Rqr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Rqr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the ICR register."]
   #[inline] fn icr(&self) -> Icr { 
      unsafe {
         Icr(::core::ptr::read_volatile((self.base() + 0x20) as *const u32))
      }
   }
...
#[doc="Modify the ICR register."]
   #[inline] fn with_icr<F: FnOnce(Icr) -> Icr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Icr(::core::ptr::read_volatile((self.base() + 0x20) as *const u32))
      };
      let value = f(tmp);
