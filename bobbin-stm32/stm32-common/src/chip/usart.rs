...
impl UsartPeriph {
    ...
    #[inline] pub fn cr3(&self) -> Cr3 { 
        unsafe {
            read_volatile((self.0 + 0x8) as *const Cr3)
        }
    }
    ...
    #[inline] pub fn set_cr3<F: FnOnce(Cr3) -> Cr3>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x8) as *mut Cr3, f(Cr3(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_cr3<F: FnOnce(Cr3) -> Cr3>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x8) as *mut Cr3, f(self.cr3()));
        }
        self
    }
    ...
    #[inline] pub fn brr(&self) -> Brr { 
        unsafe {
            read_volatile((self.0 + 0xc) as *const Brr)
        }
    }
    ...
    #[inline] pub fn set_brr<F: FnOnce(Brr) -> Brr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0xc) as *mut Brr, f(Brr(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_brr<F: FnOnce(Brr) -> Brr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0xc) as *mut Brr, f(self.brr()));
        }
        self
    }
    ...
    #[inline] pub fn set_gtpr<F: FnOnce(Gtpr) -> Gtpr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x10) as *mut Gtpr, f(Gtpr(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_gtpr<F: FnOnce(Gtpr) -> Gtpr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x10) as *mut Gtpr, f(self.gtpr()));
        }
        self
    }
    ...
    #[inline] pub fn set_rtor<F: FnOnce(Rtor) -> Rtor>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x14) as *mut Rtor, f(Rtor(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_rtor<F: FnOnce(Rtor) -> Rtor>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x14) as *mut Rtor, f(self.rtor()));
        }
        self
    }
    ...
    #[inline] pub fn rqr(&self) -> Rqr { 
        unsafe {
            read_volatile((self.0 + 0x18) as *const Rqr)
        }
    }
    ...
    #[inline] pub fn set_rqr<F: FnOnce(Rqr) -> Rqr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x18) as *mut Rqr, f(Rqr(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_rqr<F: FnOnce(Rqr) -> Rqr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x18) as *mut Rqr, f(self.rqr()));
        }
        self
    }
    ...
    #[inline] pub fn icr(&self) -> Icr { 
        unsafe {
            read_volatile((self.0 + 0x20) as *const Icr)
        }
    }
    ...
    #[inline] pub fn set_icr<F: FnOnce(Icr) -> Icr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x20) as *mut Icr, f(Icr(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_icr<F: FnOnce(Icr) -> Icr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x20) as *mut Icr, f(self.icr()));
        }
        self
    }
    ...
    #[inline] pub fn tdr(&self) -> Tdr { 
        unsafe {
            read_volatile((self.0 + 0x28) as *const Tdr)
        }
    }
    ...
    #[inline] pub fn set_tdr<F: FnOnce(Tdr) -> Tdr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x28) as *mut Tdr, f(Tdr(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_tdr<F: FnOnce(Tdr) -> Tdr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile((self.0 + 0x28) as *mut Tdr, f(self.tdr()));
        }
        self
    }
