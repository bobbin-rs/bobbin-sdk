...
// PeripheralGroup { name: "DMA_F3", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("DMA"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "ISR", offset: 0, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("DMA interrupt status register (DMA_ISR)"), fields: [Field { name: "GIF", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel n Global interrupt flag"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }, Field { name: "TCIF", bit_offset: 1, bit_width: 1, access: None, description: Some("Channel n Transfer Complete flag"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }, Field { name: "HTIF", bit_offset: 2, bit_width: 1, access: None, description: Some("Channel n Half Transfer Complete flag"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }, Field { name: "TEIF", bit_offset: 3, bit_width: 1, access: None, description: Some("Channel n Transfer Error flag"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "IFCR", offset: 4, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: None, description: Some("DMA interrupt flag clear register (DMA_IFCR)"), fields: [Field { name: "CGIF", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel n Global interrupt clear"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }, Field { name: "CTCIF", bit_offset: 1, bit_width: 1, access: None, description: Some("Channel n Transfer Complete clear"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }, Field { name: "CHTIF", bit_offset: 2, bit_width: 1, access: None, description: Some("Channel n Half Transfer clear"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }, Field { name: "CTEIF", bit_offset: 3, bit_width: 1, access: None, description: Some("Channel n Transfer Error clear"), enumerated_values: [], links: [], dim: Some(7), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CCR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA channel configuration register (DMA_CCR)"), fields: [Field { name: "EN", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCIE", bit_offset: 1, bit_width: 1, access: None, description: Some("Transfer complete interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "HTIE", bit_offset: 2, bit_width: 1, access: None, description: Some("Half Transfer interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TEIE", bit_offset: 3, bit_width: 1, access: None, description: Some("Transfer error interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DIR", bit_offset: 4, bit_width: 1, access: None, description: Some("Data transfer direction"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CIRC", bit_offset: 5, bit_width: 1, access: None, description: Some("Circular mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PINC", bit_offset: 6, bit_width: 1, access: None, description: Some("Peripheral increment mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MINC", bit_offset: 7, bit_width: 1, access: None, description: Some("Memory increment mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PSIZE", bit_offset: 8, bit_width: 2, access: None, description: Some("Peripheral size"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSIZE", bit_offset: 10, bit_width: 2, access: None, description: Some("Memory size"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PL", bit_offset: 12, bit_width: 2, access: None, description: Some("Channel Priority level"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MEM2MEM", bit_offset: 14, bit_width: 1, access: None, description: Some("Memory to memory mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(7), dim_increment: Some(20), dim_index: None }, Register { name: "CNDTR", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA channel n number of data register"), fields: [Field { name: "NDT", bit_offset: 0, bit_width: 16, access: None, description: Some("Number of data to transfer"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(7), dim_increment: Some(20), dim_index: None }, Register { name: "CPAR", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA channel n peripheral address register"), fields: [Field { name: "PA", bit_offset: 0, bit_width: 32, access: None, description: Some("Peripheral address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(7), dim_increment: Some(20), dim_index: None }, Register { name: "CMAR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DMA channel n memory address register"), fields: [Field { name: "MA", bit_offset: 0, bit_width: 32, access: None, description: Some("Memory address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(7), dim_increment: Some(20), dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the CCR register."]
   #[inline] pub fn ccr<I: Into<bits::R7>>(&self, index: I) -> Ccr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Ccr(::core::ptr::read_volatile((self.0 + 0x8 + (index * 20)) as *const u32))
      }
   }
#[doc="Write the CCR register."]
   #[inline] pub fn set_ccr<I: Into<bits::R7>, F: FnOnce(Ccr) -> Ccr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Ccr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x8 + (index * 20)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CNDTR register."]
   #[inline] pub fn cndtr<I: Into<bits::R7>>(&self, index: I) -> Cndtr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Cndtr(::core::ptr::read_volatile((self.0 + 0xc + (index * 20)) as *const u32))
      }
   }
#[doc="Write the CNDTR register."]
   #[inline] pub fn set_cndtr<I: Into<bits::R7>, F: FnOnce(Cndtr) -> Cndtr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Cndtr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0xc + (index * 20)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CPAR register."]
   #[inline] pub fn cpar<I: Into<bits::R7>>(&self, index: I) -> Cpar { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Cpar(::core::ptr::read_volatile((self.0 + 0x10 + (index * 20)) as *const u32))
      }
   }
#[doc="Write the CPAR register."]
   #[inline] pub fn set_cpar<I: Into<bits::R7>, F: FnOnce(Cpar) -> Cpar>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Cpar(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x10 + (index * 20)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CMAR register."]
   #[inline] pub fn cmar<I: Into<bits::R7>>(&self, index: I) -> Cmar { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Cmar(::core::ptr::read_volatile((self.0 + 0x14 + (index * 20)) as *const u32))
      }
   }
#[doc="Write the CMAR register."]
   #[inline] pub fn set_cmar<I: Into<bits::R7>, F: FnOnce(Cmar) -> Cmar>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Cmar(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x14 + (index * 20)) as *mut u32, value.0);
      }
      self
   }
