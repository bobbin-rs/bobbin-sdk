...
#[doc="Flexible static memory controller module reset"]
  #[inline] pub fn fsmcrst(&self) -> bits::B1 {
     (((self.0 as u32) >> 0) & 0x1).into() // [0]
  }
#[doc="Flexible static memory controller module reset"]
  #[inline] pub fn set_fsmcrst<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
...
#[doc="Flexible static memory controller module clock enable during Sleep mode"]
  #[inline] pub fn fsmclpen(&self) -> bits::B1 {
     (((self.0 as u32) >> 0) & 0x1).into() // [0]
  }
#[doc="Flexible static memory controller module clock enable during Sleep mode"]
  #[inline] pub fn set_fsmclpen<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
