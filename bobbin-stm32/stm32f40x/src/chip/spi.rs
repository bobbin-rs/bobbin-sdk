...
periph!(SpiPeriph, I2S2EXT, I2s2ext, 0x40003400);
periph!(SpiPeriph, I2S3EXT, I2s3ext, 0x40004000);
periph!(SpiPeriph, SPI4, Spi4, 0x40013400);
periph!(SpiPeriph, SPI5, Spi5, 0x40015000);
periph!(SpiPeriph, SPI6, Spi6, 0x40015400);
...
#[doc="Read the DR register."]
   #[inline] fn dr(&self) -> Dr { 
      unsafe {
         Dr(::core::ptr::read_volatile((self.base() + 0xc) as *const u32))
      }
   }
