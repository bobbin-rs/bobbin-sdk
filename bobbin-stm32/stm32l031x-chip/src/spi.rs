...
impl<T> Periph<T> {
  ...
  #[inline]
  pub fn cr2_ptr(&self) -> *const u16 { 
     ((self.0 as usize) + 0x4) as *const u16
  }
  #[inline]
  pub fn cr2_mut(&self) -> *mut u16 { 
  ...
  #[inline]
  pub fn sr_ptr(&self) -> *const u16 { 
     ((self.0 as usize) + 0x8) as *const u16
  }
  #[inline]
  pub fn sr_mut(&self) -> *mut u16 { 
  ...
  #[inline]
  pub fn rxcrcr_ptr(&self) -> *const u16 { 
     ((self.0 as usize) + 0x14) as *const u16
  }
  #[inline]
  pub fn rxcrcr_mut(&self) -> *mut u16 { 
  ...
  #[inline]
  pub fn txcrcr_ptr(&self) -> *const u16 { 
     ((self.0 as usize) + 0x18) as *const u16
  }
  #[inline]
  pub fn txcrcr_mut(&self) -> *mut u16 { 
  ...
  #[inline]
  pub fn i2scfgr_ptr(&self) -> *const u16 { 
     ((self.0 as usize) + 0x1c) as *const u16
  }
  #[inline]
  pub fn i2scfgr_mut(&self) -> *mut u16 { 
  ...
  #[inline]
  pub fn i2spr_ptr(&self) -> *const u16 { 
     ((self.0 as usize) + 0x20) as *const u16
  }
  #[inline]
  pub fn i2spr_mut(&self) -> *mut u16 { 
...
impl Cr1 {
  ...
  #[inline]
  pub fn set_bidimode(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 15);
     self.0 |= value << 15;
     self
  ...
  #[inline]
  pub fn bidioe(&self) -> u16 {
     ((self.0 as u16) >> 14) & 0x1 // [14]
  }
  #[inline]
  pub fn set_bidioe(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 14);
     self.0 |= value << 14;
     self
  ...
  #[inline]
  pub fn crcen(&self) -> u16 {
     ((self.0 as u16) >> 13) & 0x1 // [13]
  }
  #[inline]
  pub fn set_crcen(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 13);
     self.0 |= value << 13;
     self
  ...
  #[inline]
  pub fn crcnext(&self) -> u16 {
     ((self.0 as u16) >> 12) & 0x1 // [12]
  }
  #[inline]
  pub fn set_crcnext(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 12);
     self.0 |= value << 12;
     self
  ...
  #[inline]
  pub fn set_dff(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 11);
     self.0 |= value << 11;
     self
  ...
  #[inline]
  pub fn rxonly(&self) -> u16 {
     ((self.0 as u16) >> 10) & 0x1 // [10]
  }
  #[inline]
  pub fn set_rxonly(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 10);
     self.0 |= value << 10;
     self
  ...
  #[inline]
  pub fn set_ssm(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 9);
     self.0 |= value << 9;
     self
  ...
  #[inline]
  pub fn set_ssi(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 8);
     self.0 |= value << 8;
     self
  ...
  #[inline]
  pub fn lsbfirst(&self) -> u16 {
     ((self.0 as u16) >> 7) & 0x1 // [7]
  }
  #[inline]
  pub fn set_lsbfirst(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 7);
     self.0 |= value << 7;
     self
  ...
  #[inline]
  pub fn set_spe(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 6);
     self.0 |= value << 6;
     self
  ...
  #[inline]
  pub fn set_br(mut self, value: u16) -> Self {
     assert!((value & !0x7) == 0);
     self.0 &= !(0x7 << 3);
     self.0 |= value << 3;
     self
  ...
  #[inline]
  pub fn mstr(&self) -> u16 {
     ((self.0 as u16) >> 2) & 0x1 // [2]
  }
  #[inline]
  pub fn set_mstr(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 2);
     self.0 |= value << 2;
     self
  ...
  #[inline]
  pub fn cpol(&self) -> u16 {
     ((self.0 as u16) >> 1) & 0x1 // [1]
  }
  #[inline]
  pub fn set_cpol(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 1);
     self.0 |= value << 1;
     self
  ...
  #[inline]
  pub fn cpha(&self) -> u16 {
     ((self.0 as u16) >> 0) & 0x1 // [0]
  }
  #[inline]
  pub fn set_cpha(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
     self.0 |= value << 0;
     self
...
impl Cr2 {
  ...
  #[inline]
  pub fn set_rxdmaen(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
     self.0 |= value << 0;
     self
  ...
  #[inline]
  pub fn txdmaen(&self) -> u16 {
     ((self.0 as u16) >> 1) & 0x1 // [1]
  }
  #[inline]
  pub fn set_txdmaen(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 1);
     self.0 |= value << 1;
     self
  ...
  #[inline]
  pub fn ssoe(&self) -> u16 {
     ((self.0 as u16) >> 2) & 0x1 // [2]
  }
  #[inline]
  pub fn set_ssoe(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 2);
     self.0 |= value << 2;
     self
  ...
  #[inline]
  pub fn set_frf(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 4);
     self.0 |= value << 4;
     self
  ...
  #[inline]
  pub fn errie(&self) -> u16 {
     ((self.0 as u16) >> 5) & 0x1 // [5]
  }
  #[inline]
  pub fn set_errie(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 5);
     self.0 |= value << 5;
     self
  ...
  #[inline]
  pub fn rxneie(&self) -> u16 {
     ((self.0 as u16) >> 6) & 0x1 // [6]
  }
  #[inline]
  pub fn set_rxneie(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 6);
     self.0 |= value << 6;
     self
  ...
  #[inline]
  pub fn txeie(&self) -> u16 {
     ((self.0 as u16) >> 7) & 0x1 // [7]
  }
  #[inline]
  pub fn set_txeie(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 7);
     self.0 |= value << 7;
     self
...
impl Sr {
  ...
  #[inline]
  pub fn set_rxne(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
     self.0 |= value << 0;
     self
  ...
  #[inline]
  pub fn set_txe(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 1);
     self.0 |= value << 1;
     self
  ...
  #[inline]
  pub fn chside(&self) -> u16 {
     ((self.0 as u16) >> 2) & 0x1 // [2]
  }
  #[inline]
  pub fn set_chside(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 2);
     self.0 |= value << 2;
     self
  ...
  #[inline]
  pub fn set_udr(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 3);
     self.0 |= value << 3;
     self
  ...
  #[inline]
  pub fn crcerr(&self) -> u16 {
     ((self.0 as u16) >> 4) & 0x1 // [4]
  }
  #[inline]
  pub fn set_crcerr(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 4);
     self.0 |= value << 4;
     self
  ...
  #[inline]
  pub fn modf(&self) -> u16 {
     ((self.0 as u16) >> 5) & 0x1 // [5]
  }
  #[inline]
  pub fn set_modf(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 5);
     self.0 |= value << 5;
     self
  ...
  #[inline]
  pub fn set_ovr(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 6);
     self.0 |= value << 6;
     self
  ...
  #[inline]
  pub fn set_bsy(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 7);
     self.0 |= value << 7;
     self
  ...
  #[inline]
  pub fn tifrfe(&self) -> u16 {
     ((self.0 as u16) >> 8) & 0x1 // [8]
  }
  #[inline]
  pub fn set_tifrfe(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 8);
     self.0 |= value << 8;
     self
...
impl Rxcrcr {
  ...
  #[inline]
  pub fn set_rxcrc(mut self, value: u16) -> Self {
     assert!((value & !0xffff) == 0);
     self.0 &= !(0xffff << 0);
     self.0 |= value << 0;
     self
...
impl Txcrcr {
  ...
  #[inline]
  pub fn set_txcrc(mut self, value: u16) -> Self {
     assert!((value & !0xffff) == 0);
     self.0 &= !(0xffff << 0);
     self.0 |= value << 0;
     self
...
impl I2scfgr {
  ...
  #[inline]
  pub fn set_i2smod(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 11);
     self.0 |= value << 11;
     self
  ...
  #[inline]
  pub fn i2se(&self) -> u16 {
     ((self.0 as u16) >> 10) & 0x1 // [10]
  }
  #[inline]
  pub fn set_i2se(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 10);
     self.0 |= value << 10;
     self
  ...
  #[inline]
  pub fn i2scfg(&self) -> u16 {
     ((self.0 as u16) >> 8) & 0x3 // [9:8]
  }
  #[inline]
  pub fn set_i2scfg(mut self, value: u16) -> Self {
     assert!((value & !0x3) == 0);
     self.0 &= !(0x3 << 8);
     self.0 |= value << 8;
     self
  ...
  #[inline]
  pub fn pcmsync(&self) -> u16 {
     ((self.0 as u16) >> 7) & 0x1 // [7]
  }
  #[inline]
  pub fn set_pcmsync(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 7);
     self.0 |= value << 7;
     self
  ...
  #[inline]
  pub fn i2sstd(&self) -> u16 {
     ((self.0 as u16) >> 4) & 0x3 // [5:4]
  }
  #[inline]
  pub fn set_i2sstd(mut self, value: u16) -> Self {
     assert!((value & !0x3) == 0);
     self.0 &= !(0x3 << 4);
     self.0 |= value << 4;
     self
  ...
  #[inline]
  pub fn ckpol(&self) -> u16 {
     ((self.0 as u16) >> 3) & 0x1 // [3]
  }
  #[inline]
  pub fn set_ckpol(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 3);
     self.0 |= value << 3;
     self
  ...
  #[inline]
  pub fn datlen(&self) -> u16 {
     ((self.0 as u16) >> 1) & 0x3 // [2:1]
  }
  #[inline]
  pub fn set_datlen(mut self, value: u16) -> Self {
     assert!((value & !0x3) == 0);
     self.0 &= !(0x3 << 1);
     self.0 |= value << 1;
     self
  ...
  #[inline]
  pub fn chlen(&self) -> u16 {
     ((self.0 as u16) >> 0) & 0x1 // [0]
  }
  #[inline]
  pub fn set_chlen(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
     self.0 |= value << 0;
     self
...
impl I2spr {
  ...
  #[inline]
  pub fn set_mckoe(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 9);
     self.0 |= value << 9;
     self
  ...
  #[inline]
  pub fn set_odd(mut self, value: u16) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 8);
     self.0 |= value << 8;
     self
  ...
  #[inline]
  pub fn i2sdiv(&self) -> u16 {
     ((self.0 as u16) >> 0) & 0xff // [7:0]
  }
  #[inline]
  pub fn set_i2sdiv(mut self, value: u16) -> Self {
     assert!((value & !0xff) == 0);
     self.0 &= !(0xff << 0);
     self.0 |= value << 0;
     self
