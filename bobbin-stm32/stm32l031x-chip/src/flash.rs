...
impl Flash {
  ...
  #[inline]
  pub fn set_pecr(&self, value: Pecr) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_pecr<F: FnOnce(Pecr) -> Pecr>(&self, f: F) -> &Self {
     let tmp = self.pecr();
     self.set_pecr(f(tmp))
  }

  #[inline]
  pub fn pdkeyr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x8) as *const u32
  }
  #[inline]
  pub fn pdkeyr_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x8) as *mut u32
  }
  #[inline]
  pub fn set_pdkeyr(&self, value: Pdkeyr) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn pekeyr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xc) as *const u32
  }
  #[inline]
  pub fn pekeyr_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0xc) as *mut u32
  }
  #[inline]
  pub fn set_pekeyr(&self, value: Pekeyr) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn prgkeyr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x10) as *const u32
  }
  #[inline]
  pub fn prgkeyr_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x10) as *mut u32
  }
  #[inline]
  pub fn set_prgkeyr(&self, value: Prgkeyr) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn obr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x1c) as *const u32
  }
  #[inline]
  pub fn obr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn wrpr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x20) as *const u32
  }
  #[inline]
  pub fn wrpr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn set_wrpr(&self, value: Wrpr) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_wrpr<F: FnOnce(Wrpr) -> Wrpr>(&self, f: F) -> &Self {
     let tmp = self.wrpr();
     self.set_wrpr(f(tmp))
  }
