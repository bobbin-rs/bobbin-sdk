...
pub const IRQ_SPI1_IRQ: Irq = Irq(35);   // IRQ 35: SPI1 global interrupt
pub const IRQ_SPI2_IRQ: Irq = Irq(36);   // IRQ 36: SPI2 global interrupt
pub const IRQ_USART1_IRQ: Irq = Irq(37); // IRQ 37: USART1 global interrupt
pub const IRQ_USART2_IRQ: Irq = Irq(38); // IRQ 38: USART2 global interrupt
pub const IRQ_USART3_IRQ: Irq = Irq(39); // IRQ 39: USART3 global interrupt
...
pub const IRQ_SPI3_IRQ: Irq = Irq(51);   // IRQ 51: SPI3 global interrupt
...
pub const IRQ_USART6_IRQ: Irq = Irq(71); // IRQ 71: USART6 global interrupt
pub const IRQ_I2C3_EV: Irq = Irq(72);    // IRQ 72: I2C3 event interrupt
pub const IRQ_I2C3_ER: Irq = Irq(73);    // IRQ 73: I2C3 error interrupt
pub const IRQ_UART7: Irq = Irq(82);      // IRQ 82: UART 7 global interrupt
pub const IRQ_UART8: Irq = Irq(83);      // IRQ 83: UART 8 global interrupt
pub const IRQ_SPI4_IRQ: Irq = Irq(84);   // IRQ 84: SPI 4 global interrupt
pub const IRQ_SPI5_IRQ: Irq = Irq(85);   // IRQ 85: SPI 5 global interrupt
pub const IRQ_SPI6_IRQ: Irq = Irq(86);   // IRQ 86: SPI 6 global interrupt
