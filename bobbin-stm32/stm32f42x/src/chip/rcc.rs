...
periph!(RccPeriph, RCC, Rcc, 0x40023800);
...
#[doc="Get the *const pointer for the PLLCFGR register."]
   #[inline] fn pllcfgr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x4)
   }
#[doc="Get the *mut pointer for the PLLCFGR register."]
   #[inline] fn pllcfgr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x4)
   }
#[doc="Read the PLLCFGR register."]
   #[inline] fn pllcfgr(&self) -> Pllcfgr { 
      unsafe {
         Pllcfgr(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      }
   }
#[doc="Write the PLLCFGR register."]
   #[inline] fn set_pllcfgr<F: FnOnce(Pllcfgr) -> Pllcfgr>(&self, f: F) -> &Self {
...
#[doc="Modify the PLLCFGR register."]
   #[inline] fn with_pllcfgr<F: FnOnce(Pllcfgr) -> Pllcfgr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pllcfgr(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the CFGR register."]
   #[inline] fn cfgr(&self) -> Cfgr { 
      unsafe {
         Cfgr(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      }
   }
...
#[doc="Read the CIR register."]
   #[inline] fn cir(&self) -> Cir { 
      unsafe {
         Cir(::core::ptr::read_volatile((self.base() + 0xc) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the AHB1RSTR register."]
   #[inline] fn ahb1rstr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Get the *mut pointer for the AHB1RSTR register."]
   #[inline] fn ahb1rstr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Read the AHB1RSTR register."]
   #[inline] fn ahb1rstr(&self) -> Ahb1rstr { 
      unsafe {
         Ahb1rstr(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      }
   }
#[doc="Write the AHB1RSTR register."]
   #[inline] fn set_ahb1rstr<F: FnOnce(Ahb1rstr) -> Ahb1rstr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB1RSTR register."]
   #[inline] fn with_ahb1rstr<F: FnOnce(Ahb1rstr) -> Ahb1rstr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb1rstr(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHB2RSTR register."]
   #[inline] fn ahb2rstr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Get the *mut pointer for the AHB2RSTR register."]
   #[inline] fn ahb2rstr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Read the AHB2RSTR register."]
   #[inline] fn ahb2rstr(&self) -> Ahb2rstr { 
      unsafe {
         Ahb2rstr(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      }
   }
#[doc="Write the AHB2RSTR register."]
   #[inline] fn set_ahb2rstr<F: FnOnce(Ahb2rstr) -> Ahb2rstr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB2RSTR register."]
   #[inline] fn with_ahb2rstr<F: FnOnce(Ahb2rstr) -> Ahb2rstr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb2rstr(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHB3RSTR register."]
   #[inline] fn ahb3rstr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Get the *mut pointer for the AHB3RSTR register."]
   #[inline] fn ahb3rstr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Read the AHB3RSTR register."]
   #[inline] fn ahb3rstr(&self) -> Ahb3rstr { 
      unsafe {
         Ahb3rstr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      }
   }
#[doc="Write the AHB3RSTR register."]
   #[inline] fn set_ahb3rstr<F: FnOnce(Ahb3rstr) -> Ahb3rstr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB3RSTR register."]
   #[inline] fn with_ahb3rstr<F: FnOnce(Ahb3rstr) -> Ahb3rstr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb3rstr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the APB1RSTR register."]
   #[inline] fn apb1rstr(&self) -> Apb1rstr { 
      unsafe {
         Apb1rstr(::core::ptr::read_volatile((self.base() + 0x20) as *const u32))
      }
   }
...
#[doc="Read the APB2RSTR register."]
   #[inline] fn apb2rstr(&self) -> Apb2rstr { 
      unsafe {
         Apb2rstr(::core::ptr::read_volatile((self.base() + 0x24) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the AHB1ENR register."]
   #[inline] fn ahb1enr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x30)
   }
#[doc="Get the *mut pointer for the AHB1ENR register."]
   #[inline] fn ahb1enr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x30)
   }
#[doc="Read the AHB1ENR register."]
   #[inline] fn ahb1enr(&self) -> Ahb1enr { 
      unsafe {
         Ahb1enr(::core::ptr::read_volatile((self.base() + 0x30) as *const u32))
      }
   }
#[doc="Write the AHB1ENR register."]
   #[inline] fn set_ahb1enr<F: FnOnce(Ahb1enr) -> Ahb1enr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB1ENR register."]
   #[inline] fn with_ahb1enr<F: FnOnce(Ahb1enr) -> Ahb1enr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb1enr(::core::ptr::read_volatile((self.base() + 0x30) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHB2ENR register."]
   #[inline] fn ahb2enr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x34)
   }
#[doc="Get the *mut pointer for the AHB2ENR register."]
   #[inline] fn ahb2enr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x34)
   }
#[doc="Read the AHB2ENR register."]
   #[inline] fn ahb2enr(&self) -> Ahb2enr { 
      unsafe {
         Ahb2enr(::core::ptr::read_volatile((self.base() + 0x34) as *const u32))
      }
   }
#[doc="Write the AHB2ENR register."]
   #[inline] fn set_ahb2enr<F: FnOnce(Ahb2enr) -> Ahb2enr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB2ENR register."]
   #[inline] fn with_ahb2enr<F: FnOnce(Ahb2enr) -> Ahb2enr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb2enr(::core::ptr::read_volatile((self.base() + 0x34) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHB3ENR register."]
   #[inline] fn ahb3enr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x38)
   }
#[doc="Get the *mut pointer for the AHB3ENR register."]
   #[inline] fn ahb3enr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x38)
   }
#[doc="Read the AHB3ENR register."]
   #[inline] fn ahb3enr(&self) -> Ahb3enr { 
      unsafe {
         Ahb3enr(::core::ptr::read_volatile((self.base() + 0x38) as *const u32))
      }
   }
#[doc="Write the AHB3ENR register."]
   #[inline] fn set_ahb3enr<F: FnOnce(Ahb3enr) -> Ahb3enr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB3ENR register."]
   #[inline] fn with_ahb3enr<F: FnOnce(Ahb3enr) -> Ahb3enr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb3enr(::core::ptr::read_volatile((self.base() + 0x38) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the APB1ENR register."]
   #[inline] fn apb1enr(&self) -> Apb1enr { 
      unsafe {
         Apb1enr(::core::ptr::read_volatile((self.base() + 0x40) as *const u32))
      }
   }
...
#[doc="Read the APB2ENR register."]
   #[inline] fn apb2enr(&self) -> Apb2enr { 
      unsafe {
         Apb2enr(::core::ptr::read_volatile((self.base() + 0x44) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the AHB1LPENR register."]
   #[inline] fn ahb1lpenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x50)
   }
#[doc="Get the *mut pointer for the AHB1LPENR register."]
   #[inline] fn ahb1lpenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x50)
   }
#[doc="Read the AHB1LPENR register."]
   #[inline] fn ahb1lpenr(&self) -> Ahb1lpenr { 
      unsafe {
         Ahb1lpenr(::core::ptr::read_volatile((self.base() + 0x50) as *const u32))
      }
   }
#[doc="Write the AHB1LPENR register."]
   #[inline] fn set_ahb1lpenr<F: FnOnce(Ahb1lpenr) -> Ahb1lpenr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB1LPENR register."]
   #[inline] fn with_ahb1lpenr<F: FnOnce(Ahb1lpenr) -> Ahb1lpenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb1lpenr(::core::ptr::read_volatile((self.base() + 0x50) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHB2LPENR register."]
   #[inline] fn ahb2lpenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x54)
   }
#[doc="Get the *mut pointer for the AHB2LPENR register."]
   #[inline] fn ahb2lpenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x54)
   }
#[doc="Read the AHB2LPENR register."]
   #[inline] fn ahb2lpenr(&self) -> Ahb2lpenr { 
      unsafe {
         Ahb2lpenr(::core::ptr::read_volatile((self.base() + 0x54) as *const u32))
      }
   }
#[doc="Write the AHB2LPENR register."]
   #[inline] fn set_ahb2lpenr<F: FnOnce(Ahb2lpenr) -> Ahb2lpenr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB2LPENR register."]
   #[inline] fn with_ahb2lpenr<F: FnOnce(Ahb2lpenr) -> Ahb2lpenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb2lpenr(::core::ptr::read_volatile((self.base() + 0x54) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHB3LPENR register."]
   #[inline] fn ahb3lpenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x58)
   }
#[doc="Get the *mut pointer for the AHB3LPENR register."]
   #[inline] fn ahb3lpenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x58)
   }
#[doc="Read the AHB3LPENR register."]
   #[inline] fn ahb3lpenr(&self) -> Ahb3lpenr { 
      unsafe {
         Ahb3lpenr(::core::ptr::read_volatile((self.base() + 0x58) as *const u32))
      }
   }
#[doc="Write the AHB3LPENR register."]
   #[inline] fn set_ahb3lpenr<F: FnOnce(Ahb3lpenr) -> Ahb3lpenr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHB3LPENR register."]
   #[inline] fn with_ahb3lpenr<F: FnOnce(Ahb3lpenr) -> Ahb3lpenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahb3lpenr(::core::ptr::read_volatile((self.base() + 0x58) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the APB1LPENR register."]
   #[inline] fn apb1lpenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x60)
   }
#[doc="Get the *mut pointer for the APB1LPENR register."]
   #[inline] fn apb1lpenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x60)
   }
#[doc="Read the APB1LPENR register."]
   #[inline] fn apb1lpenr(&self) -> Apb1lpenr { 
      unsafe {
         Apb1lpenr(::core::ptr::read_volatile((self.base() + 0x60) as *const u32))
      }
   }
#[doc="Write the APB1LPENR register."]
   #[inline] fn set_apb1lpenr<F: FnOnce(Apb1lpenr) -> Apb1lpenr>(&self, f: F) -> &Self {
...
#[doc="Modify the APB1LPENR register."]
   #[inline] fn with_apb1lpenr<F: FnOnce(Apb1lpenr) -> Apb1lpenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Apb1lpenr(::core::ptr::read_volatile((self.base() + 0x60) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the APB2LPENR register."]
   #[inline] fn apb2lpenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x64)
   }
#[doc="Get the *mut pointer for the APB2LPENR register."]
   #[inline] fn apb2lpenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x64)
   }
#[doc="Read the APB2LPENR register."]
   #[inline] fn apb2lpenr(&self) -> Apb2lpenr { 
      unsafe {
         Apb2lpenr(::core::ptr::read_volatile((self.base() + 0x64) as *const u32))
      }
   }
#[doc="Write the APB2LPENR register."]
   #[inline] fn set_apb2lpenr<F: FnOnce(Apb2lpenr) -> Apb2lpenr>(&self, f: F) -> &Self {
...
#[doc="Modify the APB2LPENR register."]
   #[inline] fn with_apb2lpenr<F: FnOnce(Apb2lpenr) -> Apb2lpenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Apb2lpenr(::core::ptr::read_volatile((self.base() + 0x64) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the BDCR register."]
   #[inline] fn bdcr(&self) -> Bdcr { 
      unsafe {
         Bdcr(::core::ptr::read_volatile((self.base() + 0x70) as *const u32))
      }
   }
...
#[doc="Read the CSR register."]
   #[inline] fn csr(&self) -> Csr { 
      unsafe {
         Csr(::core::ptr::read_volatile((self.base() + 0x74) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the SSCGR register."]
   #[inline] fn sscgr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x80)
   }
#[doc="Get the *mut pointer for the SSCGR register."]
   #[inline] fn sscgr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x80)
   }
#[doc="Read the SSCGR register."]
   #[inline] fn sscgr(&self) -> Sscgr { 
      unsafe {
         Sscgr(::core::ptr::read_volatile((self.base() + 0x80) as *const u32))
      }
   }
#[doc="Write the SSCGR register."]
   #[inline] fn set_sscgr<F: FnOnce(Sscgr) -> Sscgr>(&self, f: F) -> &Self {
      let value = f(Sscgr(0));
      unsafe {
...
#[doc="Modify the SSCGR register."]
   #[inline] fn with_sscgr<F: FnOnce(Sscgr) -> Sscgr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Sscgr(::core::ptr::read_volatile((self.base() + 0x80) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PLLI2SCFGR register."]
   #[inline] fn plli2scfgr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x84)
   }
#[doc="Get the *mut pointer for the PLLI2SCFGR register."]
   #[inline] fn plli2scfgr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x84)
   }
#[doc="Read the PLLI2SCFGR register."]
   #[inline] fn plli2scfgr(&self) -> Plli2scfgr { 
      unsafe {
         Plli2scfgr(::core::ptr::read_volatile((self.base() + 0x84) as *const u32))
      }
   }
#[doc="Write the PLLI2SCFGR register."]
   #[inline] fn set_plli2scfgr<F: FnOnce(Plli2scfgr) -> Plli2scfgr>(&self, f: F) -> &Self {
...
#[doc="Modify the PLLI2SCFGR register."]
   #[inline] fn with_plli2scfgr<F: FnOnce(Plli2scfgr) -> Plli2scfgr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Plli2scfgr(::core::ptr::read_volatile((self.base() + 0x84) as *const u32))
      };
      let value = f(tmp);
