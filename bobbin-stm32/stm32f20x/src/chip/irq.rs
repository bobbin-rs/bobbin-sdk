...
pub const IRQ_SPI4_IRQ: IrqSpi4Irq = Irq(84, Spi4IrqId {});
pub const IRQ_SPI5_IRQ: IrqSpi5Irq = Irq(85, Spi5IrqId {});
pub const IRQ_SPI6_IRQ: IrqSpi6Irq = Irq(86, Spi6IrqId {});
...
pub const IRQ_USART6_IRQ: IrqUsart6Irq = Irq(71, Usart6IrqId {});
...
pub type IrqSpi4Irq = Irq<Spi4IrqId>;
pub type IrqSpi5Irq = Irq<Spi5IrqId>;
pub type IrqSpi6Irq = Irq<Spi6IrqId>;
...
pub type IrqUsart6Irq = Irq<Usart6IrqId>;
...
#[doc(hidden)]
pub struct Spi4IrqId {} // IRQ 84
#[doc(hidden)]
pub struct Spi5IrqId {} // IRQ 85
#[doc(hidden)]
pub struct Spi6IrqId {} // IRQ 86
#[doc(hidden)]
...
impl RegisterHandler for IrqSpi4Irq {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
...
impl RegisterHandler for IrqSpi5Irq {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
...
impl RegisterHandler for IrqSpi6Irq {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
...
impl RegisterHandler for IrqUsart6Irq {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
