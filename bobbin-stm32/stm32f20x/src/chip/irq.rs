...
irq!(IRQ_SPI4_IRQ, IrqSpi4Irq, 84);
irq!(IRQ_SPI5_IRQ, IrqSpi5Irq, 85);
irq!(IRQ_SPI6_IRQ, IrqSpi6Irq, 86);
...
irq!(IRQ_UART4_IRQ, IrqUart4Irq, 52);
irq!(IRQ_UART5_IRQ, IrqUart5Irq, 53);
irq!(IRQ_USART6_IRQ, IrqUsart6Irq, 71);
