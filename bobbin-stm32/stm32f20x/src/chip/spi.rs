...
// PeripheralGroup { name: "SPI", peripherals: [Peripheral { derived_from: None, group_name: None, name: "SPI1", address: 1073819648, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [Interrupt { name: "SPI1_IRQ", types: [], value: 35, description: Some("SPI1 global interrupt") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "SPI2", address: 1073756160, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [Interrupt { name: "SPI2_IRQ", types: [], value: 36, description: Some("SPI2 global interrupt") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "SPI3", address: 1073757184, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [Interrupt { name: "SPI3_IRQ", types: [], value: 51, description: Some("SPI3 global interrupt") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "I2S2ext", address: 1073755136, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "I2S3ext", address: 1073758208, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "SPI4", address: 1073820672, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [Interrupt { name: "SPI4_IRQ", types: [], value: 84, description: Some("SPI 4 global interrupt") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "SPI5", address: 1073827840, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [Interrupt { name: "SPI5_IRQ", types: [], value: 85, description: Some("SPI 5 global interrupt") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "SPI6", address: 1073828864, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [Interrupt { name: "SPI6_IRQ", types: [], value: 86, description: Some("SPI 6 global interrupt") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }], prototype: Some(Peripheral { derived_from: None, group_name: Some("SPI"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: Some("Serial peripheral interface"), modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CR1", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("control register 1"), fields: [Field { name: "BIDIMODE", bit_offset: 15, bit_width: 1, access: None, description: Some("Bidirectional data mode enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BIDIOE", bit_offset: 14, bit_width: 1, access: None, description: Some("Output enable in bidirectional mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCEN", bit_offset: 13, bit_width: 1, access: None, description: Some("Hardware CRC calculation enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCNEXT", bit_offset: 12, bit_width: 1, access: None, description: Some("CRC transfer next"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DFF", bit_offset: 11, bit_width: 1, access: None, description: Some("Data frame format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXONLY", bit_offset: 10, bit_width: 1, access: None, description: Some("Receive only"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SSM", bit_offset: 9, bit_width: 1, access: None, description: Some("Software slave management"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SSI", bit_offset: 8, bit_width: 1, access: None, description: Some("Internal slave select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LSBFIRST", bit_offset: 7, bit_width: 1, access: None, description: Some("Frame format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SPE", bit_offset: 6, bit_width: 1, access: None, description: Some("SPI enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BR", bit_offset: 3, bit_width: 3, access: None, description: Some("Baud rate control"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSTR", bit_offset: 2, bit_width: 1, access: None, description: Some("Master selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CPOL", bit_offset: 1, bit_width: 1, access: None, description: Some("Clock polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CPHA", bit_offset: 0, bit_width: 1, access: None, description: Some("Clock phase"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CR2", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("control register 2"), fields: [Field { name: "TXEIE", bit_offset: 7, bit_width: 1, access: None, description: Some("Tx buffer empty interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXNEIE", bit_offset: 6, bit_width: 1, access: None, description: Some("RX buffer not empty interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ERRIE", bit_offset: 5, bit_width: 1, access: None, description: Some("Error interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FRF", bit_offset: 4, bit_width: 1, access: None, description: Some("Frame format"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SSOE", bit_offset: 2, bit_width: 1, access: None, description: Some("SS output enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TXDMAEN", bit_offset: 1, bit_width: 1, access: None, description: Some("Tx buffer DMA enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXDMAEN", bit_offset: 0, bit_width: 1, access: None, description: Some("Rx buffer DMA enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SR", offset: 8, size: Some(32), access: None, reset_value: Some(2), reset_mask: None, description: Some("status register"), fields: [Field { name: "TIFRFE", bit_offset: 8, bit_width: 1, access: Some(ReadOnly), description: Some("TI frame format error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BSY", bit_offset: 7, bit_width: 1, access: Some(ReadOnly), description: Some("Busy flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "OVR", bit_offset: 6, bit_width: 1, access: Some(ReadOnly), description: Some("Overrun flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MODF", bit_offset: 5, bit_width: 1, access: Some(ReadOnly), description: Some("Mode fault"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCERR", bit_offset: 4, bit_width: 1, access: Some(ReadWrite), description: Some("CRC error flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "UDR", bit_offset: 3, bit_width: 1, access: Some(ReadOnly), description: Some("Underrun flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CHSIDE", bit_offset: 2, bit_width: 1, access: Some(ReadOnly), description: Some("Channel side"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TXE", bit_offset: 1, bit_width: 1, access: Some(ReadOnly), description: Some("Transmit buffer empty"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "RXNE", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Receive buffer not empty"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DR", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("data register"), fields: [Field { name: "DR", bit_offset: 0, bit_width: 16, access: None, description: Some("Data register"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CRCPR", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(7), reset_mask: None, description: Some("CRC polynomial register"), fields: [Field { name: "CRCPOLY", bit_offset: 0, bit_width: 16, access: None, description: Some("CRC polynomial register"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RXCRCR", offset: 20, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("RX CRC register"), fields: [Field { name: "RxCRC", bit_offset: 0, bit_width: 16, access: None, description: Some("Rx CRC register"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TXCRCR", offset: 24, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("TX CRC register"), fields: [Field { name: "TxCRC", bit_offset: 0, bit_width: 16, access: None, description: Some("Tx CRC register"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "I2SCFGR", offset: 28, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("I2S configuration register"), fields: [Field { name: "I2SMOD", bit_offset: 11, bit_width: 1, access: None, description: Some("I2S mode selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "I2SE", bit_offset: 10, bit_width: 1, access: None, description: Some("I2S Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "I2SCFG", bit_offset: 8, bit_width: 2, access: None, description: Some("I2S configuration mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PCMSYNC", bit_offset: 7, bit_width: 1, access: None, description: Some("PCM frame synchronization"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "I2SSTD", bit_offset: 4, bit_width: 2, access: None, description: Some("I2S standard selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CKPOL", bit_offset: 3, bit_width: 1, access: None, description: Some("Steady state clock polarity"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DATLEN", bit_offset: 1, bit_width: 2, access: None, description: Some("Data length to be transferred"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CHLEN", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel length (number of bits per audio channel)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "I2SPR", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(10), reset_mask: None, description: Some("I2S prescaler register"), fields: [Field { name: "MCKOE", bit_offset: 9, bit_width: 1, access: None, description: Some("Master clock output enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ODD", bit_offset: 8, bit_width: 1, access: None, description: Some("Odd factor for the prescaler"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "I2SDIV", bit_offset: 0, bit_width: 8, access: None, description: Some("I2S Linear prescaler"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
...
#[doc="Read the SR register."]
   #[inline] pub fn sr(&self) -> Sr { 
      unsafe {
         Sr(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the DR register."]
   #[inline] pub fn dr(&self) -> Dr { 
      unsafe {
         Dr(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the RXCRCR register."]
   #[inline] pub fn rxcrcr(&self) -> Rxcrcr { 
      unsafe {
         Rxcrcr(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the TXCRCR register."]
   #[inline] pub fn txcrcr(&self) -> Txcrcr { 
      unsafe {
         Txcrcr(::core::ptr::read_volatile((self.0 + 0x18) as *const u32))
      }
   }
...
#[doc="Read the I2SCFGR register."]
   #[inline] pub fn i2scfgr(&self) -> I2scfgr { 
      unsafe {
         I2scfgr(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the I2SPR register."]
   #[inline] pub fn i2spr(&self) -> I2spr { 
      unsafe {
         I2spr(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
