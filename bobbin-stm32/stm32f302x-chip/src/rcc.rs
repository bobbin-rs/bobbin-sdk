...
impl En for super::tim_gen::Tim16 {
   #[inline]
   fn en(&self) -> u32 { RCC.apb2enr().tim16en() }
   #[inline]
   fn set_en(&self, value: u32) { RCC.with_apb2enr(|r| r.set_tim16en(value)); }
}

impl En for super::tim_gen::Tim17 {
   #[inline]
   fn en(&self) -> u32 { RCC.apb2enr().tim17en() }
   #[inline]
   fn set_en(&self, value: u32) { RCC.with_apb2enr(|r| r.set_tim17en(value)); }
}
