...
#[doc="Enable WKUP1 pin"]
  #[inline] pub fn ewup1(&self) -> bits::B1 {
     (((self.0 as u32) >> 8) & 0x1).into() // [8]
  }
#[doc="Enable WKUP1 pin"]
  #[inline] pub fn set_ewup1<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 8);
...
#[doc="Enable WKUP2 pin"]
  #[inline] pub fn ewup2(&self) -> bits::B1 {
     (((self.0 as u32) >> 9) & 0x1).into() // [9]
  }
#[doc="Enable WKUP2 pin"]
  #[inline] pub fn set_ewup2<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 9);
