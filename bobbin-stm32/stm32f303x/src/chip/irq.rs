...
pub const IRQ_I2C1_EV_EXTI23: IrqI2c1EvExti23 = Irq(31, I2c1EvExti23Id {});
...
pub const IRQ_DACUNDER: IrqDacunder = Irq(54, DacunderId {});
...
pub type IrqI2c1EvExti23 = Irq<I2c1EvExti23Id>;
...
pub type IrqDacunder = Irq<DacunderId>;
...
#[doc(hidden)]
pub struct I2c1EvExti23Id {} // IRQ 31
#[doc(hidden)]
...
impl RegisterHandler for IrqI2c1EvExti23 {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
...
impl RegisterHandler for IrqI2c2EvExti24 {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
...
impl RegisterHandler for IrqDacunder {
   fn register_handler<'a, F: ::core::marker::Sync + ::core::marker::Send + HandleInterrupt>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleInterrupt>() {
