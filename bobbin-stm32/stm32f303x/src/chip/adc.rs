...
periph!(_ADC2, AdcPeriph, ADC2, Adc2, 0x50000100);
periph!(_ADC3, AdcPeriph, ADC3, Adc3, 0x50000400);
periph!(_ADC4, AdcPeriph, ADC4, Adc4, 0x50000500);
...
channel!(ADC2_REFINT, Adc2Refint, ADC2, Adc2, 18);
channel!(ADC3_CH1, Adc3Ch1, ADC3, Adc3, 1);
channel!(ADC3_CH2, Adc3Ch2, ADC3, Adc3, 2);
channel!(ADC3_CH3, Adc3Ch3, ADC3, Adc3, 3);
channel!(ADC3_CH4, Adc3Ch4, ADC3, Adc3, 4);
channel!(ADC3_CH5, Adc3Ch5, ADC3, Adc3, 5);
channel!(ADC3_CH6, Adc3Ch6, ADC3, Adc3, 6);
channel!(ADC3_CH7, Adc3Ch7, ADC3, Adc3, 7);
channel!(ADC3_CH8, Adc3Ch8, ADC3, Adc3, 8);
channel!(ADC3_CH9, Adc3Ch9, ADC3, Adc3, 9);
channel!(ADC3_CH10, Adc3Ch10, ADC3, Adc3, 10);
channel!(ADC3_CH11, Adc3Ch11, ADC3, Adc3, 11);
channel!(ADC3_CH12, Adc3Ch12, ADC3, Adc3, 12);
channel!(ADC3_CH13, Adc3Ch13, ADC3, Adc3, 13);
channel!(ADC3_CH14, Adc3Ch14, ADC3, Adc3, 14);
channel!(ADC3_CH15, Adc3Ch15, ADC3, Adc3, 15);
channel!(ADC3_REFINT, Adc3Refint, ADC3, Adc3, 18);
channel!(ADC4_CH1, Adc4Ch1, ADC4, Adc4, 1);
channel!(ADC4_CH2, Adc4Ch2, ADC4, Adc4, 2);
channel!(ADC4_CH3, Adc4Ch3, ADC4, Adc4, 3);
channel!(ADC4_CH4, Adc4Ch4, ADC4, Adc4, 4);
channel!(ADC4_CH5, Adc4Ch5, ADC4, Adc4, 5);
channel!(ADC4_CH6, Adc4Ch6, ADC4, Adc4, 6);
channel!(ADC4_CH7, Adc4Ch7, ADC4, Adc4, 7);
channel!(ADC4_CH8, Adc4Ch8, ADC4, Adc4, 8);
channel!(ADC4_CH9, Adc4Ch9, ADC4, Adc4, 9);
channel!(ADC4_CH10, Adc4Ch10, ADC4, Adc4, 10);
channel!(ADC4_CH11, Adc4Ch11, ADC4, Adc4, 11);
channel!(ADC4_CH12, Adc4Ch12, ADC4, Adc4, 12);
channel!(ADC4_CH13, Adc4Ch13, ADC4, Adc4, 13);
channel!(ADC4_CH14, Adc4Ch14, ADC4, Adc4, 14);
channel!(ADC4_CH15, Adc4Ch15, ADC4, Adc4, 15);
channel!(ADC4_REFINT, Adc4Refint, ADC4, Adc4, 18);
