...
periph!( ADC1, Adc1, _ADC1, AdcPeriph, 0x50040000);
periph!( ADC2, Adc2, _ADC2, AdcPeriph, 0x50040100);
periph!( ADC3, Adc3, _ADC3, AdcPeriph, 0x50040200);
...
channel!(ADC1_TEMP, Adc1Temp, ADC1, Adc1, _ADC1_TEMP, AdcCh, _ADC1, 17);
channel!(ADC1_REFINT, Adc1Refint, ADC1, Adc1, _ADC1_REFINT, AdcCh, _ADC1, 0);
