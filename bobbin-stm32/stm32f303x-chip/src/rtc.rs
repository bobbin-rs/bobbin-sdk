...
impl Rtc {
  ...
  pub unsafe fn set_tr(&mut self, value: Tr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x0) as *mut u32, value.0);
  }
  pub unsafe fn with_tr<F: FnOnce(Tr) -> Tr>(&mut self, f: F) {
     let tmp = self.tr();
     self.set_tr(f(tmp))
  }
  ...
  pub unsafe fn set_prer(&mut self, value: Prer) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x10) as *mut u32, value.0);
  }
  pub unsafe fn with_prer<F: FnOnce(Prer) -> Prer>(&mut self, f: F) {
     let tmp = self.prer();
     self.set_prer(f(tmp))
  }
  ...
  pub unsafe fn set_wutr(&mut self, value: Wutr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x14) as *mut u32, value.0);
  }
  pub unsafe fn with_wutr<F: FnOnce(Wutr) -> Wutr>(&mut self, f: F) {
     let tmp = self.wutr();
     self.set_wutr(f(tmp))
  }
  ...
  pub unsafe fn set_alrmar(&mut self, value: Alrmar) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x1c) as *mut u32, value.0);
  }
  pub unsafe fn with_alrmar<F: FnOnce(Alrmar) -> Alrmar>(&mut self, f: F) {
     let tmp = self.alrmar();
  ...
  pub unsafe fn set_alrmbr(&mut self, value: Alrmbr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x20) as *mut u32, value.0);
  }
  pub unsafe fn with_alrmbr<F: FnOnce(Alrmbr) -> Alrmbr>(&mut self, f: F) {
     let tmp = self.alrmbr();
     self.set_alrmbr(f(tmp))
  }

  pub unsafe fn set_wpr(&mut self, value: Wpr) {
  ...
  pub unsafe fn set_shiftr(&mut self, value: Shiftr) {
  ...
  pub unsafe fn set_calr(&mut self, value: Calr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x3c) as *mut u32, value.0);
  }
  pub unsafe fn with_calr<F: FnOnce(Calr) -> Calr>(&mut self, f: F) {
     let tmp = self.calr();
     self.set_calr(f(tmp))
  }

  pub unsafe fn tafcr(&self) -> Tafcr { 
     Tafcr(::core::ptr::read_volatile(((self.0 as usize) + 0x40) as *const u32))
  }
  pub unsafe fn set_tafcr(&mut self, value: Tafcr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x40) as *mut u32, value.0);
  }
  pub unsafe fn with_tafcr<F: FnOnce(Tafcr) -> Tafcr>(&mut self, f: F) {
     let tmp = self.tafcr();
  ...
  pub unsafe fn set_alrmassr(&mut self, value: Alrmassr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x44) as *mut u32, value.0);
  }
  pub unsafe fn with_alrmassr<F: FnOnce(Alrmassr) -> Alrmassr>(&mut self, f: F) {
  ...
  pub unsafe fn set_alrmbssr(&mut self, value: Alrmbssr) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x48) as *mut u32, value.0);
  }
  pub unsafe fn with_alrmbssr<F: FnOnce(Alrmbssr) -> Alrmbssr>(&mut self, f: F) {
  ...
  pub unsafe fn set_bkpr(&mut self, index: usize, value: Bkpr) {
     assert!(index < 32);
     ::core::ptr::write_volatile(((self.0 as usize) + 0x50 + (index << 2)) as *mut u32, value.0);
  }
  pub unsafe fn with_bkpr<F: FnOnce(Bkpr) -> Bkpr>(&mut self, index: usize, f: F) {
...
impl Cr {
  pub fn wcksel(&self) -> u32 {
     ((self.0 as u32) >> 0) & 0x7 // [2:0]
  }
  pub fn set_wcksel(mut self, value: u32) -> Self {
     assert!((value & !0x7) == 0);
     self.0 &= !(0x7 << 0);
     self.0 |= value << 0;
     self
...
impl Isr {
  ...
  pub fn tamp3f(&self) -> u32 {
     ((self.0 as u32) >> 15) & 0x1 // [15]
  }
  pub fn set_tamp3f(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 15);
     self.0 |= value << 15;
     self
  ...
  pub fn recalpf(&self) -> u32 {
     ((self.0 as u32) >> 16) & 0x1 // [16]
  }
  pub fn set_recalpf(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 16);
     self.0 |= value << 16;
     self
...
impl Tafcr {
  ...
  pub fn tamp2trg(&self) -> u32 {
     ((self.0 as u32) >> 4) & 0x1 // [4]
  }
  pub fn set_tamp2trg(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 4);
     self.0 |= value << 4;
     self
  ...
  pub fn tamp3e(&self) -> u32 {
     ((self.0 as u32) >> 5) & 0x1 // [5]
  }
  pub fn set_tamp3e(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 5);
     self.0 |= value << 5;
     self
  ...
  pub fn tamp3trg(&self) -> u32 {
     ((self.0 as u32) >> 6) & 0x1 // [6]
  }
  pub fn set_tamp3trg(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 6);
     self.0 |= value << 6;
     self
  ...
  pub fn pc13value(&self) -> u32 {
     ((self.0 as u32) >> 18) & 0x1 // [18]
  }
  pub fn set_pc13value(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 18);
     self.0 |= value << 18;
     self
  ...
  pub fn pc13mode(&self) -> u32 {
     ((self.0 as u32) >> 19) & 0x1 // [19]
  }
  pub fn set_pc13mode(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 19);
     self.0 |= value << 19;
     self
  ...
  pub fn pc14value(&self) -> u32 {
     ((self.0 as u32) >> 20) & 0x1 // [20]
  }
  pub fn set_pc14value(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 20);
     self.0 |= value << 20;
     self
  ...
  pub fn pc14mode(&self) -> u32 {
     ((self.0 as u32) >> 21) & 0x1 // [21]
  }
  pub fn set_pc14mode(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 21);
     self.0 |= value << 21;
     self
  ...
  pub fn pc15value(&self) -> u32 {
     ((self.0 as u32) >> 22) & 0x1 // [22]
  }
  pub fn set_pc15value(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 22);
     self.0 |= value << 22;
     self
  ...
  pub fn pc15mode(&self) -> u32 {
     ((self.0 as u32) >> 23) & 0x1 // [23]
  }
  pub fn set_pc15mode(mut self, value: u32) -> Self {
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 23);
     self.0 |= value << 23;
     self
