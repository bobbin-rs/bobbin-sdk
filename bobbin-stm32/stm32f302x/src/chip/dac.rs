...
// PeripheralGroup { name: "DAC", peripherals: [Peripheral { derived_from: None, group_name: None, name: "DAC", address: 1073771520, size: None, access: None, reset_value: None, reset_mask: None, description: Some("Digital-to-analog converter"), modules: [], features: [], links: [], interrupts: [Interrupt { name: "TIM6_DACUNDER", types: [], value: 54, description: Some("TIM6 global and DAC12 underrun interrupts") }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }], prototype: Some(Peripheral { derived_from: None, group_name: Some("DAC"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("control register"), fields: [Field { name: "DMAUDRIE2", bit_offset: 29, bit_width: 1, access: None, description: Some("DAC channel2 DMA underrun interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAEN2", bit_offset: 28, bit_width: 1, access: None, description: Some("DAC channel2 DMA enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MAMP2", bit_offset: 24, bit_width: 4, access: None, description: Some("DAC channel2 mask/amplitude selector"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WAVE2", bit_offset: 22, bit_width: 2, access: None, description: Some("DAC channel2 noise/triangle wave generation enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSEL2", bit_offset: 19, bit_width: 3, access: None, description: Some("DAC channel2 trigger selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TEN2", bit_offset: 18, bit_width: 1, access: None, description: Some("DAC channel2 trigger enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BOFF2", bit_offset: 17, bit_width: 1, access: None, description: Some("DAC channel2 output buffer disable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EN2", bit_offset: 16, bit_width: 1, access: None, description: Some("DAC channel2 enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAUDRIE1", bit_offset: 13, bit_width: 1, access: None, description: Some("DAC channel1 DMA Underrun Interrupt enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAEN1", bit_offset: 12, bit_width: 1, access: None, description: Some("DAC channel1 DMA enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MAMP1", bit_offset: 8, bit_width: 4, access: None, description: Some("DAC channel1 mask/amplitude selector"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "WAVE1", bit_offset: 6, bit_width: 2, access: None, description: Some("DAC channel1 noise/triangle wave generation enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSEL1", bit_offset: 3, bit_width: 3, access: None, description: Some("DAC channel1 trigger selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TEN1", bit_offset: 2, bit_width: 1, access: None, description: Some("DAC channel1 trigger enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BOFF1", bit_offset: 1, bit_width: 1, access: None, description: Some("DAC channel1 output buffer disable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EN1", bit_offset: 0, bit_width: 1, access: None, description: Some("DAC channel1 enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SWTRIGR", offset: 4, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: None, description: Some("software trigger register"), fields: [Field { name: "SWTRIG2", bit_offset: 1, bit_width: 1, access: None, description: Some("DAC channel2 software trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SWTRIG1", bit_offset: 0, bit_width: 1, access: None, description: Some("DAC channel1 software trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR12R1", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel1 12-bit right-aligned data holding register"), fields: [Field { name: "DACC1DHR", bit_offset: 0, bit_width: 12, access: None, description: Some("DAC channel1 12-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR12L1", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel1 12-bit left aligned data holding register"), fields: [Field { name: "DACC1DHR", bit_offset: 4, bit_width: 12, access: None, description: Some("DAC channel1 12-bit left-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR8R1", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel1 8-bit right aligned data holding register"), fields: [Field { name: "DACC1DHR", bit_offset: 0, bit_width: 8, access: None, description: Some("DAC channel1 8-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR12R2", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel2 12-bit right aligned data holding register"), fields: [Field { name: "DACC2DHR", bit_offset: 0, bit_width: 12, access: None, description: Some("DAC channel2 12-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR12L2", offset: 24, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel2 12-bit left aligned data holding register"), fields: [Field { name: "DACC2DHR", bit_offset: 4, bit_width: 12, access: None, description: Some("DAC channel2 12-bit left-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR8R2", offset: 28, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("channel2 8-bit right-aligned data holding register"), fields: [Field { name: "DACC2DHR", bit_offset: 0, bit_width: 8, access: None, description: Some("DAC channel2 8-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR12RD", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("Dual DAC 12-bit right-aligned data holding register"), fields: [Field { name: "DACC2DHR", bit_offset: 16, bit_width: 12, access: None, description: Some("DAC channel2 12-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DACC1DHR", bit_offset: 0, bit_width: 12, access: None, description: Some("DAC channel1 12-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR12LD", offset: 36, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DUAL DAC 12-bit left aligned data holding register"), fields: [Field { name: "DACC2DHR", bit_offset: 20, bit_width: 12, access: None, description: Some("DAC channel2 12-bit left-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DACC1DHR", bit_offset: 4, bit_width: 12, access: None, description: Some("DAC channel1 12-bit left-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DHR8RD", offset: 40, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("DUAL DAC 8-bit right aligned data holding register"), fields: [Field { name: "DACC2DHR", bit_offset: 8, bit_width: 8, access: None, description: Some("DAC channel2 8-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DACC1DHR", bit_offset: 0, bit_width: 8, access: None, description: Some("DAC channel1 8-bit right-aligned data"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DOR1", offset: 44, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("channel1 data output register"), fields: [Field { name: "DACC1DOR", bit_offset: 0, bit_width: 12, access: None, description: Some("DAC channel1 data output"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DOR2", offset: 48, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: None, description: Some("channel2 data output register"), fields: [Field { name: "DACC2DOR", bit_offset: 0, bit_width: 12, access: None, description: Some("DAC channel2 data output"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SR", offset: 52, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: None, description: Some("status register"), fields: [Field { name: "DMAUDR2", bit_offset: 29, bit_width: 1, access: None, description: Some("DAC channel2 DMA underrun flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAUDR1", bit_offset: 13, bit_width: 1, access: None, description: Some("DAC channel1 DMA underrun flag"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: false, description: None }
...
#[doc="Read the DHR12R1 register."]
   #[inline] pub fn dhr12r1(&self) -> Dhr12r1 { 
      unsafe {
         Dhr12r1(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the DHR12L1 register."]
   #[inline] pub fn dhr12l1(&self) -> Dhr12l1 { 
      unsafe {
         Dhr12l1(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the DHR8R1 register."]
   #[inline] pub fn dhr8r1(&self) -> Dhr8r1 { 
      unsafe {
         Dhr8r1(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the DHR12R2 register."]
   #[inline] pub fn dhr12r2(&self) -> Dhr12r2 { 
      unsafe {
         Dhr12r2(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the DHR12L2 register."]
   #[inline] pub fn dhr12l2(&self) -> Dhr12l2 { 
      unsafe {
         Dhr12l2(::core::ptr::read_volatile((self.0 + 0x18) as *const u32))
      }
   }
...
#[doc="Read the DHR8R2 register."]
   #[inline] pub fn dhr8r2(&self) -> Dhr8r2 { 
      unsafe {
         Dhr8r2(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the DHR12RD register."]
   #[inline] pub fn dhr12rd(&self) -> Dhr12rd { 
      unsafe {
         Dhr12rd(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the DHR12LD register."]
   #[inline] pub fn dhr12ld(&self) -> Dhr12ld { 
      unsafe {
         Dhr12ld(::core::ptr::read_volatile((self.0 + 0x24) as *const u32))
      }
   }
...
#[doc="Read the DHR8RD register."]
   #[inline] pub fn dhr8rd(&self) -> Dhr8rd { 
      unsafe {
         Dhr8rd(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
...
#[doc="Read the DOR1 register."]
   #[inline] pub fn dor1(&self) -> Dor1 { 
      unsafe {
         Dor1(::core::ptr::read_volatile((self.0 + 0x2c) as *const u32))
      }
   }
...
#[doc="Read the DOR2 register."]
   #[inline] pub fn dor2(&self) -> Dor2 { 
      unsafe {
         Dor2(::core::ptr::read_volatile((self.0 + 0x30) as *const u32))
      }
   }
...
#[doc="Read the SR register."]
   #[inline] pub fn sr(&self) -> Sr { 
      unsafe {
         Sr(::core::ptr::read_volatile((self.0 + 0x34) as *const u32))
      }
   }
