...
periph!(CAdcPeriph, C_ADC12, CAdc12, 0x50000300);
periph!(CAdcPeriph, C_ADC34, CAdc34, 0x50000700);
...
#[doc="Read the CCR register."]
   #[inline] fn ccr(&self) -> Ccr { 
      unsafe {
         Ccr(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      }
   }
...
#[doc="Read the CDR register."]
   #[inline] fn cdr(&self) -> Cdr { 
      unsafe {
         Cdr(::core::ptr::read_volatile((self.base() + 0xc) as *const u32))
      }
   }
