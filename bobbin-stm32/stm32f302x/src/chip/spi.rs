...
#[doc="Read the DR8 register."]
   #[inline] pub fn dr8(&self) -> Dr8 { 
      unsafe {
         Dr8(::core::ptr::read_volatile((self.0 + 0xc) as *const u8))
      }
   }
