...
#[doc="USB interrupt remap"]
  #[inline] pub fn usb_it_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 5) & 0x1).into() // [5]
  }
#[doc="USB interrupt remap"]
  #[inline] pub fn set_usb_it_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
...
#[doc="Timer 1 ITR3 selection"]
  #[inline] pub fn tim1_itr_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 6) & 0x1).into() // [6]
  }
#[doc="Timer 1 ITR3 selection"]
  #[inline] pub fn set_tim1_itr_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 6);
...
#[doc="DAC trigger remap (when TSEL = 001)"]
  #[inline] pub fn dac_trig_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 7) & 0x1).into() // [7]
  }
#[doc="DAC trigger remap (when TSEL = 001)"]
  #[inline] pub fn set_dac_trig_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 7);
...
#[doc="ADC24 DMA remapping bit"]
  #[inline] pub fn adc24_dma_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 8) & 0x1).into() // [8]
  }
#[doc="ADC24 DMA remapping bit"]
  #[inline] pub fn set_adc24_dma_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 8);
...
#[doc="TIM16 DMA request remapping bit"]
  #[inline] pub fn tim16_dma_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 11) & 0x1).into() // [11]
  }
#[doc="TIM16 DMA request remapping bit"]
  #[inline] pub fn set_tim16_dma_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 11);
...
#[doc="TIM17 DMA request remapping bit"]
  #[inline] pub fn tim17_dma_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 12) & 0x1).into() // [12]
  }
#[doc="TIM17 DMA request remapping bit"]
  #[inline] pub fn set_tim17_dma_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 12);
...
#[doc="TIM6 and DAC1 DMA request remapping bit"]
  #[inline] pub fn tim6_dac1_dma_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 13) & 0x1).into() // [13]
  }
#[doc="TIM6 and DAC1 DMA request remapping bit"]
  #[inline] pub fn set_tim6_dac1_dma_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 13);
...
#[doc="TIM7 and DAC2 DMA request remapping bit"]
  #[inline] pub fn tim7_dac2_dma_rmp(&self) -> bits::B1 {
     (((self.0 as u32) >> 14) & 0x1).into() // [14]
  }
#[doc="TIM7 and DAC2 DMA request remapping bit"]
  #[inline] pub fn set_tim7_dac2_dma_rmp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 14);
...
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn i2c_pb6_fm(&self) -> bits::B1 {
     (((self.0 as u32) >> 16) & 0x1).into() // [16]
  }
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn set_i2c_pb6_fm<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 16);
...
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn i2c_pb7_fm(&self) -> bits::B1 {
     (((self.0 as u32) >> 17) & 0x1).into() // [17]
  }
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn set_i2c_pb7_fm<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 17);
...
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn i2c_pb8_fm(&self) -> bits::B1 {
     (((self.0 as u32) >> 18) & 0x1).into() // [18]
  }
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn set_i2c_pb8_fm<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 18);
...
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn i2c_pb9_fm(&self) -> bits::B1 {
     (((self.0 as u32) >> 19) & 0x1).into() // [19]
  }
#[doc="Fast Mode Plus (FM+) driving capability activation bits."]
  #[inline] pub fn set_i2c_pb9_fm<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 19);
...
#[doc="I2C1 Fast Mode Plus"]
  #[inline] pub fn i2c1_fm(&self) -> bits::B1 {
     (((self.0 as u32) >> 20) & 0x1).into() // [20]
  }
#[doc="I2C1 Fast Mode Plus"]
  #[inline] pub fn set_i2c1_fm<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 20);
...
#[doc="I2C2 Fast Mode Plus"]
  #[inline] pub fn i2c2_fm(&self) -> bits::B1 {
     (((self.0 as u32) >> 21) & 0x1).into() // [21]
  }
#[doc="I2C2 Fast Mode Plus"]
  #[inline] pub fn set_i2c2_fm<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 21);
...
#[doc="Encoder mode"]
  #[inline] pub fn encoder_mode(&self) -> bits::B2 {
     (((self.0 as u32) >> 22) & 0x3).into() // [23:22]
  }
#[doc="Encoder mode"]
  #[inline] pub fn set_encoder_mode<V: Into<bits::B2>>(mut self, value: V) -> Self {
     let value: bits::B2 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x3) == 0);
     self.0 &= !(0x3 << 22);
...
#[doc="Interrupt enable bits from FPU"]
  #[inline] pub fn fpu_it(&self) -> bits::B6 {
     (((self.0 as u32) >> 26) & 0x3f).into() // [31:26]
  }
#[doc="Interrupt enable bits from FPU"]
  #[inline] pub fn set_fpu_it<V: Into<bits::B6>>(mut self, value: V) -> Self {
...
#[doc="Cortex-M0 LOCKUP bit enable bit"]
  #[inline] pub fn locup_lock(&self) -> bits::B1 {
     (((self.0 as u32) >> 0) & 0x1).into() // [0]
  }
#[doc="Cortex-M0 LOCKUP bit enable bit"]
  #[inline] pub fn set_locup_lock<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
...
#[doc="SRAM parity lock bit"]
  #[inline] pub fn sram_parity_lock(&self) -> bits::B1 {
     (((self.0 as u32) >> 1) & 0x1).into() // [1]
  }
#[doc="SRAM parity lock bit"]
  #[inline] pub fn set_sram_parity_lock<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 1);
...
#[doc="PVD lock enable bit"]
  #[inline] pub fn pvd_lock(&self) -> bits::B1 {
     (((self.0 as u32) >> 2) & 0x1).into() // [2]
  }
#[doc="PVD lock enable bit"]
  #[inline] pub fn set_pvd_lock<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 2);
...
#[doc="Bypass address bit 29 in parity calculation"]
  #[inline] pub fn byp_add_par(&self) -> bits::B1 {
     (((self.0 as u32) >> 4) & 0x1).into() // [4]
  }
#[doc="Bypass address bit 29 in parity calculation"]
  #[inline] pub fn set_byp_add_par<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 4);
...
#[doc="SRAM parity flag"]
  #[inline] pub fn sram_pef(&self) -> bits::B1 {
     (((self.0 as u32) >> 8) & 0x1).into() // [8]
  }
#[doc="SRAM parity flag"]
  #[inline] pub fn set_sram_pef<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 8);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page0_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 0) & 0x1).into() // [0]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page0_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 0);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page1_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 1) & 0x1).into() // [1]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page1_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 1);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page2_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 2) & 0x1).into() // [2]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page2_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 2);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page3_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 3) & 0x1).into() // [3]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page3_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 3);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page4_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 4) & 0x1).into() // [4]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page4_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 4);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page5_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 5) & 0x1).into() // [5]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page5_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 5);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page6_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 6) & 0x1).into() // [6]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page6_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 6);
...
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn page7_wp(&self) -> bits::B1 {
     (((self.0 as u32) >> 7) & 0x1).into() // [7]
  }
#[doc="CCM SRAM page write protection bit"]
  #[inline] pub fn set_page7_wp<V: Into<bits::B1>>(mut self, value: V) -> Self {
     let value: bits::B1 = value.into();
     let value: u32 = value.into();
     assert!((value & !0x1) == 0);
     self.0 &= !(0x1 << 7);
