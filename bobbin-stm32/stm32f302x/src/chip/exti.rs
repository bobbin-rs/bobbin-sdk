...
channel!(EXTI_LINE23, ExtiLine23, EXTI, Exti, 23);
channel!(EXTI_LINE24, ExtiLine24, EXTI, Exti, 24);
channel!(EXTI_LINE25, ExtiLine25, EXTI, Exti, 25);
channel!(EXTI_LINE26, ExtiLine26, EXTI, Exti, 26);
channel!(EXTI_LINE28, ExtiLine28, EXTI, Exti, 28);
channel!(EXTI_LINE29, ExtiLine29, EXTI, Exti, 29);
channel!(EXTI_LINE30, ExtiLine30, EXTI, Exti, 30);
channel!(EXTI_LINE31, ExtiLine31, EXTI, Exti, 31);
channel!(EXTI_LINE32, ExtiLine32, EXTI, Exti, 32);
channel!(EXTI_LINE33, ExtiLine33, EXTI, Exti, 33);
channel!(EXTI_LINE34, ExtiLine34, EXTI, Exti, 34);
channel!(EXTI_LINE35, ExtiLine35, EXTI, Exti, 35);
