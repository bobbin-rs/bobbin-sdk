...
#[doc="Read the CFGR1 register."]
   #[inline] pub fn cfgr1(&self) -> Cfgr1 { 
      unsafe {
         Cfgr1(::core::ptr::read_volatile((self.0 + 0x0) as *const u32))
      }
   }
...
#[doc="Read the CFGR2 register."]
   #[inline] pub fn cfgr2(&self) -> Cfgr2 { 
      unsafe {
         Cfgr2(::core::ptr::read_volatile((self.0 + 0x4) as *const u32))
      }
   }
...
#[doc="Read the CFGR3 register."]
   #[inline] pub fn cfgr3(&self) -> Cfgr3 { 
      unsafe {
         Cfgr3(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
