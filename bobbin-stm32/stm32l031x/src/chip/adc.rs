...
pub const ADC1_REFINT: Channel<Adc1RefintId, Adc1Id> = Channel { periph: ADC1, index: 17, id: Adc1RefintId {} }; 
#[derive(Clone, Copy, PartialEq)]
#[doc(hidden)]
pub struct Adc1RefintId {}
pub type Adc1Refint = Channel<Adc1RefintId, Adc1Id>;

pub const ADC1_TEMP: Channel<Adc1TempId, Adc1Id> = Channel { periph: ADC1, index: 18, id: Adc1TempId {} }; 
#[derive(Clone, Copy, PartialEq)]
#[doc(hidden)]
