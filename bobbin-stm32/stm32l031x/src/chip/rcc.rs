...
#[doc="Get the *const pointer for the ICSCR register."]
   #[inline] fn icscr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x4)
   }
#[doc="Get the *mut pointer for the ICSCR register."]
   #[inline] fn icscr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x4)
   }
#[doc="Read the ICSCR register."]
   #[inline] fn icscr(&self) -> Icscr { 
      unsafe {
         Icscr(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      }
   }
#[doc="Write the ICSCR register."]
   #[inline] fn set_icscr<F: FnOnce(Icscr) -> Icscr>(&self, f: F) -> &Self {
      let value = f(Icscr(0));
      unsafe {
...
#[doc="Modify the ICSCR register."]
   #[inline] fn with_icscr<F: FnOnce(Icscr) -> Icscr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Icscr(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the CRRCR register."]
   #[inline] fn crrcr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x8)
   }
#[doc="Get the *mut pointer for the CRRCR register."]
   #[inline] fn crrcr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x8)
   }
#[doc="Read the CRRCR register."]
   #[inline] fn crrcr(&self) -> Crrcr { 
      unsafe {
         Crrcr(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      }
   }
#[doc="Write the CRRCR register."]
   #[inline] fn set_crrcr<F: FnOnce(Crrcr) -> Crrcr>(&self, f: F) -> &Self {
      let value = f(Crrcr(0));
      unsafe {
...
#[doc="Modify the CRRCR register."]
   #[inline] fn with_crrcr<F: FnOnce(Crrcr) -> Crrcr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Crrcr(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the CIER register."]
   #[inline] fn cier_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Get the *mut pointer for the CIER register."]
   #[inline] fn cier_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Read the CIER register."]
   #[inline] fn cier(&self) -> Cier { 
      unsafe {
         Cier(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      }
   }

#[doc="Get the *const pointer for the CIFR register."]
   #[inline] fn cifr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Get the *mut pointer for the CIFR register."]
   #[inline] fn cifr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Read the CIFR register."]
   #[inline] fn cifr(&self) -> Cifr { 
      unsafe {
         Cifr(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      }
   }

#[doc="Get the *const pointer for the CICR register."]
   #[inline] fn cicr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Get the *mut pointer for the CICR register."]
   #[inline] fn cicr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Read the CICR register."]
   #[inline] fn cicr(&self) -> Cicr { 
      unsafe {
         Cicr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      }
   }

#[doc="Get the *const pointer for the IOPRSTR register."]
   #[inline] fn ioprstr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1c)
   }
#[doc="Get the *mut pointer for the IOPRSTR register."]
   #[inline] fn ioprstr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1c)
   }
#[doc="Read the IOPRSTR register."]
   #[inline] fn ioprstr(&self) -> Ioprstr { 
      unsafe {
         Ioprstr(::core::ptr::read_volatile((self.base() + 0x1c) as *const u32))
      }
   }
#[doc="Write the IOPRSTR register."]
   #[inline] fn set_ioprstr<F: FnOnce(Ioprstr) -> Ioprstr>(&self, f: F) -> &Self {
...
#[doc="Modify the IOPRSTR register."]
   #[inline] fn with_ioprstr<F: FnOnce(Ioprstr) -> Ioprstr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ioprstr(::core::ptr::read_volatile((self.base() + 0x1c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the AHBRSTR register."]
   #[inline] fn ahbrstr(&self) -> Ahbrstr { 
      unsafe {
         Ahbrstr(::core::ptr::read_volatile((self.base() + 0x20) as *const u32))
      }
   }
...
#[doc="Read the APB1RSTR register."]
   #[inline] fn apb1rstr(&self) -> Apb1rstr { 
      unsafe {
         Apb1rstr(::core::ptr::read_volatile((self.base() + 0x28) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the IOPENR register."]
   #[inline] fn iopenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x2c)
   }
#[doc="Get the *mut pointer for the IOPENR register."]
   #[inline] fn iopenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x2c)
   }
#[doc="Read the IOPENR register."]
   #[inline] fn iopenr(&self) -> Iopenr { 
      unsafe {
         Iopenr(::core::ptr::read_volatile((self.base() + 0x2c) as *const u32))
      }
   }
#[doc="Write the IOPENR register."]
   #[inline] fn set_iopenr<F: FnOnce(Iopenr) -> Iopenr>(&self, f: F) -> &Self {
...
#[doc="Modify the IOPENR register."]
   #[inline] fn with_iopenr<F: FnOnce(Iopenr) -> Iopenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Iopenr(::core::ptr::read_volatile((self.base() + 0x2c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the AHBENR register."]
   #[inline] fn ahbenr(&self) -> Ahbenr { 
      unsafe {
         Ahbenr(::core::ptr::read_volatile((self.base() + 0x30) as *const u32))
      }
   }
...
#[doc="Read the APB2ENR register."]
   #[inline] fn apb2enr(&self) -> Apb2enr { 
      unsafe {
         Apb2enr(::core::ptr::read_volatile((self.base() + 0x34) as *const u32))
      }
   }
...
#[doc="Read the APB1ENR register."]
   #[inline] fn apb1enr(&self) -> Apb1enr { 
      unsafe {
         Apb1enr(::core::ptr::read_volatile((self.base() + 0x38) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the IOPSMEN register."]
   #[inline] fn iopsmen_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x3c)
   }
#[doc="Get the *mut pointer for the IOPSMEN register."]
   #[inline] fn iopsmen_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x3c)
   }
#[doc="Read the IOPSMEN register."]
   #[inline] fn iopsmen(&self) -> Iopsmen { 
      unsafe {
         Iopsmen(::core::ptr::read_volatile((self.base() + 0x3c) as *const u32))
      }
   }
#[doc="Write the IOPSMEN register."]
   #[inline] fn set_iopsmen<F: FnOnce(Iopsmen) -> Iopsmen>(&self, f: F) -> &Self {
...
#[doc="Modify the IOPSMEN register."]
   #[inline] fn with_iopsmen<F: FnOnce(Iopsmen) -> Iopsmen>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Iopsmen(::core::ptr::read_volatile((self.base() + 0x3c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the AHBSMENR register."]
   #[inline] fn ahbsmenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x40)
   }
#[doc="Get the *mut pointer for the AHBSMENR register."]
   #[inline] fn ahbsmenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x40)
   }
#[doc="Read the AHBSMENR register."]
   #[inline] fn ahbsmenr(&self) -> Ahbsmenr { 
      unsafe {
         Ahbsmenr(::core::ptr::read_volatile((self.base() + 0x40) as *const u32))
      }
   }
#[doc="Write the AHBSMENR register."]
   #[inline] fn set_ahbsmenr<F: FnOnce(Ahbsmenr) -> Ahbsmenr>(&self, f: F) -> &Self {
...
#[doc="Modify the AHBSMENR register."]
   #[inline] fn with_ahbsmenr<F: FnOnce(Ahbsmenr) -> Ahbsmenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ahbsmenr(::core::ptr::read_volatile((self.base() + 0x40) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the APB2SMENR register."]
   #[inline] fn apb2smenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x44)
   }
#[doc="Get the *mut pointer for the APB2SMENR register."]
   #[inline] fn apb2smenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x44)
   }
#[doc="Read the APB2SMENR register."]
   #[inline] fn apb2smenr(&self) -> Apb2smenr { 
      unsafe {
         Apb2smenr(::core::ptr::read_volatile((self.base() + 0x44) as *const u32))
      }
   }
#[doc="Write the APB2SMENR register."]
   #[inline] fn set_apb2smenr<F: FnOnce(Apb2smenr) -> Apb2smenr>(&self, f: F) -> &Self {
...
#[doc="Modify the APB2SMENR register."]
   #[inline] fn with_apb2smenr<F: FnOnce(Apb2smenr) -> Apb2smenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Apb2smenr(::core::ptr::read_volatile((self.base() + 0x44) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the APB1SMENR register."]
   #[inline] fn apb1smenr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x48)
   }
#[doc="Get the *mut pointer for the APB1SMENR register."]
   #[inline] fn apb1smenr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x48)
   }
#[doc="Read the APB1SMENR register."]
   #[inline] fn apb1smenr(&self) -> Apb1smenr { 
      unsafe {
         Apb1smenr(::core::ptr::read_volatile((self.base() + 0x48) as *const u32))
      }
   }
#[doc="Write the APB1SMENR register."]
   #[inline] fn set_apb1smenr<F: FnOnce(Apb1smenr) -> Apb1smenr>(&self, f: F) -> &Self {
...
#[doc="Modify the APB1SMENR register."]
   #[inline] fn with_apb1smenr<F: FnOnce(Apb1smenr) -> Apb1smenr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Apb1smenr(::core::ptr::read_volatile((self.base() + 0x48) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the CCIPR register."]
   #[inline] fn ccipr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x4c)
   }
#[doc="Get the *mut pointer for the CCIPR register."]
   #[inline] fn ccipr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x4c)
   }
#[doc="Read the CCIPR register."]
   #[inline] fn ccipr(&self) -> Ccipr { 
      unsafe {
         Ccipr(::core::ptr::read_volatile((self.base() + 0x4c) as *const u32))
      }
   }
#[doc="Write the CCIPR register."]
   #[inline] fn set_ccipr<F: FnOnce(Ccipr) -> Ccipr>(&self, f: F) -> &Self {
      let value = f(Ccipr(0));
      unsafe {
...
#[doc="Modify the CCIPR register."]
   #[inline] fn with_ccipr<F: FnOnce(Ccipr) -> Ccipr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ccipr(::core::ptr::read_volatile((self.base() + 0x4c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the CSR register."]
   #[inline] fn csr(&self) -> Csr { 
      unsafe {
         Csr(::core::ptr::read_volatile((self.base() + 0x50) as *const u32))
      }
   }
