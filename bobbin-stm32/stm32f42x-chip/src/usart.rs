...
impl UsartImpl {
  ...
  #[inline]
  pub fn set_sr(&self, value: Sr) -> &UsartImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_sr<F: FnOnce(Sr) -> Sr>(&self, f: F) -> &UsartImpl {
     let tmp = self.sr();
     self.set_sr(f(tmp))
  }
  ...
  #[inline]
  pub fn set_dr(&self, value: Dr) -> &UsartImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_dr<F: FnOnce(Dr) -> Dr>(&self, f: F) -> &UsartImpl {
     let tmp = self.dr();
     self.set_dr(f(tmp))
  }
