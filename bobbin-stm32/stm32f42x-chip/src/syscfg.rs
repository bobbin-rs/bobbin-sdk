...
impl Syscfg {
  ...
  #[inline]
  pub fn set_memrm(&self, value: Memrm) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_memrm<F: FnOnce(Memrm) -> Memrm>(&self, f: F) -> &Self {
     let tmp = self.memrm();
  ...
  #[inline]
  pub fn set_pmc(&self, value: Pmc) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_pmc<F: FnOnce(Pmc) -> Pmc>(&self, f: F) -> &Self {
     let tmp = self.pmc();
     self.set_pmc(f(tmp))
  }
