...
pub trait RegisterTimHandler {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a>;
}
...
pub trait RegisterBrkHandler {
   fn register_brk_handler<'a, F: HandleBrk>(&self, f: &F) -> IrqGuard<'a>;
}
...
pub trait RegisterUpHandler {
   fn register_up_handler<'a, F: HandleUp>(&self, f: &F) -> IrqGuard<'a>;
}
...
pub trait RegisterTrgComHandler {
   fn register_trg_com_handler<'a, F: HandleTrgCom>(&self, f: &F) -> IrqGuard<'a>;
}
...
pub trait RegisterCcHandler {
   fn register_cc_handler<'a, F: HandleCc>(&self, f: &F) -> IrqGuard<'a>;
}
...
impl RegisterTimHandler for ::tim_bas::Tim6 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
...
impl RegisterTimHandler for ::tim_bas::Tim7 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim2 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim3 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim4 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim5 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim9 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim10 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim11 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim12 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim13 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim_gen::Tim14 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterBrkHandler for ::tim_adv::Tim1 {
   fn register_brk_handler<'a, F: HandleBrk>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
...
impl RegisterUpHandler for ::tim_adv::Tim1 {
   fn register_up_handler<'a, F: HandleUp>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
...
impl RegisterTrgComHandler for ::tim_adv::Tim1 {
   fn register_trg_com_handler<'a, F: HandleTrgCom>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
...
impl RegisterCcHandler for ::tim_adv::Tim1 {
   fn register_cc_handler<'a, F: HandleCc>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
...
impl RegisterBrkHandler for ::tim_adv::Tim8 {
   fn register_brk_handler<'a, F: HandleBrk>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleBrk>() {
...
impl RegisterUpHandler for ::tim_adv::Tim8 {
   fn register_up_handler<'a, F: HandleUp>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleUp>() {
...
impl RegisterTrgComHandler for ::tim_adv::Tim8 {
   fn register_trg_com_handler<'a, F: HandleTrgCom>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTrgCom>() {
...
impl RegisterCcHandler for ::tim_adv::Tim8 {
   fn register_cc_handler<'a, F: HandleCc>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleCc>() {
...
impl RegisterTimHandler for ::tim::Tim2 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim::Tim3 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim::Tim4 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
...
impl RegisterTimHandler for ::tim::Tim5 {
   fn register_tim_handler<'a, F: HandleTim>(&self, f: &F) -> IrqGuard<'a> {
       static mut HANDLER: Option<usize> = None;
       unsafe { HANDLER = Some(f as *const F as usize) }
       extern "C" fn wrapper<W: HandleTim>() {
