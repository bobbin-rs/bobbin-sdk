...
pub trait AfTim2Ch1Etr {
   fn af_tim2_ch1_etr(&self) -> usize;
}
...
pub trait AfDcmiPixck {
   fn af_dcmi_pixck(&self) -> usize;
}
...
pub trait AfFsmcD2 {
   fn af_fsmc_d2(&self) -> usize;
}

pub trait AfFsmcD3 {
   fn af_fsmc_d3(&self) -> usize;
}
...
pub trait AfFsmcClk {
   fn af_fsmc_clk(&self) -> usize;
}

pub trait AfFsmcNoe {
   fn af_fsmc_noe(&self) -> usize;
}

pub trait AfFsmcNwe {
   fn af_fsmc_nwe(&self) -> usize;
}

pub trait AfFsmcNwait {
   fn af_fsmc_nwait(&self) -> usize;
}

pub trait AfFsmcNe1 {
   fn af_fsmc_ne1(&self) -> usize;
}

pub trait AfFsmcNce2 {
   fn af_fsmc_nce2(&self) -> usize;
}

pub trait AfFsmcD13 {
   fn af_fsmc_d13(&self) -> usize;
}

pub trait AfFsmcD14 {
   fn af_fsmc_d14(&self) -> usize;
}

pub trait AfFsmcD15 {
   fn af_fsmc_d15(&self) -> usize;
}

pub trait AfFsmcA16 {
   fn af_fsmc_a16(&self) -> usize;
}

pub trait AfFsmcA17 {
   fn af_fsmc_a17(&self) -> usize;
}

pub trait AfFsmcA18 {
   fn af_fsmc_a18(&self) -> usize;
}

pub trait AfFsmcD0 {
   fn af_fsmc_d0(&self) -> usize;
}

pub trait AfFsmcD1 {
   fn af_fsmc_d1(&self) -> usize;
}
...
pub trait AfFsmcNbl0 {
   fn af_fsmc_nbl0(&self) -> usize;
}

pub trait AfFsmcNbl1 {
   fn af_fsmc_nbl1(&self) -> usize;
}
...
pub trait AfFsmcA22 {
   fn af_fsmc_a22(&self) -> usize;
}

pub trait AfFsmcD4 {
   fn af_fsmc_d4(&self) -> usize;
}

pub trait AfFsmcD5 {
   fn af_fsmc_d5(&self) -> usize;
}

pub trait AfFsmcD6 {
   fn af_fsmc_d6(&self) -> usize;
}

pub trait AfFsmcD7 {
   fn af_fsmc_d7(&self) -> usize;
}

pub trait AfFsmcD8 {
   fn af_fsmc_d8(&self) -> usize;
}

pub trait AfFsmcD9 {
   fn af_fsmc_d9(&self) -> usize;
}

pub trait AfFsmcD10 {
   fn af_fsmc_d10(&self) -> usize;
}

pub trait AfFsmcD11 {
   fn af_fsmc_d11(&self) -> usize;
}

pub trait AfFsmcD12 {
   fn af_fsmc_d12(&self) -> usize;
}

pub trait AfFsmcA0 {
   fn af_fsmc_a0(&self) -> usize;
}

pub trait AfFsmcA1 {
   fn af_fsmc_a1(&self) -> usize;
}

pub trait AfFsmcA2 {
   fn af_fsmc_a2(&self) -> usize;
}

pub trait AfFsmcA3 {
   fn af_fsmc_a3(&self) -> usize;
}

pub trait AfFsmcA4 {
   fn af_fsmc_a4(&self) -> usize;
}

pub trait AfFsmcA5 {
   fn af_fsmc_a5(&self) -> usize;
}

pub trait AfFsmcNiord {
   fn af_fsmc_niord(&self) -> usize;
}

pub trait AfFsmcNreg {
   fn af_fsmc_nreg(&self) -> usize;
}

pub trait AfFsmcNiowr {
   fn af_fsmc_niowr(&self) -> usize;
}

pub trait AfFsmcCd {
   fn af_fsmc_cd(&self) -> usize;
}

pub trait AfFsmcIntr {
   fn af_fsmc_intr(&self) -> usize;
}
...
pub trait AfFsmcA6 {
   fn af_fsmc_a6(&self) -> usize;
}

pub trait AfFsmcA7 {
   fn af_fsmc_a7(&self) -> usize;
}

pub trait AfFsmcA8 {
   fn af_fsmc_a8(&self) -> usize;
}

pub trait AfFsmcA9 {
   fn af_fsmc_a9(&self) -> usize;
}

pub trait AfFsmcA10 {
   fn af_fsmc_a10(&self) -> usize;
}

pub trait AfFsmcA11 {
   fn af_fsmc_a11(&self) -> usize;
}

pub trait AfFsmcA12 {
   fn af_fsmc_a12(&self) -> usize;
}

pub trait AfFsmcA13 {
   fn af_fsmc_a13(&self) -> usize;
}

pub trait AfFsmcA14 {
   fn af_fsmc_a14(&self) -> usize;
}

pub trait AfFsmcA15 {
   fn af_fsmc_a15(&self) -> usize;
}

pub trait AfFsmcInt2 {
   fn af_fsmc_int2(&self) -> usize;
}

pub trait AfFsmcInt3 {
   fn af_fsmc_int3(&self) -> usize;
}
...
pub trait AfFsmcNe2 {
   fn af_fsmc_ne2(&self) -> usize;
}

pub trait AfFsmcNce3 {
   fn af_fsmc_nce3(&self) -> usize;
}

pub trait AfFsmcNce41 {
   fn af_fsmc_nce4_1(&self) -> usize;
}

pub trait AfFsmcNe3 {
   fn af_fsmc_ne3(&self) -> usize;
}

pub trait AfFsmcNce42 {
   fn af_fsmc_nce4_2(&self) -> usize;
}

pub trait AfFsmcNe4 {
   fn af_fsmc_ne4(&self) -> usize;
}
...
pub trait AfFsmcA24 {
   fn af_fsmc_a24(&self) -> usize;
}

pub trait AfFsmcA25 {
   fn af_fsmc_a25(&self) -> usize;
}
...
impl AfTim2Ch1Etr for Pa0 {
   fn af_tim2_ch1_etr(&self) -> usize { 1 }
}
...
impl AfDcmiPixck for Pa6 {
   fn af_dcmi_pixck(&self) -> usize { 13 }
}
...
impl AfFsmcNl for Pb7 {
   fn af_fsmc_nl(&self) -> usize { 12 }
}
...
impl AfSpi2Miso for Pc2 {
   fn af_spi2_miso(&self) -> usize { 5 }
}

impl AfI2s2extSd for Pc2 {
   fn af_i2s2ext_sd(&self) -> usize { 6 }
}
...
impl AfSpi2Mosi for Pc3 {
   fn af_spi2_mosi(&self) -> usize { 5 }
}

impl AfI2s2Sd for Pc3 {
   fn af_i2s2_sd(&self) -> usize { 5 }
}
...
impl AfFsmcD2 for Pd0 {
   fn af_fsmc_d2(&self) -> usize { 12 }
}
...
impl AfFsmcD3 for Pd1 {
   fn af_fsmc_d3(&self) -> usize { 12 }
}
...
impl AfFsmcClk for Pd3 {
   fn af_fsmc_clk(&self) -> usize { 12 }
}
...
impl AfFsmcNoe for Pd4 {
   fn af_fsmc_noe(&self) -> usize { 12 }
}
...
impl AfFsmcNwe for Pd5 {
   fn af_fsmc_nwe(&self) -> usize { 12 }
}
...
impl AfFsmcNwait for Pd6 {
   fn af_fsmc_nwait(&self) -> usize { 12 }
}
...
impl AfFsmcNe1 for Pd7 {
   fn af_fsmc_ne1(&self) -> usize { 12 }
}

impl AfFsmcNce2 for Pd7 {
   fn af_fsmc_nce2(&self) -> usize { 12 }
}
...
impl AfFsmcD13 for Pd8 {
   fn af_fsmc_d13(&self) -> usize { 12 }
}
...
impl AfFsmcD14 for Pd9 {
   fn af_fsmc_d14(&self) -> usize { 12 }
}
...
impl AfFsmcD15 for Pd10 {
   fn af_fsmc_d15(&self) -> usize { 12 }
}
...
impl AfFsmcA16 for Pd11 {
   fn af_fsmc_a16(&self) -> usize { 12 }
}
...
impl AfFsmcA17 for Pd12 {
   fn af_fsmc_a17(&self) -> usize { 12 }
}
...
impl AfFsmcA18 for Pd13 {
   fn af_fsmc_a18(&self) -> usize { 12 }
}
...
impl AfFsmcD0 for Pd14 {
   fn af_fsmc_d0(&self) -> usize { 12 }
}
...
impl AfFsmcD1 for Pd15 {
   fn af_fsmc_d1(&self) -> usize { 12 }
}
...
impl AfFsmcNbl0 for Pe0 {
   fn af_fsmc_nbl0(&self) -> usize { 12 }
}

impl AfDcmiD2 for Pe0 {
   fn af_dcmi_d2(&self) -> usize { 13 }
}
...
impl AfFsmcNbl1 for Pe1 {
   fn af_fsmc_nbl1(&self) -> usize { 12 }
}

impl AfDcmiD3 for Pe1 {
   fn af_dcmi_d3(&self) -> usize { 13 }
}
...
impl AfFsmcA23 for Pe2 {
   fn af_fsmc_a23(&self) -> usize { 12 }
}
...
impl AfFsmcA19 for Pe3 {
   fn af_fsmc_a19(&self) -> usize { 12 }
}
...
impl AfFsmcA20 for Pe4 {
   fn af_fsmc_a20(&self) -> usize { 12 }
}

impl AfDcmiD4 for Pe4 {
   fn af_dcmi_d4(&self) -> usize { 13 }
}
...
impl AfFsmcA21 for Pe5 {
   fn af_fsmc_a21(&self) -> usize { 12 }
}

impl AfDcmiD6 for Pe5 {
   fn af_dcmi_d6(&self) -> usize { 13 }
}
...
impl AfFsmcA22 for Pe6 {
   fn af_fsmc_a22(&self) -> usize { 12 }
}

impl AfDcmiD7 for Pe6 {
   fn af_dcmi_d7(&self) -> usize { 13 }
}
...
impl AfFsmcD4 for Pe7 {
   fn af_fsmc_d4(&self) -> usize { 12 }
}
...
impl AfFsmcD5 for Pe8 {
   fn af_fsmc_d5(&self) -> usize { 12 }
}
...
impl AfFsmcD6 for Pe9 {
   fn af_fsmc_d6(&self) -> usize { 12 }
}
...
impl AfFsmcD7 for Pe10 {
   fn af_fsmc_d7(&self) -> usize { 12 }
}
...
impl AfFsmcD8 for Pe11 {
   fn af_fsmc_d8(&self) -> usize { 12 }
}
...
impl AfFsmcD9 for Pe12 {
   fn af_fsmc_d9(&self) -> usize { 12 }
}
...
impl AfFsmcD10 for Pe13 {
   fn af_fsmc_d10(&self) -> usize { 12 }
}
...
impl AfFsmcD11 for Pe14 {
   fn af_fsmc_d11(&self) -> usize { 12 }
}
...
impl AfFsmcD12 for Pe15 {
   fn af_fsmc_d12(&self) -> usize { 12 }
}
...
impl AfFsmcA0 for Pf0 {
   fn af_fsmc_a0(&self) -> usize { 12 }
}
...
impl AfFsmcA1 for Pf1 {
   fn af_fsmc_a1(&self) -> usize { 12 }
}
...
impl AfFsmcA2 for Pf2 {
   fn af_fsmc_a2(&self) -> usize { 12 }
}
...
impl AfFsmcA3 for Pf3 {
   fn af_fsmc_a3(&self) -> usize { 12 }
}
...
impl AfFsmcA4 for Pf4 {
   fn af_fsmc_a4(&self) -> usize { 12 }
}
...
impl AfFsmcA5 for Pf5 {
   fn af_fsmc_a5(&self) -> usize { 12 }
}
...
impl AfFsmcNiord for Pf6 {
   fn af_fsmc_niord(&self) -> usize { 12 }
}
...
impl AfFsmcNreg for Pf7 {
   fn af_fsmc_nreg(&self) -> usize { 12 }
}
...
impl AfFsmcNiowr for Pf8 {
   fn af_fsmc_niowr(&self) -> usize { 12 }
}
...
impl AfFsmcCd for Pf9 {
   fn af_fsmc_cd(&self) -> usize { 12 }
}
...
impl AfFsmcIntr for Pf10 {
   fn af_fsmc_intr(&self) -> usize { 12 }
}
...
impl AfFsmcA6 for Pf12 {
   fn af_fsmc_a6(&self) -> usize { 12 }
}
...
impl AfFsmcA7 for Pf13 {
   fn af_fsmc_a7(&self) -> usize { 12 }
}
...
impl AfFsmcA8 for Pf14 {
   fn af_fsmc_a8(&self) -> usize { 12 }
}
...
impl AfFsmcA9 for Pf15 {
   fn af_fsmc_a9(&self) -> usize { 12 }
}
...
impl AfFsmcA10 for Pg0 {
   fn af_fsmc_a10(&self) -> usize { 12 }
}
...
impl AfFsmcA11 for Pg1 {
   fn af_fsmc_a11(&self) -> usize { 12 }
}
...
impl AfFsmcA12 for Pg2 {
   fn af_fsmc_a12(&self) -> usize { 12 }
}
...
impl AfFsmcA13 for Pg3 {
   fn af_fsmc_a13(&self) -> usize { 12 }
}
...
impl AfFsmcA14 for Pg4 {
   fn af_fsmc_a14(&self) -> usize { 12 }
}
...
impl AfFsmcA15 for Pg5 {
   fn af_fsmc_a15(&self) -> usize { 12 }
}
...
impl AfFsmcInt2 for Pg6 {
   fn af_fsmc_int2(&self) -> usize { 12 }
}
...
impl AfFsmcInt3 for Pg7 {
   fn af_fsmc_int3(&self) -> usize { 12 }
}
...
impl AfFsmcNe2 for Pg9 {
   fn af_fsmc_ne2(&self) -> usize { 12 }
}

impl AfFsmcNce3 for Pg9 {
   fn af_fsmc_nce3(&self) -> usize { 12 }
}
...
impl AfFsmcNce41 for Pg10 {
   fn af_fsmc_nce4_1(&self) -> usize { 12 }
}

impl AfFsmcNe3 for Pg10 {
   fn af_fsmc_ne3(&self) -> usize { 12 }
}
...
impl AfFsmcNce42 for Pg11 {
   fn af_fsmc_nce4_2(&self) -> usize { 12 }
}
...
impl AfUsart6Rts for Pg12 {
   fn af_usart6_rts(&self) -> usize { 8 }
}

impl AfFsmcNe4 for Pg12 {
   fn af_fsmc_ne4(&self) -> usize { 12 }
}
...
impl AfFsmcA24 for Pg13 {
   fn af_fsmc_a24(&self) -> usize { 12 }
}
...
impl AfFsmcA25 for Pg14 {
   fn af_fsmc_a25(&self) -> usize { 12 }
}
