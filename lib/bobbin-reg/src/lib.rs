...
impl<T: Copy + Default> Register<T> {
    ...
    #[inline]
    pub fn read(&self) -> T { unsafe { rw::read_volatile(self.ptr()) } }

    #[inline]
    pub fn write(&self, value: T) { unsafe { rw::write_volatile(self.ptr(), value) } }
...
impl<T: Copy + Default, I: Copy + ::core::ops::Mul<isize, Output=isize>> RegisterArray<T, I>
{
    ...
    #[inline]
    pub fn read(&self, index: I) -> T { unsafe { rw::read_volatile(self.ptr(index)) } }

    #[inline]
    pub fn write(&self, index: I, value: T) { unsafe { rw::write_volatile(self.ptr(index), value) } }
...
mod tests {
    ...
    pub fn test_ptr() {
        ...
        ::rw::add_region(0x1000_0000, 0x1000);
        GPIOA_MODER.write(0x1234);
        assert_eq!(::rw::read_u32(0x1000_0000 as *const u32), 0x1234);
    }
