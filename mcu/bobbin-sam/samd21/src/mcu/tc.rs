...
periph!( TC3, Tc3, TC3_PERIPH, TcPeriph, 0x42002c00, 0x00, 0x0c);
periph!( TC4, Tc4, TC4_PERIPH, TcPeriph, 0x42003000, 0x01, 0x0d);
periph!( TC5, Tc5, TC5_PERIPH, TcPeriph, 0x42003400, 0x02, 0x0e);
