...
periph!( SERCOM0, Sercom0, SERCOM0_PERIPH, SercomPeriph, 0x42000800, 0x00, 0x11);
periph!( SERCOM1, Sercom1, SERCOM1_PERIPH, SercomPeriph, 0x42000c00, 0x01, 0x12);
periph!( SERCOM2, Sercom2, SERCOM2_PERIPH, SercomPeriph, 0x42001000, 0x02, 0x13);
periph!( SERCOM3, Sercom3, SERCOM3_PERIPH, SercomPeriph, 0x42001400, 0x03, 0x14);
periph!( SERCOM4, Sercom4, SERCOM4_PERIPH, SercomPeriph, 0x42001800, 0x04, 0x15);
periph!( SERCOM5, Sercom5, SERCOM5_PERIPH, SercomPeriph, 0x42001c00, 0x05, 0x16);
