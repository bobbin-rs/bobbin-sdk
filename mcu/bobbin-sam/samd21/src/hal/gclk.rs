...
impl GclkPeriph {
    pub fn reset(&self) {
        self.set_ctrl(|r| r.set_swrst(1));
        while self.ctrl().swrst() != 0 {}
    }

    pub fn configure_clk(&self, clk: GenericClock, cfg: ClockConfig) {    
        self.set_clkctrl(|r| r
            .set_id(clk as u16)
    ...
    pub fn set_clk(&self, clk: GenericClock, clk_gen: GenericClockGen) {
        self.set_clkctrl(|r| r
            .set_id(clk as u16)
    ...
    pub fn configure_clkgen(&self, clk_gen: GenericClockGen, cfg: ClockGenConfig) {
        self.set_gendiv(|r| r.set_id(clk_gen as u32).set_div(cfg.division_factor as u32));
        self.set_genctrl(|r| r
    ...
    pub fn set_clockgen(&self, clk_gen: GenericClockGen, clk_src: ClockSource, div_selection: DivideSelection, div_factor: u32) {
        self.set_gendiv(|r| r.set_id(clk_gen as u32).set_div(div_factor as u32));
        self.set_genctrl(|r| r
            .set_id(clk_gen as u32)
