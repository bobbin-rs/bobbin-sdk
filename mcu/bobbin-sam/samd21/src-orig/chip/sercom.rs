...
periph!( SERCOM0, Sercom0, SERCOM0_PERIPH, SercomPeriph, 0x42000800, 0x15);
periph!( SERCOM1, Sercom1, SERCOM1_PERIPH, SercomPeriph, 0x42000c00, 0x16);
periph!( SERCOM2, Sercom2, SERCOM2_PERIPH, SercomPeriph, 0x42001000, 0x17);
periph!( SERCOM3, Sercom3, SERCOM3_PERIPH, SercomPeriph, 0x42001400, 0x18);
periph!( SERCOM4, Sercom4, SERCOM4_PERIPH, SercomPeriph, 0x42001800, 0x19);
periph!( SERCOM5, Sercom5, SERCOM5_PERIPH, SercomPeriph, 0x42001c00, 0x1a);
...
impl Usart {
    ...
    #[inline] pub fn set_rxpl<F: FnOnce(Rxpl) -> Rxpl>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.rxpl_mut(), f(Rxpl(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_rxpl<F: FnOnce(Rxpl) -> Rxpl>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.rxpl_mut(), f(self.rxpl()));
        }
        self
    }
