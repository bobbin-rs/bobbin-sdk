...
periph!( SIM, Sim, SIM_PERIPH, SimPeriph, 0x40047000, 0x02);

impl Src for super::tpm::Tpm0 {
    #[inline] fn src(&self) -> bits::U2 { SIM.sopt2().tpmsrc() }
    #[inline] fn set_src<V: Into<bits::U2>>(&self, value: V) { SIM.with_sopt2(|r| r.set_tpmsrc(value)); }
}
...
impl Src for super::uart0::Uart0 {
    #[inline] fn src(&self) -> bits::U2 { SIM.sopt2().uart0src() }
    #[inline] fn set_src<V: Into<bits::U2>>(&self, value: V) { SIM.with_sopt2(|r| r.set_uart0src(value)); }
}
...
impl En for super::spi::Spi0 {
    #[inline] fn en(&self) -> bits::U1 { SIM.scgc4().spi0() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { SIM.with_scgc4(|r| r.set_spi0(value)); }
}

impl En for super::spi::Spi1 {
    #[inline] fn en(&self) -> bits::U1 { SIM.scgc4().spi1() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { SIM.with_scgc4(|r| r.set_spi1(value)); }
}
...
impl En for super::tpm::Tpm0 {
    #[inline] fn en(&self) -> bits::U1 { SIM.scgc6().tpm0() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { SIM.with_scgc6(|r| r.set_tpm0(value)); }
}

impl En for super::tpm::Tpm1 {
    #[inline] fn en(&self) -> bits::U1 { SIM.scgc6().tpm1() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { SIM.with_scgc6(|r| r.set_tpm1(value)); }
}

impl En for super::tpm::Tpm2 {
    #[inline] fn en(&self) -> bits::U1 { SIM.scgc6().tpm2() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { SIM.with_scgc6(|r| r.set_tpm2(value)); }
}
