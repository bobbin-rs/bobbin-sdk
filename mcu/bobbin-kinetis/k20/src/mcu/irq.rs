...
irq_type!(IRQ_PIT0, IrqPit0);
irq_type!(IRQ_PIT1, IrqPit1);
irq_type!(IRQ_PIT2, IrqPit2);
irq_type!(IRQ_PIT3, IrqPit3);
irq_type!(IRQ_SPI, IrqSpi);
irq_type!(IRQ_I2C, IrqI2c);
irq_type!(IRQ_UART_LON, IrqUartLon);
irq_type!(IRQ_UART_RX_TX, IrqUartRxTx);
...
irq!(::pit::Pit, IrqPit0, Irq48);
irq!(::pit::Pit, IrqPit1, Irq49);
irq!(::pit::Pit, IrqPit2, Irq50);
irq!(::pit::Pit, IrqPit3, Irq51);
...
irq!(::uart::Uart0, IrqUartRxTx, Irq31);
irq!(::uart::Uart0, IrqUartErr, Irq32);
irq!(::uart::Uart1, IrqUartRxTx, Irq33);
irq!(::uart::Uart1, IrqUartErr, Irq34);
irq!(::uart::Uart2, IrqUartRxTx, Irq35);
irq!(::uart::Uart2, IrqUartErr, Irq36);
irq!(::uart::Uart3, IrqUartRxTx, Irq37);
irq!(::uart::Uart3, IrqUartErr, Irq38);
irq!(::uart::Uart4, IrqUartRxTx, Irq66);
irq!(::uart::Uart4, IrqUartErr, Irq67);
irq!(::uart::Uart5, IrqUartRxTx, Irq68);
