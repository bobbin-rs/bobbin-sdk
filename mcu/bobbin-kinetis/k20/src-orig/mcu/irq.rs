...
irq!(::edma::Dma, IrqEdma, Irq16);
irq!(::edma::Dma, IrqEdma, Irq0);
irq!(::edma::Dma, IrqEdma, Irq1);
irq!(::edma::Dma, IrqEdma, Irq2);
irq!(::edma::Dma, IrqEdma, Irq3);
irq!(::edma::Dma, IrqEdma, Irq4);
irq!(::edma::Dma, IrqEdma, Irq5);
irq!(::edma::Dma, IrqEdma, Irq6);
irq!(::edma::Dma, IrqEdma, Irq7);
irq!(::edma::Dma, IrqEdma, Irq8);
irq!(::edma::Dma, IrqEdma, Irq9);
irq!(::edma::Dma, IrqEdma, Irq10);
irq!(::edma::Dma, IrqEdma, Irq11);
irq!(::edma::Dma, IrqEdma, Irq12);
irq!(::edma::Dma, IrqEdma, Irq13);
irq!(::edma::Dma, IrqEdma, Irq14);
irq!(::edma::Dma, IrqEdma, Irq15);
irq_type!(IRQ_EDMA, IrqEdma);
irq!(::ftm::Ftm0, IrqFtm, Irq42);
irq!(::ftm::Ftm1, IrqFtm, Irq43);
irq!(::ftm::Ftm2, IrqFtm, Irq44);
irq_type!(IRQ_FTM, IrqFtm);
irq!(::pit::Pit, IrqPit, Irq48);
irq!(::pit::Pit, IrqPit, Irq49);
irq!(::pit::Pit, IrqPit, Irq50);
irq!(::pit::Pit, IrqPit, Irq51);
...
irq!(::uart::Uart0, IrqUart, Irq30);
irq!(::uart::Uart0, IrqUart, Irq31);
irq!(::uart::Uart0, IrqUart, Irq32);
irq!(::uart::Uart1, IrqUart, Irq33);
irq!(::uart::Uart1, IrqUart, Irq34);
irq!(::uart::Uart2, IrqUart, Irq35);
irq!(::uart::Uart2, IrqUart, Irq36);
irq!(::uart::Uart3, IrqUart, Irq37);
irq!(::uart::Uart3, IrqUart, Irq38);
irq!(::uart::Uart4, IrqUart, Irq66);
irq!(::uart::Uart4, IrqUart, Irq67);
irq!(::uart::Uart5, IrqUart, Irq68);
irq!(::uart::Uart5, IrqUart, Irq69);
