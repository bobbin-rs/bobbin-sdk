...
impl ::bobbin_mcu::gate::GateEn for Dac0 {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::sim::SIM.scgc2().dac0() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateEn for Dac1 {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::sim::SIM.scgc2().dac1() }
    #[inline]
    fn set_gate_en<V: Into<::bobbin_bits::U1>>(&self, value: V) -> &Self {
...
impl DacPeriph {
    ...
    #[inline] pub fn datsl_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Datsl, ::bobbin_bits::R16> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Datsl, 0x0, 0x2)
    }

    #[doc="Get the *mut pointer for the DATSL register."]
    #[inline] pub fn datsl_mut<I: Into<::bobbin_bits::R16>>(&self, index: I) -> *mut Datsl { 
        self.datsl_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the DATSL register."]
    #[inline] pub fn datsl_ptr<I: Into<::bobbin_bits::R16>>(&self, index: I) -> *const Datsl { 
        self.datsl_reg().ptr(index.into())
    }

    #[doc="Read the DATSL register."]
    #[inline] pub fn datsl<I: Into<::bobbin_bits::R16>>(&self, index: I) -> Datsl { 
        self.datsl_reg().read(index.into())
    }

    #[doc="Write the DATSL register."]
    #[inline] pub fn write_datsl<I: Into<::bobbin_bits::R16>>(&self, index: I, value: Datsl) -> &Self {
        self.datsl_reg().write(index.into(), value);
        self
    }

    #[doc="Set the DATSL register."]
    #[inline] pub fn set_datsl<I: Into<::bobbin_bits::R16>, F: FnOnce(Datsl) -> Datsl>(&self, index: I, f: F) -> &Self {
        self.datsl_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the DATSL register."]
    #[inline] pub fn with_datsl<I: Into<::bobbin_bits::R16> + Copy, F: FnOnce(Datsl) -> Datsl>(&self, index: I, f: F) -> &Self {
        self.datsl_reg().with(index.into(), f);
        self
    }

    #[doc="Get the DATSH Register."]
    #[inline] pub fn datsh_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Datsh, ::bobbin_bits::R16> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Datsh, 0x1, 0x2)
    }

    #[doc="Get the *mut pointer for the DATSH register."]
    #[inline] pub fn datsh_mut<I: Into<::bobbin_bits::R16>>(&self, index: I) -> *mut Datsh { 
        self.datsh_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the DATSH register."]
    #[inline] pub fn datsh_ptr<I: Into<::bobbin_bits::R16>>(&self, index: I) -> *const Datsh { 
        self.datsh_reg().ptr(index.into())
    }

    #[doc="Read the DATSH register."]
    #[inline] pub fn datsh<I: Into<::bobbin_bits::R16>>(&self, index: I) -> Datsh { 
        self.datsh_reg().read(index.into())
    }

    #[doc="Write the DATSH register."]
    #[inline] pub fn write_datsh<I: Into<::bobbin_bits::R16>>(&self, index: I, value: Datsh) -> &Self {
        self.datsh_reg().write(index.into(), value);
        self
    }

    #[doc="Set the DATSH register."]
    #[inline] pub fn set_datsh<I: Into<::bobbin_bits::R16>, F: FnOnce(Datsh) -> Datsh>(&self, index: I, f: F) -> &Self {
        self.datsh_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the DATSH register."]
    #[inline] pub fn with_datsh<I: Into<::bobbin_bits::R16> + Copy, F: FnOnce(Datsh) -> Datsh>(&self, index: I, f: F) -> &Self {
    ...
    #[inline] pub fn sr_reg(&self) -> ::bobbin_mcu::register::Register<Sr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Sr, 0x20)
    }
    ...
    #[inline] pub fn c0_reg(&self) -> ::bobbin_mcu::register::Register<C0> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut C0, 0x21)
    }
    ...
    #[inline] pub fn c1_reg(&self) -> ::bobbin_mcu::register::Register<C1> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut C1, 0x22)
    }
    ...
    #[inline] pub fn c2_reg(&self) -> ::bobbin_mcu::register::Register<C2> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut C2, 0x23)
    }
...
impl Datsh {
    ...
    #[inline] pub fn data1(&self) -> ::bobbin_bits::U4 {
    ...
    #[inline] pub fn set_data1<V: Into<::bobbin_bits::U4>>(mut self, value: V) -> Self {
...
impl Sr {
    ...
    #[inline] pub fn dacbfrpbf(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dacbfrpbf<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn dacbfrptf(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dacbfrptf<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[inline] pub fn dacbfwmf(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dacbfwmf<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
...
impl C0 {
    ...
    #[inline] pub fn dacbbien(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_dacbbien<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn dacbtien(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 1) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn set_dacbtien<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[inline] pub fn dacbwien(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 2) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn set_dacbwien<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
    ...
    #[inline] pub fn dacswtrg(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dacswtrg<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 4);
        self.0 |= value << 4;
    ...
    #[inline] pub fn dactrgsel(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dactrgsel<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 5);
        self.0 |= value << 5;
    ...
    #[inline] pub fn dacrfs(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dacrfs<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 6);
        self.0 |= value << 6;
...
impl C1 {
    ...
    #[inline] pub fn dacbfen(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_dacbfen<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn dacbfmd(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_dacbfmd<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn dacbfwm(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_dacbfwm<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U2 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x3 << 3);
        self.0 |= value << 3;
...
impl C2 {
    ...
    #[inline] pub fn dacbfup(&self) -> ::bobbin_bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xf) as u8) } // [3:0]
    }
    ...
    #[inline] pub fn set_dacbfup<V: Into<::bobbin_bits::U4>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U4 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0xf << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn dacbfrp(&self) -> ::bobbin_bits::U4 {
    ...
    #[inline] pub fn set_dacbfrp<V: Into<::bobbin_bits::U4>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U4 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0xf << 4);
        self.0 |= value << 4;
