...
impl RcmPeriph {
    ...
    #[inline] pub fn srs0_reg(&self) -> ::bobbin_mcu::register::Register<Srs0> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Srs0, 0x0)
    }
    ...
    #[inline] pub fn srs1_reg(&self) -> ::bobbin_mcu::register::Register<Srs1> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Srs1, 0x1)
    }
    ...
    #[inline] pub fn rpfc_reg(&self) -> ::bobbin_mcu::register::Register<Rpfc> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Rpfc, 0x4)
    }
    ...
    #[inline] pub fn rpfw_reg(&self) -> ::bobbin_mcu::register::Register<Rpfw> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Rpfw, 0x5)
    }
    ...
    #[inline] pub fn mr_reg(&self) -> ::bobbin_mcu::register::Register<Mr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Mr, 0x7)
    }
...
impl Srs0 {
    ...
    #[inline] pub fn lol(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_lol<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 3);
        self.0 |= value << 3;
...
impl Srs1 {
    ...
    #[inline] pub fn jtag(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_jtag<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn mdm_ap(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 3) & 0x1) as u8) } // [3]
    }
    ...
    #[inline] pub fn set_mdm_ap<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 3);
        self.0 |= value << 3;
    ...
    #[doc="EzPort Reset"]
    #[inline] pub fn ezpt(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_ezpt<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 4);
        self.0 |= value << 4;
...
impl Rpfc {
    ...
    #[inline] pub fn rstfltsrw(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_rstfltsrw<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn rstfltss(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 2) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn set_rstfltss<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
...
impl Rpfw {
    ...
    #[inline] pub fn rstfltsel(&self) -> ::bobbin_bits::U5 {
    ...
    #[inline] pub fn set_rstfltsel<V: Into<::bobbin_bits::U5>>(mut self, value: V) -> Self {
...
impl Mr {
    ...
    #[inline] pub fn ezp_ms(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 1) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn set_ezp_ms<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
