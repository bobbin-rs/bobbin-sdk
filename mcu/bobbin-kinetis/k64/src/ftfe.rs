...
impl FtfePeriph {
    ...
    #[inline] pub fn fstat_reg(&self) -> ::bobbin_mcu::register::Register<Fstat> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Fstat, 0x0)
    }
    ...
    #[inline] pub fn fcnfg_reg(&self) -> ::bobbin_mcu::register::Register<Fcnfg> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Fcnfg, 0x1)
    }
    ...
    #[inline] pub fn fsec_reg(&self) -> ::bobbin_mcu::register::Register<Fsec> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Fsec, 0x2)
    }
    ...
    #[inline] pub fn fopt_reg(&self) -> ::bobbin_mcu::register::Register<Fopt> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Fopt, 0x3)
    }
    ...
    #[inline] pub fn fccob_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Fccob, ::bobbin_bits::R12> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Fccob, 0x4, 0x1)
    }

    #[doc="Get the *mut pointer for the FCCOB register."]
    #[inline] pub fn fccob_mut<I: Into<::bobbin_bits::R12>>(&self, index: I) -> *mut Fccob { 
        self.fccob_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the FCCOB register."]
    #[inline] pub fn fccob_ptr<I: Into<::bobbin_bits::R12>>(&self, index: I) -> *const Fccob { 
        self.fccob_reg().ptr(index.into())
    }

    #[doc="Read the FCCOB register."]
    #[inline] pub fn fccob<I: Into<::bobbin_bits::R12>>(&self, index: I) -> Fccob { 
        self.fccob_reg().read(index.into())
    }

    #[doc="Write the FCCOB register."]
    #[inline] pub fn write_fccob<I: Into<::bobbin_bits::R12>>(&self, index: I, value: Fccob) -> &Self {
        self.fccob_reg().write(index.into(), value);
        self
    }

    #[doc="Set the FCCOB register."]
    #[inline] pub fn set_fccob<I: Into<::bobbin_bits::R12>, F: FnOnce(Fccob) -> Fccob>(&self, index: I, f: F) -> &Self {
        self.fccob_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the FCCOB register."]
    #[inline] pub fn with_fccob<I: Into<::bobbin_bits::R12> + Copy, F: FnOnce(Fccob) -> Fccob>(&self, index: I, f: F) -> &Self {
        self.fccob_reg().with(index.into(), f);
        self
    }

    #[doc="Get the FPROT Register."]
    #[inline] pub fn fprot_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Fprot, ::bobbin_bits::R4> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Fprot, 0x10, 0x1)
    }

    #[doc="Get the *mut pointer for the FPROT register."]
    #[inline] pub fn fprot_mut<I: Into<::bobbin_bits::R4>>(&self, index: I) -> *mut Fprot { 
        self.fprot_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the FPROT register."]
    #[inline] pub fn fprot_ptr<I: Into<::bobbin_bits::R4>>(&self, index: I) -> *const Fprot { 
        self.fprot_reg().ptr(index.into())
    }

    #[doc="Read the FPROT register."]
    #[inline] pub fn fprot<I: Into<::bobbin_bits::R4>>(&self, index: I) -> Fprot { 
        self.fprot_reg().read(index.into())
    }

    #[doc="Write the FPROT register."]
    #[inline] pub fn write_fprot<I: Into<::bobbin_bits::R4>>(&self, index: I, value: Fprot) -> &Self {
        self.fprot_reg().write(index.into(), value);
        self
    }

    #[doc="Set the FPROT register."]
    #[inline] pub fn set_fprot<I: Into<::bobbin_bits::R4>, F: FnOnce(Fprot) -> Fprot>(&self, index: I, f: F) -> &Self {
        self.fprot_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the FPROT register."]
    #[inline] pub fn with_fprot<I: Into<::bobbin_bits::R4> + Copy, F: FnOnce(Fprot) -> Fprot>(&self, index: I, f: F) -> &Self {
        self.fprot_reg().with(index.into(), f);
        self
    }

    #[doc="Get the FEPROT Register."]
    #[inline] pub fn feprot_reg(&self) -> ::bobbin_mcu::register::Register<Feprot> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Feprot, 0x16)
    }
    ...
    #[inline] pub fn fdprot_reg(&self) -> ::bobbin_mcu::register::Register<Fdprot> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Fdprot, 0x17)
    }
...
impl Fstat {
    ...
    #[inline] pub fn mgstat0(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_mgstat0<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn rdcolerr(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_rdcolerr<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 6);
        self.0 |= value << 6;
...
impl Fcnfg {
    ...
    #[inline] pub fn eeerdy(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_eeerdy<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
    ...
    #[doc="RAM Ready"]
    #[inline] pub fn ramrdy(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_ramrdy<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[doc="Erase Suspend"]
    #[inline] pub fn erssusp(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 4) & 0x1) as u8) } // [4]
    }
    ...
    #[inline] pub fn set_erssusp<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 4);
        self.0 |= value << 4;
    ...
    #[inline] pub fn ersareq(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 5) & 0x1) as u8) } // [5]
    }
    ...
    #[inline] pub fn set_ersareq<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 5);
        self.0 |= value << 5;
    ...
    #[inline] pub fn rdcollie(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 6) & 0x1) as u8) } // [6]
    }
    ...
    #[inline] pub fn set_rdcollie<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x1 << 6);
        self.0 |= value << 6;
...
impl Fsec {
    ...
    #[inline] pub fn fslacc(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_fslacc<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U2 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x3 << 2);
        self.0 |= value << 2;
    ...
    #[inline] pub fn meen(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_meen<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U2 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0x3 << 4);
        self.0 |= value << 4;
...
impl Fopt {
    ...
    #[inline] pub fn opt(&self) -> ::bobbin_bits::U8 {
    ...
    #[inline] pub fn set_opt<V: Into<::bobbin_bits::U8>>(mut self, value: V) -> Self {
...
impl Fprot {
    ...
    #[inline] pub fn prot(&self) -> ::bobbin_bits::U8 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xff) as u8) } // [7:0]
    }
    ...
    #[inline] pub fn set_prot<V: Into<::bobbin_bits::U8>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U8 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0xff << 0);
        self.0 |= value << 0;
...
impl Feprot {
    ...
    #[inline] pub fn eprot(&self) -> ::bobbin_bits::U8 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xff) as u8) } // [7:0]
    }
    ...
    #[inline] pub fn set_eprot<V: Into<::bobbin_bits::U8>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U8 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0xff << 0);
        self.0 |= value << 0;
...
impl Fdprot {
    ...
    #[inline] pub fn dprot(&self) -> ::bobbin_bits::U8 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xff) as u8) } // [7:0]
    }
    ...
    #[inline] pub fn set_dprot<V: Into<::bobbin_bits::U8>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U8 = value.into();
        let value: u8 = value.into();
        self.0 &= !(0xff << 0);
        self.0 |= value << 0;
