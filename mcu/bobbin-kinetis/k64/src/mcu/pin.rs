...
pin!(PTC2, Ptc2, PORTC, Portc, PTC2_PIN, PortPin, PORTC_PERIPH, 2);
   pin_source!(Ptc2, super::adc::Adc0Ch4, super::sig::SigAdc, 0);
...
pin!(PTD1, Ptd1, PORTD, Portd, PTD1_PIN, PortPin, PORTD_PERIPH, 1);
   pin_source!(Ptd1, super::adc::Adc0Ch5, super::sig::SigAdc, 0);
...
pin!(PTD5, Ptd5, PORTD, Portd, PTD5_PIN, PortPin, PORTD_PERIPH, 5);
   pin_source!(Ptd5, super::adc::Adc0Ch6, super::sig::SigAdc, 0);
...
pin!(PTD6, Ptd6, PORTD, Portd, PTD6_PIN, PortPin, PORTD_PERIPH, 6);
   pin_source!(Ptd6, super::adc::Adc0Ch7, super::sig::SigAdc, 0);
...
pin!(PTE0, Pte0, PORTE, Porte, PTE0_PIN, PortPin, PORTE_PERIPH, 0);
   pin_source!(Pte0, super::adc::Adc1Ch4, super::sig::SigAdc, 0);
...
pin!(PTE1, Pte1, PORTE, Porte, PTE1_PIN, PortPin, PORTE_PERIPH, 1);
   pin_source!(Pte1, super::adc::Adc1Ch5, super::sig::SigAdc, 0);
...
pin!(PTE2, Pte2, PORTE, Porte, PTE2_PIN, PortPin, PORTE_PERIPH, 2);
   pin_source!(Pte2, super::adc::Adc0Ch2, super::sig::SigAdc, 0);
   pin_source!(Pte2, super::adc::Adc1Ch6, super::sig::SigAdc, 0);
   pin_source!(Pte2, super::spi::Spi1, super::sig::SigSpiSck, 2);
pin!(PTE3, Pte3, PORTE, Porte, PTE3_PIN, PortPin, PORTE_PERIPH, 3);
   pin_source!(Pte3, super::adc::Adc0Ch2, super::sig::SigAdc, 0);
   pin_source!(Pte3, super::adc::Adc1Ch7, super::sig::SigAdc, 0);
