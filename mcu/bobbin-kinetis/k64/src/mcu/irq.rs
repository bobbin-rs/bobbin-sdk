...
irq_type!(IRQ_CAN_MB, IrqCanMb);
irq_type!(IRQ_CAN_BUS_OFF, IrqCanBusOff);
irq_type!(IRQ_CAN_ERR, IrqCanErr);
irq_type!(IRQ_CAN_TX_WARN, IrqCanTxWarn);
irq_type!(IRQ_CAN_RX_WARM, IrqCanRxWarm);
irq_type!(IRQ_CAN_WAKE, IrqCanWake);
...
irq!(::flexcan::Can0, IrqCanMb, Irq75);
irq!(::flexcan::Can0, IrqCanBusOff, Irq76);
irq!(::flexcan::Can0, IrqCanErr, Irq77);
irq!(::flexcan::Can0, IrqCanTxWarn, Irq78);
irq!(::flexcan::Can0, IrqCanRxWarm, Irq79);
irq!(::flexcan::Can0, IrqCanWake, Irq80);
irq!(::dac::Dac0, IrqDac, Irq56);
irq!(::dac::Dac1, IrqDac, Irq72);
