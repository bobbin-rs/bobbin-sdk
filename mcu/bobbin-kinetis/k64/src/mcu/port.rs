...
periph!( PORTA, Porta, PORTA_PERIPH, PortPeriph, 0x40049000, 0x00, 0x23);
periph!( PORTB, Portb, PORTB_PERIPH, PortPeriph, 0x4004a000, 0x01, 0x24);
periph!( PORTC, Portc, PORTC_PERIPH, PortPeriph, 0x4004b000, 0x02, 0x25);
periph!( PORTD, Portd, PORTD_PERIPH, PortPeriph, 0x4004c000, 0x03, 0x26);
periph!( PORTE, Porte, PORTE_PERIPH, PortPeriph, 0x4004d000, 0x04, 0x27);
