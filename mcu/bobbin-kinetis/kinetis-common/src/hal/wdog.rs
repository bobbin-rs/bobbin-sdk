...
impl WdogPeriph {
    ...
    pub fn set_clock_source(&self, value: ClockSource) -> &Self {
    ...
    pub fn set_timeout(&self, value: u32) -> &Self {
    ...
    pub fn set_window(&self, value: u32) -> &Self {
        let (hi, lo) = split_u32(value);
    ...
    pub fn set_prescaler(&self, value: Prescaler) -> &Self {
