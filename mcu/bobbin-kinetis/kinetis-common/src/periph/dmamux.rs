...
impl DmamuxPeriph {
    ...
    #[inline] pub fn chcfg_reg(&self) -> RegisterArray<Chcfg, bits::R16> { 
        RegisterArray::new(self.0 as *mut Chcfg, 0x0, 0x1)
    }
    ...
    #[inline] pub fn write_chcfg<I: Into<bits::R16>>(&self, index: I, value: Chcfg) -> &Self {
