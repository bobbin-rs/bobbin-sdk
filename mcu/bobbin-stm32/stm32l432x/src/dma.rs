...
::bobbin_mcu::periph!( DMA1, Dma1, DMA1_PERIPH, DmaPeriph, DMA1_OWNED, DMA1_REF_COUNT, 0x40020000, 0x00, 0x0e);
::bobbin_mcu::periph!( DMA2, Dma2, DMA2_PERIPH, DmaPeriph, DMA2_OWNED, DMA2_REF_COUNT, 0x40020400, 0x01, 0x0f);
...
::bobbin_mcu::channel!(DMA2_CH6, Dma2Ch6, dma2_ch6, DMA2, Dma2, DMA2_CH6_CH, DmaCh, DMA2_PERIPH, DMA2_CH6_OWNED, DMA2_CH6_REF_COUNT, 5);
::bobbin_mcu::channel!(DMA2_CH7, Dma2Ch7, dma2_ch7, DMA2, Dma2, DMA2_CH7_CH, DmaCh, DMA2_PERIPH, DMA2_CH7_OWNED, DMA2_CH7_REF_COUNT, 6);
...
impl ::bobbin_mcu::gate::GateSleepEn for Dma1 {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1smenr().dma1smen() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateSleepEn for Dma2 {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1smenr().dma2smen() }
    #[inline]
    fn set_gate_sleep_en<V: Into<::bobbin_bits::U1>>(&self, value: V) -> &Self {
