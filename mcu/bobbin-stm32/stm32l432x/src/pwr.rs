...
::bobbin_mcu::periph!( PWR, Pwr, PWR_PERIPH, PwrPeriph, PWR_OWNED, PWR_REF_COUNT, 0x40007000, 0x00, 0x01);


// Gate { name: None, gate_type: Some("RST"), periph: Some("RCC"), register: Some("APB1RSTR1"), field: Some("PWRRST"), description: None }
impl ::bobbin_mcu::gate::GateRst for Pwr {
    #[inline]
    fn gate_rst(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb1rstr1().pwrrst() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateEn for Pwr {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb1enr1().pwren() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateSleepEn for Pwr {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb1smenr1().pwrsmen() }
    #[inline]
...
impl PwrPeriph {
    ...
    #[inline] pub fn pucrf_reg(&self) -> ::bobbin_mcu::register::Register<Pucrf> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Pucrf, 0x48)
    }
    ...
    #[inline] pub fn pdcrf_reg(&self) -> ::bobbin_mcu::register::Register<Pdcrf> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Pdcrf, 0x4c)
    }
    ...
    #[inline] pub fn pucrg_reg(&self) -> ::bobbin_mcu::register::Register<Pucrg> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Pucrg, 0x50)
    }
    ...
    #[inline] pub fn pdcrg_reg(&self) -> ::bobbin_mcu::register::Register<Pdcrg> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Pdcrg, 0x54)
    }
...
impl Cr2 {
    ...
    #[inline] pub fn iosv(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_iosv<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 9);
        self.0 |= value << 9;
    ...
    #[inline] pub fn pvme4(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_pvme4<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 7);
        self.0 |= value << 7;
    ...
    #[inline] pub fn pvme2(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_pvme2<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 5);
        self.0 |= value << 5;
...
impl Cr3 {
    ...
    #[inline] pub fn ewf(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_ewf<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 15);
        self.0 |= value << 15;
...
impl Sr2 {
    ...
    #[inline] pub fn pvmo4(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 15) & 0x1) as u8) } // [15]
    }
    ...
    #[inline] pub fn set_pvmo4<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 15);
        self.0 |= value << 15;
    ...
    #[inline] pub fn pvmo2(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_pvmo2<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 13);
        self.0 |= value << 13;
...
impl Scr {
    ...
    #[inline] pub fn wuf5(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 4) & 0x1) as u8) } // [4]
    }
    ...
    #[inline] pub fn set_wuf5<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 4);
        self.0 |= value << 4;
    ...
    #[inline] pub fn wuf4(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 3) & 0x1) as u8) } // [3]
    }
    ...
    #[inline] pub fn set_wuf4<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 3);
        self.0 |= value << 3;
    ...
    #[inline] pub fn wuf3(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 2) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn set_wuf3<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
    ...
    #[inline] pub fn wuf2(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 1) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn set_wuf2<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[inline] pub fn wuf1(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_wuf1<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
