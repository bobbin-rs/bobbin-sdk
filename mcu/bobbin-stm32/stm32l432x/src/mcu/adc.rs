...
periph!( ADC1, Adc1, ADC1_PERIPH, AdcPeriph, 0x50040000, 0x2d);
periph!( ADC2, Adc2, ADC2_PERIPH, AdcPeriph, 0x50040100, 0x2e);
periph!( ADC3, Adc3, ADC3_PERIPH, AdcPeriph, 0x50040200, 0x2f);
