...
periph!( TIM2, Tim2, TIM2_PERIPH, TimGenPeriph, 0x40000000, 0x00, 0x17);
periph!( TIM3, Tim3, TIM3_PERIPH, TimGenPeriph, 0x40000400, 0x01, 0x18);
periph!( TIM4, Tim4, TIM4_PERIPH, TimGenPeriph, 0x40000800, 0x02, 0x19);
periph!( TIM5, Tim5, TIM5_PERIPH, TimGenPeriph, 0x40000c00, 0x03, 0x1a);
periph!( TIM15, Tim15, TIM15_PERIPH, TimGenPeriph, 0x40014000, 0x04, 0x1b);
periph!( TIM16, Tim16, TIM16_PERIPH, TimGenPeriph, 0x40014400, 0x05, 0x1c);
