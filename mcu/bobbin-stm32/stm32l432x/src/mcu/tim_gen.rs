...
periph!( TIM2, Tim2, TIM2_PERIPH, TimGenPeriph, TIM2_OWNED, TIM2_REF_COUNT, 0x40000000, 0x00, 0x17);
periph!( TIM3, Tim3, TIM3_PERIPH, TimGenPeriph, TIM3_OWNED, TIM3_REF_COUNT, 0x40000400, 0x01, 0x18);
periph!( TIM4, Tim4, TIM4_PERIPH, TimGenPeriph, TIM4_OWNED, TIM4_REF_COUNT, 0x40000800, 0x02, 0x19);
periph!( TIM5, Tim5, TIM5_PERIPH, TimGenPeriph, TIM5_OWNED, TIM5_REF_COUNT, 0x40000c00, 0x03, 0x1a);
periph!( TIM15, Tim15, TIM15_PERIPH, TimGenPeriph, TIM15_OWNED, TIM15_REF_COUNT, 0x40014000, 0x04, 0x1b);
periph!( TIM16, Tim16, TIM16_PERIPH, TimGenPeriph, TIM16_OWNED, TIM16_REF_COUNT, 0x40014400, 0x05, 0x1c);
...
channel!(TIM16_CH2, Tim16Ch2, tim16_ch2, TIM16, Tim16, TIM16_CH2_CH, TimGenCh, TIM16_PERIPH, TIM16_CH2_OWNED, TIM16_CH2_REF_COUNT, 1);
