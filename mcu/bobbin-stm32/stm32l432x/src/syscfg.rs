...
::bobbin_mcu::periph!( SYSCFG, Syscfg, SYSCFG_PERIPH, SyscfgPeriph, SYSCFG_OWNED, SYSCFG_REF_COUNT, 0x40010000, 0x00, 0x03);
...
impl ::bobbin_mcu::gate::GateSleepEn for Syscfg {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb2smenr().syscfgsmen() }
    #[inline]
...
impl Memrmp {
    ...
    #[inline] pub fn qfs(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_qfs<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 3);
        self.0 |= value << 3;
...
impl Cfgr1 {
    ...
    #[inline] pub fn i2c2_fmp(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_i2c2_fmp<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 21);
        self.0 |= value << 21;
    ...
    #[inline] pub fn fwdis(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_fwdis<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
