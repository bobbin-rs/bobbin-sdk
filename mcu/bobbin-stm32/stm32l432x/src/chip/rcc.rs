...
impl En for super::gpio::Gpiog {
    #[inline] fn en(&self) -> u32 { RCC.ahb2enr().gpiogen().into() }
    #[inline] fn set_en(&self, value: u32) { RCC.with_ahb2enr(|r| r.set_gpiogen(value)); }
}

impl En for super::gpio::Gpiof {
    #[inline] fn en(&self) -> u32 { RCC.ahb2enr().gpiofen().into() }
    #[inline] fn set_en(&self, value: u32) { RCC.with_ahb2enr(|r| r.set_gpiofen(value)); }
}
...
impl En for super::usart::Uart5 {
    #[inline] fn en(&self) -> u32 { RCC.apb1enr1().uart5en().into() }
    #[inline] fn set_en(&self, value: u32) { RCC.with_apb1enr1(|r| r.set_uart5en(value)); }
}
