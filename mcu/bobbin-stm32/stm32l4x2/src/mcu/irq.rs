...
irq_type!(IRQ_DFSDM_FLT, IrqDfsdmFlt);
...
irq!(::exti::Exti, IrqExti, Irq6);
irq!(::exti::Exti, IrqExti, Irq7);
irq!(::exti::Exti, IrqExti, Irq8);
irq!(::exti::Exti, IrqExti, Irq9);
irq!(::exti::Exti, IrqExti, Irq10);
irq!(::exti::Exti, IrqExti, Irq23);
irq!(::exti::Exti, IrqExti, Irq40);
irq_type!(IRQ_EXTI, IrqExti);
irq!(::vref::Vrefbuf, IrqVref, Irq81);
irq_type!(IRQ_VREF, IrqVref);
irq!(::can::Can1, IrqCan, Irq19);
irq!(::can::Can1, IrqCan, Irq20);
irq!(::can::Can1, IrqCan, Irq21);
irq!(::can::Can1, IrqCan, Irq22);
...
irq!(::dfsdm::Dfsdm, IrqDfsdmFlt, Irq61);
irq!(::dfsdm::Dfsdm, IrqDfsdmFlt, Irq62);
