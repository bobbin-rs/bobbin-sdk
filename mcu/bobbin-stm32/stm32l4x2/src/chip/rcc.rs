...
impl Pllcfgr {
    ...
    #[inline] pub fn pllpdiv(&self) -> bits::U5 {
        unsafe { ::core::mem::transmute(((self.0 >> 27) & 0x1f) as u8) } // [31:27]
    }

    #[doc="Returns true if PLLPDIV != 0"]
    #[inline] pub fn test_pllpdiv(&self) -> bool {
        self.pllpdiv() != 0
    }

    #[doc="Sets the PLLPDIV field."]
    #[inline] pub fn set_pllpdiv<V: Into<bits::U5>>(mut self, value: V) -> Self {
        let value: bits::U5 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1f << 27);
        self.0 |= value << 27;
...
impl ::core::fmt::Debug for Pllcfgr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.pllpdiv() != 0 { try!(write!(f, " pllpdiv=0x{:x}", self.pllpdiv()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Pllsai1cfgr {
    ...
    #[inline] pub fn pllsai1pdiv(&self) -> bits::U5 {
        unsafe { ::core::mem::transmute(((self.0 >> 27) & 0x1f) as u8) } // [31:27]
    }

    #[doc="Returns true if PLLSAI1PDIV != 0"]
    #[inline] pub fn test_pllsai1pdiv(&self) -> bool {
        self.pllsai1pdiv() != 0
    }

    #[doc="Sets the PLLSAI1PDIV field."]
    #[inline] pub fn set_pllsai1pdiv<V: Into<bits::U5>>(mut self, value: V) -> Self {
        let value: bits::U5 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1f << 27);
        self.0 |= value << 27;
...
impl ::core::fmt::Debug for Pllsai1cfgr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.pllsai1pdiv() != 0 { try!(write!(f, " pllsai1pdiv=0x{:x}", self.pllsai1pdiv()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Apb1rstr1 {
    ...
    #[doc="USART4 reset."]
    #[inline] pub fn usart4rst(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 19) & 0x1) as u8) } // [19]
    }

    #[doc="Returns true if USART4RST != 0"]
    #[inline] pub fn test_usart4rst(&self) -> bool {
        self.usart4rst() != 0
    }

    #[doc="Sets the USART4RST field."]
    #[inline] pub fn set_usart4rst<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 19);
        self.0 |= value << 19;
    ...
    #[doc="USB FS reset"]
    #[inline] pub fn usbfsrst(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 26) & 0x1) as u8) } // [26]
    }
    ...
    #[inline] pub fn set_usbfsrst<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 26);
        self.0 |= value << 26;
...
impl ::core::fmt::Debug for Apb1rstr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.usart4rst() != 0 { try!(write!(f, " usart4rst"))}
...
impl Apb1enr1 {
    ...
    #[inline] pub fn rtcapben(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 10) & 0x1) as u8) } // [10]
    }
    ...
    #[inline] pub fn set_rtcapben<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 10);
        self.0 |= value << 10;
    ...
    #[inline] pub fn usbf(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 26) & 0x1) as u8) } // [26]
    }

    #[doc="Returns true if USBF != 0"]
    #[inline] pub fn test_usbf(&self) -> bool {
        self.usbf() != 0
    }

    #[doc="Sets the USBF field."]
    #[inline] pub fn set_usbf<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 26);
        self.0 |= value << 26;
...
impl ::core::fmt::Debug for Apb1enr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.usbf() != 0 { try!(write!(f, " usbf"))}
...
impl Apb1smenr1 {
    ...
    #[doc="USART1 clocks enable during Sleep and Stop modes"]
    ...
    #[inline] pub fn rtcapbsmen(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 10) & 0x1) as u8) } // [10]
    }
    ...
    #[inline] pub fn set_rtcapbsmen<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 10);
        self.0 |= value << 10;
    ...
    #[inline] pub fn usbfssmen(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 26) & 0x1) as u8) } // [26]
    }

    #[doc="Returns true if USBFSSMEN != 0"]
    #[inline] pub fn test_usbfssmen(&self) -> bool {
        self.usbfssmen() != 0
    }

    #[doc="Sets the USBFSSMEN field."]
    #[inline] pub fn set_usbfssmen<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 26);
        self.0 |= value << 26;
...
impl ::core::fmt::Debug for Apb1smenr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.usbfssmen() != 0 { try!(write!(f, " usbfssmen"))}
...
impl Crrcr {
    ...
    #[inline] pub fn hsi48cal(&self) -> bits::U9 {
    ...
    #[inline] pub fn set_hsi48cal<V: Into<bits::U9>>(mut self, value: V) -> Self {
