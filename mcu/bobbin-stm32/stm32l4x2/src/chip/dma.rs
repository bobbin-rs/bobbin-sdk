...
channel!(DMA2_CH6, Dma2Ch6, DMA2, Dma2, _DMA2_CH6, DmaCh, _DMA2, 5);
channel!(DMA2_CH7, Dma2Ch7, DMA2, Dma2, _DMA2_CH7, DmaCh, _DMA2, 6);
...
impl IrqDma<super::irq::IrqDma2Ch6> for Dma2Ch6 {
    fn irq_dma(&self) -> super::irq::IrqDma2Ch6 { super::irq::IRQ_DMA2_CH6 }
}

impl IrqDma<super::irq::IrqDma2Ch7> for Dma2Ch7 {
