...
periph!( DAC1, Dac1, _DAC1, DacPeriph, 0x40007400);
...
impl DacPeriph {
    ...
    #[doc="Get the *mut pointer for the SHSR1 register."]
    #[inline] pub fn shsr1_mut(&self) -> *mut Shsr1 { 
        (self.0 + 0x40) as *mut Shsr1
    }

    #[doc="Get the *const pointer for the SHSR1 register."]
    #[inline] pub fn shsr1_ptr(&self) -> *const Shsr1 { 
           self.shsr1_mut()
    }

    #[doc="Read the SHSR1 register."]
    #[inline] pub fn shsr1(&self) -> Shsr1 { 
        unsafe {
            read_volatile(self.shsr1_ptr())
        }
    }

    #[doc="Write the SHSR1 register."]
    #[inline] pub fn set_shsr1<F: FnOnce(Shsr1) -> Shsr1>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shsr1_mut(), f(Shsr1(0)));
        }
        self
    }

    #[doc="Modify the SHSR1 register."]
    #[inline] pub fn with_shsr1<F: FnOnce(Shsr1) -> Shsr1>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shsr1_mut(), f(self.shsr1()));
        }
        self
    }

    #[doc="Get the *mut pointer for the SHSR2 register."]
    #[inline] pub fn shsr2_mut(&self) -> *mut Shsr2 { 
        (self.0 + 0x44) as *mut Shsr2
    }

    #[doc="Get the *const pointer for the SHSR2 register."]
    #[inline] pub fn shsr2_ptr(&self) -> *const Shsr2 { 
           self.shsr2_mut()
    }

    #[doc="Read the SHSR2 register."]
    #[inline] pub fn shsr2(&self) -> Shsr2 { 
        unsafe {
            read_volatile(self.shsr2_ptr())
        }
    }

    #[doc="Write the SHSR2 register."]
    #[inline] pub fn set_shsr2<F: FnOnce(Shsr2) -> Shsr2>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shsr2_mut(), f(Shsr2(0)));
        }
        self
    }

    #[doc="Modify the SHSR2 register."]
    #[inline] pub fn with_shsr2<F: FnOnce(Shsr2) -> Shsr2>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shsr2_mut(), f(self.shsr2()));
        }
        self
    }

    #[doc="Get the *mut pointer for the SHHR register."]
    #[inline] pub fn shhr_mut(&self) -> *mut Shhr { 
        (self.0 + 0x48) as *mut Shhr
    }

    #[doc="Get the *const pointer for the SHHR register."]
    #[inline] pub fn shhr_ptr(&self) -> *const Shhr { 
           self.shhr_mut()
    }

    #[doc="Read the SHHR register."]
    #[inline] pub fn shhr(&self) -> Shhr { 
        unsafe {
            read_volatile(self.shhr_ptr())
        }
    }

    #[doc="Write the SHHR register."]
    #[inline] pub fn set_shhr<F: FnOnce(Shhr) -> Shhr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shhr_mut(), f(Shhr(0)));
        }
        self
    }

    #[doc="Modify the SHHR register."]
    #[inline] pub fn with_shhr<F: FnOnce(Shhr) -> Shhr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shhr_mut(), f(self.shhr()));
        }
        self
    }

    #[doc="Get the *mut pointer for the SHRR register."]
    #[inline] pub fn shrr_mut(&self) -> *mut Shrr { 
        (self.0 + 0x4c) as *mut Shrr
    }

    #[doc="Get the *const pointer for the SHRR register."]
    #[inline] pub fn shrr_ptr(&self) -> *const Shrr { 
           self.shrr_mut()
    }

    #[doc="Read the SHRR register."]
    #[inline] pub fn shrr(&self) -> Shrr { 
        unsafe {
            read_volatile(self.shrr_ptr())
        }
    }

    #[doc="Write the SHRR register."]
    #[inline] pub fn set_shrr<F: FnOnce(Shrr) -> Shrr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shrr_mut(), f(Shrr(0)));
        }
        self
    }

    #[doc="Modify the SHRR register."]
    #[inline] pub fn with_shrr<F: FnOnce(Shrr) -> Shrr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.shrr_mut(), f(self.shrr()));
        }
        self
    }
...
impl Cr {
    ...
    #[inline] pub fn cen1(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 14) & 0x1) as u8) } // [14]
    }

    #[doc="Returns true if CEN1 != 0"]
    #[inline] pub fn test_cen1(&self) -> bool {
        self.cen1() != 0
    }

    #[doc="Sets the CEN1 field."]
    #[inline] pub fn set_cen1<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 14);
        self.0 |= value << 14;
    ...
    #[inline] pub fn cen2(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 30) & 0x1) as u8) } // [30]
    }

    #[doc="Returns true if CEN2 != 0"]
    #[inline] pub fn test_cen2(&self) -> bool {
        self.cen2() != 0
    }

    #[doc="Sets the CEN2 field."]
    #[inline] pub fn set_cen2<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 30);
        self.0 |= value << 30;
...
impl ::core::fmt::Debug for Cr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.cen1() != 0 { try!(write!(f, " cen1"))}
        ...
        if self.cen2() != 0 { try!(write!(f, " cen2"))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Sr {
    ...
    #[inline] pub fn cal_flag1(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 14) & 0x1) as u8) } // [14]
    }

    #[doc="Returns true if CAL_FLAG1 != 0"]
    #[inline] pub fn test_cal_flag1(&self) -> bool {
        self.cal_flag1() != 0
    }

    #[doc="Sets the CAL_FLAG1 field."]
    #[inline] pub fn set_cal_flag1<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 14);
        self.0 |= value << 14;
    ...
    #[inline] pub fn bwst1(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 15) & 0x1) as u8) } // [15]
    }

    #[doc="Returns true if BWST1 != 0"]
    #[inline] pub fn test_bwst1(&self) -> bool {
        self.bwst1() != 0
    }

    #[doc="Sets the BWST1 field."]
    #[inline] pub fn set_bwst1<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 15);
        self.0 |= value << 15;
    ...
    #[inline] pub fn cal_flag2(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 30) & 0x1) as u8) } // [30]
    }

    #[doc="Returns true if CAL_FLAG2 != 0"]
    #[inline] pub fn test_cal_flag2(&self) -> bool {
        self.cal_flag2() != 0
    }

    #[doc="Sets the CAL_FLAG2 field."]
    #[inline] pub fn set_cal_flag2<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 30);
        self.0 |= value << 30;
    ...
    #[inline] pub fn bwst2(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 31) & 0x1) as u8) } // [31]
    }

    #[doc="Returns true if BWST2 != 0"]
    #[inline] pub fn test_bwst2(&self) -> bool {
        self.bwst2() != 0
    }

    #[doc="Sets the BWST2 field."]
    #[inline] pub fn set_bwst2<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 31);
        self.0 |= value << 31;
...
impl ::core::fmt::Debug for Sr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.cal_flag1() != 0 { try!(write!(f, " cal_flag1"))}
        if self.bwst1() != 0 { try!(write!(f, " bwst1"))}
        if self.dmaudr2() != 0 { try!(write!(f, " dmaudr2"))}
        if self.cal_flag2() != 0 { try!(write!(f, " cal_flag2"))}
        if self.bwst2() != 0 { try!(write!(f, " bwst2"))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Ccr {
    ...
    #[inline] pub fn otrim1(&self) -> bits::U5 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1f) as u8) } // [4:0]
    }

    #[doc="Returns true if OTRIM1 != 0"]
    #[inline] pub fn test_otrim1(&self) -> bool {
        self.otrim1() != 0
    }

    #[doc="Sets the OTRIM1 field."]
    #[inline] pub fn set_otrim1<V: Into<bits::U5>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn otrim2(&self) -> bits::U5 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0x1f) as u8) } // [20:16]
    }

    #[doc="Returns true if OTRIM2 != 0"]
    #[inline] pub fn test_otrim2(&self) -> bool {
        self.otrim2() != 0
    }

    #[doc="Sets the OTRIM2 field."]
    #[inline] pub fn set_otrim2<V: Into<bits::U5>>(mut self, value: V) -> Self {
        let value: bits::U5 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1f << 16);
        self.0 |= value << 16;
...
impl ::core::fmt::Debug for Ccr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.otrim1() != 0 { try!(write!(f, " otrim1=0x{:x}", self.otrim1()))}
        if self.otrim2() != 0 { try!(write!(f, " otrim2=0x{:x}", self.otrim2()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Mcr {
    ...
    #[inline] pub fn mode1(&self) -> bits::U3 {
    ...
    #[inline] pub fn set_mode1<V: Into<bits::U3>>(mut self, value: V) -> Self {
        let value: bits::U3 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x7 << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn mode2(&self) -> bits::U3 {
    ...
    #[inline] pub fn set_mode2<V: Into<bits::U3>>(mut self, value: V) -> Self {
        let value: bits::U3 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x7 << 16);
        self.0 |= value << 16;
...
impl Shsr1 {
    #[doc="DAC Channel 1 sample Time"]
    #[inline] pub fn tsample1(&self) -> bits::U10 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x3ff) as u16) } // [9:0]
    }

    #[doc="Returns true if TSAMPLE1 != 0"]
    #[inline] pub fn test_tsample1(&self) -> bool {
        self.tsample1() != 0
    }

    #[doc="Sets the TSAMPLE1 field."]
    #[inline] pub fn set_tsample1<V: Into<bits::U10>>(mut self, value: V) -> Self {
...
impl ::core::fmt::Display for Shsr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}
...
impl ::core::fmt::Debug for Shsr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.tsample1() != 0 { try!(write!(f, " tsample1=0x{:x}", self.tsample1()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Shsr2 {
    #[doc="DAC Channel 2 sample Time"]
    #[inline] pub fn tsample2(&self) -> bits::U10 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x3ff) as u16) } // [9:0]
    }

    #[doc="Returns true if TSAMPLE2 != 0"]
    #[inline] pub fn test_tsample2(&self) -> bool {
        self.tsample2() != 0
    }

    #[doc="Sets the TSAMPLE2 field."]
    #[inline] pub fn set_tsample2<V: Into<bits::U10>>(mut self, value: V) -> Self {
        let value: bits::U10 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x3ff << 0);
        self.0 |= value << 0;
...
impl ::core::fmt::Display for Shsr2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}
...
impl ::core::fmt::Debug for Shsr2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.tsample2() != 0 { try!(write!(f, " tsample2=0x{:x}", self.tsample2()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Shhr {
    #[doc="DAC Channel 1 hold Time"]
    #[inline] pub fn thold1(&self) -> bits::U10 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x3ff) as u16) } // [9:0]
    }

    #[doc="Returns true if THOLD1 != 0"]
    #[inline] pub fn test_thold1(&self) -> bool {
        self.thold1() != 0
    }

    #[doc="Sets the THOLD1 field."]
    #[inline] pub fn set_thold1<V: Into<bits::U10>>(mut self, value: V) -> Self {
        let value: bits::U10 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x3ff << 0);
        self.0 |= value << 0;
    ...
    #[doc="DAC Channel 2 hold time"]
    #[inline] pub fn thold2(&self) -> bits::U10 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0x3ff) as u16) } // [25:16]
    }

    #[doc="Returns true if THOLD2 != 0"]
    #[inline] pub fn test_thold2(&self) -> bool {
        self.thold2() != 0
    }

    #[doc="Sets the THOLD2 field."]
    #[inline] pub fn set_thold2<V: Into<bits::U10>>(mut self, value: V) -> Self {
        let value: bits::U10 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x3ff << 16);
        self.0 |= value << 16;
...
impl ::core::fmt::Display for Shhr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}
...
impl ::core::fmt::Debug for Shhr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.thold1() != 0 { try!(write!(f, " thold1=0x{:x}", self.thold1()))}
        if self.thold2() != 0 { try!(write!(f, " thold2=0x{:x}", self.thold2()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Shrr {
    #[doc="DAC Channel 1 refresh Time"]
    #[inline] pub fn trefresh1(&self) -> bits::U8 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xff) as u8) } // [7:0]
    }

    #[doc="Returns true if TREFRESH1 != 0"]
    #[inline] pub fn test_trefresh1(&self) -> bool {
        self.trefresh1() != 0
    }

    #[doc="Sets the TREFRESH1 field."]
    #[inline] pub fn set_trefresh1<V: Into<bits::U8>>(mut self, value: V) -> Self {
        let value: bits::U8 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xff << 0);
        self.0 |= value << 0;
    ...
    #[doc="DAC Channel 2 refresh Time"]
    #[inline] pub fn trefresh2(&self) -> bits::U8 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0xff) as u8) } // [23:16]
    }

    #[doc="Returns true if TREFRESH2 != 0"]
    #[inline] pub fn test_trefresh2(&self) -> bool {
        self.trefresh2() != 0
    }

    #[doc="Sets the TREFRESH2 field."]
    #[inline] pub fn set_trefresh2<V: Into<bits::U8>>(mut self, value: V) -> Self {
        let value: bits::U8 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xff << 16);
        self.0 |= value << 16;
...
impl ::core::fmt::Display for Shrr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}
...
impl ::core::fmt::Debug for Shrr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.trefresh1() != 0 { try!(write!(f, " trefresh1=0x{:x}", self.trefresh1()))}
        if self.trefresh2() != 0 { try!(write!(f, " trefresh2=0x{:x}", self.trefresh2()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
