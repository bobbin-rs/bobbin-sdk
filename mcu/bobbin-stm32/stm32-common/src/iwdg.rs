...
impl IwdgPeriph {
    ...
    #[inline] pub fn pr_reg(&self) -> ::bobbin_mcu::register::Register<Pr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Pr, 0x4)
    }
    ...
    #[inline] pub fn rlr_reg(&self) -> ::bobbin_mcu::register::Register<Rlr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Rlr, 0x8)
    }
    ...
    #[inline] pub fn winr_reg(&self) -> ::bobbin_mcu::register::Register<Winr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Winr, 0x10)
    }
...
impl Pr {
    ...
    #[inline] pub fn pr(&self) -> ::bobbin_bits::U3 {
    ...
    #[inline] pub fn set_pr<V: Into<::bobbin_bits::U3>>(mut self, value: V) -> Self {
...
impl Rlr {
    ...
    #[inline] pub fn rl(&self) -> ::bobbin_bits::U12 {
    ...
    #[inline] pub fn set_rl<V: Into<::bobbin_bits::U12>>(mut self, value: V) -> Self {
...
impl Sr {
    ...
    #[inline] pub fn wvu(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_wvu<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn rvu(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_rvu<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[inline] pub fn pvu(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_pvu<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
...
impl Winr {
    ...
    #[inline] pub fn win(&self) -> ::bobbin_bits::U12 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xfff) as u16) } // [11:0]
    }
    ...
    #[inline] pub fn set_win<V: Into<::bobbin_bits::U12>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U12 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xfff << 0);
        self.0 |= value << 0;
