...
impl TimGenPeriph {
    ...
    #[doc="Get the CCMR_OUTPUT Register."]
    #[inline] pub fn ccmr_output_reg(&self) -> ::bobbin_mcu::register::RegisterArray<CcmrOutput, ::bobbin_bits::R2> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut CcmrOutput, 0x18, 0x4)
    }

    #[doc="Get the *mut pointer for the CCMR_OUTPUT register."]
    #[inline] pub fn ccmr_output_mut<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *mut CcmrOutput { 
        self.ccmr_output_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the CCMR_OUTPUT register."]
    #[inline] pub fn ccmr_output_ptr<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *const CcmrOutput { 
        self.ccmr_output_reg().ptr(index.into())
    }

    #[doc="Read the CCMR_OUTPUT register."]
    #[inline] pub fn ccmr_output<I: Into<::bobbin_bits::R2>>(&self, index: I) -> CcmrOutput { 
        self.ccmr_output_reg().read(index.into())
    }

    #[doc="Write the CCMR_OUTPUT register."]
    #[inline] pub fn write_ccmr_output<I: Into<::bobbin_bits::R2>>(&self, index: I, value: CcmrOutput) -> &Self {
        self.ccmr_output_reg().write(index.into(), value);
        self
    }

    #[doc="Set the CCMR_OUTPUT register."]
    #[inline] pub fn set_ccmr_output<I: Into<::bobbin_bits::R2>, F: FnOnce(CcmrOutput) -> CcmrOutput>(&self, index: I, f: F) -> &Self {
        self.ccmr_output_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the CCMR_OUTPUT register."]
    #[inline] pub fn with_ccmr_output<I: Into<::bobbin_bits::R2> + Copy, F: FnOnce(CcmrOutput) -> CcmrOutput>(&self, index: I, f: F) -> &Self {
        self.ccmr_output_reg().with(index.into(), f);
        self
    }

    #[doc="Get the CCMR_INPUT Register."]
    #[inline] pub fn ccmr_input_reg(&self) -> ::bobbin_mcu::register::RegisterArray<CcmrInput, ::bobbin_bits::R2> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut CcmrInput, 0x18, 0x4)
    }

    #[doc="Get the *mut pointer for the CCMR_INPUT register."]
    #[inline] pub fn ccmr_input_mut<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *mut CcmrInput { 
        self.ccmr_input_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the CCMR_INPUT register."]
    #[inline] pub fn ccmr_input_ptr<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *const CcmrInput { 
        self.ccmr_input_reg().ptr(index.into())
    }

    #[doc="Read the CCMR_INPUT register."]
    #[inline] pub fn ccmr_input<I: Into<::bobbin_bits::R2>>(&self, index: I) -> CcmrInput { 
        self.ccmr_input_reg().read(index.into())
    }

    #[doc="Write the CCMR_INPUT register."]
    #[inline] pub fn write_ccmr_input<I: Into<::bobbin_bits::R2>>(&self, index: I, value: CcmrInput) -> &Self {
        self.ccmr_input_reg().write(index.into(), value);
        self
    }

    #[doc="Set the CCMR_INPUT register."]
    #[inline] pub fn set_ccmr_input<I: Into<::bobbin_bits::R2>, F: FnOnce(CcmrInput) -> CcmrInput>(&self, index: I, f: F) -> &Self {
        self.ccmr_input_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the CCMR_INPUT register."]
    #[inline] pub fn with_ccmr_input<I: Into<::bobbin_bits::R2> + Copy, F: FnOnce(CcmrInput) -> CcmrInput>(&self, index: I, f: F) -> &Self {
        self.ccmr_input_reg().with(index.into(), f);
        self
    }
    ...
    #[inline] pub fn ccr_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Ccr, ::bobbin_bits::R4> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Ccr, 0x34, 0x4)
    }

    #[doc="Get the *mut pointer for the CCR register."]
    #[inline] pub fn ccr_mut<I: Into<::bobbin_bits::R4>>(&self, index: I) -> *mut Ccr { 
        self.ccr_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the CCR register."]
    #[inline] pub fn ccr_ptr<I: Into<::bobbin_bits::R4>>(&self, index: I) -> *const Ccr { 
        self.ccr_reg().ptr(index.into())
    }

    #[doc="Read the CCR register."]
    #[inline] pub fn ccr<I: Into<::bobbin_bits::R4>>(&self, index: I) -> Ccr { 
        self.ccr_reg().read(index.into())
    }

    #[doc="Write the CCR register."]
    #[inline] pub fn write_ccr<I: Into<::bobbin_bits::R4>>(&self, index: I, value: Ccr) -> &Self {
        self.ccr_reg().write(index.into(), value);
        self
    }

    #[doc="Set the CCR register."]
    #[inline] pub fn set_ccr<I: Into<::bobbin_bits::R4>, F: FnOnce(Ccr) -> Ccr>(&self, index: I, f: F) -> &Self {
        self.ccr_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the CCR register."]
    #[inline] pub fn with_ccr<I: Into<::bobbin_bits::R4> + Copy, F: FnOnce(Ccr) -> Ccr>(&self, index: I, f: F) -> &Self {
...
impl Dier {
    ...
    #[inline] pub fn ccde<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn test_ccde<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccde(index) != 0
    }

    #[doc="Sets the CCDE field."]
    #[inline] pub fn set_ccde<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 9 + index;
    ...
    #[inline] pub fn ccie<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ccie<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccie(index) != 0
    }

    #[doc="Sets the CCIE field."]
    #[inline] pub fn set_ccie<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 1 + index;
...
impl Sr {
    ...
    #[inline] pub fn ccof<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 9 + index;
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x1) as u8) } // [9]
    }
    ...
    #[inline] pub fn test_ccof<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccof(index) != 0
    }

    #[doc="Sets the CCOF field."]
    #[inline] pub fn set_ccof<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 9 + index;
    ...
    #[inline] pub fn ccif<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 1 + index;
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn test_ccif<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccif(index) != 0
    }

    #[doc="Sets the CCIF field."]
    #[inline] pub fn set_ccif<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 1 + index;
...
impl Egr {
    ...
    #[inline] pub fn ccg<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 1 + index;
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn test_ccg<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccg(index) != 0
    }

    #[doc="Sets the CCG field."]
    #[inline] pub fn set_ccg<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 1 + index;
...
impl CcmrOutput {
    ...
    #[inline] pub fn ccs<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U2 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ccs<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.ccs(index) != 0
    }

    #[doc="Sets the CCS field."]
    #[inline] pub fn set_ccs<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U2>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U2 = value.into();
        let value: u32 = value.into();
        let shift: usize = 0 + (index << 3);
    ...
    #[inline] pub fn ocfe<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ocfe<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.ocfe(index) != 0
    }

    #[doc="Sets the OCFE field."]
    #[inline] pub fn set_ocfe<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 2 + (index << 3);
    ...
    #[inline] pub fn ocpe<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ocpe<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.ocpe(index) != 0
    }

    #[doc="Sets the OCPE field."]
    #[inline] pub fn set_ocpe<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 3 + (index << 3);
    ...
    #[inline] pub fn ocm<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U3 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ocm<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.ocm(index) != 0
    }

    #[doc="Sets the OCM field."]
    #[inline] pub fn set_ocm<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U3>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U3 = value.into();
        let value: u32 = value.into();
        let shift: usize = 4 + (index << 3);
    ...
    #[inline] pub fn occe<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_occe<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.occe(index) != 0
    }

    #[doc="Sets the OCCE field."]
    #[inline] pub fn set_occe<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 7 + (index << 3);
    ...
    #[inline] pub fn ocm_3<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ocm_3<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.ocm_3(index) != 0
    }

    #[doc="Sets the OCM_3 field."]
    #[inline] pub fn set_ocm_3<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 16 + (index << 3);
...
impl CcmrInput {
    ...
    #[inline] pub fn icf<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U4 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 4 + (index << 3);
    ...
    #[inline] pub fn test_icf<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.icf(index) != 0
    }

    #[doc="Sets the ICF field."]
    #[inline] pub fn set_icf<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U4>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U4 = value.into();
        let value: u32 = value.into();
        let shift: usize = 4 + (index << 3);
    ...
    #[inline] pub fn icpsc<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U2 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 2 + (index << 3);
    ...
    #[inline] pub fn test_icpsc<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.icpsc(index) != 0
    }

    #[doc="Sets the ICPSC field."]
    #[inline] pub fn set_icpsc<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U2>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U2 = value.into();
        let value: u32 = value.into();
        let shift: usize = 2 + (index << 3);
...
impl Ccer {
    ...
    #[inline] pub fn cce<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_cce<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.cce(index) != 0
    }

    #[doc="Sets the CCE field."]
    #[inline] pub fn set_cce<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 0 + (index << 2);
    ...
    #[inline] pub fn ccp<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ccp<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccp(index) != 0
    }

    #[doc="Sets the CCP field."]
    #[inline] pub fn set_ccp<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 1 + (index << 2);
    ...
    #[doc="Capture/Compare n output Polarity"]
    #[inline] pub fn ccnp<I: Into<::bobbin_bits::R4>>(&self, index: I) -> ::bobbin_bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_ccnp<I: Into<::bobbin_bits::R4>>(&self, index: I) -> bool{
        self.ccnp(index) != 0
    }

    #[doc="Sets the CCNP field."]
    #[inline] pub fn set_ccnp<I: Into<::bobbin_bits::R4>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 3 + (index << 2);
...
impl Cnt {
    ...
    #[inline] pub fn cntl(&self) -> ::bobbin_bits::U16 {
    ...
    #[inline] pub fn set_cntl<V: Into<::bobbin_bits::U16>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn cnth(&self) -> ::bobbin_bits::U15 {
    ...
    #[inline] pub fn set_cnth<V: Into<::bobbin_bits::U15>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn cnt_or_uifcpy(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_cnt_or_uifcpy<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 31);
        self.0 |= value << 31;
...
impl Arr {
    ...
    #[inline] pub fn arrl(&self) -> ::bobbin_bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }
    ...
    #[inline] pub fn set_arrl<V: Into<::bobbin_bits::U16>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn arrh(&self) -> ::bobbin_bits::U16 {
    ...
    #[inline] pub fn set_arrh<V: Into<::bobbin_bits::U16>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 16);
        self.0 |= value << 16;
...
impl Ccr {
    ...
    #[inline] pub fn ccrl(&self) -> ::bobbin_bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }
    ...
    #[inline] pub fn set_ccrl<V: Into<::bobbin_bits::U16>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn ccrh(&self) -> ::bobbin_bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0xffff) as u16) } // [31:16]
    }
    ...
    #[inline] pub fn set_ccrh<V: Into<::bobbin_bits::U16>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 16);
        self.0 |= value << 16;
