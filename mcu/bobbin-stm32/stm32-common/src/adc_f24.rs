...
impl Cr2 {
    ...
    #[inline] pub fn eocs(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 10) & 0x1) as u8) } // [10]
    }
    ...
    #[inline] pub fn set_eocs<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 10);
        self.0 |= value << 10;
...
impl Smpr1 {
    ...
    #[inline] pub fn smpx_x(&self) -> ::bobbin_bits::U32 {
    ...
    #[inline] pub fn set_smpx_x<V: Into<::bobbin_bits::U32>>(mut self, value: V) -> Self {
