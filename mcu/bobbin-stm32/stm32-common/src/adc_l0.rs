...
impl AdcPeriph {
    ...
    #[inline] pub fn cfgr1_reg(&self) -> ::bobbin_mcu::register::Register<Cfgr1> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Cfgr1, 0xc)
    }
    ...
    #[inline] pub fn cfgr2_reg(&self) -> ::bobbin_mcu::register::Register<Cfgr2> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Cfgr2, 0x10)
    }
    ...
    #[doc="Get the SMPR Register."]
    #[inline] pub fn smpr_reg(&self) -> ::bobbin_mcu::register::Register<Smpr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Smpr, 0x14)
    }
    ...
    #[inline] pub fn write_smpr(&self, value: Smpr) -> &Self { 
        self.smpr_reg().write(value);
        self
    }

    #[doc="Set the SMPR register."]
    ...
    #[doc="Get the CHSELR Register."]
    #[inline] pub fn chselr_reg(&self) -> ::bobbin_mcu::register::Register<Chselr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Chselr, 0x28)
    }
    ...
    #[inline] pub fn ccr_reg(&self) -> ::bobbin_mcu::register::Register<Ccr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Ccr, 0x308)
    }
...
impl Isr {
    ...
    #[inline] pub fn eocal(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_eocal<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 11);
        self.0 |= value << 11;
...
impl Ier {
    ...
    #[inline] pub fn eocalie(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 11) & 0x1) as u8) } // [11]
    }
    ...
    #[inline] pub fn set_eocalie<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 11);
        self.0 |= value << 11;
...
impl Cr {
    ...
    #[inline] pub fn advregen(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_advregen<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 28);
        self.0 |= value << 28;
...
impl Cfgr1 {
    ...
    #[inline] pub fn scandir(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 2) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn set_scandir<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
...
impl Cfgr2 {
    ...
    #[inline] pub fn ovse(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_ovse<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn ovsr(&self) -> ::bobbin_bits::U3 {
    ...
    #[inline] pub fn set_ovsr<V: Into<::bobbin_bits::U3>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U3 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x7 << 2);
        self.0 |= value << 2;
    ...
    #[inline] pub fn ovss(&self) -> ::bobbin_bits::U4 {
    ...
    #[inline] pub fn set_ovss<V: Into<::bobbin_bits::U4>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn tovs(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_tovs<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 9);
        self.0 |= value << 9;
...
impl Smpr {
    ...
    #[inline] pub fn smp(&self) -> ::bobbin_bits::U3 {
    ...
    #[inline] pub fn set_smp<V: Into<::bobbin_bits::U3>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U3 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x7 << 0);
        self.0 |= value << 0;
...
impl Chselr {
    ...
    #[inline] pub fn chsel<I: Into<::bobbin_bits::R19>>(&self, index: I) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn test_chsel<I: Into<::bobbin_bits::R19>>(&self, index: I) -> bool{
        self.chsel(index) != 0
    }

    #[doc="Sets the CHSEL field."]
    #[inline] pub fn set_chsel<I: Into<::bobbin_bits::R19>, V: Into<::bobbin_bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 0 + index;
...
impl Calfact {
    ...
    #[inline] pub fn calfact(&self) -> ::bobbin_bits::U7 {
    ...
    #[inline] pub fn set_calfact<V: Into<::bobbin_bits::U7>>(mut self, value: V) -> Self {
...
impl Ccr {
    ...
    #[doc="VLCD enable"]
    #[inline] pub fn vlcden(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_vlcden<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 24);
        self.0 |= value << 24;
    ...
    #[inline] pub fn lfmen(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_lfmen<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 25);
        self.0 |= value << 25;
