...
impl TimAdvPeriph {
    ...
    #[inline] pub fn or_reg(&self) -> ::bobbin_mcu::register::Register<Or> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Or, 0x60)
    }
...
impl Smcr {
    ...
    #[inline] pub fn sms3(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0x1) as u8) } // [16]
    }
    ...
    #[inline] pub fn set_sms3<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 16);
        self.0 |= value << 16;
...
impl CcmrInput {
    ...
    #[inline] pub fn icpcs<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U2 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 2 + (index << 3);
    ...
    #[inline] pub fn test_icpcs<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.icpcs(index) != 0
    }

    #[doc="Sets the ICPCS field."]
    #[inline] pub fn set_icpcs<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U2>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U2 = value.into();
        let value: u32 = value.into();
        let shift: usize = 2 + (index << 3);
    ...
    #[inline] pub fn cc1s<I: Into<::bobbin_bits::R2>>(&self, index: I) -> ::bobbin_bits::U2 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 0 + (index << 3);
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x3) as u8) } // [1:0]
    }
    ...
    #[inline] pub fn test_cc1s<I: Into<::bobbin_bits::R2>>(&self, index: I) -> bool{
        self.cc1s(index) != 0
    }

    #[doc="Sets the CC1S field."]
    #[inline] pub fn set_cc1s<I: Into<::bobbin_bits::R2>, V: Into<::bobbin_bits::U2>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: ::bobbin_bits::U2 = value.into();
        let value: u32 = value.into();
        let shift: usize = 0 + (index << 3);
...
impl Ccer {
    ...
    #[inline] pub fn ccp(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 1) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn set_ccp<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[inline] pub fn ccne(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 2) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn set_ccne<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
    ...
    #[doc="Capture/Compare n output Polarity"]
    #[inline] pub fn ccnp(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 3) & 0x1) as u8) } // [3]
    }
    ...
    #[inline] pub fn set_ccnp<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 3);
        self.0 |= value << 3;
...
impl Ccr {
    ...
    #[inline] pub fn ccr(&self) -> ::bobbin_bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }
    ...
    #[inline] pub fn set_ccr<V: Into<::bobbin_bits::U16>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
...
impl Ccmr3Output {
    ...
    #[inline] pub fn oc5m_3(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0x1) as u8) } // [16]
    }
    ...
    #[inline] pub fn set_oc5m_3<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 16);
        self.0 |= value << 16;
    ...
    #[inline] pub fn oc6m_3(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 24) & 0x1) as u8) } // [24]
    }
    ...
    #[inline] pub fn set_oc6m_3<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 24);
        self.0 |= value << 24;
...
impl Or {
    ...
    #[inline] pub fn tim1_etr_adc4_rmp(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_tim1_etr_adc4_rmp<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U2 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x3 << 2);
        self.0 |= value << 2;
