::bobbin_mcu::periph!( TIM17, Tim17, TIM17_PERIPH, Tim17Periph, TIM17_OWNED, TIM17_REF_COUNT, 0x40014800, 0x00, 0x26);

#[derive(Clone, Copy, PartialEq, Eq)]
#[doc="TIM17 Peripheral"]
pub struct Tim17Periph(pub usize); 
...
impl Tim17Periph {
    ...
    #[inline] pub fn dier_reg(&self) -> ::bobbin_mcu::register::Register<Dier> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Dier, 0x8)
    }
    ...
    #[inline] pub fn egr_reg(&self) -> ::bobbin_mcu::register::Register<Egr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Egr, 0x10)
    }
    ...
    #[inline] pub fn ccmr1_output_reg(&self) -> ::bobbin_mcu::register::Register<Ccmr1Output> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Ccmr1Output, 0x14)
    }
    ...
    #[inline] pub fn ccer_reg(&self) -> ::bobbin_mcu::register::Register<Ccer> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Ccer, 0x1c)
    }
    ...
    #[inline] pub fn cnt_reg(&self) -> ::bobbin_mcu::register::Register<Cnt> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Cnt, 0x20)
    }
    ...
    #[inline] pub fn psc_reg(&self) -> ::bobbin_mcu::register::Register<Psc> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Psc, 0x24)
    }
    ...
    #[inline] pub fn arr_reg(&self) -> ::bobbin_mcu::register::Register<Arr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Arr, 0x28)
    }
    ...
    #[inline] pub fn rcr_reg(&self) -> ::bobbin_mcu::register::Register<Rcr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Rcr, 0x2c)
    }
    ...
    #[inline] pub fn ccr1_reg(&self) -> ::bobbin_mcu::register::Register<Ccr1> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Ccr1, 0x30)
    }
    ...
    #[inline] pub fn bdtr_reg(&self) -> ::bobbin_mcu::register::Register<Bdtr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Bdtr, 0x34)
    }
    ...
    #[inline] pub fn dcr_reg(&self) -> ::bobbin_mcu::register::Register<Dcr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Dcr, 0x38)
    }
    ...
    #[inline] pub fn dmar_reg(&self) -> ::bobbin_mcu::register::Register<Dmar> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Dmar, 0x3c)
    }
    ...
    #[inline] pub fn or_reg(&self) -> ::bobbin_mcu::register::Register<Or> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Or, 0x40)
    }
    ...
    #[inline] pub fn af1_reg(&self) -> ::bobbin_mcu::register::Register<Af1> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Af1, 0x44)
    }
