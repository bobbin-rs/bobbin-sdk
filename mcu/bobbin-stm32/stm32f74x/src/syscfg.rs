...
impl ::bobbin_mcu::gate::GateRst for Syscfg {
    #[inline]
    fn gate_rst(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb2rstr().syscfgrst() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateEn for Syscfg {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb2enr().syscfgen() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateSleepEn for Syscfg {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb2lpenr().syscfglpen() }
    #[inline]
...
impl Memrm {
    ...
    #[inline] pub fn fb_mode(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_fb_mode<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn swp_fmc(&self) -> ::bobbin_bits::U2 {
    ...
    #[inline] pub fn set_swp_fmc<V: Into<::bobbin_bits::U2>>(mut self, value: V) -> Self {
...
impl Pmc {
    ...
    #[doc="ADC1DC2"]
    #[inline] pub fn adc1dc2(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_adc1dc2<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 16);
        self.0 |= value << 16;
    ...
    #[doc="ADC2DC2"]
    #[inline] pub fn adc2dc2(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_adc2dc2<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 17);
        self.0 |= value << 17;
    ...
    #[doc="ADC3DC2"]
    #[inline] pub fn adc3dc2(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_adc3dc2<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 18);
        self.0 |= value << 18;
