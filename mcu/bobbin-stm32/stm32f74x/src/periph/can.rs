...
impl CanPeriph {
    ...
    #[inline] pub fn msr_reg(&self) -> Register<Msr> { 
        Register::new(self.0 as *mut Msr, 0x4)
    }
    ...
    #[inline] pub fn tsr_reg(&self) -> Register<Tsr> { 
        Register::new(self.0 as *mut Tsr, 0x8)
    }
    ...
    #[inline] pub fn rfr_reg(&self) -> RegisterArray<Rfr, bits::R2> { 
        RegisterArray::new(self.0 as *mut Rfr, 0xc, 0x4)
    }
    ...
    #[inline] pub fn write_rfr<I: Into<bits::R2>>(&self, index: I, value: Rfr) -> &Self {
    ...
    #[inline] pub fn ier_reg(&self) -> Register<Ier> { 
        Register::new(self.0 as *mut Ier, 0x14)
    }
    ...
    #[inline] pub fn esr_reg(&self) -> Register<Esr> { 
        Register::new(self.0 as *mut Esr, 0x18)
    }
    ...
    #[inline] pub fn btr_reg(&self) -> Register<Btr> { 
        Register::new(self.0 as *mut Btr, 0x1c)
    }
    ...
    #[inline] pub fn tir_reg(&self) -> RegisterArray<Tir, bits::R3> { 
        RegisterArray::new(self.0 as *mut Tir, 0x180, 0x10)
    }
    ...
    #[inline] pub fn write_tir<I: Into<bits::R3>>(&self, index: I, value: Tir) -> &Self {
    ...
    #[inline] pub fn tdtr_reg(&self) -> RegisterArray<Tdtr, bits::R3> { 
        RegisterArray::new(self.0 as *mut Tdtr, 0x184, 0x10)
    }
    ...
    #[inline] pub fn write_tdtr<I: Into<bits::R3>>(&self, index: I, value: Tdtr) -> &Self {
    ...
    #[inline] pub fn tdlr_reg(&self) -> RegisterArray<Tdlr, bits::R3> { 
        RegisterArray::new(self.0 as *mut Tdlr, 0x188, 0x10)
    }
    ...
    #[inline] pub fn write_tdlr<I: Into<bits::R3>>(&self, index: I, value: Tdlr) -> &Self {
    ...
    #[inline] pub fn tdhr_reg(&self) -> RegisterArray<Tdhr, bits::R3> { 
        RegisterArray::new(self.0 as *mut Tdhr, 0x18c, 0x10)
    }
    ...
    #[inline] pub fn write_tdhr<I: Into<bits::R3>>(&self, index: I, value: Tdhr) -> &Self {
    ...
    #[inline] pub fn rir_reg(&self) -> RegisterArray<Rir, bits::R2> { 
        RegisterArray::new(self.0 as *mut Rir, 0x1b0, 0x10)
    }
    ...
    #[inline] pub fn rdtr_reg(&self) -> RegisterArray<Rdtr, bits::R2> { 
        RegisterArray::new(self.0 as *mut Rdtr, 0x1b4, 0x10)
    }
    ...
    #[inline] pub fn rdlr_reg(&self) -> RegisterArray<Rdlr, bits::R2> { 
        RegisterArray::new(self.0 as *mut Rdlr, 0x1b8, 0x10)
    }
    ...
    #[inline] pub fn rdhr_reg(&self) -> RegisterArray<Rdhr, bits::R2> { 
        RegisterArray::new(self.0 as *mut Rdhr, 0x1bc, 0x10)
    }
    ...
    #[inline] pub fn fmr_reg(&self) -> Register<Fmr> { 
        Register::new(self.0 as *mut Fmr, 0x200)
    }
    ...
    #[inline] pub fn fm1r_reg(&self) -> Register<Fm1r> { 
        Register::new(self.0 as *mut Fm1r, 0x204)
    }
    ...
    #[inline] pub fn fs1r_reg(&self) -> Register<Fs1r> { 
        Register::new(self.0 as *mut Fs1r, 0x20c)
    }
    ...
    #[inline] pub fn ffa1r_reg(&self) -> Register<Ffa1r> { 
        Register::new(self.0 as *mut Ffa1r, 0x214)
    }
    ...
    #[inline] pub fn fa1r_reg(&self) -> Register<Fa1r> { 
        Register::new(self.0 as *mut Fa1r, 0x21c)
    }
    ...
    #[inline] pub fn fr0_reg(&self) -> RegisterArray<Fr0, bits::R28> { 
        RegisterArray::new(self.0 as *mut Fr0, 0x240, 0x8)
    }
    ...
    #[inline] pub fn write_fr0<I: Into<bits::R28>>(&self, index: I, value: Fr0) -> &Self {
    ...
    #[inline] pub fn fr1_reg(&self) -> RegisterArray<Fr1, bits::R28> { 
        RegisterArray::new(self.0 as *mut Fr1, 0x244, 0x8)
    }
    ...
    #[inline] pub fn write_fr1<I: Into<bits::R28>>(&self, index: I, value: Fr1) -> &Self {
...
impl Tsr {
    ...
    #[inline] pub fn low<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
    ...
    #[inline] pub fn test_low<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.low(index) != 0
    }

    #[doc="Sets the LOW field."]
    #[inline] pub fn set_low<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 29 + index;
    ...
    #[doc="Lowest priority flag for mailbox n"]
    #[inline] pub fn tme<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_tme<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.tme(index) != 0
    }

    #[doc="Sets the TME field."]
    #[inline] pub fn set_tme<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 26 + index;
    ...
    #[doc="ABRQ"]
    #[inline] pub fn abrq<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_abrq<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.abrq(index) != 0
    }

    #[doc="Sets the ABRQ field."]
    #[inline] pub fn set_abrq<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 7 + (index << 3);
    ...
    #[doc="TERR"]
    #[inline] pub fn terr<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_terr<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.terr(index) != 0
    }

    #[doc="Sets the TERR field."]
    #[inline] pub fn set_terr<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 3 + (index << 3);
    ...
    #[doc="ALST"]
    #[inline] pub fn alst<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_alst<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.alst(index) != 0
    }

    #[doc="Sets the ALST field."]
    #[inline] pub fn set_alst<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 2 + (index << 3);
    ...
    #[doc="TXOK"]
    #[inline] pub fn txok<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_txok<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.txok(index) != 0
    }

    #[doc="Sets the TXOK field."]
    #[inline] pub fn set_txok<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 1 + (index << 3);
    ...
    #[doc="RQCP"]
    #[inline] pub fn rqcp<I: Into<bits::R3>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
    ...
    #[inline] pub fn test_rqcp<I: Into<bits::R3>>(&self, index: I) -> bool{
        self.rqcp(index) != 0
    }

    #[doc="Sets the RQCP field."]
    #[inline] pub fn set_rqcp<I: Into<bits::R3>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 0 + (index << 3);
...
impl Ier {
    ...
    #[doc="FOVIE"]
    #[inline] pub fn fovie<I: Into<bits::R2>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 3 + (index * 3);
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x1) as u8) } // [3]
    }
    ...
    #[inline] pub fn test_fovie<I: Into<bits::R2>>(&self, index: I) -> bool{
        self.fovie(index) != 0
    }

    #[doc="Sets the FOVIE field."]
    #[inline] pub fn set_fovie<I: Into<bits::R2>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 3 + (index * 3);
    ...
    #[doc="FFIE"]
    #[inline] pub fn ffie<I: Into<bits::R2>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 2 + (index * 3);
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn test_ffie<I: Into<bits::R2>>(&self, index: I) -> bool{
        self.ffie(index) != 0
    }

    #[doc="Sets the FFIE field."]
    #[inline] pub fn set_ffie<I: Into<bits::R2>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 2 + (index * 3);
    ...
    #[doc="FMPIE"]
    #[inline] pub fn fmpie<I: Into<bits::R2>>(&self, index: I) -> bits::U1 {
        let index: usize = index.into().value() as usize;
        let shift: usize = 1 + (index * 3);
        unsafe { ::core::mem::transmute(((self.0 >> shift) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn test_fmpie<I: Into<bits::R2>>(&self, index: I) -> bool{
        self.fmpie(index) != 0
    }

    #[doc="Sets the FMPIE field."]
    #[inline] pub fn set_fmpie<I: Into<bits::R2>, V: Into<bits::U1>>(mut self, index: I, value: V) -> Self {
        let index: usize = index.into().value() as usize;
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        let shift: usize = 1 + (index * 3);
