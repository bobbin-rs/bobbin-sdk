...
impl SyscfgPeriph {
    ...
    #[inline] pub fn memrm_reg(&self) -> Register<Memrm> { 
        Register::new(self.0 as *mut Memrm, 0x0)
    }
    ...
    #[inline] pub fn pmc_reg(&self) -> Register<Pmc> { 
        Register::new(self.0 as *mut Pmc, 0x4)
    }
    ...
    #[inline] pub fn exticr1_reg(&self) -> Register<Exticr1> { 
        Register::new(self.0 as *mut Exticr1, 0x8)
    }
    ...
    #[inline] pub fn exticr2_reg(&self) -> Register<Exticr2> { 
        Register::new(self.0 as *mut Exticr2, 0xc)
    }
    ...
    #[inline] pub fn exticr3_reg(&self) -> Register<Exticr3> { 
        Register::new(self.0 as *mut Exticr3, 0x10)
    }
    ...
    #[inline] pub fn exticr4_reg(&self) -> Register<Exticr4> { 
        Register::new(self.0 as *mut Exticr4, 0x14)
    }
    ...
    #[inline] pub fn cmpcr_reg(&self) -> Register<Cmpcr> { 
        Register::new(self.0 as *mut Cmpcr, 0x20)
    }
...
impl Memrm {
    ...
    #[inline] pub fn swp_fmc(&self) -> bits::U2 {
        unsafe { ::core::mem::transmute(((self.0 >> 10) & 0x3) as u8) } // [11:10]
    }

    #[doc="Returns true if SWP_FMC != 0"]
    #[inline] pub fn test_swp_fmc(&self) -> bool {
        self.swp_fmc() != 0
    }

    #[doc="Sets the SWP_FMC field."]
    #[inline] pub fn set_swp_fmc<V: Into<bits::U2>>(mut self, value: V) -> Self {
...
impl ::core::fmt::Debug for Memrm {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.swp_fmc() != 0 { try!(write!(f, " swp_fmc=0x{:x}", self.swp_fmc()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
impl Pmc {
    ...
    #[doc="ADC1DC2"]
    #[inline] pub fn adc1dc2(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0x1) as u8) } // [16]
    }

    #[doc="Returns true if ADC1DC2 != 0"]
    #[inline] pub fn test_adc1dc2(&self) -> bool {
        self.adc1dc2() != 0
    }

    #[doc="Sets the ADC1DC2 field."]
    #[inline] pub fn set_adc1dc2<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 16);
        self.0 |= value << 16;
    ...
    #[doc="ADC2DC2"]
    #[inline] pub fn adc2dc2(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 17) & 0x1) as u8) } // [17]
    }

    #[doc="Returns true if ADC2DC2 != 0"]
    #[inline] pub fn test_adc2dc2(&self) -> bool {
        self.adc2dc2() != 0
    }

    #[doc="Sets the ADC2DC2 field."]
    #[inline] pub fn set_adc2dc2<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 17);
        self.0 |= value << 17;
    ...
    #[doc="ADC3DC2"]
    #[inline] pub fn adc3dc2(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 18) & 0x1) as u8) } // [18]
    }

    #[doc="Returns true if ADC3DC2 != 0"]
    #[inline] pub fn test_adc3dc2(&self) -> bool {
        self.adc3dc2() != 0
    }

    #[doc="Sets the ADC3DC2 field."]
    #[inline] pub fn set_adc3dc2<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 18);
        self.0 |= value << 18;
...
impl ::core::fmt::Debug for Pmc {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.adc1dc2() != 0 { try!(write!(f, " adc1dc2"))}
        if self.adc2dc2() != 0 { try!(write!(f, " adc2dc2"))}
        if self.adc3dc2() != 0 { try!(write!(f, " adc3dc2"))}
        try!(write!(f, "]"));
        Ok(())
    }
}
