...
pin!(PA0, Pa0, GPIOA, Gpioa, _PA0, GpioPin, _GPIOA, 0);
    ...
    alt_fn!(Pa0, super::sig::Sai2SdB, 10);
...
pin!(PA1, Pa1, GPIOA, Gpioa, _PA1, GpioPin, _GPIOA, 1);
    ...
    alt_fn!(Pa1, super::sig::QuadspiBk1Io3, 9);
    alt_fn!(Pa1, super::sig::Sai2MckB, 10);
    alt_fn!(Pa1, super::sig::EthMiiRxClk, 11);
    alt_fn!(Pa1, super::sig::EthRmiiRefClk, 11);
    alt_fn!(Pa1, super::sig::LcdR2, 14);
...
pin!(PA2, Pa2, GPIOA, Gpioa, _PA2, GpioPin, _GPIOA, 2);
    ...
    alt_fn!(Pa2, super::sig::Sai2SckB, 8);
    alt_fn!(Pa2, super::sig::EthMdio, 11);
    alt_fn!(Pa2, super::sig::MdiosMdio, 12);
    alt_fn!(Pa2, super::sig::LcdR1, 14);
...
pin!(PA5, Pa5, GPIOA, Gpioa, _PA5, GpioPin, _GPIOA, 5);
    ...
    alt_fn!(Pa5, super::sig::I2s1Ck, 5);
    alt_fn!(Pa5, super::sig::Spi6Sck, 8);
    alt_fn!(Pa5, super::sig::OtgHsUlpiCk, 10);
    alt_fn!(Pa5, super::sig::LcdR4, 14);
...
pin!(PA6, Pa6, GPIOA, Gpioa, _PA6, GpioPin, _GPIOA, 6);
    ...
    alt_fn!(Pa6, super::sig::Spi6Miso, 8);
    alt_fn!(Pa6, super::sig::Tim13Ch1, 9);
    alt_fn!(Pa6, super::sig::MdiosMdc, 12);
    alt_fn!(Pa6, super::sig::DcmiPixclk, 13);
...
pin!(PA8, Pa8, GPIOA, Gpioa, _PA8, GpioPin, _GPIOA, 8);
    ...
    alt_fn!(Pa8, super::sig::Tim8Bkin2, 3);
    alt_fn!(Pa8, super::sig::I2c3Scl, 4);
    alt_fn!(Pa8, super::sig::Usart1Ck, 7);
    alt_fn!(Pa8, super::sig::OtgFsSof, 10);
    alt_fn!(Pa8, super::sig::Can3Rx, 11);
    alt_fn!(Pa8, super::sig::Uart7Rx, 12);
    alt_fn!(Pa8, super::sig::LcdB3, 13);
...
pin!(PA9, Pa9, GPIOA, Gpioa, _PA9, GpioPin, _GPIOA, 9);
    ...
    alt_fn!(Pa9, super::sig::Spi2Sck, 5);
    alt_fn!(Pa9, super::sig::I2s2Ck, 5);
    alt_fn!(Pa9, super::sig::Usart1Tx, 7);
    alt_fn!(Pa9, super::sig::DcmiD0, 13);
    alt_fn!(Pa9, super::sig::LcdR5, 14);
...
pin!(PA10, Pa10, GPIOA, Gpioa, _PA10, GpioPin, _GPIOA, 10);
    ...
    alt_fn!(Pa10, super::sig::LcdB4, 9);
    alt_fn!(Pa10, super::sig::OtgFsId, 10);
    alt_fn!(Pa10, super::sig::MdiosMdio, 12);
    alt_fn!(Pa10, super::sig::DcmiD1, 13);
    alt_fn!(Pa10, super::sig::LcdB1, 14);
    alt_fn!(Pa10, super::sig::Eventout, 15);

pin!(PA11, Pa11, GPIOA, Gpioa, _PA11, GpioPin, _GPIOA, 11);
    alt_fn!(Pa11, super::sig::Tim1Ch4, 1);
    alt_fn!(Pa11, super::sig::Spi2Nss, 5);
    alt_fn!(Pa11, super::sig::I2s2Ws, 5);
    alt_fn!(Pa11, super::sig::Uart4Rx, 6);
...
pin!(PA12, Pa12, GPIOA, Gpioa, _PA12, GpioPin, _GPIOA, 12);
    ...
    alt_fn!(Pa12, super::sig::Spi2Sck, 5);
    alt_fn!(Pa12, super::sig::I2s2Ck, 5);
    alt_fn!(Pa12, super::sig::Uart4Tx, 6);
    alt_fn!(Pa12, super::sig::Usart1Rts, 7);
    alt_fn!(Pa12, super::sig::Sai2FsB, 8);
...
pin!(PA15, Pa15, GPIOA, Gpioa, _PA15, GpioPin, _GPIOA, 15);
    ...
    alt_fn!(Pa15, super::sig::HdmiCec, 4);
    alt_fn!(Pa15, super::sig::Spi1Nss, 5);
    alt_fn!(Pa15, super::sig::I2s1Ws, 5);
    alt_fn!(Pa15, super::sig::Spi3Nss, 6);
    alt_fn!(Pa15, super::sig::I2s3Ws, 6);
    alt_fn!(Pa15, super::sig::Spi6Nss, 7);
    alt_fn!(Pa15, super::sig::Uart4Rts, 8);
    alt_fn!(Pa15, super::sig::Can3Tx, 11);
    alt_fn!(Pa15, super::sig::Uart7Tx, 12);
...
pin!(PB1, Pb1, GPIOB, Gpiob, _PB1, GpioPin, _GPIOB, 1);
    ...
    alt_fn!(Pb1, super::sig::Dfsdm1Datin1, 6);
    alt_fn!(Pb1, super::sig::LcdR6, 9);
    alt_fn!(Pb1, super::sig::OtgHsUlpiD2, 10);
    alt_fn!(Pb1, super::sig::EthMiiRxd3, 11);
    alt_fn!(Pb1, super::sig::LcdG0, 14);
    alt_fn!(Pb1, super::sig::Eventout, 15);

pin!(PB2, Pb2, GPIOB, Gpiob, _PB2, GpioPin, _GPIOB, 2);
    alt_fn!(Pb2, super::sig::Sai1SdA, 6);
    alt_fn!(Pb2, super::sig::Spi3Mosi, 7);
    alt_fn!(Pb2, super::sig::I2s3Sd, 7);
    alt_fn!(Pb2, super::sig::QuadspiClk, 9);
    alt_fn!(Pb2, super::sig::Dfsdm1Ckin1, 10);
...
pin!(PB3, Pb3, GPIOB, Gpiob, _PB3, GpioPin, _GPIOB, 3);
    ...
    alt_fn!(Pb3, super::sig::I2s1Ck, 5);
    alt_fn!(Pb3, super::sig::Spi3Sck, 6);
    alt_fn!(Pb3, super::sig::I2s3Ck, 6);
    alt_fn!(Pb3, super::sig::Spi6Sck, 8);
    alt_fn!(Pb3, super::sig::Sdmmc2D2, 10);
    alt_fn!(Pb3, super::sig::Can3Rx, 11);
    alt_fn!(Pb3, super::sig::Uart7Rx, 12);
...
pin!(PB4, Pb4, GPIOB, Gpiob, _PB4, GpioPin, _GPIOB, 4);
    ...
    alt_fn!(Pb4, super::sig::Spi2Nss, 7);
    alt_fn!(Pb4, super::sig::I2s2Ws, 7);
    alt_fn!(Pb4, super::sig::Spi6Miso, 8);
    alt_fn!(Pb4, super::sig::Sdmmc2D3, 10);
    alt_fn!(Pb4, super::sig::Can3Tx, 11);
    alt_fn!(Pb4, super::sig::Uart7Tx, 12);
    alt_fn!(Pb4, super::sig::Eventout, 15);

pin!(PB5, Pb5, GPIOB, Gpiob, _PB5, GpioPin, _GPIOB, 5);
    alt_fn!(Pb5, super::sig::Uart5Rx, 1);
    alt_fn!(Pb5, super::sig::Tim3Ch2, 2);
    alt_fn!(Pb5, super::sig::I2c1Smba, 4);
    alt_fn!(Pb5, super::sig::Spi1Mosi, 5);
    alt_fn!(Pb5, super::sig::I2s1Sd, 5);
    alt_fn!(Pb5, super::sig::Spi3Mosi, 6);
    alt_fn!(Pb5, super::sig::I2s3Sd, 6);
    alt_fn!(Pb5, super::sig::Spi6Mosi, 8);
...
pin!(PB7, Pb7, GPIOB, Gpiob, _PB7, GpioPin, _GPIOB, 7);
    ...
    alt_fn!(Pb7, super::sig::Dfsdm1Ckin5, 6);
    alt_fn!(Pb7, super::sig::Usart1Rx, 7);
    alt_fn!(Pb7, super::sig::I2s4Sda, 11);
...
pin!(PB8, Pb8, GPIOB, Gpiob, _PB8, GpioPin, _GPIOB, 8);
    alt_fn!(Pb8, super::sig::I2c4Scl, 1);
    alt_fn!(Pb8, super::sig::Tim4Ch3, 2);
    alt_fn!(Pb8, super::sig::Tim10Ch1, 3);
    alt_fn!(Pb8, super::sig::I2c1Scl, 4);
    alt_fn!(Pb8, super::sig::Dfsdm1Ckin7, 6);
    alt_fn!(Pb8, super::sig::Uart5Rx, 7);
    alt_fn!(Pb8, super::sig::Can1Rx, 9);
    alt_fn!(Pb8, super::sig::Sdmmc2D4, 10);
    alt_fn!(Pb8, super::sig::EthMiiTxd3, 11);
    alt_fn!(Pb8, super::sig::SdmmcD4, 12);
...
pin!(PB9, Pb9, GPIOB, Gpiob, _PB9, GpioPin, _GPIOB, 9);
    alt_fn!(Pb9, super::sig::I2c4Sda, 1);
    ...
    alt_fn!(Pb9, super::sig::Dfsdm1Datin7, 6);
    alt_fn!(Pb9, super::sig::Uart5Tx, 7);
    alt_fn!(Pb9, super::sig::Can1Tx, 9);
    alt_fn!(Pb9, super::sig::Sdmmc2D5, 10);
    alt_fn!(Pb9, super::sig::I2c4Smba, 11);
    alt_fn!(Pb9, super::sig::SdmmcD5, 12);
...
pin!(PB10, Pb10, GPIOB, Gpiob, _PB10, GpioPin, _GPIOB, 10);
    ...
    alt_fn!(Pb10, super::sig::Dfsdm1Datin7, 6);
    alt_fn!(Pb10, super::sig::Usart3Tx, 7);
    alt_fn!(Pb10, super::sig::QuadspiBk1Ncs, 9);
...
pin!(PB11, Pb11, GPIOB, Gpiob, _PB11, GpioPin, _GPIOB, 11);
    ...
    alt_fn!(Pb11, super::sig::Dfsdm1Ckin7, 6);
    ...
    alt_fn!(Pb11, super::sig::DsiTe, 13);
    alt_fn!(Pb11, super::sig::LcdG5, 14);
...
pin!(PB12, Pb12, GPIOB, Gpiob, _PB12, GpioPin, _GPIOB, 12);
    ...
    alt_fn!(Pb12, super::sig::Uart5Rx, 8);
...
pin!(PB13, Pb13, GPIOB, Gpiob, _PB13, GpioPin, _GPIOB, 13);
    ...
    alt_fn!(Pb13, super::sig::Uart5Tx, 8);
...
pin!(PC0, Pc0, GPIOC, Gpioc, _PC0, GpioPin, _GPIOC, 0);
    ...
    alt_fn!(Pc0, super::sig::Dfsdm1Ckin0, 3);
    alt_fn!(Pc0, super::sig::Dfsdm1Datin4, 6);
    alt_fn!(Pc0, super::sig::Sai2FsB, 8);
    alt_fn!(Pc0, super::sig::OtgHsUlpiStp, 10);
    alt_fn!(Pc0, super::sig::FmcSdnwe, 12);
    alt_fn!(Pc0, super::sig::LcdR5, 14);
...
pin!(PC1, Pc1, GPIOC, Gpioc, _PC1, GpioPin, _GPIOC, 1);
    ...
    alt_fn!(Pc1, super::sig::Dfsdm1Datain0, 3);
    alt_fn!(Pc1, super::sig::Spi2Mosi, 5);
    alt_fn!(Pc1, super::sig::I2s2Sd, 5);
    alt_fn!(Pc1, super::sig::Sai1SdA, 6);
    alt_fn!(Pc1, super::sig::Dfsdm1Ckin4, 10);
    alt_fn!(Pc1, super::sig::EthMdc, 11);
    alt_fn!(Pc1, super::sig::MdiosMdc, 12);
...
pin!(PC2, Pc2, GPIOC, Gpioc, _PC2, GpioPin, _GPIOC, 2);
    ...
    alt_fn!(Pc2, super::sig::Dfsdm1Ckin1, 3);
...
pin!(PC3, Pc3, GPIOC, Gpioc, _PC3, GpioPin, _GPIOC, 3);
    ...
    alt_fn!(Pc3, super::sig::Dfsdm1Datain1, 3);
...
pin!(PC4, Pc4, GPIOC, Gpioc, _PC4, GpioPin, _GPIOC, 4);
    ...
    alt_fn!(Pc4, super::sig::Dfsdm1Ckin2, 3);
    alt_fn!(Pc4, super::sig::I2s1Mck, 5);
    alt_fn!(Pc4, super::sig::SpdifRx2, 8);
    alt_fn!(Pc4, super::sig::EthMiiRxd0, 11);
    alt_fn!(Pc4, super::sig::EthRmiiRxd0, 11);
    alt_fn!(Pc4, super::sig::FmcSdne0, 12);
...
pin!(PC5, Pc5, GPIOC, Gpioc, _PC5, GpioPin, _GPIOC, 5);
    ...
    alt_fn!(Pc5, super::sig::Dfsdm1Datain2, 3);
    alt_fn!(Pc5, super::sig::SpdifRx3, 8);
    alt_fn!(Pc5, super::sig::EthMiiRxd1, 11);
    alt_fn!(Pc5, super::sig::EthRmiiRxd1, 11);
    alt_fn!(Pc5, super::sig::FmcSdcke0, 12);
...
pin!(PC6, Pc6, GPIOC, Gpioc, _PC6, GpioPin, _GPIOC, 6);
    ...
    alt_fn!(Pc6, super::sig::Dfsdm1Ckin3, 7);
    alt_fn!(Pc6, super::sig::Usart6Tx, 8);
    alt_fn!(Pc6, super::sig::FmcNwait, 9);
    alt_fn!(Pc6, super::sig::Sdmmc2D6, 10);
    alt_fn!(Pc6, super::sig::SdmmcD6, 12);
...
pin!(PC7, Pc7, GPIOC, Gpioc, _PC7, GpioPin, _GPIOC, 7);
    ...
    alt_fn!(Pc7, super::sig::Dfsdm1Datain3, 7);
    alt_fn!(Pc7, super::sig::Usart6Rx, 8);
    alt_fn!(Pc7, super::sig::FmcNe1, 9);
    alt_fn!(Pc7, super::sig::Sdmmc2D7, 10);
    alt_fn!(Pc7, super::sig::SdmmcD7, 12);
...
pin!(PC8, Pc8, GPIOC, Gpioc, _PC8, GpioPin, _GPIOC, 8);
    alt_fn!(Pc8, super::sig::Traced1, 0);
    alt_fn!(Pc8, super::sig::Tim3Ch3, 2);
    alt_fn!(Pc8, super::sig::Tim8Ch3, 3);
    alt_fn!(Pc8, super::sig::Uart5Rts, 7);
    alt_fn!(Pc8, super::sig::Usart6Ck, 8);
    alt_fn!(Pc8, super::sig::FmcNe2, 9);
    alt_fn!(Pc8, super::sig::FmcNce, 9);
    alt_fn!(Pc8, super::sig::SdmmcD0, 12);
...
pin!(PC9, Pc9, GPIOC, Gpioc, _PC9, GpioPin, _GPIOC, 9);
    ...
    alt_fn!(Pc9, super::sig::Uart5Cts, 7);
    alt_fn!(Pc9, super::sig::QuadspiBk1Io0, 9);
    alt_fn!(Pc9, super::sig::LcdG3, 10);
    alt_fn!(Pc9, super::sig::SdmmcD1, 12);
    alt_fn!(Pc9, super::sig::DcmiD3, 13);
    alt_fn!(Pc9, super::sig::LcdB2, 14);
    alt_fn!(Pc9, super::sig::Eventout, 15);

pin!(PC10, Pc10, GPIOC, Gpioc, _PC10, GpioPin, _GPIOC, 10);
    alt_fn!(Pc10, super::sig::Dfsdm1Ckin5, 3);
    ...
    alt_fn!(Pc10, super::sig::QuadspiBk1Io1, 9);
    alt_fn!(Pc10, super::sig::SdmmcD2, 12);
...
pin!(PC11, Pc11, GPIOC, Gpioc, _PC11, GpioPin, _GPIOC, 11);
    alt_fn!(Pc11, super::sig::Dfsdm1Datain5, 3);
    alt_fn!(Pc11, super::sig::Spi3Miso, 6);
    alt_fn!(Pc11, super::sig::Usart3Rx, 7);
    alt_fn!(Pc11, super::sig::Uart4Rx, 8);
    alt_fn!(Pc11, super::sig::QuadspiBk2Ncs, 9);
    alt_fn!(Pc11, super::sig::SdmmcD3, 12);
...
pin!(PC12, Pc12, GPIOC, Gpioc, _PC12, GpioPin, _GPIOC, 12);
    ...
    alt_fn!(Pc12, super::sig::SdmmcCk, 12);
...
pin!(PD0, Pd0, GPIOD, Gpiod, _PD0, GpioPin, _GPIOD, 0);
    alt_fn!(Pd0, super::sig::Dfsdm1Ckin6, 3);
    alt_fn!(Pd0, super::sig::Dfsdm1Datain7, 6);
    alt_fn!(Pd0, super::sig::Uart4Rx, 8);
...
pin!(PD1, Pd1, GPIOD, Gpiod, _PD1, GpioPin, _GPIOD, 1);
    alt_fn!(Pd1, super::sig::Dfsdm1Datain6, 3);
    alt_fn!(Pd1, super::sig::Dfsdm1Ckin7, 6);
    alt_fn!(Pd1, super::sig::Uart4Tx, 8);
...
pin!(PD6, Pd6, GPIOD, Gpiod, _PD6, GpioPin, _GPIOD, 6);
    alt_fn!(Pd6, super::sig::Dfsdm1Ckin4, 3);
    ...
    alt_fn!(Pd6, super::sig::Dfsdm1Datain1, 10);
    alt_fn!(Pd6, super::sig::Sdmmc2Ck, 11);
...
pin!(PD10, Pd10, GPIOD, Gpiod, _PD10, GpioPin, _GPIOD, 10);
    alt_fn!(Pd10, super::sig::Dfsdm1Ckout, 3);
    alt_fn!(Pd10, super::sig::Usart3Ck, 7);
    alt_fn!(Pd10, super::sig::FmcD15, 12);
    alt_fn!(Pd10, super::sig::LcdB3, 14);
...
pin!(PD14, Pd14, GPIOD, Gpiod, _PD14, GpioPin, _GPIOD, 14);
    ...
    alt_fn!(Pd14, super::sig::Uart8Cts, 8);
...
pin!(PD15, Pd15, GPIOD, Gpiod, _PD15, GpioPin, _GPIOD, 15);
    ...
    alt_fn!(Pd15, super::sig::Uart8Rts, 8);
...
pin!(PE0, Pe0, GPIOE, Gpioe, _PE0, GpioPin, _GPIOE, 0);
    ...
    alt_fn!(Pe0, super::sig::Lptim1Etr, 3);
    alt_fn!(Pe0, super::sig::Uart8Rx, 8);
    alt_fn!(Pe0, super::sig::Sai2MckA, 10);
...
pin!(PE1, Pe1, GPIOE, Gpioe, _PE1, GpioPin, _GPIOE, 1);
    alt_fn!(Pe1, super::sig::Lptim1In2, 3);
...
pin!(PE2, Pe2, GPIOE, Gpioe, _PE2, GpioPin, _GPIOE, 2);
    ...
    alt_fn!(Pe2, super::sig::QuadspiBk1Io2, 9);
...
pin!(PE4, Pe4, GPIOE, Gpioe, _PE4, GpioPin, _GPIOE, 4);
    ...
    alt_fn!(Pe4, super::sig::Dfsdm1Datain3, 10);
    alt_fn!(Pe4, super::sig::FmcA20, 12);
    alt_fn!(Pe4, super::sig::DcmiD4, 13);
    alt_fn!(Pe4, super::sig::LcdB0, 14);
...
pin!(PE8, Pe8, GPIOE, Gpioe, _PE8, GpioPin, _GPIOE, 8);
    ...
    alt_fn!(Pe8, super::sig::Uart7Tx, 8);
    alt_fn!(Pe8, super::sig::QuadspiBk2Io1, 10);
...
pin!(PE9, Pe9, GPIOE, Gpioe, _PE9, GpioPin, _GPIOE, 9);
    ...
    alt_fn!(Pe9, super::sig::Uart7Rts, 8);
    alt_fn!(Pe9, super::sig::QuadspiBk2Io2, 10);
...
pin!(PE10, Pe10, GPIOE, Gpioe, _PE10, GpioPin, _GPIOE, 10);
    ...
    alt_fn!(Pe10, super::sig::Dfsdm1Datain4, 6);
    alt_fn!(Pe10, super::sig::Uart7Cts, 8);
    alt_fn!(Pe10, super::sig::QuadspiBk2Io3, 10);
...
pin!(PE11, Pe11, GPIOE, Gpioe, _PE11, GpioPin, _GPIOE, 11);
    ...
    alt_fn!(Pe11, super::sig::Dfsdm1Ckin4, 6);
    alt_fn!(Pe11, super::sig::Sai2SdB, 10);
...
pin!(PE12, Pe12, GPIOE, Gpioe, _PE12, GpioPin, _GPIOE, 12);
    ...
    alt_fn!(Pe12, super::sig::Dfsdm1Datain5, 6);
    alt_fn!(Pe12, super::sig::Sai2SckB, 10);
...
pin!(PE13, Pe13, GPIOE, Gpioe, _PE13, GpioPin, _GPIOE, 13);
    ...
    alt_fn!(Pe13, super::sig::Dfsdm1Ckin5, 6);
    alt_fn!(Pe13, super::sig::Sai2FsB, 10);
...
pin!(PE14, Pe14, GPIOE, Gpioe, _PE14, GpioPin, _GPIOE, 14);
    ...
    alt_fn!(Pe14, super::sig::Sai2MckB, 10);
...
pin!(PF6, Pf6, GPIOF, Gpiof, _PF6, GpioPin, _GPIOF, 6);
    ...
    alt_fn!(Pf6, super::sig::QuadspiBk1Io3, 9);
...
pin!(PF7, Pf7, GPIOF, Gpiof, _PF7, GpioPin, _GPIOF, 7);
    ...
    alt_fn!(Pf7, super::sig::QuadspiBk1Io2, 9);
...
pin!(PF8, Pf8, GPIOF, Gpiof, _PF8, GpioPin, _GPIOF, 8);
    ...
    alt_fn!(Pf8, super::sig::Sai1SckB, 6);
    alt_fn!(Pf8, super::sig::Uart7Rts, 8);
    alt_fn!(Pf8, super::sig::Tim13Ch1, 9);
    alt_fn!(Pf8, super::sig::QuadspiBk1Io0, 10);
...
pin!(PF11, Pf11, GPIOF, Gpiof, _PF11, GpioPin, _GPIOF, 11);
    ...
    alt_fn!(Pf11, super::sig::Sai2SdB, 10);
...
pin!(PG6, Pg6, GPIOG, Gpiog, _PG6, GpioPin, _GPIOG, 6);
    alt_fn!(Pg6, super::sig::FmcNe3, 12);
...
pin!(PG7, Pg7, GPIOG, Gpiog, _PG7, GpioPin, _GPIOG, 7);
    alt_fn!(Pg7, super::sig::Sai1MclkA, 6);
    alt_fn!(Pg7, super::sig::Usart6Ck, 8);
    alt_fn!(Pg7, super::sig::FmcInt, 12);
...
pin!(PG11, Pg11, GPIOG, Gpiog, _PG11, GpioPin, _GPIOG, 11);
    alt_fn!(Pg11, super::sig::Spi1Sck, 5);
    alt_fn!(Pg11, super::sig::I2s1Ck, 5);
    alt_fn!(Pg11, super::sig::SpdifRx0, 7);
    alt_fn!(Pg11, super::sig::Sdmmc2D2, 10);
...
pin!(PG12, Pg12, GPIOG, Gpiog, _PG12, GpioPin, _GPIOG, 12);
    alt_fn!(Pg12, super::sig::Lptim1In1, 3);
    alt_fn!(Pg12, super::sig::Spi6Miso, 5);
    alt_fn!(Pg12, super::sig::SpdifRx1, 7);
    alt_fn!(Pg12, super::sig::Usart6Rts, 8);
    alt_fn!(Pg12, super::sig::LcdB4, 9);
    alt_fn!(Pg12, super::sig::Sdmmc2D3, 11);
...
pin!(PG13, Pg13, GPIOG, Gpiog, _PG13, GpioPin, _GPIOG, 13);
    alt_fn!(Pg13, super::sig::Traced0, 0);
    alt_fn!(Pg13, super::sig::Lptim1Out, 3);
    alt_fn!(Pg13, super::sig::Spi6Sck, 5);
...
pin!(PH2, Ph2, GPIOH, Gpioh, _PH2, GpioPin, _GPIOH, 2);
    alt_fn!(Ph2, super::sig::Lptim1In2, 3);
    alt_fn!(Ph2, super::sig::QuadspiBk2Io0, 9);
    alt_fn!(Ph2, super::sig::Sai2SckB, 10);
...
pin!(PH3, Ph3, GPIOH, Gpioh, _PH3, GpioPin, _GPIOH, 3);
    alt_fn!(Ph3, super::sig::QuadspiBk2Io1, 9);
    alt_fn!(Ph3, super::sig::Sai2MckB, 10);
...
pin!(PH4, Ph4, GPIOH, Gpioh, _PH4, GpioPin, _GPIOH, 4);
    ...
    alt_fn!(Ph4, super::sig::LcdG5, 9);
    alt_fn!(Ph4, super::sig::OtgHsUlpiNxt, 10);
    alt_fn!(Ph4, super::sig::LcdG4, 14);
...
pin!(PH10, Ph10, GPIOH, Gpioh, _PH10, GpioPin, _GPIOH, 10);
    ...
    alt_fn!(Ph10, super::sig::I2c4Smba, 4);
...
pin!(PH11, Ph11, GPIOH, Gpioh, _PH11, GpioPin, _GPIOH, 11);
    ...
    alt_fn!(Ph11, super::sig::I2c4Scl, 4);
...
pin!(PH12, Ph12, GPIOH, Gpioh, _PH12, GpioPin, _GPIOH, 12);
    ...
    alt_fn!(Ph12, super::sig::I2c4Sda, 4);
...
pin!(PH13, Ph13, GPIOH, Gpioh, _PH13, GpioPin, _GPIOH, 13);
    ...
    alt_fn!(Ph13, super::sig::Uart4Tx, 8);
...
pin!(PH14, Ph14, GPIOH, Gpioh, _PH14, GpioPin, _GPIOH, 14);
    ...
    alt_fn!(Ph14, super::sig::Uart4Rx, 8);
    alt_fn!(Ph14, super::sig::Can1Rx, 9);
...
pin!(PI1, Pi1, GPIOI, Gpioi, _PI1, GpioPin, _GPIOI, 1);
    alt_fn!(Pi1, super::sig::Tim8Bkin2, 3);
...
pin!(PI4, Pi4, GPIOI, Gpioi, _PI4, GpioPin, _GPIOI, 4);
    ...
    alt_fn!(Pi4, super::sig::Sai2MckA, 10);
...
pin!(PI5, Pi5, GPIOI, Gpioi, _PI5, GpioPin, _GPIOI, 5);
    ...
    alt_fn!(Pi5, super::sig::Sai2SckA, 10);
...
pin!(PI6, Pi6, GPIOI, Gpioi, _PI6, GpioPin, _GPIOI, 6);
    ...
    alt_fn!(Pi6, super::sig::Sai2SdA, 10);
...
pin!(PI7, Pi7, GPIOI, Gpioi, _PI7, GpioPin, _GPIOI, 7);
    ...
    alt_fn!(Pi7, super::sig::Sai2FsA, 10);
...
pin!(PI9, Pi9, GPIOI, Gpioi, _PI9, GpioPin, _GPIOI, 9);
    alt_fn!(Pi9, super::sig::Uart4Rx, 8);
