...
irq!(IRQ_UART7, IrqUart7, 82);
irq!(IRQ_UART8, IrqUart8, 83);
...
pub static mut INTERRUPT_HANDLERS: [Option<Handler>; 98] = [
    ...
    None,
    None,
    None,                          // IRQ 49: SDMMC1 global interrupt
    ...
    None,
    None,
    None,                          // IRQ 78: DCMI global interrupt
    None,
    None,
    None,
    ...
    None,
    None,                          // IRQ 88: LTDC global interrupt
    None,                          // IRQ 89: LTDC Error global interrupt
    None,                          // IRQ 90: DMA2D global interrupt
    None,
    None,
    None,                          // IRQ 93: LP TIM1 interrupt
    None,
    None,                          // IRQ 95: I2C4 event interrupt
    None,                          // IRQ 96: I2C4 error interrupt
    None,
];
