...
impl Rcc {
    ...
    #[inline] pub fn pllsaicfgr(&self) -> Pllsaicfgr { 
        unsafe {
            read_volatile(self.pllsaicfgr_ptr())
        }
    }
    ...
    #[inline] pub fn set_pllsaicfgr<F: FnOnce(Pllsaicfgr) -> Pllsaicfgr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.pllsaicfgr_mut(), f(Pllsaicfgr(0)));
        }
        self
    }
    ...
    #[inline] pub fn with_pllsaicfgr<F: FnOnce(Pllsaicfgr) -> Pllsaicfgr>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.pllsaicfgr_mut(), f(self.pllsaicfgr()));
        }
        self
    }

    #[doc="Get the *mut pointer for the DKCFGR1 register."]
    #[inline] pub fn dkcfgr1_mut(&self) -> *mut Dkcfgr1 { 
        (self.0 + 0x8c) as *mut Dkcfgr1
    }

    #[doc="Get the *const pointer for the DKCFGR1 register."]
    #[inline] pub fn dkcfgr1_ptr(&self) -> *const Dkcfgr1 { 
           self.dkcfgr1_mut()
    }

    #[doc="Read the DKCFGR1 register."]
    #[inline] pub fn dkcfgr1(&self) -> Dkcfgr1 { 
        unsafe {
            read_volatile(self.dkcfgr1_ptr())
        }
    }

    #[doc="Write the DKCFGR1 register."]
    #[inline] pub fn set_dkcfgr1<F: FnOnce(Dkcfgr1) -> Dkcfgr1>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.dkcfgr1_mut(), f(Dkcfgr1(0)));
        }
        self
    }

    #[doc="Modify the DKCFGR1 register."]
    #[inline] pub fn with_dkcfgr1<F: FnOnce(Dkcfgr1) -> Dkcfgr1>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.dkcfgr1_mut(), f(self.dkcfgr1()));
        }
        self
    }

    #[doc="Get the *mut pointer for the DKCFGR2 register."]
    #[inline] pub fn dkcfgr2_mut(&self) -> *mut Dkcfgr2 { 
        (self.0 + 0x90) as *mut Dkcfgr2
    }

    #[doc="Get the *const pointer for the DKCFGR2 register."]
    #[inline] pub fn dkcfgr2_ptr(&self) -> *const Dkcfgr2 { 
           self.dkcfgr2_mut()
    }

    #[doc="Read the DKCFGR2 register."]
    #[inline] pub fn dkcfgr2(&self) -> Dkcfgr2 { 
        unsafe {
            read_volatile(self.dkcfgr2_ptr())
        }
    }

    #[doc="Write the DKCFGR2 register."]
    #[inline] pub fn set_dkcfgr2<F: FnOnce(Dkcfgr2) -> Dkcfgr2>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.dkcfgr2_mut(), f(Dkcfgr2(0)));
        }
        self
    }

    #[doc="Modify the DKCFGR2 register."]
    #[inline] pub fn with_dkcfgr2<F: FnOnce(Dkcfgr2) -> Dkcfgr2>(&self, f: F) -> &Self {
        unsafe {
            write_volatile(self.dkcfgr2_mut(), f(self.dkcfgr2()));
        }
        self
    }
...
impl Ahb2rstr {
    ...
    #[inline] pub fn hsahrst(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 5) & 0x1) as u8) } // [5]
    }
    ...
    #[inline] pub fn set_hsahrst<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 5);
        self.0 |= value << 5;
...
impl Apb1enr {
    ...
    #[inline] pub fn lptmi1en(&self) -> bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 9) & 0x1) as u8) } // [9]
    }

    #[doc="Returns true if LPTMI1EN != 0"]
    #[inline] pub fn test_lptmi1en(&self) -> bool {
        self.lptmi1en() != 0
    }

    #[doc="Sets the LPTMI1EN field."]
    #[inline] pub fn set_lptmi1en<V: Into<bits::U1>>(mut self, value: V) -> Self {
        let value: bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 9);
        self.0 |= value << 9;
...
impl ::core::fmt::Debug for Apb1enr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        if self.lptmi1en() != 0 { try!(write!(f, " lptmi1en"))}
...
impl ::core::fmt::Display for Dkcfgr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for Dkcfgr1 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
...
impl ::core::fmt::Display for Dkcfgr2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for Dkcfgr2 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
...
impl En for super::usb_fs_device::UsbFsDevice {
    #[inline] fn en(&self) -> u32 { RCC.ahb2enr().otgfsen().into() }
    #[inline] fn set_en(&self, value: u32) { RCC.with_ahb2enr(|r| r.set_otgfsen(value)); }
}

impl En for super::usb_fs_host::UsbFsHost {
    #[inline] fn en(&self) -> u32 { RCC.ahb2enr().otgfsen().into() }
    #[inline] fn set_en(&self, value: u32) { RCC.with_ahb2enr(|r| r.set_otgfsen(value)); }
}
