...
::bobbin_mcu::irq_number!(IRQ_91, Irq91, 91);
::bobbin_mcu::irq_number!(IRQ_92, Irq92, 92);
::bobbin_mcu::irq_number!(IRQ_93, Irq93, 93);
::bobbin_mcu::irq_number!(IRQ_94, Irq94, 94);
::bobbin_mcu::irq_number!(IRQ_95, Irq95, 95);
::bobbin_mcu::irq_number!(IRQ_96, Irq96, 96);
...
#[no_mangle]
pub static mut INTERRUPTS: [Option<Handler>; 98] = [
    Some(IRQ_0_HANDLER),
    Some(IRQ_1_HANDLER),
    Some(IRQ_2_HANDLER),
    Some(IRQ_3_HANDLER),
...
::bobbin_mcu::irq_type!(IRQ_DCMI, IrqDcmi);
...
::bobbin_mcu::irq!(::dcmi::Dcmi, ::bobbin_mcu::irq::IrqMain, Irq78);
::bobbin_mcu::irq!(::dcmi::Dcmi, IrqDcmi, Irq78);
::bobbin_mcu::irq!(::usb_fs_global::UsbFsGlobal, ::bobbin_mcu::irq::IrqMain, Irq42);
::bobbin_mcu::irq!(::usb_fs_global::UsbFsGlobal, IrqUsbFsGlobal, Irq42);
::bobbin_mcu::irq!(::usb_fs_global::UsbFsGlobal, IrqUsb, Irq67);
::bobbin_mcu::irq_type!(IRQ_USB_FS_GLOBAL, IrqUsbFsGlobal);
...
::bobbin_mcu::irq!(::lptim::Lptim1, ::bobbin_mcu::irq::IrqMain, Irq93);
::bobbin_mcu::irq!(::lptim::Lptim1, IrqLptim, Irq93);
...
::bobbin_mcu::irq!(::i2c::I2c4, ::bobbin_mcu::irq::IrqMain, Irq95);
::bobbin_mcu::irq!(::i2c::I2c4, IrqI2cEv, Irq95);
::bobbin_mcu::irq!(::i2c::I2c4, IrqI2cEr, Irq96);
...
::bobbin_mcu::irq!(::ethernet_dma::EthernetDma, ::bobbin_mcu::irq::IrqMain, Irq61);
::bobbin_mcu::irq!(::sdmmc::Sdmmc, ::bobbin_mcu::irq::IrqMain, Irq49);
::bobbin_mcu::irq!(::ltdc::Ltdc, ::bobbin_mcu::irq::IrqMain, Irq88);
::bobbin_mcu::irq!(::dma2d::Dma2d, ::bobbin_mcu::irq::IrqMain, Irq90);
