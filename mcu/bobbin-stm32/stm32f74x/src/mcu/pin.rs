...
pin!(PH3, Ph3, ph3, GPIOH, Gpioh, PH3_PIN, GpioPin, GPIOH_PERIPH, PH3_OWNED, PH3_REF_COUNT, 3);
pin!(PH4, Ph4, ph4, GPIOH, Gpioh, PH4_PIN, GpioPin, GPIOH_PERIPH, PH4_OWNED, PH4_REF_COUNT, 4);
   pin_source!(Ph4, super::i2c::I2c2, super::sig::SigI2cScl, 4);
pin!(PH5, Ph5, ph5, GPIOH, Gpioh, PH5_PIN, GpioPin, GPIOH_PERIPH, PH5_OWNED, PH5_REF_COUNT, 5);
   pin_source!(Ph5, super::i2c::I2c2, super::sig::SigI2cSda, 4);
   pin_source!(Ph5, super::spi::Spi5, super::sig::SigSpiNss, 5);
pin!(PH6, Ph6, ph6, GPIOH, Gpioh, PH6_PIN, GpioPin, GPIOH_PERIPH, PH6_OWNED, PH6_REF_COUNT, 6);
...
pin!(PH7, Ph7, ph7, GPIOH, Gpioh, PH7_PIN, GpioPin, GPIOH_PERIPH, PH7_OWNED, PH7_REF_COUNT, 7);
...
pin!(PH8, Ph8, ph8, GPIOH, Gpioh, PH8_PIN, GpioPin, GPIOH_PERIPH, PH8_OWNED, PH8_REF_COUNT, 8);
   pin_source!(Ph8, super::i2c::I2c3, super::sig::SigI2cSda, 4);
   pin_source!(Ph8, super::dcmi::Dcmi, super::sig::SigDcmiHsync, 13);
pin!(PH9, Ph9, ph9, GPIOH, Gpioh, PH9_PIN, GpioPin, GPIOH_PERIPH, PH9_OWNED, PH9_REF_COUNT, 9);
   pin_source!(Ph9, super::tim_gen::Tim12Ch2, super::sig::SigTim, 9);
   pin_source!(Ph9, super::dcmi::Dcmi, super::sig::SigDcmiD0, 13);
pin!(PH10, Ph10, ph10, GPIOH, Gpioh, PH10_PIN, GpioPin, GPIOH_PERIPH, PH10_OWNED, PH10_REF_COUNT, 10);
   pin_source!(Ph10, super::tim_gen::Tim5Ch1, super::sig::SigTim, 2);
   pin_source!(Ph10, super::dcmi::Dcmi, super::sig::SigDcmiD1, 13);
pin!(PH11, Ph11, ph11, GPIOH, Gpioh, PH11_PIN, GpioPin, GPIOH_PERIPH, PH11_OWNED, PH11_REF_COUNT, 11);
...
pin!(PH12, Ph12, ph12, GPIOH, Gpioh, PH12_PIN, GpioPin, GPIOH_PERIPH, PH12_OWNED, PH12_REF_COUNT, 12);
...
pin!(PH13, Ph13, ph13, GPIOH, Gpioh, PH13_PIN, GpioPin, GPIOH_PERIPH, PH13_OWNED, PH13_REF_COUNT, 13);
   pin_source!(Ph13, super::usart::Uart4, super::sig::SigUsartTx, 8);
   pin_source!(Ph13, super::can::Can1, super::sig::SigCanTx, 9);
pin!(PH14, Ph14, ph14, GPIOH, Gpioh, PH14_PIN, GpioPin, GPIOH_PERIPH, PH14_OWNED, PH14_REF_COUNT, 14);
...
pin!(PH15, Ph15, ph15, GPIOH, Gpioh, PH15_PIN, GpioPin, GPIOH_PERIPH, PH15_OWNED, PH15_REF_COUNT, 15);
   pin_source!(Ph15, super::dcmi::Dcmi, super::sig::SigDcmiD11, 13);
pin!(PI0, Pi0, pi0, GPIOI, Gpioi, PI0_PIN, GpioPin, GPIOI_PERIPH, PI0_OWNED, PI0_REF_COUNT, 0);
...
pin!(PI1, Pi1, pi1, GPIOI, Gpioi, PI1_PIN, GpioPin, GPIOI_PERIPH, PI1_OWNED, PI1_REF_COUNT, 1);
   pin_source!(Pi1, super::spi::Spi2, super::sig::SigSpiSck, 5);
   pin_source!(Pi1, super::dcmi::Dcmi, super::sig::SigDcmiD8, 13);
pin!(PI2, Pi2, pi2, GPIOI, Gpioi, PI2_PIN, GpioPin, GPIOI_PERIPH, PI2_OWNED, PI2_REF_COUNT, 2);
...
pin!(PI3, Pi3, pi3, GPIOI, Gpioi, PI3_PIN, GpioPin, GPIOI_PERIPH, PI3_OWNED, PI3_REF_COUNT, 3);
   pin_source!(Pi3, super::spi::Spi2, super::sig::SigSpiMosi, 5);
   pin_source!(Pi3, super::dcmi::Dcmi, super::sig::SigDcmiD10, 13);
pin!(PI4, Pi4, pi4, GPIOI, Gpioi, PI4_PIN, GpioPin, GPIOI_PERIPH, PI4_OWNED, PI4_REF_COUNT, 4);
   pin_source!(Pi4, super::dcmi::Dcmi, super::sig::SigDcmiD5, 13);
pin!(PI5, Pi5, pi5, GPIOI, Gpioi, PI5_PIN, GpioPin, GPIOI_PERIPH, PI5_OWNED, PI5_REF_COUNT, 5);
   pin_source!(Pi5, super::tim_adv::Tim8Ch1, super::sig::SigTim, 3);
   pin_source!(Pi5, super::dcmi::Dcmi, super::sig::SigDcmiVsync, 13);
pin!(PI6, Pi6, pi6, GPIOI, Gpioi, PI6_PIN, GpioPin, GPIOI_PERIPH, PI6_OWNED, PI6_REF_COUNT, 6);
   pin_source!(Pi6, super::tim_adv::Tim8Ch2, super::sig::SigTim, 3);
   pin_source!(Pi6, super::dcmi::Dcmi, super::sig::SigDcmiD6, 13);
pin!(PI7, Pi7, pi7, GPIOI, Gpioi, PI7_PIN, GpioPin, GPIOI_PERIPH, PI7_OWNED, PI7_REF_COUNT, 7);
   pin_source!(Pi7, super::tim_adv::Tim8Ch3, super::sig::SigTim, 3);
   pin_source!(Pi7, super::dcmi::Dcmi, super::sig::SigDcmiD7, 13);
pin!(PI8, Pi8, pi8, GPIOI, Gpioi, PI8_PIN, GpioPin, GPIOI_PERIPH, PI8_OWNED, PI8_REF_COUNT, 8);
pin!(PI9, Pi9, pi9, GPIOI, Gpioi, PI9_PIN, GpioPin, GPIOI_PERIPH, PI9_OWNED, PI9_REF_COUNT, 9);
   pin_source!(Pi9, super::usart::Uart4, super::sig::SigUsartRx, 8);
   pin_source!(Pi9, super::can::Can1, super::sig::SigCanRx, 9);
pin!(PI10, Pi10, pi10, GPIOI, Gpioi, PI10_PIN, GpioPin, GPIOI_PERIPH, PI10_OWNED, PI10_REF_COUNT, 10);
pin!(PI11, Pi11, pi11, GPIOI, Gpioi, PI11_PIN, GpioPin, GPIOI_PERIPH, PI11_OWNED, PI11_REF_COUNT, 11);
pin!(PI12, Pi12, pi12, GPIOI, Gpioi, PI12_PIN, GpioPin, GPIOI_PERIPH, PI12_OWNED, PI12_REF_COUNT, 12);
pin!(PI13, Pi13, pi13, GPIOI, Gpioi, PI13_PIN, GpioPin, GPIOI_PERIPH, PI13_OWNED, PI13_REF_COUNT, 13);
pin!(PI14, Pi14, pi14, GPIOI, Gpioi, PI14_PIN, GpioPin, GPIOI_PERIPH, PI14_OWNED, PI14_REF_COUNT, 14);
pin!(PI15, Pi15, pi15, GPIOI, Gpioi, PI15_PIN, GpioPin, GPIOI_PERIPH, PI15_OWNED, PI15_REF_COUNT, 15);
pin!(PJ0, Pj0, pj0, GPIOJ, Gpioj, PJ0_PIN, GpioPin, GPIOJ_PERIPH, PJ0_OWNED, PJ0_REF_COUNT, 0);
pin!(PJ1, Pj1, pj1, GPIOJ, Gpioj, PJ1_PIN, GpioPin, GPIOJ_PERIPH, PJ1_OWNED, PJ1_REF_COUNT, 1);
pin!(PJ2, Pj2, pj2, GPIOJ, Gpioj, PJ2_PIN, GpioPin, GPIOJ_PERIPH, PJ2_OWNED, PJ2_REF_COUNT, 2);
pin!(PJ3, Pj3, pj3, GPIOJ, Gpioj, PJ3_PIN, GpioPin, GPIOJ_PERIPH, PJ3_OWNED, PJ3_REF_COUNT, 3);
pin!(PJ4, Pj4, pj4, GPIOJ, Gpioj, PJ4_PIN, GpioPin, GPIOJ_PERIPH, PJ4_OWNED, PJ4_REF_COUNT, 4);
pin!(PJ5, Pj5, pj5, GPIOJ, Gpioj, PJ5_PIN, GpioPin, GPIOJ_PERIPH, PJ5_OWNED, PJ5_REF_COUNT, 5);
pin!(PJ6, Pj6, pj6, GPIOJ, Gpioj, PJ6_PIN, GpioPin, GPIOJ_PERIPH, PJ6_OWNED, PJ6_REF_COUNT, 6);
pin!(PJ7, Pj7, pj7, GPIOJ, Gpioj, PJ7_PIN, GpioPin, GPIOJ_PERIPH, PJ7_OWNED, PJ7_REF_COUNT, 7);
pin!(PJ8, Pj8, pj8, GPIOJ, Gpioj, PJ8_PIN, GpioPin, GPIOJ_PERIPH, PJ8_OWNED, PJ8_REF_COUNT, 8);
pin!(PJ9, Pj9, pj9, GPIOJ, Gpioj, PJ9_PIN, GpioPin, GPIOJ_PERIPH, PJ9_OWNED, PJ9_REF_COUNT, 9);
pin!(PJ10, Pj10, pj10, GPIOJ, Gpioj, PJ10_PIN, GpioPin, GPIOJ_PERIPH, PJ10_OWNED, PJ10_REF_COUNT, 10);
pin!(PJ11, Pj11, pj11, GPIOJ, Gpioj, PJ11_PIN, GpioPin, GPIOJ_PERIPH, PJ11_OWNED, PJ11_REF_COUNT, 11);
pin!(PJ12, Pj12, pj12, GPIOJ, Gpioj, PJ12_PIN, GpioPin, GPIOJ_PERIPH, PJ12_OWNED, PJ12_REF_COUNT, 12);
pin!(PJ13, Pj13, pj13, GPIOJ, Gpioj, PJ13_PIN, GpioPin, GPIOJ_PERIPH, PJ13_OWNED, PJ13_REF_COUNT, 13);
pin!(PJ14, Pj14, pj14, GPIOJ, Gpioj, PJ14_PIN, GpioPin, GPIOJ_PERIPH, PJ14_OWNED, PJ14_REF_COUNT, 14);
pin!(PJ15, Pj15, pj15, GPIOJ, Gpioj, PJ15_PIN, GpioPin, GPIOJ_PERIPH, PJ15_OWNED, PJ15_REF_COUNT, 15);
pin!(PK0, Pk0, pk0, GPIOK, Gpiok, PK0_PIN, GpioPin, GPIOK_PERIPH, PK0_OWNED, PK0_REF_COUNT, 0);
pin!(PK1, Pk1, pk1, GPIOK, Gpiok, PK1_PIN, GpioPin, GPIOK_PERIPH, PK1_OWNED, PK1_REF_COUNT, 1);
pin!(PK2, Pk2, pk2, GPIOK, Gpiok, PK2_PIN, GpioPin, GPIOK_PERIPH, PK2_OWNED, PK2_REF_COUNT, 2);
pin!(PK3, Pk3, pk3, GPIOK, Gpiok, PK3_PIN, GpioPin, GPIOK_PERIPH, PK3_OWNED, PK3_REF_COUNT, 3);
pin!(PK4, Pk4, pk4, GPIOK, Gpiok, PK4_PIN, GpioPin, GPIOK_PERIPH, PK4_OWNED, PK4_REF_COUNT, 4);
pin!(PK5, Pk5, pk5, GPIOK, Gpiok, PK5_PIN, GpioPin, GPIOK_PERIPH, PK5_OWNED, PK5_REF_COUNT, 5);
pin!(PK6, Pk6, pk6, GPIOK, Gpiok, PK6_PIN, GpioPin, GPIOK_PERIPH, PK6_OWNED, PK6_REF_COUNT, 6);
pin!(PK7, Pk7, pk7, GPIOK, Gpiok, PK7_PIN, GpioPin, GPIOK_PERIPH, PK7_OWNED, PK7_REF_COUNT, 7);
