...
channel!(TIM2_CH1, Tim2Ch1, TIM2, Tim2, TIM2_CH1_CH, TimGenCh, TIM2_PERIPH, TIM2_CH1_OWNED, 0);
channel!(TIM2_CH2, Tim2Ch2, TIM2, Tim2, TIM2_CH2_CH, TimGenCh, TIM2_PERIPH, TIM2_CH2_OWNED, 1);
channel!(TIM2_CH3, Tim2Ch3, TIM2, Tim2, TIM2_CH3_CH, TimGenCh, TIM2_PERIPH, TIM2_CH3_OWNED, 2);
channel!(TIM2_CH4, Tim2Ch4, TIM2, Tim2, TIM2_CH4_CH, TimGenCh, TIM2_PERIPH, TIM2_CH4_OWNED, 3);
channel!(TIM3_CH1, Tim3Ch1, TIM3, Tim3, TIM3_CH1_CH, TimGenCh, TIM3_PERIPH, TIM3_CH1_OWNED, 0);
channel!(TIM3_CH2, Tim3Ch2, TIM3, Tim3, TIM3_CH2_CH, TimGenCh, TIM3_PERIPH, TIM3_CH2_OWNED, 1);
channel!(TIM3_CH3, Tim3Ch3, TIM3, Tim3, TIM3_CH3_CH, TimGenCh, TIM3_PERIPH, TIM3_CH3_OWNED, 2);
channel!(TIM3_CH4, Tim3Ch4, TIM3, Tim3, TIM3_CH4_CH, TimGenCh, TIM3_PERIPH, TIM3_CH4_OWNED, 3);
channel!(TIM4_CH1, Tim4Ch1, TIM4, Tim4, TIM4_CH1_CH, TimGenCh, TIM4_PERIPH, TIM4_CH1_OWNED, 0);
channel!(TIM4_CH2, Tim4Ch2, TIM4, Tim4, TIM4_CH2_CH, TimGenCh, TIM4_PERIPH, TIM4_CH2_OWNED, 1);
channel!(TIM4_CH3, Tim4Ch3, TIM4, Tim4, TIM4_CH3_CH, TimGenCh, TIM4_PERIPH, TIM4_CH3_OWNED, 2);
channel!(TIM4_CH4, Tim4Ch4, TIM4, Tim4, TIM4_CH4_CH, TimGenCh, TIM4_PERIPH, TIM4_CH4_OWNED, 3);
channel!(TIM5_CH1, Tim5Ch1, TIM5, Tim5, TIM5_CH1_CH, TimGenCh, TIM5_PERIPH, TIM5_CH1_OWNED, 0);
channel!(TIM5_CH2, Tim5Ch2, TIM5, Tim5, TIM5_CH2_CH, TimGenCh, TIM5_PERIPH, TIM5_CH2_OWNED, 1);
channel!(TIM5_CH3, Tim5Ch3, TIM5, Tim5, TIM5_CH3_CH, TimGenCh, TIM5_PERIPH, TIM5_CH3_OWNED, 2);
channel!(TIM5_CH4, Tim5Ch4, TIM5, Tim5, TIM5_CH4_CH, TimGenCh, TIM5_PERIPH, TIM5_CH4_OWNED, 3);
channel!(TIM9_CH1, Tim9Ch1, TIM9, Tim9, TIM9_CH1_CH, TimGenCh, TIM9_PERIPH, TIM9_CH1_OWNED, 0);
channel!(TIM9_CH2, Tim9Ch2, TIM9, Tim9, TIM9_CH2_CH, TimGenCh, TIM9_PERIPH, TIM9_CH2_OWNED, 1);
channel!(TIM10_CH1, Tim10Ch1, TIM10, Tim10, TIM10_CH1_CH, TimGenCh, TIM10_PERIPH, TIM10_CH1_OWNED, 0);
channel!(TIM11_CH1, Tim11Ch1, TIM11, Tim11, TIM11_CH1_CH, TimGenCh, TIM11_PERIPH, TIM11_CH1_OWNED, 0);
channel!(TIM12_CH1, Tim12Ch1, TIM12, Tim12, TIM12_CH1_CH, TimGenCh, TIM12_PERIPH, TIM12_CH1_OWNED, 0);
channel!(TIM12_CH2, Tim12Ch2, TIM12, Tim12, TIM12_CH2_CH, TimGenCh, TIM12_PERIPH, TIM12_CH2_OWNED, 1);
channel!(TIM13_CH1, Tim13Ch1, TIM13, Tim13, TIM13_CH1_CH, TimGenCh, TIM13_PERIPH, TIM13_CH1_OWNED, 0);
channel!(TIM14_CH1, Tim14Ch1, TIM14, Tim14, TIM14_CH1_CH, TimGenCh, TIM14_PERIPH, TIM14_CH1_OWNED, 0);
