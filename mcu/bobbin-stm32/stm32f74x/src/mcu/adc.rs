...
periph!( ADC1, Adc1, ADC1_PERIPH, AdcPeriph, 0x40012000, 0x00, 0x2b);
periph!( ADC2, Adc2, ADC2_PERIPH, AdcPeriph, 0x40012100, 0x01, 0x2c);
periph!( ADC3, Adc3, ADC3_PERIPH, AdcPeriph, 0x40012200, 0x02, 0x2d);
