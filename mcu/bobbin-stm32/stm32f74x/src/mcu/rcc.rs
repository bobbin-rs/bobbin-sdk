...
periph!( RCC, Rcc, RCC_PERIPH, RccPeriph, RCC_OWNED, RCC_REF_COUNT, 0x40023800, 0x00, 0x00);
...
impl En for super::usb_fs_device::UsbFsDevice {
    #[inline] fn en(&self) -> bits::U1 { RCC.ahb2enr().otgfsen() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_ahb2enr(|r| r.set_otgfsen(value)); }
}
...
impl En for super::dcmi::Dcmi {
    #[inline] fn en(&self) -> bits::U1 { RCC.ahb2enr().dcmien() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_ahb2enr(|r| r.set_dcmien(value)); }
}

impl En for super::usart::Uart8 {
    #[inline] fn en(&self) -> bits::U1 { RCC.apb1enr().uart8en() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_apb1enr(|r| r.set_uart8en(value)); }
}

impl En for super::usart::Uart7 {
    #[inline] fn en(&self) -> bits::U1 { RCC.apb1enr().uart7en() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_apb1enr(|r| r.set_uart7en(value)); }
}

impl En for super::can::Can2 {
    #[inline] fn en(&self) -> bits::U1 { RCC.apb1enr().can2en() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_apb1enr(|r| r.set_can2en(value)); }
}

impl En for super::can::Can1 {
    #[inline] fn en(&self) -> bits::U1 { RCC.apb1enr().can1en() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_apb1enr(|r| r.set_can1en(value)); }
}

impl En for super::i2c::I2c4 {
    #[inline] fn en(&self) -> bits::U1 { RCC.apb1enr().i2c4en() }
    #[inline] fn set_en<V: Into<bits::U1>>(&self, value: V) { RCC.with_apb1enr(|r| r.set_i2c4en(value)); }
}
