...
::bobbin_mcu::periph!( ETHERNET_PTP, EthernetPtp, ETHERNET_PTP_PERIPH, EthernetPtpPeriph, ETHERNET_PTP_OWNED, ETHERNET_PTP_REF_COUNT, 0x40028700, 0x00, 0x07);


// Gate { name: None, gate_type: Some("EN"), periph: Some("RCC"), register: Some("AHB1ENR"), field: Some("ETHMACPTPEN"), description: None }
impl ::bobbin_mcu::gate::GateEn for EthernetPtp {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1enr().ethmacptpen() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateSleepEn for EthernetPtp {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1lpenr().ethmacptplpen() }
    #[inline]
