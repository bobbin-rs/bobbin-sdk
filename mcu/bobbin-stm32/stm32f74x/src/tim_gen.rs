...
::bobbin_mcu::periph!( TIM2, Tim2, TIM2_PERIPH, TimGenPeriph, TIM2_OWNED, TIM2_REF_COUNT, 0x40000000, 0x00, 0x1e);
::bobbin_mcu::periph!( TIM3, Tim3, TIM3_PERIPH, TimGenPeriph, TIM3_OWNED, TIM3_REF_COUNT, 0x40000400, 0x01, 0x1f);
::bobbin_mcu::periph!( TIM4, Tim4, TIM4_PERIPH, TimGenPeriph, TIM4_OWNED, TIM4_REF_COUNT, 0x40000800, 0x02, 0x20);
::bobbin_mcu::periph!( TIM5, Tim5, TIM5_PERIPH, TimGenPeriph, TIM5_OWNED, TIM5_REF_COUNT, 0x40000c00, 0x03, 0x21);
::bobbin_mcu::periph!( TIM9, Tim9, TIM9_PERIPH, TimGenPeriph, TIM9_OWNED, TIM9_REF_COUNT, 0x40014000, 0x04, 0x22);
::bobbin_mcu::periph!( TIM10, Tim10, TIM10_PERIPH, TimGenPeriph, TIM10_OWNED, TIM10_REF_COUNT, 0x40014400, 0x05, 0x23);
::bobbin_mcu::periph!( TIM11, Tim11, TIM11_PERIPH, TimGenPeriph, TIM11_OWNED, TIM11_REF_COUNT, 0x40014800, 0x06, 0x24);
::bobbin_mcu::periph!( TIM12, Tim12, TIM12_PERIPH, TimGenPeriph, TIM12_OWNED, TIM12_REF_COUNT, 0x40001800, 0x07, 0x25);
::bobbin_mcu::periph!( TIM13, Tim13, TIM13_PERIPH, TimGenPeriph, TIM13_OWNED, TIM13_REF_COUNT, 0x40001c00, 0x08, 0x26);
::bobbin_mcu::periph!( TIM14, Tim14, TIM14_PERIPH, TimGenPeriph, TIM14_OWNED, TIM14_REF_COUNT, 0x40002000, 0x09, 0x27);
