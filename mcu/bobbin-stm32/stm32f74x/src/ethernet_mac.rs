...
::bobbin_mcu::periph!( ETHERNET_MAC, EthernetMac, ETHERNET_MAC_PERIPH, EthernetMacPeriph, ETHERNET_MAC_OWNED, ETHERNET_MAC_REF_COUNT, 0x40028000, 0x00, 0x05);


// Gate { name: None, gate_type: Some("RST"), periph: Some("RCC"), register: Some("AHB1RSTR"), field: Some("ETHMACRST"), description: None }
impl ::bobbin_mcu::gate::GateRst for EthernetMac {
    #[inline]
    fn gate_rst(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1rstr().ethmacrst() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateEn for EthernetMac {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1enr().ethmacen() }
    #[inline]
...
impl ::bobbin_mcu::gate::GateSleepEn for EthernetMac {
    #[inline]
    fn gate_sleep_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.ahb1lpenr().ethmaclpen() }
    #[inline]
...
impl EthernetMacPeriph {
    ...
    #[inline] pub fn macrwuffer_reg(&self) -> ::bobbin_mcu::register::Register<Macrwuffer> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Macrwuffer, 0x60)
    }
