...
::bobbin_mcu::periph!( QUADSPI, Quadspi, QUADSPI_PERIPH, QuadspiPeriph, QUADSPI_OWNED, QUADSPI_REF_COUNT, 0xa0001000, 0x00, 0x0a);
...
impl Cr {
    ...
    #[inline] pub fn fthres(&self) -> ::bobbin_bits::U5 {
    ...
    #[inline] pub fn set_fthres<V: Into<::bobbin_bits::U5>>(mut self, value: V) -> Self {
    ...
    #[inline] pub fn fsel(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_fsel<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 7);
        self.0 |= value << 7;
    ...
    #[doc="Dual-flash mode"]
    #[inline] pub fn dfm(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dfm<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 6);
        self.0 |= value << 6;
...
impl Sr {
    #[doc="FIFO level"]
    #[inline] pub fn flevel(&self) -> ::bobbin_bits::U7 {
    ...
    #[inline] pub fn set_flevel<V: Into<::bobbin_bits::U7>>(mut self, value: V) -> Self {
...
impl Ccr {
    ...
    #[inline] pub fn dhhc(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_dhhc<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 30);
        self.0 |= value << 30;
