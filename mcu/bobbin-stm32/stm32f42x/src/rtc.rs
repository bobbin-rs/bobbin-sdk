...
::bobbin_mcu::periph!( , Rtc, _PERIPH, RtcPeriph, _OWNED, _REF_COUNT, 0x00000000, 0x00, 0x0a);
...
impl RtcPeriph {
    ...
    #[doc="Get the CALIBR Register."]
    #[inline] pub fn calibr_reg(&self) -> ::bobbin_mcu::register::Register<Calibr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Calibr, 0x18)
    }

    #[doc="Get the *mut pointer for the CALIBR register."]
    #[inline] pub fn calibr_mut(&self) -> *mut Calibr { 
        self.calibr_reg().ptr()
    }

    #[doc="Get the *const pointer for the CALIBR register."]
    #[inline] pub fn calibr_ptr(&self) -> *const Calibr { 
        self.calibr_reg().ptr()
    }

    #[doc="Read the CALIBR register."]
    #[inline] pub fn calibr(&self) -> Calibr { 
        self.calibr_reg().read()
    }

    #[doc="Write the CALIBR register."]
    #[inline] pub fn write_calibr(&self, value: Calibr) -> &Self { 
        self.calibr_reg().write(value);
        self
    }

    #[doc="Set the CALIBR register."]
    #[inline] pub fn set_calibr<F: FnOnce(Calibr) -> Calibr>(&self, f: F) -> &Self {
        self.calibr_reg().set(f);
        self
    }

    #[doc="Modify the CALIBR register."]
    #[inline] pub fn with_calibr<F: FnOnce(Calibr) -> Calibr>(&self, f: F) -> &Self {
        self.calibr_reg().with(f);
        self
    }
    ...
    #[inline] pub fn tafcr_reg(&self) -> ::bobbin_mcu::register::Register<Tafcr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Tafcr, 0x40)
    }
...
impl Cr {
    ...
    #[inline] pub fn dce(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 7) & 0x1) as u8) } // [7]
    }

    #[doc="Returns true if DCE != 0"]
    #[inline] pub fn test_dce(&self) -> bool {
        self.dce() != 0
    }

    #[doc="Sets the DCE field."]
    #[inline] pub fn set_dce<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 7);
        self.0 |= value << 7;
...
impl Calibr {
    ...
    #[inline] pub fn dcs(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 7) & 0x1) as u8) } // [7]
    }

    #[doc="Returns true if DCS != 0"]
    #[inline] pub fn test_dcs(&self) -> bool {
        self.dcs() != 0
    }

    #[doc="Sets the DCS field."]
    #[inline] pub fn set_dcs<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 7);
        self.0 |= value << 7;
    ...
    #[inline] pub fn dc(&self) -> ::bobbin_bits::U5 {
    ...
    #[inline] pub fn set_dc<V: Into<::bobbin_bits::U5>>(mut self, value: V) -> Self {
...
impl ::core::fmt::Display for Calibr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}
...
impl Tstr {
    ...
    #[inline] pub fn alarmouttype(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 18) & 0x1) as u8) } // [18]
    }

    #[doc="Returns true if ALARMOUTTYPE != 0"]
    #[inline] pub fn test_alarmouttype(&self) -> bool {
        self.alarmouttype() != 0
    }

    #[doc="Sets the ALARMOUTTYPE field."]
    #[inline] pub fn set_alarmouttype<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 18);
        self.0 |= value << 18;
    ...
    #[inline] pub fn tsinsel(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 17) & 0x1) as u8) } // [17]
    }

    #[doc="Returns true if TSINSEL != 0"]
    #[inline] pub fn test_tsinsel(&self) -> bool {
        self.tsinsel() != 0
    }

    #[doc="Sets the TSINSEL field."]
    #[inline] pub fn set_tsinsel<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 17);
        self.0 |= value << 17;
    ...
    #[doc="TAMPER1 mapping"]
    #[inline] pub fn tamp1insel(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0x1) as u8) } // [16]
    }

    #[doc="Returns true if TAMP1INSEL != 0"]
    #[inline] pub fn test_tamp1insel(&self) -> bool {
        self.tamp1insel() != 0
    }

    #[doc="Sets the TAMP1INSEL field."]
    #[inline] pub fn set_tamp1insel<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 16);
        self.0 |= value << 16;
...
impl ::core::fmt::Debug for Tstr {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.alarmouttype() != 0 { try!(write!(f, " alarmouttype"))}
        if self.tsinsel() != 0 { try!(write!(f, " tsinsel"))}
        if self.tamp1insel() != 0 { try!(write!(f, " tamp1insel"))}
