...
::bobbin_mcu::periph!( GPIOA, Gpioa, GPIOA_PERIPH, GpioPeriph, GPIOA_OWNED, GPIOA_REF_COUNT, 0x40020000, 0x00, 0x31);
::bobbin_mcu::periph!( GPIOB, Gpiob, GPIOB_PERIPH, GpioPeriph, GPIOB_OWNED, GPIOB_REF_COUNT, 0x40020400, 0x01, 0x32);
::bobbin_mcu::periph!( GPIOC, Gpioc, GPIOC_PERIPH, GpioPeriph, GPIOC_OWNED, GPIOC_REF_COUNT, 0x40020800, 0x02, 0x33);
::bobbin_mcu::periph!( GPIOD, Gpiod, GPIOD_PERIPH, GpioPeriph, GPIOD_OWNED, GPIOD_REF_COUNT, 0x40020c00, 0x03, 0x34);
::bobbin_mcu::periph!( GPIOE, Gpioe, GPIOE_PERIPH, GpioPeriph, GPIOE_OWNED, GPIOE_REF_COUNT, 0x40021000, 0x04, 0x35);
::bobbin_mcu::periph!( GPIOF, Gpiof, GPIOF_PERIPH, GpioPeriph, GPIOF_OWNED, GPIOF_REF_COUNT, 0x40021400, 0x05, 0x36);
::bobbin_mcu::periph!( GPIOG, Gpiog, GPIOG_PERIPH, GpioPeriph, GPIOG_OWNED, GPIOG_REF_COUNT, 0x40021800, 0x06, 0x37);
::bobbin_mcu::periph!( GPIOH, Gpioh, GPIOH_PERIPH, GpioPeriph, GPIOH_OWNED, GPIOH_REF_COUNT, 0x40021c00, 0x07, 0x38);
::bobbin_mcu::periph!( GPIOI, Gpioi, GPIOI_PERIPH, GpioPeriph, GPIOI_OWNED, GPIOI_REF_COUNT, 0x40022000, 0x08, 0x39);
::bobbin_mcu::periph!( GPIOJ, Gpioj, GPIOJ_PERIPH, GpioPeriph, GPIOJ_OWNED, GPIOJ_REF_COUNT, 0x40022400, 0x09, 0x3a);
::bobbin_mcu::periph!( GPIOK, Gpiok, GPIOK_PERIPH, GpioPeriph, GPIOK_OWNED, GPIOK_REF_COUNT, 0x40022800, 0x0a, 0x3b);
