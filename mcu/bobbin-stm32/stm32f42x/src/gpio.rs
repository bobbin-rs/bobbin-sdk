...
::bobbin_mcu::periph!( GPIOJ, Gpioj, GPIOJ_PERIPH, GpioPeriph, GPIOJ_OWNED, GPIOJ_REF_COUNT, 0x40022400, 0x09, 0x33);
::bobbin_mcu::periph!( GPIOK, Gpiok, GPIOK_PERIPH, GpioPeriph, GPIOK_OWNED, GPIOK_REF_COUNT, 0x40022800, 0x0a, 0x34);
