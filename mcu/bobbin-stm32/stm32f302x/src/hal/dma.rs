...
pub const DMA2_1: Channel = Channel(DMA2, 0);
pub const DMA2_2: Channel = Channel(DMA2, 1);
pub const DMA2_3: Channel = Channel(DMA2, 2);
pub const DMA2_4: Channel = Channel(DMA2, 3);
pub const DMA2_5: Channel = Channel(DMA2, 4);
pub const DMA2_6: Channel = Channel(DMA2, 5);
pub const DMA2_7: Channel = Channel(DMA2, 6);
