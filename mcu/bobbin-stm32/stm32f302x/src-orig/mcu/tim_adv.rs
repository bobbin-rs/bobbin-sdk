...
periph!( TIM1, Tim1, TIM1_PERIPH, TimAdvPeriph, 0x40012c00, 0x25);
periph!( TIM8, Tim8, TIM8_PERIPH, TimAdvPeriph, 0x40013400, 0x26);
periph!( TIM20, Tim20, TIM20_PERIPH, TimAdvPeriph, 0x40015000, 0x27);
