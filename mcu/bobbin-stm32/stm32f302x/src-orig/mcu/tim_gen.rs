...
periph!( TIM2, Tim2, TIM2_PERIPH, TimGenPeriph, 0x40000000, 0x1f);
periph!( TIM3, Tim3, TIM3_PERIPH, TimGenPeriph, 0x40000400, 0x20);
periph!( TIM4, Tim4, TIM4_PERIPH, TimGenPeriph, 0x40000800, 0x21);
periph!( TIM15, Tim15, TIM15_PERIPH, TimGenPeriph, 0x40014000, 0x22);
periph!( TIM16, Tim16, TIM16_PERIPH, TimGenPeriph, 0x40014400, 0x23);
periph!( TIM17, Tim17, TIM17_PERIPH, TimGenPeriph, 0x40014800, 0x24);
