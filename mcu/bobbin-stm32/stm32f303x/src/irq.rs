...
::bobbin_mcu::irq_type!(IRQ_TIM_BRK, IrqTimBrk);
::bobbin_mcu::irq_type!(IRQ_TIM_UP, IrqTimUp);
::bobbin_mcu::irq_type!(IRQ_TIM_TRG_COM, IrqTimTrgCom);
::bobbin_mcu::irq_type!(IRQ_TIM_CC, IrqTimCc);
