...
::bobbin_mcu::periph!( FLASH, Flash, FLASH_PERIPH, FlashPeriph, FLASH_OWNED, FLASH_REF_COUNT, 0x40022000, 0x00, 0x02);
...
impl FlashPeriph {
    ...
    #[inline] pub fn ar_reg(&self) -> ::bobbin_mcu::register::Register<Ar> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Ar, 0x14)
    }
    ...
    #[inline] pub fn obr_reg(&self) -> ::bobbin_mcu::register::Register<Obr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Obr, 0x1c)
    }
    ...
    #[inline] pub fn wrpr_reg(&self) -> ::bobbin_mcu::register::Register<Wrpr> { 
        ::bobbin_mcu::register::Register::new(self.0 as *mut Wrpr, 0x20)
    }
...
impl Acr {
    ...
    #[doc="PRFTBE"]
    #[inline] pub fn prftbe(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_prftbe<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
    ...
    #[doc="PRFTBS"]
    #[inline] pub fn prftbs(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_prftbs<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 5);
        self.0 |= value << 5;
...
impl Keyr {
    #[doc="Flash Key"]
    #[inline] pub fn fkeyr(&self) -> ::bobbin_bits::U32 {
    ...
    #[inline] pub fn set_fkeyr<V: Into<::bobbin_bits::U32>>(mut self, value: V) -> Self {
...
impl Sr {
    ...
    #[inline] pub fn wrprt(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 4) & 0x1) as u8) } // [4]
    }
    ...
    #[inline] pub fn set_wrprt<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 4);
        self.0 |= value << 4;
    ...
    #[inline] pub fn pgerr(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_pgerr<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
...
impl Cr {
    ...
    #[inline] pub fn force_optload(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_force_optload<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 13);
        self.0 |= value << 13;
    ...
    #[inline] pub fn optwre(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_optwre<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 9);
        self.0 |= value << 9;
    ...
    #[inline] pub fn opter(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 5) & 0x1) as u8) } // [5]
    }
    ...
    #[inline] pub fn set_opter<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 5);
        self.0 |= value << 5;
    ...
    #[inline] pub fn optpg(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 4) & 0x1) as u8) } // [4]
    }
    ...
    #[inline] pub fn set_optpg<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 4);
        self.0 |= value << 4;
...
impl Ar {
    #[doc="Flash address"]
    #[inline] pub fn far(&self) -> ::bobbin_bits::U32 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffffffff) as u32) } // [31:0]
    }
    ...
    #[inline] pub fn set_far<V: Into<::bobbin_bits::U32>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U32 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffffffff << 0);
        self.0 |= value << 0;
...
impl Obr {
    ...
    #[inline] pub fn opterr(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0x1) as u8) } // [0]
    }
    ...
    #[inline] pub fn set_opterr<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 0);
        self.0 |= value << 0;
    ...
    #[inline] pub fn level1_prot(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 1) & 0x1) as u8) } // [1]
    }
    ...
    #[inline] pub fn set_level1_prot<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 1);
        self.0 |= value << 1;
    ...
    #[inline] pub fn level2_prot(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 2) & 0x1) as u8) } // [2]
    }
    ...
    #[inline] pub fn set_level2_prot<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 2);
        self.0 |= value << 2;
    ...
    #[doc="BOOT1"]
    #[inline] pub fn boot1(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 12) & 0x1) as u8) } // [12]
    }
    ...
    #[inline] pub fn set_boot1<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 12);
        self.0 |= value << 12;
    ...
    #[doc="VDDA_MONITOR"]
    #[inline] pub fn vdda_monitor(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 13) & 0x1) as u8) } // [13]
    }
    ...
    #[inline] pub fn set_vdda_monitor<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 13);
        self.0 |= value << 13;
    ...
    #[inline] pub fn sram_parity_check(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_sram_parity_check<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 14);
        self.0 |= value << 14;
...
impl Wrpr {
    #[doc="Write protect"]
    #[inline] pub fn wrp(&self) -> ::bobbin_bits::U32 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffffffff) as u32) } // [31:0]
    }
    ...
    #[inline] pub fn set_wrp<V: Into<::bobbin_bits::U32>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U32 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffffffff << 0);
        self.0 |= value << 0;
