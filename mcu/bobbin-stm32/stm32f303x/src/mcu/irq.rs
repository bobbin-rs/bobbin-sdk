...
irq!(::tim_gen::Tim17, IrqTim, Irq26);
...
irq!(::tim_adv::Tim8, IrqTimBrk, Irq43);
irq!(::tim_adv::Tim8, IrqTimUp, Irq44);
irq!(::tim_adv::Tim8, IrqTrgCom, Irq45);
irq!(::tim_adv::Tim8, IrqTimCc, Irq46);
irq!(::tim_adv::Tim20, IrqTimAdv, Irq77);
irq!(::tim_adv::Tim20, IrqTimUp, Irq78);
irq!(::tim_adv::Tim20, IrqTimTrgCom, Irq79);
irq!(::tim_adv::Tim20, IrqTimCc, Irq80);
