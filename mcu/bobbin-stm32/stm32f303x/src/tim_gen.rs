...
::bobbin_mcu::periph!( TIM2, Tim2, TIM2_PERIPH, TimGenPeriph, TIM2_OWNED, TIM2_REF_COUNT, 0x40000000, 0x00, 0x25);
::bobbin_mcu::periph!( TIM3, Tim3, TIM3_PERIPH, TimGenPeriph, TIM3_OWNED, TIM3_REF_COUNT, 0x40000400, 0x01, 0x26);
::bobbin_mcu::periph!( TIM4, Tim4, TIM4_PERIPH, TimGenPeriph, TIM4_OWNED, TIM4_REF_COUNT, 0x40000800, 0x02, 0x27);
::bobbin_mcu::periph!( TIM15, Tim15, TIM15_PERIPH, TimGenPeriph, TIM15_OWNED, TIM15_REF_COUNT, 0x40014000, 0x03, 0x28);
::bobbin_mcu::periph!( TIM16, Tim16, TIM16_PERIPH, TimGenPeriph, TIM16_OWNED, TIM16_REF_COUNT, 0x40014400, 0x04, 0x29);
::bobbin_mcu::periph!( TIM17, Tim17, TIM17_PERIPH, TimGenPeriph, TIM17_OWNED, TIM17_REF_COUNT, 0x40014800, 0x05, 0x2a);
...
::bobbin_mcu::channel!(TIM17_CH1, Tim17Ch1, tim17_ch1, TIM17, Tim17, TIM17_CH1_CH, TimGenCh, TIM17_PERIPH, TIM17_CH1_OWNED, TIM17_CH1_REF_COUNT, 0);
...
impl ::bobbin_mcu::gate::GateRst for Tim17 {
    #[inline]
    fn gate_rst(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb2rstr().tim17rst() }
    #[inline]
    fn set_gate_rst<V: Into<::bobbin_bits::U1>>(&self, value: V) -> &Self {
...
impl ::bobbin_mcu::gate::GateEn for Tim17 {
    #[inline]
    fn gate_en(&self) -> ::bobbin_bits::U1 { ::rcc::RCC.apb2enr().tim17en() }
    #[inline]
    fn set_gate_en<V: Into<::bobbin_bits::U1>>(&self, value: V) -> &Self {
