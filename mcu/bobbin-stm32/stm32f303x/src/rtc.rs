...
::bobbin_mcu::periph!( RTC, Rtc, RTC_PERIPH, RtcPeriph, RTC_OWNED, RTC_REF_COUNT, 0x40002800, 0x00, 0x04);
...
impl RtcPeriph {
    ...
    #[inline] pub fn bkpr_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Bkpr, ::bobbin_bits::R32> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Bkpr, 0x50, 0x4)
    }

    #[doc="Get the *mut pointer for the BKPR register."]
    #[inline] pub fn bkpr_mut<I: Into<::bobbin_bits::R32>>(&self, index: I) -> *mut Bkpr { 
        self.bkpr_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the BKPR register."]
    #[inline] pub fn bkpr_ptr<I: Into<::bobbin_bits::R32>>(&self, index: I) -> *const Bkpr { 
        self.bkpr_reg().ptr(index.into())
    }

    #[doc="Read the BKPR register."]
    #[inline] pub fn bkpr<I: Into<::bobbin_bits::R32>>(&self, index: I) -> Bkpr { 
        self.bkpr_reg().read(index.into())
    }

    #[doc="Write the BKPR register."]
    #[inline] pub fn write_bkpr<I: Into<::bobbin_bits::R32>>(&self, index: I, value: Bkpr) -> &Self {
        self.bkpr_reg().write(index.into(), value);
        self
    }

    #[doc="Set the BKPR register."]
    #[inline] pub fn set_bkpr<I: Into<::bobbin_bits::R32>, F: FnOnce(Bkpr) -> Bkpr>(&self, index: I, f: F) -> &Self {
        self.bkpr_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the BKPR register."]
    #[inline] pub fn with_bkpr<I: Into<::bobbin_bits::R32> + Copy, F: FnOnce(Bkpr) -> Bkpr>(&self, index: I, f: F) -> &Self {
...
impl Tafcr {
    ...
    #[doc="PC13 value"]
    #[inline] pub fn pc13value(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 18) & 0x1) as u8) } // [18]
    }
    ...
    #[inline] pub fn set_pc13value<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 18);
        self.0 |= value << 18;
    ...
    #[doc="PC13 mode"]
    #[inline] pub fn pc13mode(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 19) & 0x1) as u8) } // [19]
    }
    ...
    #[inline] pub fn set_pc13mode<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 19);
        self.0 |= value << 19;
    ...
    #[doc="PC14 value"]
    #[inline] pub fn pc14value(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 20) & 0x1) as u8) } // [20]
    }
    ...
    #[inline] pub fn set_pc14value<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 20);
        self.0 |= value << 20;
    ...
    #[doc="PC 14 mode"]
    #[inline] pub fn pc14mode(&self) -> ::bobbin_bits::U1 {
    ...
    #[inline] pub fn set_pc14mode<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 21);
        self.0 |= value << 21;
    ...
    #[doc="PC15 value"]
    #[inline] pub fn pc15value(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 22) & 0x1) as u8) } // [22]
    }
    ...
    #[inline] pub fn set_pc15value<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 22);
        self.0 |= value << 22;
    ...
    #[doc="PC15 mode"]
    #[inline] pub fn pc15mode(&self) -> ::bobbin_bits::U1 {
        unsafe { ::core::mem::transmute(((self.0 >> 23) & 0x1) as u8) } // [23]
    }
    ...
    #[inline] pub fn set_pc15mode<V: Into<::bobbin_bits::U1>>(mut self, value: V) -> Self {
        let value: ::bobbin_bits::U1 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0x1 << 23);
        self.0 |= value << 23;
