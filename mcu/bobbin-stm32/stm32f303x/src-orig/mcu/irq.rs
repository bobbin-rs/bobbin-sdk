...
#[no_mangle]
pub static mut INTERRUPTS: [Option<Handler>; 82] = [
    Some(IRQ_0_HANDLER),
    Some(IRQ_1_HANDLER),
    Some(IRQ_2_HANDLER),
    Some(IRQ_3_HANDLER),
...
irq!(::exti::ExtiLine20, IrqExti, Irq3);
irq!(::exti::ExtiLine21, IrqExti, Irq64);
irq!(::exti::ExtiLine22, IrqExti, Irq64);
irq!(::exti::ExtiLine23, IrqExti, Irq31);
irq!(::exti::ExtiLine24, IrqExti, Irq32);
irq!(::exti::ExtiLine25, IrqExti, Irq37);
irq!(::exti::ExtiLine26, IrqExti, Irq38);
irq!(::exti::ExtiLine28, IrqExti, Irq39);
irq!(::exti::ExtiLine29, IrqExti, Irq64);
irq!(::exti::ExtiLine30, IrqExti, Irq65);
irq!(::exti::ExtiLine31, IrqExti, Irq65);
irq!(::exti::ExtiLine32, IrqExti, Irq65);
...
irq!(::i2c::I2c1, IrqI2c, Irq31);
irq!(::i2c::I2c1, IrqI2c, Irq32);
irq!(::i2c::I2c2, IrqI2c, Irq33);
irq!(::i2c::I2c2, IrqI2c, Irq34);
irq!(::i2c::I2c3, IrqI2c, Irq72);
irq!(::i2c::I2c3, IrqI2c, Irq73);
...
irq!(::adc::Adc3, IrqAdc, Irq47);
irq!(::adc::Adc4, IrqAdc, Irq61);
irq_type!(IRQ_ADC, IrqAdc);
irq!(::dac::Dac, IrqDac, Irq54);
irq_type!(IRQ_DAC, IrqDac);
irq!(::tim_bas::Tim6, IrqTimBas, Irq54);
irq!(::tim_bas::Tim7, IrqTimBas, Irq55);
irq_type!(IRQ_TIM_BAS, IrqTimBas);
irq!(::tim_gen::Tim2, IrqTimGen, Irq28);
irq!(::tim_gen::Tim3, IrqTimGen, Irq29);
irq!(::tim_gen::Tim4, IrqTimGen, Irq30);
irq!(::tim_gen::Tim15, IrqTimGen, Irq24);
irq!(::tim_gen::Tim16, IrqTimGen, Irq25);
irq!(::tim_gen::Tim17, IrqTimGen, Irq26);
irq_type!(IRQ_TIM_GEN, IrqTimGen);
irq!(::tim_adv::Tim1, IrqTimAdv, Irq24);
irq!(::tim_adv::Tim1, IrqTimAdv, Irq25);
irq!(::tim_adv::Tim1, IrqTimAdv, Irq26);
irq!(::tim_adv::Tim1, IrqTimAdv, Irq27);
irq!(::tim_adv::Tim8, IrqTimAdv, Irq43);
irq!(::tim_adv::Tim8, IrqTimAdv, Irq44);
irq!(::tim_adv::Tim8, IrqTimAdv, Irq45);
irq!(::tim_adv::Tim8, IrqTimAdv, Irq46);
irq!(::tim_adv::Tim20, IrqTimAdv, Irq77);
irq!(::tim_adv::Tim20, IrqTimAdv, Irq78);
irq!(::tim_adv::Tim20, IrqTimAdv, Irq79);
irq!(::tim_adv::Tim20, IrqTimAdv, Irq80);
irq_type!(IRQ_TIM_ADV, IrqTimAdv);
