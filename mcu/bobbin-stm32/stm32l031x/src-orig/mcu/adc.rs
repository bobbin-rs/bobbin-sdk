...
periph!( ADC1, Adc1, ADC1_PERIPH, AdcPeriph, 0x40012400, 0x16);
...
channel!(ADC1_REFINT, Adc1Refint, ADC1, Adc1, ADC1_REFINT_CH, AdcCh, ADC1_PERIPH, 17);
channel!(ADC1_TEMP, Adc1Temp, ADC1, Adc1, ADC1_TEMP_CH, AdcCh, ADC1_PERIPH, 18);
