...
periph!( GPIO, Gpio, _GPIO, GpioPeriph, 0x4000a000);
...
impl GpioPeriph {
    #[doc="Get the *mut pointer for the P_CTRL register."]
    #[inline] pub fn p_ctrl_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PCtrl { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x0 + (index * 48)) as *mut PCtrl
    }

    #[doc="Get the *const pointer for the P_CTRL register."]
    #[inline] pub fn p_ctrl_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PCtrl { 
           self.p_ctrl_mut(index)
    }

    #[doc="Read the P_CTRL register."]
    #[inline] pub fn p_ctrl<I: Into<bits::R12>>(&self, index: I) -> PCtrl { 
        unsafe {
            read_volatile(self.p_ctrl_ptr(index))
        }
    }

    #[doc="Write the P_CTRL register."]
    #[inline] pub fn set_p_ctrl<I: Into<bits::R12>, F: FnOnce(PCtrl) -> PCtrl>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_ctrl_mut(index), f(PCtrl(0)));
        }
        self
    }

    #[doc="Modify the P_CTRL register."]
    #[inline] pub fn with_p_ctrl<I: Into<bits::R12> + Copy, F: FnOnce(PCtrl) -> PCtrl>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_ctrl_mut(index), f(self.p_ctrl(index)));
        }
        self
    }

    #[doc="Get the *mut pointer for the P_MODEL register."]
    #[inline] pub fn p_model_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PModel { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x4 + (index * 48)) as *mut PModel
    }

    #[doc="Get the *const pointer for the P_MODEL register."]
    #[inline] pub fn p_model_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PModel { 
           self.p_model_mut(index)
    }

    #[doc="Read the P_MODEL register."]
    #[inline] pub fn p_model<I: Into<bits::R12>>(&self, index: I) -> PModel { 
        unsafe {
            read_volatile(self.p_model_ptr(index))
        }
    }

    #[doc="Write the P_MODEL register."]
    #[inline] pub fn set_p_model<I: Into<bits::R12>, F: FnOnce(PModel) -> PModel>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_model_mut(index), f(PModel(0)));
        }
        self
    }

    #[doc="Modify the P_MODEL register."]
    #[inline] pub fn with_p_model<I: Into<bits::R12> + Copy, F: FnOnce(PModel) -> PModel>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_model_mut(index), f(self.p_model(index)));
        }
        self
    }

    #[doc="Get the *mut pointer for the P_MODEH register."]
    #[inline] pub fn p_modeh_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PModeh { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x8 + (index * 48)) as *mut PModeh
    }

    #[doc="Get the *const pointer for the P_MODEH register."]
    #[inline] pub fn p_modeh_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PModeh { 
           self.p_modeh_mut(index)
    }

    #[doc="Read the P_MODEH register."]
    #[inline] pub fn p_modeh<I: Into<bits::R12>>(&self, index: I) -> PModeh { 
        unsafe {
            read_volatile(self.p_modeh_ptr(index))
        }
    }

    #[doc="Write the P_MODEH register."]
    #[inline] pub fn set_p_modeh<I: Into<bits::R12>, F: FnOnce(PModeh) -> PModeh>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_modeh_mut(index), f(PModeh(0)));
        }
        self
    }

    #[doc="Modify the P_MODEH register."]
    #[inline] pub fn with_p_modeh<I: Into<bits::R12> + Copy, F: FnOnce(PModeh) -> PModeh>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_modeh_mut(index), f(self.p_modeh(index)));
        }
        self
    }

    #[doc="Get the *mut pointer for the P_DOUT register."]
    #[inline] pub fn p_dout_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PDout { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0xc + (index * 48)) as *mut PDout
    }

    #[doc="Get the *const pointer for the P_DOUT register."]
    #[inline] pub fn p_dout_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PDout { 
           self.p_dout_mut(index)
    }

    #[doc="Read the P_DOUT register."]
    #[inline] pub fn p_dout<I: Into<bits::R12>>(&self, index: I) -> PDout { 
        unsafe {
            read_volatile(self.p_dout_ptr(index))
        }
    }

    #[doc="Write the P_DOUT register."]
    #[inline] pub fn set_p_dout<I: Into<bits::R12>, F: FnOnce(PDout) -> PDout>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_dout_mut(index), f(PDout(0)));
        }
        self
    }

    #[doc="Modify the P_DOUT register."]
    #[inline] pub fn with_p_dout<I: Into<bits::R12> + Copy, F: FnOnce(PDout) -> PDout>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_dout_mut(index), f(self.p_dout(index)));
        }
        self
    }

    #[doc="Get the *mut pointer for the P_DOUTTGL register."]
    #[inline] pub fn p_douttgl_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PDouttgl { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x18 + (index * 48)) as *mut PDouttgl
    }

    #[doc="Get the *const pointer for the P_DOUTTGL register."]
    #[inline] pub fn p_douttgl_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PDouttgl { 
           self.p_douttgl_mut(index)
    }

    #[doc="Write the P_DOUTTGL register."]
    #[inline] pub fn set_p_douttgl<I: Into<bits::R12>, F: FnOnce(PDouttgl) -> PDouttgl>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_douttgl_mut(index), f(PDouttgl(0)));
        }
        self
    }

    #[doc="Get the *mut pointer for the P_DIN register."]
    #[inline] pub fn p_din_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PDin { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x1c + (index * 48)) as *mut PDin
    }

    #[doc="Get the *const pointer for the P_DIN register."]
    #[inline] pub fn p_din_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PDin { 
           self.p_din_mut(index)
    }

    #[doc="Read the P_DIN register."]
    #[inline] pub fn p_din<I: Into<bits::R12>>(&self, index: I) -> PDin { 
        unsafe {
            read_volatile(self.p_din_ptr(index))
        }
    }

    #[doc="Get the *mut pointer for the P_PINLOCKN register."]
    #[inline] pub fn p_pinlockn_mut<I: Into<bits::R12>>(&self, index: I) -> *mut PPinlockn { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x20 + (index * 48)) as *mut PPinlockn
    }

    #[doc="Get the *const pointer for the P_PINLOCKN register."]
    #[inline] pub fn p_pinlockn_ptr<I: Into<bits::R12>>(&self, index: I) -> *const PPinlockn { 
           self.p_pinlockn_mut(index)
    }

    #[doc="Read the P_PINLOCKN register."]
    #[inline] pub fn p_pinlockn<I: Into<bits::R12>>(&self, index: I) -> PPinlockn { 
        unsafe {
            read_volatile(self.p_pinlockn_ptr(index))
        }
    }

    #[doc="Write the P_PINLOCKN register."]
    #[inline] pub fn set_p_pinlockn<I: Into<bits::R12>, F: FnOnce(PPinlockn) -> PPinlockn>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_pinlockn_mut(index), f(PPinlockn(0)));
        }
        self
    }

    #[doc="Modify the P_PINLOCKN register."]
    #[inline] pub fn with_p_pinlockn<I: Into<bits::R12> + Copy, F: FnOnce(PPinlockn) -> PPinlockn>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_pinlockn_mut(index), f(self.p_pinlockn(index)));
        }
        self
    }

    #[doc="Get the *mut pointer for the P_OVTDIS register."]
    #[inline] pub fn p_ovtdis_mut<I: Into<bits::R12>>(&self, index: I) -> *mut POvtdis { 
        let index: usize = index.into().value() as usize;
        (self.0 + 0x28 + (index * 48)) as *mut POvtdis
    }

    #[doc="Get the *const pointer for the P_OVTDIS register."]
    #[inline] pub fn p_ovtdis_ptr<I: Into<bits::R12>>(&self, index: I) -> *const POvtdis { 
           self.p_ovtdis_mut(index)
    }

    #[doc="Read the P_OVTDIS register."]
    #[inline] pub fn p_ovtdis<I: Into<bits::R12>>(&self, index: I) -> POvtdis { 
        unsafe {
            read_volatile(self.p_ovtdis_ptr(index))
        }
    }

    #[doc="Write the P_OVTDIS register."]
    #[inline] pub fn set_p_ovtdis<I: Into<bits::R12>, F: FnOnce(POvtdis) -> POvtdis>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_ovtdis_mut(index), f(POvtdis(0)));
        }
        self
    }

    #[doc="Modify the P_OVTDIS register."]
    #[inline] pub fn with_p_ovtdis<I: Into<bits::R12> + Copy, F: FnOnce(POvtdis) -> POvtdis>(&self, index: I, f: F) -> &Self {
        unsafe {
            write_volatile(self.p_ovtdis_mut(index), f(self.p_ovtdis(index)));
        }
        self
    }
...
impl ::core::fmt::Display for PCtrl {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PCtrl {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct PModel(pub u32);
impl PModel {
    #[doc="Pin 0 Mode"]
    #[inline] pub fn mode0(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xf) as u8) } // [3:0]
    }

    #[doc="Returns true if MODE0 != 0"]
    #[inline] pub fn test_mode0(&self) -> bool {
        self.mode0() != 0
    }

    #[doc="Sets the MODE0 field."]
    #[inline] pub fn set_mode0<V: Into<bits::U4>>(mut self, value: V) -> Self {
    ...
    #[doc="Pin 1 Mode"]
    #[inline] pub fn mode1(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 4) & 0xf) as u8) } // [7:4]
    }

    #[doc="Returns true if MODE1 != 0"]
    #[inline] pub fn test_mode1(&self) -> bool {
        self.mode1() != 0
    }

    #[doc="Sets the MODE1 field."]
    #[inline] pub fn set_mode1<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 4);
        self.0 |= value << 4;
    ...
    #[doc="Pin 2 Mode"]
    #[inline] pub fn mode2(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 8) & 0xf) as u8) } // [11:8]
    }

    #[doc="Returns true if MODE2 != 0"]
    #[inline] pub fn test_mode2(&self) -> bool {
        self.mode2() != 0
    }

    #[doc="Sets the MODE2 field."]
    #[inline] pub fn set_mode2<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 8);
        self.0 |= value << 8;
    ...
    #[doc="Pin 3 Mode"]
    #[inline] pub fn mode3(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 12) & 0xf) as u8) } // [15:12]
    }

    #[doc="Returns true if MODE3 != 0"]
    #[inline] pub fn test_mode3(&self) -> bool {
        self.mode3() != 0
    }

    #[doc="Sets the MODE3 field."]
    #[inline] pub fn set_mode3<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 12);
        self.0 |= value << 12;
    ...
    #[doc="Pin 4 Mode"]
    #[inline] pub fn mode4(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0xf) as u8) } // [19:16]
    }

    #[doc="Returns true if MODE4 != 0"]
    #[inline] pub fn test_mode4(&self) -> bool {
        self.mode4() != 0
    }

    #[doc="Sets the MODE4 field."]
    #[inline] pub fn set_mode4<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 16);
        self.0 |= value << 16;
    ...
    #[doc="Pin 5 Mode"]
    #[inline] pub fn mode5(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 20) & 0xf) as u8) } // [23:20]
    }

    #[doc="Returns true if MODE5 != 0"]
    #[inline] pub fn test_mode5(&self) -> bool {
        self.mode5() != 0
    }

    #[doc="Sets the MODE5 field."]
    #[inline] pub fn set_mode5<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 20);
        self.0 |= value << 20;
    ...
    #[doc="Pin 6 Mode"]
    #[inline] pub fn mode6(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 24) & 0xf) as u8) } // [27:24]
    }

    #[doc="Returns true if MODE6 != 0"]
    #[inline] pub fn test_mode6(&self) -> bool {
        self.mode6() != 0
    }

    #[doc="Sets the MODE6 field."]
    #[inline] pub fn set_mode6<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 24);
        self.0 |= value << 24;
    ...
    #[doc="Pin 7 Mode"]
    #[inline] pub fn mode7(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 28) & 0xf) as u8) } // [31:28]
    }

    #[doc="Returns true if MODE7 != 0"]
    #[inline] pub fn test_mode7(&self) -> bool {
        self.mode7() != 0
    }

    #[doc="Sets the MODE7 field."]
    #[inline] pub fn set_mode7<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 28);
        self.0 |= value << 28;
...
impl ::core::fmt::Display for PModel {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PModel {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.mode0() != 0 { try!(write!(f, " mode0=0x{:x}", self.mode0()))}
        if self.mode1() != 0 { try!(write!(f, " mode1=0x{:x}", self.mode1()))}
        if self.mode2() != 0 { try!(write!(f, " mode2=0x{:x}", self.mode2()))}
        if self.mode3() != 0 { try!(write!(f, " mode3=0x{:x}", self.mode3()))}
        if self.mode4() != 0 { try!(write!(f, " mode4=0x{:x}", self.mode4()))}
        if self.mode5() != 0 { try!(write!(f, " mode5=0x{:x}", self.mode5()))}
        if self.mode6() != 0 { try!(write!(f, " mode6=0x{:x}", self.mode6()))}
        if self.mode7() != 0 { try!(write!(f, " mode7=0x{:x}", self.mode7()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct PModeh(pub u32);
impl PModeh {
    #[doc="Pin 8 Mode"]
    #[inline] pub fn mode8(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xf) as u8) } // [3:0]
    }

    #[doc="Returns true if MODE8 != 0"]
    #[inline] pub fn test_mode8(&self) -> bool {
        self.mode8() != 0
    }

    #[doc="Sets the MODE8 field."]
    #[inline] pub fn set_mode8<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 0);
        self.0 |= value << 0;
    ...
    #[doc="Pin 9 Mode"]
    #[inline] pub fn mode9(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 4) & 0xf) as u8) } // [7:4]
    }

    #[doc="Returns true if MODE9 != 0"]
    #[inline] pub fn test_mode9(&self) -> bool {
        self.mode9() != 0
    }

    #[doc="Sets the MODE9 field."]
    #[inline] pub fn set_mode9<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 4);
        self.0 |= value << 4;
    ...
    #[doc="Pin 10 Mode"]
    #[inline] pub fn mode10(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 8) & 0xf) as u8) } // [11:8]
    }

    #[doc="Returns true if MODE10 != 0"]
    #[inline] pub fn test_mode10(&self) -> bool {
        self.mode10() != 0
    }

    #[doc="Sets the MODE10 field."]
    #[inline] pub fn set_mode10<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 8);
        self.0 |= value << 8;
    ...
    #[doc="Pin 11 Mode"]
    #[inline] pub fn mode11(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 12) & 0xf) as u8) } // [15:12]
    }

    #[doc="Returns true if MODE11 != 0"]
    #[inline] pub fn test_mode11(&self) -> bool {
        self.mode11() != 0
    }

    #[doc="Sets the MODE11 field."]
    #[inline] pub fn set_mode11<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 12);
        self.0 |= value << 12;
    ...
    #[doc="Pin 12 Mode"]
    #[inline] pub fn mode12(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 16) & 0xf) as u8) } // [19:16]
    }

    #[doc="Returns true if MODE12 != 0"]
    #[inline] pub fn test_mode12(&self) -> bool {
        self.mode12() != 0
    }

    #[doc="Sets the MODE12 field."]
    #[inline] pub fn set_mode12<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 16);
        self.0 |= value << 16;
    ...
    #[doc="Pin 13 Mode"]
    #[inline] pub fn mode13(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 20) & 0xf) as u8) } // [23:20]
    }

    #[doc="Returns true if MODE13 != 0"]
    #[inline] pub fn test_mode13(&self) -> bool {
        self.mode13() != 0
    }

    #[doc="Sets the MODE13 field."]
    #[inline] pub fn set_mode13<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 20);
        self.0 |= value << 20;
    ...
    #[doc="Pin 14 Mode"]
    #[inline] pub fn mode14(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 24) & 0xf) as u8) } // [27:24]
    }

    #[doc="Returns true if MODE14 != 0"]
    #[inline] pub fn test_mode14(&self) -> bool {
        self.mode14() != 0
    }

    #[doc="Sets the MODE14 field."]
    #[inline] pub fn set_mode14<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 24);
        self.0 |= value << 24;
    ...
    #[doc="Pin 15 Mode"]
    #[inline] pub fn mode15(&self) -> bits::U4 {
        unsafe { ::core::mem::transmute(((self.0 >> 28) & 0xf) as u8) } // [31:28]
    }

    #[doc="Returns true if MODE15 != 0"]
    #[inline] pub fn test_mode15(&self) -> bool {
        self.mode15() != 0
    }

    #[doc="Sets the MODE15 field."]
    #[inline] pub fn set_mode15<V: Into<bits::U4>>(mut self, value: V) -> Self {
        let value: bits::U4 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xf << 28);
        self.0 |= value << 28;
...
impl ::core::fmt::Display for PModeh {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PModeh {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.mode8() != 0 { try!(write!(f, " mode8=0x{:x}", self.mode8()))}
        if self.mode9() != 0 { try!(write!(f, " mode9=0x{:x}", self.mode9()))}
        if self.mode10() != 0 { try!(write!(f, " mode10=0x{:x}", self.mode10()))}
        if self.mode11() != 0 { try!(write!(f, " mode11=0x{:x}", self.mode11()))}
        if self.mode12() != 0 { try!(write!(f, " mode12=0x{:x}", self.mode12()))}
        if self.mode13() != 0 { try!(write!(f, " mode13=0x{:x}", self.mode13()))}
        if self.mode14() != 0 { try!(write!(f, " mode14=0x{:x}", self.mode14()))}
        if self.mode15() != 0 { try!(write!(f, " mode15=0x{:x}", self.mode15()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct PDout(pub u32);
impl PDout {
    #[doc="Data Out"]
    #[inline] pub fn dout(&self) -> bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }

    #[doc="Returns true if DOUT != 0"]
    #[inline] pub fn test_dout(&self) -> bool {
        self.dout() != 0
    }

    #[doc="Sets the DOUT field."]
    #[inline] pub fn set_dout<V: Into<bits::U16>>(mut self, value: V) -> Self {
...
impl ::core::fmt::Display for PDout {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PDout {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.dout() != 0 { try!(write!(f, " dout=0x{:x}", self.dout()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct PDouttgl(pub u32);
impl PDouttgl {
    #[doc="Data Out Toggle"]
    #[inline] pub fn douttgl(&self) -> bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }

    #[doc="Returns true if DOUTTGL != 0"]
    #[inline] pub fn test_douttgl(&self) -> bool {
        self.douttgl() != 0
    }

    #[doc="Sets the DOUTTGL field."]
    #[inline] pub fn set_douttgl<V: Into<bits::U16>>(mut self, value: V) -> Self {
        let value: bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
...
impl ::core::fmt::Display for PDouttgl {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PDouttgl {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.douttgl() != 0 { try!(write!(f, " douttgl=0x{:x}", self.douttgl()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct PDin(pub u32);
impl PDin {
    #[doc="Data In"]
    #[inline] pub fn din(&self) -> bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }

    #[doc="Returns true if DIN != 0"]
    #[inline] pub fn test_din(&self) -> bool {
        self.din() != 0
    }

    #[doc="Sets the DIN field."]
    #[inline] pub fn set_din<V: Into<bits::U16>>(mut self, value: V) -> Self {
        let value: bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
...
impl ::core::fmt::Display for PDin {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PDin {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.din() != 0 { try!(write!(f, " din=0x{:x}", self.din()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct PPinlockn(pub u32);
impl PPinlockn {
    #[doc="Unlocked Pins"]
    #[inline] pub fn pinlockn(&self) -> bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }

    #[doc="Returns true if PINLOCKN != 0"]
    #[inline] pub fn test_pinlockn(&self) -> bool {
        self.pinlockn() != 0
    }

    #[doc="Sets the PINLOCKN field."]
    #[inline] pub fn set_pinlockn<V: Into<bits::U16>>(mut self, value: V) -> Self {
        let value: bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
...
impl ::core::fmt::Display for PPinlockn {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for PPinlockn {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.pinlockn() != 0 { try!(write!(f, " pinlockn=0x{:x}", self.pinlockn()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
...
#[derive(Default, Clone, Copy, PartialEq, Eq)]
pub struct POvtdis(pub u32);
impl POvtdis {
    #[doc="Disable Over Voltage capability"]
    #[inline] pub fn ovtdis(&self) -> bits::U16 {
        unsafe { ::core::mem::transmute(((self.0 >> 0) & 0xffff) as u16) } // [15:0]
    }

    #[doc="Returns true if OVTDIS != 0"]
    #[inline] pub fn test_ovtdis(&self) -> bool {
        self.ovtdis() != 0
    }

    #[doc="Sets the OVTDIS field."]
    #[inline] pub fn set_ovtdis<V: Into<bits::U16>>(mut self, value: V) -> Self {
        let value: bits::U16 = value.into();
        let value: u32 = value.into();
        self.0 &= !(0xffff << 0);
        self.0 |= value << 0;
...
impl ::core::fmt::Display for POvtdis {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
         self.0.fmt(f)
    }
}

impl ::core::fmt::Debug for POvtdis {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        try!(write!(f, "[0x{:08x}", self.0));
        if self.ovtdis() != 0 { try!(write!(f, " ovtdis=0x{:x}", self.ovtdis()))}
        try!(write!(f, "]"));
        Ok(())
    }
}
