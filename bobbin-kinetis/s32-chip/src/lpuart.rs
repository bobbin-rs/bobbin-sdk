pub const LPUART0: Lpuart = Lpuart(0x4006a000);
pub const LPUART1: Lpuart = Lpuart(0x4006b000);
pub const LPUART2: Lpuart = Lpuart(0x4006c000);
...
impl Lpuart {
  ...
  pub unsafe fn global(&self) -> Global { 
     Global(::core::ptr::read_volatile(((self.0 as usize) + 0x8) as *const u32))
  }
  pub unsafe fn set_global(&mut self, value: Global) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x8) as *mut u32, value.0);
  }
  pub unsafe fn with_global<F: FnOnce(Global) -> Global>(&mut self, f: F) {
     let tmp = self.global();
     self.set_global(f(tmp))
  }

  pub unsafe fn pincfg(&self) -> Pincfg { 
     Pincfg(::core::ptr::read_volatile(((self.0 as usize) + 0xc) as *const u32))
  }
  pub unsafe fn set_pincfg(&mut self, value: Pincfg) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0xc) as *mut u32, value.0);
  }
  pub unsafe fn with_pincfg<F: FnOnce(Pincfg) -> Pincfg>(&mut self, f: F) {
     let tmp = self.pincfg();
     self.set_pincfg(f(tmp))
  }

  pub unsafe fn baud(&self) -> Baud { 
     Baud(::core::ptr::read_volatile(((self.0 as usize) + 0x10) as *const u32))
  }
  pub unsafe fn set_baud(&mut self, value: Baud) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x10) as *mut u32, value.0);
  }
  pub unsafe fn with_baud<F: FnOnce(Baud) -> Baud>(&mut self, f: F) {
     let tmp = self.baud();
     self.set_baud(f(tmp))
  }
  ...
  pub unsafe fn set_stat(&mut self, value: Stat) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x14) as *mut u32, value.0);
  }
  pub unsafe fn with_stat<F: FnOnce(Stat) -> Stat>(&mut self, f: F) {
     let tmp = self.stat();
     self.set_stat(f(tmp))
  }
  ...
  pub unsafe fn _match(&self) -> Match { 
     Match(::core::ptr::read_volatile(((self.0 as usize) + 0x20) as *const u32))
  }
  pub unsafe fn set_match(&mut self, value: Match) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x20) as *mut u32, value.0);
  }
  pub unsafe fn with_match<F: FnOnce(Match) -> Match>(&mut self, f: F) {
     let tmp = self._match();
     self.set_match(f(tmp))
  }

  pub unsafe fn modir(&self) -> Modir { 
     Modir(::core::ptr::read_volatile(((self.0 as usize) + 0x24) as *const u32))
  }
  pub unsafe fn set_modir(&mut self, value: Modir) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x24) as *mut u32, value.0);
  }
  pub unsafe fn with_modir<F: FnOnce(Modir) -> Modir>(&mut self, f: F) {
     let tmp = self.modir();
     self.set_modir(f(tmp))
  }

  pub unsafe fn fifo(&self) -> Fifo { 
     Fifo(::core::ptr::read_volatile(((self.0 as usize) + 0x28) as *const u32))
  }
  pub unsafe fn set_fifo(&mut self, value: Fifo) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x28) as *mut u32, value.0);
  }
  pub unsafe fn with_fifo<F: FnOnce(Fifo) -> Fifo>(&mut self, f: F) {
     let tmp = self.fifo();
     self.set_fifo(f(tmp))
  }

  pub unsafe fn water(&self) -> Water { 
     Water(::core::ptr::read_volatile(((self.0 as usize) + 0x2c) as *const u32))
  }
  pub unsafe fn set_water(&mut self, value: Water) {
     ::core::ptr::write_volatile(((self.0 as usize) + 0x2c) as *mut u32, value.0);
  }
  pub unsafe fn with_water<F: FnOnce(Water) -> Water>(&mut self, f: F) {
     let tmp = self.water();
