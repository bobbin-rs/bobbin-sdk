...
impl LinkPortPin<super::port::Pta21 > for Pa21 {
   fn port_pin(&self) -> super::port::Pta21  { super::port::PTA21 }
}

impl LinkPortPin<super::port::Pta22 > for Pa22 {
   fn port_pin(&self) -> super::port::Pta22  { super::port::PTA22 }
}

impl LinkPortPin<super::port::Pta23 > for Pa23 {
   fn port_pin(&self) -> super::port::Pta23  { super::port::PTA23 }
}
...
impl LinkPortPin<super::port::Ptb14 > for Pb14 {
   fn port_pin(&self) -> super::port::Ptb14  { super::port::PTB14 }
}

impl LinkPortPin<super::port::Ptb15 > for Pb15 {
   fn port_pin(&self) -> super::port::Ptb15  { super::port::PTB15 }
}
...
impl LinkPortPin<super::port::Pte13 > for Pe13 {
   fn port_pin(&self) -> super::port::Pte13  { super::port::PTE13 }
}

impl LinkPortPin<super::port::Pte14 > for Pe14 {
   fn port_pin(&self) -> super::port::Pte14  { super::port::PTE14 }
}

impl LinkPortPin<super::port::Pte15 > for Pe15 {
   fn port_pin(&self) -> super::port::Pte15  { super::port::PTE15 }
}

impl LinkPortPin<super::port::Pte16 > for Pe16 {
   fn port_pin(&self) -> super::port::Pte16  { super::port::PTE16 }
}

impl LinkPortPin<super::port::Pte17 > for Pe17 {
   fn port_pin(&self) -> super::port::Pte17  { super::port::PTE17 }
}

impl LinkPortPin<super::port::Pte18 > for Pe18 {
   fn port_pin(&self) -> super::port::Pte18  { super::port::PTE18 }
}

impl LinkPortPin<super::port::Pte19 > for Pe19 {
   fn port_pin(&self) -> super::port::Pte19  { super::port::PTE19 }
}
