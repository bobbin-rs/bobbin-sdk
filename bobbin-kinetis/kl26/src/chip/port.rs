...
impl LinkGpioPin<super::gpio::Pa20 > for Pta20 {
   fn gpio_pin(&self) -> super::gpio::Pa20  { super::gpio::PA20 }
}
...
impl LinkGpioPin<super::gpio::Pe20 > for Pte20 {
   fn gpio_pin(&self) -> super::gpio::Pe20  { super::gpio::PE20 }
}

impl LinkGpioPin<super::gpio::Pe21 > for Pte21 {
   fn gpio_pin(&self) -> super::gpio::Pe21  { super::gpio::PE21 }
}

impl LinkGpioPin<super::gpio::Pe22 > for Pte22 {
   fn gpio_pin(&self) -> super::gpio::Pe22  { super::gpio::PE22 }
}

impl LinkGpioPin<super::gpio::Pe23 > for Pte23 {
   fn gpio_pin(&self) -> super::gpio::Pe23  { super::gpio::PE23 }
}
...
impl LinkGpioPin<super::gpio::Pe29 > for Pte29 {
   fn gpio_pin(&self) -> super::gpio::Pe29  { super::gpio::PE29 }
}

impl LinkGpioPin<super::gpio::Pe30 > for Pte30 {
   fn gpio_pin(&self) -> super::gpio::Pe30  { super::gpio::PE30 }
}

impl LinkGpioPin<super::gpio::Pe31 > for Pte31 {
   fn gpio_pin(&self) -> super::gpio::Pe31  { super::gpio::PE31 }
}
