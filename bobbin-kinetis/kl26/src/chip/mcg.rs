...
periph!(McgPeriph, MCG, Mcg, 0x40064000);

#[doc="Multipurpose Clock Generator module"]
pub trait McgPeriph : Base {
...
#[doc="Read the C1 register."]
   #[inline] fn c1(&self) -> C1 { 
      unsafe {
         C1(::core::ptr::read_volatile((self.base() + 0x0) as *const u8))
      }
   }
...
#[doc="Read the C2 register."]
   #[inline] fn c2(&self) -> C2 { 
      unsafe {
         C2(::core::ptr::read_volatile((self.base() + 0x1) as *const u8))
      }
   }
...
#[doc="Read the C3 register."]
   #[inline] fn c3(&self) -> C3 { 
      unsafe {
         C3(::core::ptr::read_volatile((self.base() + 0x2) as *const u8))
      }
   }
...
#[doc="Read the C4 register."]
   #[inline] fn c4(&self) -> C4 { 
      unsafe {
         C4(::core::ptr::read_volatile((self.base() + 0x3) as *const u8))
      }
   }
...
#[doc="Read the C5 register."]
   #[inline] fn c5(&self) -> C5 { 
      unsafe {
         C5(::core::ptr::read_volatile((self.base() + 0x4) as *const u8))
      }
   }
...
#[doc="Get the *const pointer for the C6 register."]
   #[inline] fn c6_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0x5)
   }
#[doc="Get the *mut pointer for the C6 register."]
   #[inline] fn c6_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0x5)
   }
#[doc="Read the C6 register."]
   #[inline] fn c6(&self) -> C6 { 
      unsafe {
         C6(::core::ptr::read_volatile((self.base() + 0x5) as *const u8))
      }
   }
#[doc="Write the C6 register."]
   #[inline] fn set_c6<F: FnOnce(C6) -> C6>(&self, f: F) -> &Self {
      let value = f(C6(0));
      unsafe {
...
#[doc="Modify the C6 register."]
   #[inline] fn with_c6<F: FnOnce(C6) -> C6>(&self, f: F) -> &Self {
      let tmp = unsafe {
         C6(::core::ptr::read_volatile((self.base() + 0x5) as *const u8))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the S register."]
   #[inline] fn s_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0x6)
   }
#[doc="Get the *mut pointer for the S register."]
   #[inline] fn s_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0x6)
   }
#[doc="Read the S register."]
   #[inline] fn s(&self) -> S { 
      unsafe {
         S(::core::ptr::read_volatile((self.base() + 0x6) as *const u8))
      }
   }
#[doc="Write the S register."]
   #[inline] fn set_s<F: FnOnce(S) -> S>(&self, f: F) -> &Self {
      let value = f(S(0));
      unsafe {
...
#[doc="Modify the S register."]
   #[inline] fn with_s<F: FnOnce(S) -> S>(&self, f: F) -> &Self {
      let tmp = unsafe {
         S(::core::ptr::read_volatile((self.base() + 0x6) as *const u8))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the ATCVH register."]
   #[inline] fn atcvh_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0xa)
   }
#[doc="Get the *mut pointer for the ATCVH register."]
   #[inline] fn atcvh_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0xa)
   }
#[doc="Read the ATCVH register."]
   #[inline] fn atcvh(&self) -> Atcvh { 
      unsafe {
         Atcvh(::core::ptr::read_volatile((self.base() + 0xa) as *const u8))
      }
   }
#[doc="Write the ATCVH register."]
   #[inline] fn set_atcvh<F: FnOnce(Atcvh) -> Atcvh>(&self, f: F) -> &Self {
      let value = f(Atcvh(0));
      unsafe {
...
#[doc="Modify the ATCVH register."]
   #[inline] fn with_atcvh<F: FnOnce(Atcvh) -> Atcvh>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Atcvh(::core::ptr::read_volatile((self.base() + 0xa) as *const u8))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the ATCVL register."]
   #[inline] fn atcvl_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0xb)
   }
#[doc="Get the *mut pointer for the ATCVL register."]
   #[inline] fn atcvl_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0xb)
   }
#[doc="Read the ATCVL register."]
   #[inline] fn atcvl(&self) -> Atcvl { 
      unsafe {
         Atcvl(::core::ptr::read_volatile((self.base() + 0xb) as *const u8))
      }
   }
#[doc="Write the ATCVL register."]
   #[inline] fn set_atcvl<F: FnOnce(Atcvl) -> Atcvl>(&self, f: F) -> &Self {
      let value = f(Atcvl(0));
      unsafe {
...
#[doc="Modify the ATCVL register."]
   #[inline] fn with_atcvl<F: FnOnce(Atcvl) -> Atcvl>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Atcvl(::core::ptr::read_volatile((self.base() + 0xb) as *const u8))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the C7 register."]
   #[inline] fn c7_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0xc)
   }
#[doc="Get the *mut pointer for the C7 register."]
   #[inline] fn c7_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0xc)
   }
#[doc="Read the C7 register."]
   #[inline] fn c7(&self) -> C7 { 
      unsafe {
         C7(::core::ptr::read_volatile((self.base() + 0xc) as *const u8))
      }
   }
#[doc="Write the C7 register."]
   #[inline] fn set_c7<F: FnOnce(C7) -> C7>(&self, f: F) -> &Self {
      let value = f(C7(0));
      unsafe {
...
#[doc="Modify the C7 register."]
   #[inline] fn with_c7<F: FnOnce(C7) -> C7>(&self, f: F) -> &Self {
      let tmp = unsafe {
         C7(::core::ptr::read_volatile((self.base() + 0xc) as *const u8))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the C8 register."]
   #[inline] fn c8_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0xd)
   }
#[doc="Get the *mut pointer for the C8 register."]
   #[inline] fn c8_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0xd)
   }
#[doc="Read the C8 register."]
   #[inline] fn c8(&self) -> C8 { 
      unsafe {
         C8(::core::ptr::read_volatile((self.base() + 0xd) as *const u8))
      }
   }
#[doc="Write the C8 register."]
   #[inline] fn set_c8<F: FnOnce(C8) -> C8>(&self, f: F) -> &Self {
      let value = f(C8(0));
      unsafe {
...
#[doc="Modify the C8 register."]
   #[inline] fn with_c8<F: FnOnce(C8) -> C8>(&self, f: F) -> &Self {
      let tmp = unsafe {
         C8(::core::ptr::read_volatile((self.base() + 0xd) as *const u8))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the C9 register."]
   #[inline] fn c9_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0xe)
   }
#[doc="Get the *mut pointer for the C9 register."]
   #[inline] fn c9_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0xe)
   }
#[doc="Read the C9 register."]
   #[inline] fn c9(&self) -> C9 { 
      unsafe {
         C9(::core::ptr::read_volatile((self.base() + 0xe) as *const u8))
      }
   }

#[doc="Get the *const pointer for the C10 register."]
   #[inline] fn c10_ptr(&self) -> *const u8 { 
       <Self as Base>::addr(&self, 0xf)
   }
#[doc="Get the *mut pointer for the C10 register."]
   #[inline] fn c10_mut(&self) -> *mut u8 { 
       <Self as Base>::addr(&self, 0xf)
   }
#[doc="Read the C10 register."]
   #[inline] fn c10(&self) -> C10 { 
      unsafe {
         C10(::core::ptr::read_volatile((self.base() + 0xf) as *const u8))
      }
   }
