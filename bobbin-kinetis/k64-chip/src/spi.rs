pub const SPI0: Spi0 = Spi0 {};
pub const SPI0_REF: &Spi0 = &SPI0;
pub const SPI0_IMPL: SpiImpl = SpiImpl(0x4002c000);
pub const SPI0_IMPL_REF: &SpiImpl = &SPI0_IMPL;

pub struct Spi0 {}
impl ::core::ops::Deref for Spi0 {
   type Target = SpiImpl;
   #[inline]
   fn deref(&self) -> &SpiImpl { SPI0_IMPL_REF }
}


pub const SPI1: Spi1 = Spi1 {};
pub const SPI1_REF: &Spi1 = &SPI1;
pub const SPI1_IMPL: SpiImpl = SpiImpl(0x4002d000);
...
pub const SPI2_REF: &Spi2 = &SPI2;
pub const SPI2_IMPL: SpiImpl = SpiImpl(0x400ac000);
...
impl SpiImpl {
  ...
  #[inline]
  pub fn set_mcr(&self, value: Mcr) -> &SpiImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_mcr<F: FnOnce(Mcr) -> Mcr>(&self, f: F) -> &SpiImpl {
     let tmp = self.mcr();
     self.set_mcr(f(tmp))
  }
  ...
  #[inline]
  pub fn set_tcr(&self, value: Tcr) -> &SpiImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_tcr<F: FnOnce(Tcr) -> Tcr>(&self, f: F) -> &SpiImpl {
     let tmp = self.tcr();
     self.set_tcr(f(tmp))
  }

  #[inline]
  pub fn ctar_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 2);
     ((self.0 as usize) + 0xc + (index << 2)) as *const u32
  }
  #[inline]
  pub fn ctar_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 2);
     ((self.0 as usize) + 0xc + (index << 2)) as *mut u32
  }
  #[inline]
  pub fn ctar(&self, index: usize) -> Ctar { 
     assert!(index < 2);
     unsafe {
  ...
  #[inline]
  pub fn set_ctar(&self, index: usize, value: Ctar) -> &SpiImpl {
     assert!(index < 2);
     unsafe {
  ...
  #[inline]
  pub fn with_ctar<F: FnOnce(Ctar) -> Ctar>(&self, index: usize, f: F) -> &SpiImpl {
     let tmp = self.ctar(index);
     self.set_ctar(index, f(tmp))
  }

  #[inline]
  pub fn ctar_slave_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xc) as *const u32
  }
  #[inline]
  pub fn ctar_slave_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0xc) as *mut u32
  }
  #[inline]
  pub fn ctar_slave(&self) -> CtarSlave { 
     unsafe {
       CtarSlave(::core::ptr::read_volatile(((self.0 as usize) + 0xc) as *const u32))
     }
  }
  #[inline]
  pub fn set_ctar_slave(&self, value: CtarSlave) -> &SpiImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_ctar_slave<F: FnOnce(CtarSlave) -> CtarSlave>(&self, f: F) -> &SpiImpl {
  ...
  #[inline]
  pub fn rser_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x30) as *const u32
  }
  #[inline]
  pub fn rser_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x30) as *mut u32
  }
  #[inline]
  pub fn rser(&self) -> Rser { 
     unsafe {
       Rser(::core::ptr::read_volatile(((self.0 as usize) + 0x30) as *const u32))
     }
  }
  #[inline]
  pub fn set_rser(&self, value: Rser) -> &SpiImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_rser<F: FnOnce(Rser) -> Rser>(&self, f: F) -> &SpiImpl {
     let tmp = self.rser();
     self.set_rser(f(tmp))
  }

  #[inline]
  pub fn pushr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x34) as *const u32
  }
  #[inline]
  pub fn pushr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn set_pushr(&self, value: Pushr) -> &SpiImpl {
     unsafe {
  ...
  #[inline]
  pub fn with_pushr<F: FnOnce(Pushr) -> Pushr>(&self, f: F) -> &SpiImpl {
     let tmp = self.pushr();
     self.set_pushr(f(tmp))
  }

  #[inline]
  pub fn pushr_slave_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x34) as *const u32
  }
  #[inline]
  pub fn pushr_slave_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x34) as *mut u32
  }
  #[inline]
  pub fn pushr_slave(&self) -> PushrSlave { 
     unsafe {
       PushrSlave(::core::ptr::read_volatile(((self.0 as usize) + 0x34) as *const u32))
     }
  }
  #[inline]
  pub fn set_pushr_slave(&self, value: PushrSlave) -> &SpiImpl {
     unsafe {
       ::core::ptr::write_volatile(((self.0 as usize) + 0x34) as *mut u32, value.0);
     }
     self
  ...
  #[inline]
  pub fn with_pushr_slave<F: FnOnce(PushrSlave) -> PushrSlave>(&self, f: F) -> &SpiImpl {
     let tmp = self.pushr_slave();
     self.set_pushr_slave(f(tmp))
  }

  #[inline]
  pub fn popr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x38) as *const u32
  }
  #[inline]
  pub fn popr_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x38) as *mut u32
  }
  #[inline]
  pub fn popr(&self) -> Popr { 
     unsafe {
  ...
  #[inline]
  pub fn txfr_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x3c + (index << 2)) as *const u32
  }
  #[inline]
  pub fn txfr_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x3c + (index << 2)) as *mut u32
  }
  #[inline]
  pub fn txfr(&self, index: usize) -> Txfr { 
     assert!(index < 4);
     unsafe {
  ...
  #[inline]
  pub fn rxfr_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x7c + (index << 2)) as *const u32
  }
  #[inline]
  pub fn rxfr_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x7c + (index << 2)) as *mut u32
  }
  #[inline]
  pub fn rxfr(&self, index: usize) -> Rxfr { 
     assert!(index < 4);
     unsafe {
