...
impl Sim {
  ...
  #[inline]
  pub fn with_scgc1<F: FnOnce(Scgc1) -> Scgc1>(&self, f: F) -> &Self {
     let tmp = self.scgc1();
     self.set_scgc1(f(tmp))
  }

  #[inline]
  pub fn scgc2_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x102c) as *const u32
  }
  #[inline]
  pub fn scgc2_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x102c) as *mut u32
  }
  #[inline]
  pub fn scgc2(&self) -> Scgc2 { 
     unsafe {
       Scgc2(::core::ptr::read_volatile(((self.0 as usize) + 0x102c) as *const u32))
     }
  }
  #[inline]
  pub fn set_scgc2(&self, value: Scgc2) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_scgc2<F: FnOnce(Scgc2) -> Scgc2>(&self, f: F) -> &Self {
     let tmp = self.scgc2();
     self.set_scgc2(f(tmp))
  }

  #[inline]
  pub fn scgc3_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x1030) as *const u32
  }
  #[inline]
  pub fn scgc3_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x1030) as *mut u32
  }
  #[inline]
  pub fn scgc3(&self) -> Scgc3 { 
     unsafe {
       Scgc3(::core::ptr::read_volatile(((self.0 as usize) + 0x1030) as *const u32))
     }
  }
  #[inline]
  pub fn set_scgc3(&self, value: Scgc3) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_scgc3<F: FnOnce(Scgc3) -> Scgc3>(&self, f: F) -> &Self {
     let tmp = self.scgc3();
  ...
  #[inline]
  pub fn with_clkdiv2<F: FnOnce(Clkdiv2) -> Clkdiv2>(&self, f: F) -> &Self {
  ...
  #[inline]
  pub fn uidh_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x1054) as *const u32
  }
  #[inline]
  pub fn uidh_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x1054) as *mut u32
  }
  #[inline]
  pub fn uidh(&self) -> Uidh { 
     unsafe {
...
impl En for super::uart::Uart4 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc1().uart4() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc1(|r| r.set_uart4(value)); }
}

impl En for super::uart::Uart5 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc1().uart5() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc1(|r| r.set_uart5(value)); }
}

impl En for super::enet::Enet {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc2().enet() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc2(|r| r.set_enet(value)); }
}

impl En for super::spi::Spi2 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc3().spi2() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc3(|r| r.set_spi2(value)); }
}

impl En for super::i2c::I2c0 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc4().i2c0() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc4(|r| r.set_i2c0(value)); }
}

impl En for super::i2c::I2c1 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc4().i2c1() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc4(|r| r.set_i2c1(value)); }
}
...
impl En for super::uart::Uart3 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc4().uart3() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc4(|r| r.set_uart3(value)); }
}
...
impl En for super::spi::Spi0 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc6().spi0() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc6(|r| r.set_spi0(value)); }
}

impl En for super::spi::Spi1 {
   #[inline]
   fn en(&self) -> u32 { SIM.scgc6().spi1() }
   #[inline]
   fn set_en(&self, value: u32) { SIM.with_scgc6(|r| r.set_spi1(value)); }
}
