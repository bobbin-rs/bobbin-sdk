...
impl Sim {
  ...
  #[inline]
  pub fn set_scgc1(&self, value: Scgc1) -> &Sim {
     unsafe {
  ...
  #[inline]
  pub fn with_scgc1<F: FnOnce(Scgc1) -> Scgc1>(&self, f: F) -> &Sim {
     let tmp = self.scgc1();
  ...
  #[inline]
  pub fn set_scgc2(&self, value: Scgc2) -> &Sim {
     unsafe {
  ...
  #[inline]
  pub fn with_scgc2<F: FnOnce(Scgc2) -> Scgc2>(&self, f: F) -> &Sim {
     let tmp = self.scgc2();
  ...
  #[inline]
  pub fn set_scgc3(&self, value: Scgc3) -> &Sim {
     unsafe {
  ...
  #[inline]
  pub fn with_scgc3<F: FnOnce(Scgc3) -> Scgc3>(&self, f: F) -> &Sim {
     let tmp = self.scgc3();
  ...
  #[inline]
  pub fn set_clkdiv2(&self, value: Clkdiv2) -> &Sim {
     unsafe {
  ...
  #[inline]
  pub fn with_clkdiv2<F: FnOnce(Clkdiv2) -> Clkdiv2>(&self, f: F) -> &Sim {
