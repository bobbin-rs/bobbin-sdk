...
impl<T> Periph<T> {
  ...
  #[inline]
  pub fn set_a1(&self, value: A1) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_a1<F: FnOnce(A1) -> A1>(&self, f: F) -> &Self {
     let tmp = self.a1();
     self.set_a1(f(tmp))
  }
  ...
  #[inline]
  pub fn set_f(&self, value: F) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_f<_F: FnOnce(F) -> F>(&self, f: _F) -> &Self {
     let tmp = self.f();
     self.set_f(f(tmp))
  }
  ...
  #[inline]
  pub fn set_flt(&self, value: Flt) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_flt<F: FnOnce(Flt) -> Flt>(&self, f: F) -> &Self {
     let tmp = self.flt();
     self.set_flt(f(tmp))
  }
  ...
  #[inline]
  pub fn set_ra(&self, value: Ra) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_ra<F: FnOnce(Ra) -> Ra>(&self, f: F) -> &Self {
     let tmp = self.ra();
     self.set_ra(f(tmp))
  }
  ...
  #[inline]
  pub fn set_smb(&self, value: Smb) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_smb<F: FnOnce(Smb) -> Smb>(&self, f: F) -> &Self {
     let tmp = self.smb();
     self.set_smb(f(tmp))
  }
  ...
  #[inline]
  pub fn set_a2(&self, value: A2) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_a2<F: FnOnce(A2) -> A2>(&self, f: F) -> &Self {
     let tmp = self.a2();
     self.set_a2(f(tmp))
  }
  ...
  #[inline]
  pub fn set_slth(&self, value: Slth) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_slth<F: FnOnce(Slth) -> Slth>(&self, f: F) -> &Self {
     let tmp = self.slth();
     self.set_slth(f(tmp))
  }
  ...
  #[inline]
  pub fn set_sltl(&self, value: Sltl) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_sltl<F: FnOnce(Sltl) -> Sltl>(&self, f: F) -> &Self {
     let tmp = self.sltl();
     self.set_sltl(f(tmp))
  }
