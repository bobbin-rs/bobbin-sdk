...
impl LpitImpl {
  ...
  #[inline]
  pub fn msr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xc) as *const u32
  }
  #[inline]
  pub fn msr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn mier_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x10) as *const u32
  }
  #[inline]
  pub fn mier_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn setten_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x14) as *const u32
  }
  #[inline]
  pub fn setten_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x14) as *mut u32
  }
  #[inline]
  pub fn setten(&self) -> Setten { 
     unsafe {
  ...
  #[inline]
  pub fn clrten_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x18) as *const u32
  }
  #[inline]
  pub fn clrten_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x18) as *mut u32
  }
  #[inline]
  pub fn clrten(&self) -> Clrten { 
     unsafe {
  ...
  #[inline]
  pub fn tval_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x20 + (index << 4)) as *const u32
  }
  #[inline]
  pub fn tval_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x20 + (index << 4)) as *mut u32
  }
  #[inline]
  pub fn tval(&self, index: usize) -> Tval { 
     assert!(index < 4);
     unsafe {
  ...
  #[inline]
  pub fn cval_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x24 + (index << 4)) as *const u32
  }
  #[inline]
  pub fn cval_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x24 + (index << 4)) as *mut u32
  }
  #[inline]
  pub fn cval(&self, index: usize) -> Cval { 
     assert!(index < 4);
     unsafe {
  ...
  #[inline]
  pub fn tctrl_ptr(&self, index: usize) -> *const u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x28 + (index << 4)) as *const u32
  }
  #[inline]
  pub fn tctrl_mut(&self, index: usize) -> *mut u32 { 
     assert!(index < 4);
     ((self.0 as usize) + 0x28 + (index << 4)) as *mut u32
  }
  #[inline]
  pub fn tctrl(&self, index: usize) -> Tctrl { 
     assert!(index < 4);
     unsafe {
