...
// PeripheralGroup { name: "LPIT", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("LPIT"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "VERID", offset: 0, size: Some(32), access: Some(ReadOnly), reset_value: Some(16777216), reset_mask: Some(4294967295), description: Some("Version ID Register"), fields: [Field { name: "FEATURE", bit_offset: 0, bit_width: 16, access: Some(ReadOnly), description: Some("Feature Number"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MINOR", bit_offset: 16, bit_width: 8, access: Some(ReadOnly), description: Some("Minor Version Number"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MAJOR", bit_offset: 24, bit_width: 8, access: Some(ReadOnly), description: Some("Major Version Number"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PARAM", offset: 4, size: Some(32), access: Some(ReadOnly), reset_value: Some(1028), reset_mask: Some(4294967295), description: Some("Parameter Register"), fields: [Field { name: "CHANNEL", bit_offset: 0, bit_width: 8, access: Some(ReadOnly), description: Some("Number of Timer Channels"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EXT_TRIG", bit_offset: 8, bit_width: 8, access: Some(ReadOnly), description: Some("Number of External Trigger Inputs"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "MCR", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Module Control Register"), fields: [Field { name: "M_CEN", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Module Clock Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Peripheral clock to timers is disabled") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Peripheral clock to timers is enabled") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SW_RST", bit_offset: 1, bit_width: 1, access: Some(ReadWrite), description: Some("Software Reset Bit"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer channels and registers are not reset") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timer channels and registers are reset") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DOZE_EN", bit_offset: 2, bit_width: 1, access: Some(ReadWrite), description: Some("DOZE Mode Enable Bit"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer channels are stopped in DOZE mode") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timer channels continue to run in DOZE mode") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DBG_EN", bit_offset: 3, bit_width: 1, access: Some(ReadWrite), description: Some("Debug Enable Bit"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer channels are stopped in Debug mode") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timer channels continue to run in Debug mode") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "MSR", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Module Status Register"), fields: [Field { name: "TIF", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Channel n Timer Interrupt Flag"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer has not timed out") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timeout has occurred") }], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "MIER", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Module Interrupt Enable Register"), fields: [Field { name: "TIE", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Channel n Timer Interrupt Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Interrupt generation is disabled") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Interrupt generation is enabled") }], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SETTEN", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Set Timer Enable Register"), fields: [Field { name: "SET_T_EN", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Set Timer n Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("No effect") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Enables the Timer Channel 0") }], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CLRTEN", offset: 24, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Clear Timer Enable Register"), fields: [Field { name: "CLR_T_EN", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Clear Timer n Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("No action") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Clear T_EN bit for Timer Channel 0") }], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TVAL", offset: 32, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Timer Value Register"), fields: [Field { name: "TMR_VAL", bit_offset: 0, bit_width: 32, access: Some(ReadWrite), description: Some("Timer Value"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Invalid load value in compare modes.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Invalid load value in compare modes.") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(16), dim_index: None }, Register { name: "CVAL", offset: 36, size: Some(32), access: Some(ReadOnly), reset_value: Some(4294967295), reset_mask: Some(4294967295), description: Some("Current Timer Value"), fields: [Field { name: "TMR_CUR_VAL", bit_offset: 0, bit_width: 32, access: Some(ReadOnly), description: Some("Current Timer Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(16), dim_index: None }, Register { name: "TCTRL", offset: 40, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Timer Control Register"), fields: [Field { name: "T_EN", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Timer Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer Channel is disabled") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timer Channel is enabled") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CHAIN", bit_offset: 1, bit_width: 1, access: Some(ReadWrite), description: Some("Chain Channel"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Channel Chaining is disabled. Channel Timer runs independently.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Channel Chaining is enabled. Timer decrements on previous channel\\\'s timeout") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MODE", bit_offset: 2, bit_width: 2, access: Some(ReadWrite), description: Some("Timer Operation Mode"), enumerated_values: [EnumeratedValue { value: "#00", name: Some("0"), description: Some("32-bit Periodic Counter") }, EnumeratedValue { value: "#01", name: Some("1"), description: Some("Dual 16-bit Periodic Counter") }, EnumeratedValue { value: "#10", name: Some("10"), description: Some("32-bit Trigger Accumulator") }, EnumeratedValue { value: "#11", name: Some("11"), description: Some("32-bit Trigger Input Capture") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSOT", bit_offset: 16, bit_width: 1, access: Some(ReadWrite), description: Some("Timer Start On Trigger"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer starts to decrement immediately based on restart condition (controlled by TSOI bit)") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timer starts to decrement when rising edge on selected trigger is detected") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSOI", bit_offset: 17, bit_width: 1, access: Some(ReadWrite), description: Some("Timer Stop On Interrupt"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("The channel timer does not stop after timeout.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("The channel timer will stop after a timeout, and the channel timer will restart based on TSOT. When TSOT = 0, the channel timer will restart after a rising edge on the T_EN bit is detected (which means that the timer channel is disabled and then enabled); when TSOT = 1, the channel timer will restart after a rising edge on the selected trigger is detected.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TROT", bit_offset: 18, bit_width: 1, access: Some(ReadWrite), description: Some("Timer Reload On Trigger"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Timer will not reload on selected trigger") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Timer will reload on selected trigger") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRG_SRC", bit_offset: 23, bit_width: 1, access: Some(ReadWrite), description: Some("Trigger Source"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Trigger source selected in external") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Trigger source selected is the internal trigger") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRG_SEL", bit_offset: 24, bit_width: 4, access: Some(ReadWrite), description: Some("Trigger Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(16), dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the MCR register."]
   #[inline] pub fn mcr(&self) -> Mcr { 
      unsafe {
         Mcr(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the MSR register."]
   #[inline] pub fn msr(&self) -> Msr { 
      unsafe {
         Msr(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the MIER register."]
   #[inline] pub fn mier(&self) -> Mier { 
      unsafe {
         Mier(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the SETTEN register."]
   #[inline] pub fn setten(&self) -> Setten { 
      unsafe {
         Setten(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the CLRTEN register."]
   #[inline] pub fn clrten(&self) -> Clrten { 
      unsafe {
         Clrten(::core::ptr::read_volatile((self.0 + 0x18) as *const u32))
      }
   }
...
#[doc="Read the TVAL register."]
   #[inline] pub fn tval<I: Into<bits::R4>>(&self, index: I) -> Tval { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tval(::core::ptr::read_volatile((self.0 + 0x20 + (index << 4)) as *const u32))
      }
   }
#[doc="Write the TVAL register."]
   #[inline] pub fn set_tval<I: Into<bits::R4>, F: FnOnce(Tval) -> Tval>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tval(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x20 + (index << 4)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CVAL register."]
   #[inline] pub fn cval<I: Into<bits::R4>>(&self, index: I) -> Cval { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Cval(::core::ptr::read_volatile((self.0 + 0x24 + (index << 4)) as *const u32))
      }
   }
...
#[doc="Read the TCTRL register."]
   #[inline] pub fn tctrl<I: Into<bits::R4>>(&self, index: I) -> Tctrl { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tctrl(::core::ptr::read_volatile((self.0 + 0x28 + (index << 4)) as *const u32))
      }
   }
#[doc="Write the TCTRL register."]
   #[inline] pub fn set_tctrl<I: Into<bits::R4>, F: FnOnce(Tctrl) -> Tctrl>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tctrl(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x28 + (index << 4)) as *mut u32, value.0);
      }
      self
   }
