...
// PeripheralGroup { name: "TPM", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("TPM"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "SC", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Status and Control"), fields: [Field { name: "PS", bit_offset: 0, bit_width: 3, access: Some(ReadWrite), description: Some("Prescale Factor Selection"), enumerated_values: [EnumeratedValue { value: "#000", name: Some("000"), description: Some("Divide by 1") }, EnumeratedValue { value: "#001", name: Some("001"), description: Some("Divide by 2") }, EnumeratedValue { value: "#010", name: Some("010"), description: Some("Divide by 4") }, EnumeratedValue { value: "#011", name: Some("011"), description: Some("Divide by 8") }, EnumeratedValue { value: "#100", name: Some("100"), description: Some("Divide by 16") }, EnumeratedValue { value: "#101", name: Some("101"), description: Some("Divide by 32") }, EnumeratedValue { value: "#110", name: Some("110"), description: Some("Divide by 64") }, EnumeratedValue { value: "#111", name: Some("111"), description: Some("Divide by 128") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMOD", bit_offset: 3, bit_width: 2, access: Some(ReadWrite), description: Some("Clock Mode Selection"), enumerated_values: [EnumeratedValue { value: "#00", name: Some("00"), description: Some("TPM counter is disabled") }, EnumeratedValue { value: "#01", name: Some("01"), description: Some("TPM counter increments on every TPM counter clock") }, EnumeratedValue { value: "#10", name: Some("10"), description: Some("TPM counter increments on rising edge of TPM_EXTCLK synchronized to the TPM counter clock") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CPWMS", bit_offset: 5, bit_width: 1, access: Some(ReadWrite), description: Some("Center-Aligned PWM Select"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("TPM counter operates in up counting mode.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("TPM counter operates in up-down counting mode.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TOIE", bit_offset: 6, bit_width: 1, access: Some(ReadWrite), description: Some("Timer Overflow Interrupt Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Disable TOF interrupts. Use software polling or DMA request.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Enable TOF interrupts. An interrupt is generated when TOF equals one.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TOF", bit_offset: 7, bit_width: 1, access: Some(ReadWrite), description: Some("Timer Overflow Flag"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("TPM counter has not overflowed.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("TPM counter has overflowed.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMA", bit_offset: 8, bit_width: 1, access: Some(ReadWrite), description: Some("DMA Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Disables DMA transfers.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Enables DMA transfers.") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CNT", offset: 4, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Counter"), fields: [Field { name: "COUNT", bit_offset: 0, bit_width: 16, access: Some(ReadWrite), description: Some("Counter value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "MOD", offset: 8, size: Some(32), access: Some(ReadWrite), reset_value: Some(65535), reset_mask: Some(4294967295), description: Some("Modulo"), fields: [Field { name: "MOD", bit_offset: 0, bit_width: 16, access: Some(ReadWrite), description: Some("Modulo value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CSC", offset: 12, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Channel (n) Status and Control"), fields: [Field { name: "DMA", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("DMA Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Disable DMA transfers.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Enable DMA transfers.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ELSA", bit_offset: 2, bit_width: 1, access: Some(ReadWrite), description: Some("Edge or Level Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ELSB", bit_offset: 3, bit_width: 1, access: Some(ReadWrite), description: Some("Edge or Level Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSA", bit_offset: 4, bit_width: 1, access: Some(ReadWrite), description: Some("Channel Mode Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MSB", bit_offset: 5, bit_width: 1, access: Some(ReadWrite), description: Some("Channel Mode Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CHIE", bit_offset: 6, bit_width: 1, access: Some(ReadWrite), description: Some("Channel Interrupt Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Disable channel interrupts.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Enable channel interrupts.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CHF", bit_offset: 7, bit_width: 1, access: Some(ReadWrite), description: Some("Channel Flag"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("No channel event has occurred.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("A channel event has occurred.") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(6), dim_increment: Some(8), dim_index: Some("0,1,2,3,4,5") }, Register { name: "CV", offset: 16, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Channel (n) Value"), fields: [Field { name: "VAL", bit_offset: 0, bit_width: 16, access: Some(ReadWrite), description: Some("Channel Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(6), dim_increment: Some(8), dim_index: Some("0,1,2,3,4,5") }, Register { name: "STATUS", offset: 80, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Capture and Compare Status"), fields: [Field { name: "CHF", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Channel n Flag"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("No channel event has occurred.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("A channel event has occurred.") }], links: [], dim: Some(6), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CONF", offset: 132, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Configuration"), fields: [Field { name: "DOZEEN", bit_offset: 5, bit_width: 1, access: Some(ReadWrite), description: Some("Doze Enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Internal TPM counter continues in Doze mode.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Internal TPM counter is paused and does not increment during Doze mode. Trigger inputs and input capture events are also ignored.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DBGMODE", bit_offset: 6, bit_width: 2, access: Some(ReadWrite), description: Some("Debug Mode"), enumerated_values: [EnumeratedValue { value: "#00", name: Some("00"), description: Some("TPM counter is paused and does not increment during debug mode. Trigger inputs and input capture events are also ignored.") }, EnumeratedValue { value: "#11", name: Some("11"), description: Some("TPM counter continues in debug mode.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "GTBEEN", bit_offset: 9, bit_width: 1, access: Some(ReadWrite), description: Some("Global time base enable"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("All channels use the internally generated TPM counter as their timebase") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("All channels use an externally generated global timebase as their timebase") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CSOT", bit_offset: 16, bit_width: 1, access: Some(ReadWrite), description: Some("Counter Start on Trigger"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("TPM counter starts to increment immediately, once it is enabled.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("TPM counter only starts to increment when it a rising edge on the selected input trigger is detected, after it has been enabled or after it has stopped due to overflow.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CSOO", bit_offset: 17, bit_width: 1, access: Some(ReadWrite), description: Some("Counter Stop On Overflow"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("TPM counter continues incrementing or decrementing after overflow") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("TPM counter stops incrementing or decrementing after overflow.") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CROT", bit_offset: 18, bit_width: 1, access: Some(ReadWrite), description: Some("Counter Reload On Trigger"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Counter is not reloaded due to a rising edge on the selected input trigger") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Counter is reloaded when a rising edge is detected on the selected input trigger") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRGSEL", bit_offset: 24, bit_width: 4, access: Some(ReadWrite), description: Some("Trigger Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
