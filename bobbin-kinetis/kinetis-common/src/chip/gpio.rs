...
// PeripheralGroup { name: "GPIO", peripherals: [], prototype: Some(Peripheral { derived_from: None, group_name: Some("GPIO"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "PDOR", offset: 0, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Port Data Output Register"), fields: [Field { name: "PDO", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Port Data Output"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Logic level 0 is driven on pin, provided pin is configured for general-purpose output.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Logic level 1 is driven on pin, provided pin is configured for general-purpose output.") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PSOR", offset: 4, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Port Set Output Register"), fields: [Field { name: "PTSO", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Port Set Output"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Corresponding bit in PDORn does not change.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Corresponding bit in PDORn is set to logic 1.") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PCOR", offset: 8, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Port Clear Output Register"), fields: [Field { name: "PTCO", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Port Clear Output"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Corresponding bit in PDORn does not change.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Corresponding bit in PDORn is cleared to logic 0.") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PTOR", offset: 12, size: Some(32), access: Some(WriteOnly), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Port Toggle Output Register"), fields: [Field { name: "PTTO", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Port Toggle Output"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Corresponding bit in PDORn does not change.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Corresponding bit in PDORn is set to the inverse of its existing logic state.") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PDIR", offset: 16, size: Some(32), access: Some(ReadOnly), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Port Data Input Register"), fields: [Field { name: "PDI", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Port Data Input"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Pin logic level is logic 0, or is not configured for use by digital function.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Pin logic level is logic 1.") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PDDR", offset: 20, size: Some(32), access: Some(ReadWrite), reset_value: Some(0), reset_mask: Some(4294967295), description: Some("Port Data Direction Register"), fields: [Field { name: "PDD", bit_offset: 0, bit_width: 1, access: Some(ReadWrite), description: Some("Port Data Direction"), enumerated_values: [EnumeratedValue { value: "#0", name: Some("0"), description: Some("Pin is configured as general-purpose input, for the GPIO function.") }, EnumeratedValue { value: "#1", name: Some("1"), description: Some("Pin is configured as general-purpose output, for the GPIO function.") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: true, has_channels: false, description: None }
