...
impl LpspiImpl {
  ...
  #[inline]
  pub fn der_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x1c) as *const u32
  }
  #[inline]
  pub fn der_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn cfgr0_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x20) as *const u32
  }
  #[inline]
  pub fn cfgr0_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x20) as *mut u32
  }
  #[inline]
  pub fn cfgr0(&self) -> Cfgr0 { 
     unsafe {
  ...
  #[inline]
  pub fn dmr0_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x30) as *const u32
  }
  #[inline]
  pub fn dmr0_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x30) as *mut u32
  }
  #[inline]
  pub fn dmr0(&self) -> Dmr0 { 
     unsafe {
  ...
  #[inline]
  pub fn dmr1_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x34) as *const u32
  }
  #[inline]
  pub fn dmr1_mut(&self) -> *mut u32 { 
     ((self.0 as usize) + 0x34) as *mut u32
  }
  #[inline]
  pub fn dmr1(&self) -> Dmr1 { 
     unsafe {
  ...
  #[inline]
  pub fn fcr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x58) as *const u32
  }
  #[inline]
  pub fn fcr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn fsr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x5c) as *const u32
  }
  #[inline]
  pub fn fsr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn tdr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x64) as *const u32
  }
  #[inline]
  pub fn tdr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn rdr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0x74) as *const u32
  }
  #[inline]
  pub fn rdr_mut(&self) -> *mut u32 { 
