...
impl<T> Periph<T> {
  ...
  #[inline]
  pub fn set_ctar(&self, index: usize, value: Ctar) -> &Self {
     assert!(index < 2);
     unsafe {
  ...
  #[inline]
  pub fn with_ctar<F: FnOnce(Ctar) -> Ctar>(&self, index: usize, f: F) -> &Self {
  ...
  #[inline]
  pub fn set_ctar_slave(&self, value: CtarSlave) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_ctar_slave<F: FnOnce(CtarSlave) -> CtarSlave>(&self, f: F) -> &Self {
  ...
  #[inline]
  pub fn set_rser(&self, value: Rser) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_rser<F: FnOnce(Rser) -> Rser>(&self, f: F) -> &Self {
     let tmp = self.rser();
     self.set_rser(f(tmp))
  }
  ...
  #[inline]
  pub fn set_pushr(&self, value: Pushr) -> &Self {
     unsafe {
  ...
  #[inline]
  pub fn with_pushr<F: FnOnce(Pushr) -> Pushr>(&self, f: F) -> &Self {
     let tmp = self.pushr();
  ...
  #[inline]
  pub fn set_pushr_slave(&self, value: PushrSlave) -> &Self {
     unsafe {
       ::core::ptr::write_volatile(((self.0 as usize) + 0x34) as *mut u32, value.0);
     }
     self
  ...
  #[inline]
  pub fn with_pushr_slave<F: FnOnce(PushrSlave) -> PushrSlave>(&self, f: F) -> &Self {
