...
#[doc="Read the CFG1 register."]
  #[inline] pub fn cfg1(&self) -> Cfg1 { 
     unsafe {
        Cfg1(::core::ptr::read_volatile(((self.0 as usize) + 0x8) as *const u32))
     }
  }
...
#[doc="Read the CFG2 register."]
  #[inline] pub fn cfg2(&self) -> Cfg2 { 
     unsafe {
        Cfg2(::core::ptr::read_volatile(((self.0 as usize) + 0xc) as *const u32))
     }
  }
...
#[doc="Read the R register."]
  #[inline] pub fn r<I: Into<bits::R2>>(&self, index: I) -> R { 
     ...
     let index: usize = index.value() as usize;
     unsafe {
        R(::core::ptr::read_volatile(((self.0 as usize) + 0x10 + (index << 2)) as *const u32))
     }
  }
...
#[doc="Read the CV register."]
  #[inline] pub fn cv<I: Into<bits::R2>>(&self, index: I) -> Cv { 
     ...
     let index: usize = index.value() as usize;
     unsafe {
        Cv(::core::ptr::read_volatile(((self.0 as usize) + 0x18 + (index << 2)) as *const u32))
     }
  }
...
#[doc="Read the SC2 register."]
  #[inline] pub fn sc2(&self) -> Sc2 { 
     unsafe {
        Sc2(::core::ptr::read_volatile(((self.0 as usize) + 0x20) as *const u32))
     }
  }
...
#[doc="Read the SC3 register."]
  #[inline] pub fn sc3(&self) -> Sc3 { 
     unsafe {
        Sc3(::core::ptr::read_volatile(((self.0 as usize) + 0x24) as *const u32))
     }
  }
...
#[doc="Read the OFS register."]
  #[inline] pub fn ofs(&self) -> Ofs { 
     unsafe {
        Ofs(::core::ptr::read_volatile(((self.0 as usize) + 0x28) as *const u32))
     }
  }
...
#[doc="Read the PG register."]
  #[inline] pub fn pg(&self) -> Pg { 
     unsafe {
        Pg(::core::ptr::read_volatile(((self.0 as usize) + 0x2c) as *const u32))
     }
  }
...
#[doc="Read the MG register."]
  #[inline] pub fn mg(&self) -> Mg { 
     unsafe {
        Mg(::core::ptr::read_volatile(((self.0 as usize) + 0x30) as *const u32))
     }
  }
...
#[doc="Read the CLPD register."]
  #[inline] pub fn clpd(&self) -> Clpd { 
     unsafe {
        Clpd(::core::ptr::read_volatile(((self.0 as usize) + 0x34) as *const u32))
     }
  }
...
#[doc="Read the CLPS register."]
  #[inline] pub fn clps(&self) -> Clps { 
     unsafe {
        Clps(::core::ptr::read_volatile(((self.0 as usize) + 0x38) as *const u32))
     }
  }
...
#[doc="Read the CLP4 register."]
  #[inline] pub fn clp4(&self) -> Clp4 { 
     unsafe {
        Clp4(::core::ptr::read_volatile(((self.0 as usize) + 0x3c) as *const u32))
     }
  }
...
#[doc="Read the CLP3 register."]
  #[inline] pub fn clp3(&self) -> Clp3 { 
     unsafe {
        Clp3(::core::ptr::read_volatile(((self.0 as usize) + 0x40) as *const u32))
     }
  }
...
#[doc="Read the CLP2 register."]
  #[inline] pub fn clp2(&self) -> Clp2 { 
     unsafe {
        Clp2(::core::ptr::read_volatile(((self.0 as usize) + 0x44) as *const u32))
     }
  }
...
#[doc="Read the CLP1 register."]
  #[inline] pub fn clp1(&self) -> Clp1 { 
     unsafe {
        Clp1(::core::ptr::read_volatile(((self.0 as usize) + 0x48) as *const u32))
     }
  }
...
#[doc="Read the CLP0 register."]
  #[inline] pub fn clp0(&self) -> Clp0 { 
     unsafe {
        Clp0(::core::ptr::read_volatile(((self.0 as usize) + 0x4c) as *const u32))
     }
  }
...
#[doc="Read the CLMD register."]
  #[inline] pub fn clmd(&self) -> Clmd { 
     unsafe {
        Clmd(::core::ptr::read_volatile(((self.0 as usize) + 0x54) as *const u32))
     }
  }
...
#[doc="Read the CLMS register."]
  #[inline] pub fn clms(&self) -> Clms { 
     unsafe {
        Clms(::core::ptr::read_volatile(((self.0 as usize) + 0x58) as *const u32))
     }
  }
...
#[doc="Read the CLM4 register."]
  #[inline] pub fn clm4(&self) -> Clm4 { 
     unsafe {
        Clm4(::core::ptr::read_volatile(((self.0 as usize) + 0x5c) as *const u32))
     }
  }
...
#[doc="Read the CLM3 register."]
  #[inline] pub fn clm3(&self) -> Clm3 { 
     unsafe {
        Clm3(::core::ptr::read_volatile(((self.0 as usize) + 0x60) as *const u32))
     }
  }
...
#[doc="Read the CLM2 register."]
  #[inline] pub fn clm2(&self) -> Clm2 { 
     unsafe {
        Clm2(::core::ptr::read_volatile(((self.0 as usize) + 0x64) as *const u32))
     }
  }
...
#[doc="Read the CLM1 register."]
  #[inline] pub fn clm1(&self) -> Clm1 { 
     unsafe {
        Clm1(::core::ptr::read_volatile(((self.0 as usize) + 0x68) as *const u32))
     }
  }
...
#[doc="Read the CLM0 register."]
  #[inline] pub fn clm0(&self) -> Clm0 { 
     unsafe {
        Clm0(::core::ptr::read_volatile(((self.0 as usize) + 0x6c) as *const u32))
     }
  }
