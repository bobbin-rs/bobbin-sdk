...
impl LinkPortPin<super::port::Pta25 > for Pa25 {
   #[inline] fn port_pin(&self) -> super::port::Pta25  { super::port::PTA25 }
}

impl LinkPortPin<super::port::Pta26 > for Pa26 {
   #[inline] fn port_pin(&self) -> super::port::Pta26  { super::port::PTA26 }
}

impl LinkPortPin<super::port::Pta27 > for Pa27 {
   #[inline] fn port_pin(&self) -> super::port::Pta27  { super::port::PTA27 }
}

impl LinkPortPin<super::port::Pta28 > for Pa28 {
   #[inline] fn port_pin(&self) -> super::port::Pta28  { super::port::PTA28 }
}

impl LinkPortPin<super::port::Pta29 > for Pa29 {
   #[inline] fn port_pin(&self) -> super::port::Pta29  { super::port::PTA29 }
}
...
impl LinkPortPin<super::port::Ptb20 > for Pb20 {
   #[inline] fn port_pin(&self) -> super::port::Ptb20  { super::port::PTB20 }
}

impl LinkPortPin<super::port::Ptb21 > for Pb21 {
   #[inline] fn port_pin(&self) -> super::port::Ptb21  { super::port::PTB21 }
}

impl LinkPortPin<super::port::Ptb22 > for Pb22 {
   #[inline] fn port_pin(&self) -> super::port::Ptb22  { super::port::PTB22 }
}

impl LinkPortPin<super::port::Ptb23 > for Pb23 {
   #[inline] fn port_pin(&self) -> super::port::Ptb23  { super::port::PTB23 }
}
...
impl LinkPortPin<super::port::Ptc18 > for Pc18 {
   #[inline] fn port_pin(&self) -> super::port::Ptc18  { super::port::PTC18 }
}

impl LinkPortPin<super::port::Ptc19 > for Pc19 {
   #[inline] fn port_pin(&self) -> super::port::Ptc19  { super::port::PTC19 }
}
...
impl LinkPortPin<super::port::Pte26 > for Pe26 {
   #[inline] fn port_pin(&self) -> super::port::Pte26  { super::port::PTE26 }
}

impl LinkPortPin<super::port::Pte27 > for Pe27 {
   #[inline] fn port_pin(&self) -> super::port::Pte27  { super::port::PTE27 }
}

impl LinkPortPin<super::port::Pte28 > for Pe28 {
   #[inline] fn port_pin(&self) -> super::port::Pte28  { super::port::PTE28 }
}
