...
pub const SMC: Smc = Smc(0x4007e000);
...
#[doc="Read the PMPROT register."]
  #[inline] pub fn pmprot(&self) -> Pmprot { 
     unsafe {
        Pmprot(::core::ptr::read_volatile(((self.0 as usize) + 0x8) as *const u32))
     }
  }
...
#[doc="Read the PMCTRL register."]
  #[inline] pub fn pmctrl(&self) -> Pmctrl { 
     unsafe {
        Pmctrl(::core::ptr::read_volatile(((self.0 as usize) + 0xc) as *const u32))
     }
  }
...
#[doc="Read the STOPCTRL register."]
  #[inline] pub fn stopctrl(&self) -> Stopctrl { 
     unsafe {
        Stopctrl(::core::ptr::read_volatile(((self.0 as usize) + 0x10) as *const u32))
     }
  }
...
#[doc="Read the PMSTAT register."]
  #[inline] pub fn pmstat(&self) -> Pmstat { 
     unsafe {
        Pmstat(::core::ptr::read_volatile(((self.0 as usize) + 0x14) as *const u32))
     }
  }
