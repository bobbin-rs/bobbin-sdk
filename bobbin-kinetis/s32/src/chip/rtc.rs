...
periph!(RtcPeriph, RTC, Rtc, 0x4003d000);

#[doc="Secure Real Time Clock"]
pub trait RtcPeriph : Base {
#[doc="Get the *const pointer for the TSR register."]
   #[inline] fn tsr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x0)
   }
#[doc="Get the *mut pointer for the TSR register."]
   #[inline] fn tsr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x0)
   }
#[doc="Read the TSR register."]
   #[inline] fn tsr(&self) -> Tsr { 
      unsafe {
         Tsr(::core::ptr::read_volatile((self.base() + 0x0) as *const u32))
      }
   }
#[doc="Write the TSR register."]
   #[inline] fn set_tsr<F: FnOnce(Tsr) -> Tsr>(&self, f: F) -> &Self {
      let value = f(Tsr(0));
      unsafe {
...
#[doc="Modify the TSR register."]
   #[inline] fn with_tsr<F: FnOnce(Tsr) -> Tsr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Tsr(::core::ptr::read_volatile((self.base() + 0x0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the TPR register."]
   #[inline] fn tpr(&self) -> Tpr { 
      unsafe {
         Tpr(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the TAR register."]
   #[inline] fn tar_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x8)
   }
#[doc="Get the *mut pointer for the TAR register."]
   #[inline] fn tar_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x8)
   }
#[doc="Read the TAR register."]
   #[inline] fn tar(&self) -> Tar { 
      unsafe {
         Tar(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      }
   }
#[doc="Write the TAR register."]
   #[inline] fn set_tar<F: FnOnce(Tar) -> Tar>(&self, f: F) -> &Self {
      let value = f(Tar(0));
      unsafe {
...
#[doc="Modify the TAR register."]
   #[inline] fn with_tar<F: FnOnce(Tar) -> Tar>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Tar(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the TCR register."]
   #[inline] fn tcr(&self) -> Tcr { 
      unsafe {
         Tcr(::core::ptr::read_volatile((self.base() + 0xc) as *const u32))
      }
   }
...
#[doc="Get the *const pointer for the LR register."]
   #[inline] fn lr_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Get the *mut pointer for the LR register."]
   #[inline] fn lr_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Read the LR register."]
   #[inline] fn lr(&self) -> Lr { 
      unsafe {
         Lr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      }
   }
#[doc="Write the LR register."]
   #[inline] fn set_lr<F: FnOnce(Lr) -> Lr>(&self, f: F) -> &Self {
      let value = f(Lr(0));
      unsafe {
...
#[doc="Modify the LR register."]
   #[inline] fn with_lr<F: FnOnce(Lr) -> Lr>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lr(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Read the IER register."]
   #[inline] fn ier(&self) -> Ier { 
      unsafe {
         Ier(::core::ptr::read_volatile((self.base() + 0x1c) as *const u32))
      }
   }
