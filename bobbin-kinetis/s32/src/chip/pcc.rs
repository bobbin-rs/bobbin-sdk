...
periph!(PccPeriph, PCC, Pcc, 0x40065000);

#[doc="PCC"]
pub trait PccPeriph : Base {
#[doc="Get the *const pointer for the PCCDUMMY0 register."]
   #[inline] fn pccdummy0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY0 register."]
   #[inline] fn pccdummy0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x0)
   }
#[doc="Read the PCCDUMMY0 register."]
   #[inline] fn pccdummy0(&self) -> Pccdummy0 { 
      unsafe {
         Pccdummy0(::core::ptr::read_volatile((self.base() + 0x0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY0 register."]
   #[inline] fn set_pccdummy0<F: FnOnce(Pccdummy0) -> Pccdummy0>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY0 register."]
   #[inline] fn with_pccdummy0<F: FnOnce(Pccdummy0) -> Pccdummy0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy0(::core::ptr::read_volatile((self.base() + 0x0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY1 register."]
   #[inline] fn pccdummy1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x4)
   }
#[doc="Get the *mut pointer for the PCCDUMMY1 register."]
   #[inline] fn pccdummy1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x4)
   }
#[doc="Read the PCCDUMMY1 register."]
   #[inline] fn pccdummy1(&self) -> Pccdummy1 { 
      unsafe {
         Pccdummy1(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY1 register."]
   #[inline] fn set_pccdummy1<F: FnOnce(Pccdummy1) -> Pccdummy1>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY1 register."]
   #[inline] fn with_pccdummy1<F: FnOnce(Pccdummy1) -> Pccdummy1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy1(::core::ptr::read_volatile((self.base() + 0x4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY2 register."]
   #[inline] fn pccdummy2_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x8)
   }
#[doc="Get the *mut pointer for the PCCDUMMY2 register."]
   #[inline] fn pccdummy2_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x8)
   }
#[doc="Read the PCCDUMMY2 register."]
   #[inline] fn pccdummy2(&self) -> Pccdummy2 { 
      unsafe {
         Pccdummy2(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY2 register."]
   #[inline] fn set_pccdummy2<F: FnOnce(Pccdummy2) -> Pccdummy2>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY2 register."]
   #[inline] fn with_pccdummy2<F: FnOnce(Pccdummy2) -> Pccdummy2>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy2(::core::ptr::read_volatile((self.base() + 0x8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY3 register."]
   #[inline] fn pccdummy3_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xc)
   }
#[doc="Get the *mut pointer for the PCCDUMMY3 register."]
   #[inline] fn pccdummy3_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xc)
   }
#[doc="Read the PCCDUMMY3 register."]
   #[inline] fn pccdummy3(&self) -> Pccdummy3 { 
      unsafe {
         Pccdummy3(::core::ptr::read_volatile((self.base() + 0xc) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY3 register."]
   #[inline] fn set_pccdummy3<F: FnOnce(Pccdummy3) -> Pccdummy3>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY3 register."]
   #[inline] fn with_pccdummy3<F: FnOnce(Pccdummy3) -> Pccdummy3>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy3(::core::ptr::read_volatile((self.base() + 0xc) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY4 register."]
   #[inline] fn pccdummy4_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Get the *mut pointer for the PCCDUMMY4 register."]
   #[inline] fn pccdummy4_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x10)
   }
#[doc="Read the PCCDUMMY4 register."]
   #[inline] fn pccdummy4(&self) -> Pccdummy4 { 
      unsafe {
         Pccdummy4(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY4 register."]
   #[inline] fn set_pccdummy4<F: FnOnce(Pccdummy4) -> Pccdummy4>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY4 register."]
   #[inline] fn with_pccdummy4<F: FnOnce(Pccdummy4) -> Pccdummy4>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy4(::core::ptr::read_volatile((self.base() + 0x10) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY5 register."]
   #[inline] fn pccdummy5_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Get the *mut pointer for the PCCDUMMY5 register."]
   #[inline] fn pccdummy5_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x14)
   }
#[doc="Read the PCCDUMMY5 register."]
   #[inline] fn pccdummy5(&self) -> Pccdummy5 { 
      unsafe {
         Pccdummy5(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY5 register."]
   #[inline] fn set_pccdummy5<F: FnOnce(Pccdummy5) -> Pccdummy5>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY5 register."]
   #[inline] fn with_pccdummy5<F: FnOnce(Pccdummy5) -> Pccdummy5>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy5(::core::ptr::read_volatile((self.base() + 0x14) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY6 register."]
   #[inline] fn pccdummy6_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Get the *mut pointer for the PCCDUMMY6 register."]
   #[inline] fn pccdummy6_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x18)
   }
#[doc="Read the PCCDUMMY6 register."]
   #[inline] fn pccdummy6(&self) -> Pccdummy6 { 
      unsafe {
         Pccdummy6(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY6 register."]
   #[inline] fn set_pccdummy6<F: FnOnce(Pccdummy6) -> Pccdummy6>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY6 register."]
   #[inline] fn with_pccdummy6<F: FnOnce(Pccdummy6) -> Pccdummy6>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy6(::core::ptr::read_volatile((self.base() + 0x18) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY7 register."]
   #[inline] fn pccdummy7_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY7 register."]
   #[inline] fn pccdummy7_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1c)
   }
#[doc="Read the PCCDUMMY7 register."]
   #[inline] fn pccdummy7(&self) -> Pccdummy7 { 
      unsafe {
         Pccdummy7(::core::ptr::read_volatile((self.base() + 0x1c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY7 register."]
   #[inline] fn set_pccdummy7<F: FnOnce(Pccdummy7) -> Pccdummy7>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY7 register."]
   #[inline] fn with_pccdummy7<F: FnOnce(Pccdummy7) -> Pccdummy7>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy7(::core::ptr::read_volatile((self.base() + 0x1c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY8 register."]
   #[inline] fn pccdummy8_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x20)
   }
#[doc="Get the *mut pointer for the PCCDUMMY8 register."]
   #[inline] fn pccdummy8_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x20)
   }
#[doc="Read the PCCDUMMY8 register."]
   #[inline] fn pccdummy8(&self) -> Pccdummy8 { 
      unsafe {
         Pccdummy8(::core::ptr::read_volatile((self.base() + 0x20) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY8 register."]
   #[inline] fn set_pccdummy8<F: FnOnce(Pccdummy8) -> Pccdummy8>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY8 register."]
   #[inline] fn with_pccdummy8<F: FnOnce(Pccdummy8) -> Pccdummy8>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy8(::core::ptr::read_volatile((self.base() + 0x20) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY9 register."]
   #[inline] fn pccdummy9_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x24)
   }
#[doc="Get the *mut pointer for the PCCDUMMY9 register."]
   #[inline] fn pccdummy9_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x24)
   }
#[doc="Read the PCCDUMMY9 register."]
   #[inline] fn pccdummy9(&self) -> Pccdummy9 { 
      unsafe {
         Pccdummy9(::core::ptr::read_volatile((self.base() + 0x24) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY9 register."]
   #[inline] fn set_pccdummy9<F: FnOnce(Pccdummy9) -> Pccdummy9>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY9 register."]
   #[inline] fn with_pccdummy9<F: FnOnce(Pccdummy9) -> Pccdummy9>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy9(::core::ptr::read_volatile((self.base() + 0x24) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY10 register."]
   #[inline] fn pccdummy10_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x28)
   }
#[doc="Get the *mut pointer for the PCCDUMMY10 register."]
   #[inline] fn pccdummy10_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x28)
   }
#[doc="Read the PCCDUMMY10 register."]
   #[inline] fn pccdummy10(&self) -> Pccdummy10 { 
      unsafe {
         Pccdummy10(::core::ptr::read_volatile((self.base() + 0x28) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY10 register."]
   #[inline] fn set_pccdummy10<F: FnOnce(Pccdummy10) -> Pccdummy10>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY10 register."]
   #[inline] fn with_pccdummy10<F: FnOnce(Pccdummy10) -> Pccdummy10>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy10(::core::ptr::read_volatile((self.base() + 0x28) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY11 register."]
   #[inline] fn pccdummy11_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x2c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY11 register."]
   #[inline] fn pccdummy11_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x2c)
   }
#[doc="Read the PCCDUMMY11 register."]
   #[inline] fn pccdummy11(&self) -> Pccdummy11 { 
      unsafe {
         Pccdummy11(::core::ptr::read_volatile((self.base() + 0x2c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY11 register."]
   #[inline] fn set_pccdummy11<F: FnOnce(Pccdummy11) -> Pccdummy11>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY11 register."]
   #[inline] fn with_pccdummy11<F: FnOnce(Pccdummy11) -> Pccdummy11>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy11(::core::ptr::read_volatile((self.base() + 0x2c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY12 register."]
   #[inline] fn pccdummy12_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x30)
   }
#[doc="Get the *mut pointer for the PCCDUMMY12 register."]
   #[inline] fn pccdummy12_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x30)
   }
#[doc="Read the PCCDUMMY12 register."]
   #[inline] fn pccdummy12(&self) -> Pccdummy12 { 
      unsafe {
         Pccdummy12(::core::ptr::read_volatile((self.base() + 0x30) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY12 register."]
   #[inline] fn set_pccdummy12<F: FnOnce(Pccdummy12) -> Pccdummy12>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY12 register."]
   #[inline] fn with_pccdummy12<F: FnOnce(Pccdummy12) -> Pccdummy12>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy12(::core::ptr::read_volatile((self.base() + 0x30) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY13 register."]
   #[inline] fn pccdummy13_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x34)
   }
#[doc="Get the *mut pointer for the PCCDUMMY13 register."]
   #[inline] fn pccdummy13_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x34)
   }
#[doc="Read the PCCDUMMY13 register."]
   #[inline] fn pccdummy13(&self) -> Pccdummy13 { 
      unsafe {
         Pccdummy13(::core::ptr::read_volatile((self.base() + 0x34) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY13 register."]
   #[inline] fn set_pccdummy13<F: FnOnce(Pccdummy13) -> Pccdummy13>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY13 register."]
   #[inline] fn with_pccdummy13<F: FnOnce(Pccdummy13) -> Pccdummy13>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy13(::core::ptr::read_volatile((self.base() + 0x34) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY14 register."]
   #[inline] fn pccdummy14_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x38)
   }
#[doc="Get the *mut pointer for the PCCDUMMY14 register."]
   #[inline] fn pccdummy14_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x38)
   }
#[doc="Read the PCCDUMMY14 register."]
   #[inline] fn pccdummy14(&self) -> Pccdummy14 { 
      unsafe {
         Pccdummy14(::core::ptr::read_volatile((self.base() + 0x38) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY14 register."]
   #[inline] fn set_pccdummy14<F: FnOnce(Pccdummy14) -> Pccdummy14>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY14 register."]
   #[inline] fn with_pccdummy14<F: FnOnce(Pccdummy14) -> Pccdummy14>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy14(::core::ptr::read_volatile((self.base() + 0x38) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY15 register."]
   #[inline] fn pccdummy15_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x3c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY15 register."]
   #[inline] fn pccdummy15_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x3c)
   }
#[doc="Read the PCCDUMMY15 register."]
   #[inline] fn pccdummy15(&self) -> Pccdummy15 { 
      unsafe {
         Pccdummy15(::core::ptr::read_volatile((self.base() + 0x3c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY15 register."]
   #[inline] fn set_pccdummy15<F: FnOnce(Pccdummy15) -> Pccdummy15>(&self, f: F) -> &Self {
      let value = f(Pccdummy15(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x3c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY15 register."]
   #[inline] fn with_pccdummy15<F: FnOnce(Pccdummy15) -> Pccdummy15>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy15(::core::ptr::read_volatile((self.base() + 0x3c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY16 register."]
   #[inline] fn pccdummy16_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x40)
   }
#[doc="Get the *mut pointer for the PCCDUMMY16 register."]
   #[inline] fn pccdummy16_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x40)
   }
#[doc="Read the PCCDUMMY16 register."]
   #[inline] fn pccdummy16(&self) -> Pccdummy16 { 
      unsafe {
         Pccdummy16(::core::ptr::read_volatile((self.base() + 0x40) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY16 register."]
   #[inline] fn set_pccdummy16<F: FnOnce(Pccdummy16) -> Pccdummy16>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY16 register."]
   #[inline] fn with_pccdummy16<F: FnOnce(Pccdummy16) -> Pccdummy16>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy16(::core::ptr::read_volatile((self.base() + 0x40) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY17 register."]
   #[inline] fn pccdummy17_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x44)
   }
#[doc="Get the *mut pointer for the PCCDUMMY17 register."]
   #[inline] fn pccdummy17_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x44)
   }
#[doc="Read the PCCDUMMY17 register."]
   #[inline] fn pccdummy17(&self) -> Pccdummy17 { 
      unsafe {
         Pccdummy17(::core::ptr::read_volatile((self.base() + 0x44) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY17 register."]
   #[inline] fn set_pccdummy17<F: FnOnce(Pccdummy17) -> Pccdummy17>(&self, f: F) -> &Self {
      let value = f(Pccdummy17(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x44) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY17 register."]
   #[inline] fn with_pccdummy17<F: FnOnce(Pccdummy17) -> Pccdummy17>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy17(::core::ptr::read_volatile((self.base() + 0x44) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY18 register."]
   #[inline] fn pccdummy18_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x48)
   }
#[doc="Get the *mut pointer for the PCCDUMMY18 register."]
   #[inline] fn pccdummy18_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x48)
   }
#[doc="Read the PCCDUMMY18 register."]
   #[inline] fn pccdummy18(&self) -> Pccdummy18 { 
      unsafe {
         Pccdummy18(::core::ptr::read_volatile((self.base() + 0x48) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY18 register."]
   #[inline] fn set_pccdummy18<F: FnOnce(Pccdummy18) -> Pccdummy18>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY18 register."]
   #[inline] fn with_pccdummy18<F: FnOnce(Pccdummy18) -> Pccdummy18>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy18(::core::ptr::read_volatile((self.base() + 0x48) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY19 register."]
   #[inline] fn pccdummy19_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x4c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY19 register."]
   #[inline] fn pccdummy19_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x4c)
   }
#[doc="Read the PCCDUMMY19 register."]
   #[inline] fn pccdummy19(&self) -> Pccdummy19 { 
      unsafe {
         Pccdummy19(::core::ptr::read_volatile((self.base() + 0x4c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY19 register."]
   #[inline] fn set_pccdummy19<F: FnOnce(Pccdummy19) -> Pccdummy19>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY19 register."]
   #[inline] fn with_pccdummy19<F: FnOnce(Pccdummy19) -> Pccdummy19>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy19(::core::ptr::read_volatile((self.base() + 0x4c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY20 register."]
   #[inline] fn pccdummy20_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x50)
   }
#[doc="Get the *mut pointer for the PCCDUMMY20 register."]
   #[inline] fn pccdummy20_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x50)
   }
#[doc="Read the PCCDUMMY20 register."]
   #[inline] fn pccdummy20(&self) -> Pccdummy20 { 
      unsafe {
         Pccdummy20(::core::ptr::read_volatile((self.base() + 0x50) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY20 register."]
   #[inline] fn set_pccdummy20<F: FnOnce(Pccdummy20) -> Pccdummy20>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY20 register."]
   #[inline] fn with_pccdummy20<F: FnOnce(Pccdummy20) -> Pccdummy20>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy20(::core::ptr::read_volatile((self.base() + 0x50) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY21 register."]
   #[inline] fn pccdummy21_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x54)
   }
#[doc="Get the *mut pointer for the PCCDUMMY21 register."]
   #[inline] fn pccdummy21_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x54)
   }
#[doc="Read the PCCDUMMY21 register."]
   #[inline] fn pccdummy21(&self) -> Pccdummy21 { 
      unsafe {
         Pccdummy21(::core::ptr::read_volatile((self.base() + 0x54) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY21 register."]
   #[inline] fn set_pccdummy21<F: FnOnce(Pccdummy21) -> Pccdummy21>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY21 register."]
   #[inline] fn with_pccdummy21<F: FnOnce(Pccdummy21) -> Pccdummy21>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy21(::core::ptr::read_volatile((self.base() + 0x54) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY22 register."]
   #[inline] fn pccdummy22_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x58)
   }
#[doc="Get the *mut pointer for the PCCDUMMY22 register."]
   #[inline] fn pccdummy22_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x58)
   }
#[doc="Read the PCCDUMMY22 register."]
   #[inline] fn pccdummy22(&self) -> Pccdummy22 { 
      unsafe {
         Pccdummy22(::core::ptr::read_volatile((self.base() + 0x58) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY22 register."]
   #[inline] fn set_pccdummy22<F: FnOnce(Pccdummy22) -> Pccdummy22>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY22 register."]
   #[inline] fn with_pccdummy22<F: FnOnce(Pccdummy22) -> Pccdummy22>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy22(::core::ptr::read_volatile((self.base() + 0x58) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY23 register."]
   #[inline] fn pccdummy23_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x5c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY23 register."]
   #[inline] fn pccdummy23_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x5c)
   }
#[doc="Read the PCCDUMMY23 register."]
   #[inline] fn pccdummy23(&self) -> Pccdummy23 { 
      unsafe {
         Pccdummy23(::core::ptr::read_volatile((self.base() + 0x5c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY23 register."]
   #[inline] fn set_pccdummy23<F: FnOnce(Pccdummy23) -> Pccdummy23>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY23 register."]
   #[inline] fn with_pccdummy23<F: FnOnce(Pccdummy23) -> Pccdummy23>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy23(::core::ptr::read_volatile((self.base() + 0x5c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY24 register."]
   #[inline] fn pccdummy24_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x60)
   }
#[doc="Get the *mut pointer for the PCCDUMMY24 register."]
   #[inline] fn pccdummy24_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x60)
   }
#[doc="Read the PCCDUMMY24 register."]
   #[inline] fn pccdummy24(&self) -> Pccdummy24 { 
      unsafe {
         Pccdummy24(::core::ptr::read_volatile((self.base() + 0x60) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY24 register."]
   #[inline] fn set_pccdummy24<F: FnOnce(Pccdummy24) -> Pccdummy24>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY24 register."]
   #[inline] fn with_pccdummy24<F: FnOnce(Pccdummy24) -> Pccdummy24>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy24(::core::ptr::read_volatile((self.base() + 0x60) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY25 register."]
   #[inline] fn pccdummy25_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x64)
   }
#[doc="Get the *mut pointer for the PCCDUMMY25 register."]
   #[inline] fn pccdummy25_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x64)
   }
#[doc="Read the PCCDUMMY25 register."]
   #[inline] fn pccdummy25(&self) -> Pccdummy25 { 
      unsafe {
         Pccdummy25(::core::ptr::read_volatile((self.base() + 0x64) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY25 register."]
   #[inline] fn set_pccdummy25<F: FnOnce(Pccdummy25) -> Pccdummy25>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY25 register."]
   #[inline] fn with_pccdummy25<F: FnOnce(Pccdummy25) -> Pccdummy25>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy25(::core::ptr::read_volatile((self.base() + 0x64) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY26 register."]
   #[inline] fn pccdummy26_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x68)
   }
#[doc="Get the *mut pointer for the PCCDUMMY26 register."]
   #[inline] fn pccdummy26_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x68)
   }
#[doc="Read the PCCDUMMY26 register."]
   #[inline] fn pccdummy26(&self) -> Pccdummy26 { 
      unsafe {
         Pccdummy26(::core::ptr::read_volatile((self.base() + 0x68) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY26 register."]
   #[inline] fn set_pccdummy26<F: FnOnce(Pccdummy26) -> Pccdummy26>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY26 register."]
   #[inline] fn with_pccdummy26<F: FnOnce(Pccdummy26) -> Pccdummy26>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy26(::core::ptr::read_volatile((self.base() + 0x68) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY27 register."]
   #[inline] fn pccdummy27_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x6c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY27 register."]
   #[inline] fn pccdummy27_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x6c)
   }
#[doc="Read the PCCDUMMY27 register."]
   #[inline] fn pccdummy27(&self) -> Pccdummy27 { 
      unsafe {
         Pccdummy27(::core::ptr::read_volatile((self.base() + 0x6c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY27 register."]
   #[inline] fn set_pccdummy27<F: FnOnce(Pccdummy27) -> Pccdummy27>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY27 register."]
   #[inline] fn with_pccdummy27<F: FnOnce(Pccdummy27) -> Pccdummy27>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy27(::core::ptr::read_volatile((self.base() + 0x6c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY28 register."]
   #[inline] fn pccdummy28_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x70)
   }
#[doc="Get the *mut pointer for the PCCDUMMY28 register."]
   #[inline] fn pccdummy28_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x70)
   }
#[doc="Read the PCCDUMMY28 register."]
   #[inline] fn pccdummy28(&self) -> Pccdummy28 { 
      unsafe {
         Pccdummy28(::core::ptr::read_volatile((self.base() + 0x70) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY28 register."]
   #[inline] fn set_pccdummy28<F: FnOnce(Pccdummy28) -> Pccdummy28>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY28 register."]
   #[inline] fn with_pccdummy28<F: FnOnce(Pccdummy28) -> Pccdummy28>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy28(::core::ptr::read_volatile((self.base() + 0x70) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY29 register."]
   #[inline] fn pccdummy29_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x74)
   }
#[doc="Get the *mut pointer for the PCCDUMMY29 register."]
   #[inline] fn pccdummy29_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x74)
   }
#[doc="Read the PCCDUMMY29 register."]
   #[inline] fn pccdummy29(&self) -> Pccdummy29 { 
      unsafe {
         Pccdummy29(::core::ptr::read_volatile((self.base() + 0x74) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY29 register."]
   #[inline] fn set_pccdummy29<F: FnOnce(Pccdummy29) -> Pccdummy29>(&self, f: F) -> &Self {
      let value = f(Pccdummy29(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x74) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY29 register."]
   #[inline] fn with_pccdummy29<F: FnOnce(Pccdummy29) -> Pccdummy29>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy29(::core::ptr::read_volatile((self.base() + 0x74) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY30 register."]
   #[inline] fn pccdummy30_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x78)
   }
#[doc="Get the *mut pointer for the PCCDUMMY30 register."]
   #[inline] fn pccdummy30_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x78)
   }
#[doc="Read the PCCDUMMY30 register."]
   #[inline] fn pccdummy30(&self) -> Pccdummy30 { 
      unsafe {
         Pccdummy30(::core::ptr::read_volatile((self.base() + 0x78) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY30 register."]
   #[inline] fn set_pccdummy30<F: FnOnce(Pccdummy30) -> Pccdummy30>(&self, f: F) -> &Self {
      let value = f(Pccdummy30(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x78) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY30 register."]
   #[inline] fn with_pccdummy30<F: FnOnce(Pccdummy30) -> Pccdummy30>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy30(::core::ptr::read_volatile((self.base() + 0x78) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY31 register."]
   #[inline] fn pccdummy31_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x7c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY31 register."]
   #[inline] fn pccdummy31_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x7c)
   }
#[doc="Read the PCCDUMMY31 register."]
   #[inline] fn pccdummy31(&self) -> Pccdummy31 { 
      unsafe {
         Pccdummy31(::core::ptr::read_volatile((self.base() + 0x7c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY31 register."]
   #[inline] fn set_pccdummy31<F: FnOnce(Pccdummy31) -> Pccdummy31>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY31 register."]
   #[inline] fn with_pccdummy31<F: FnOnce(Pccdummy31) -> Pccdummy31>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy31(::core::ptr::read_volatile((self.base() + 0x7c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FTFC register."]
   #[inline] fn ftfc_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x80)
   }
#[doc="Get the *mut pointer for the FTFC register."]
   #[inline] fn ftfc_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x80)
   }
#[doc="Read the FTFC register."]
   #[inline] fn ftfc(&self) -> Ftfc { 
      unsafe {
         Ftfc(::core::ptr::read_volatile((self.base() + 0x80) as *const u32))
      }
   }
#[doc="Write the FTFC register."]
   #[inline] fn set_ftfc<F: FnOnce(Ftfc) -> Ftfc>(&self, f: F) -> &Self {
      let value = f(Ftfc(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x80) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FTFC register."]
   #[inline] fn with_ftfc<F: FnOnce(Ftfc) -> Ftfc>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ftfc(::core::ptr::read_volatile((self.base() + 0x80) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the DMAMUX register."]
   #[inline] fn dmamux_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x84)
   }
#[doc="Get the *mut pointer for the DMAMUX register."]
   #[inline] fn dmamux_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x84)
   }
#[doc="Read the DMAMUX register."]
   #[inline] fn dmamux(&self) -> Dmamux { 
      unsafe {
         Dmamux(::core::ptr::read_volatile((self.base() + 0x84) as *const u32))
      }
   }
#[doc="Write the DMAMUX register."]
   #[inline] fn set_dmamux<F: FnOnce(Dmamux) -> Dmamux>(&self, f: F) -> &Self {
      let value = f(Dmamux(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x84) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the DMAMUX register."]
   #[inline] fn with_dmamux<F: FnOnce(Dmamux) -> Dmamux>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Dmamux(::core::ptr::read_volatile((self.base() + 0x84) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY34 register."]
   #[inline] fn pccdummy34_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x88)
   }
#[doc="Get the *mut pointer for the PCCDUMMY34 register."]
   #[inline] fn pccdummy34_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x88)
   }
#[doc="Read the PCCDUMMY34 register."]
   #[inline] fn pccdummy34(&self) -> Pccdummy34 { 
      unsafe {
         Pccdummy34(::core::ptr::read_volatile((self.base() + 0x88) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY34 register."]
   #[inline] fn set_pccdummy34<F: FnOnce(Pccdummy34) -> Pccdummy34>(&self, f: F) -> &Self {
      let value = f(Pccdummy34(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x88) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY34 register."]
   #[inline] fn with_pccdummy34<F: FnOnce(Pccdummy34) -> Pccdummy34>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy34(::core::ptr::read_volatile((self.base() + 0x88) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY35 register."]
   #[inline] fn pccdummy35_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x8c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY35 register."]
   #[inline] fn pccdummy35_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x8c)
   }
#[doc="Read the PCCDUMMY35 register."]
   #[inline] fn pccdummy35(&self) -> Pccdummy35 { 
      unsafe {
         Pccdummy35(::core::ptr::read_volatile((self.base() + 0x8c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY35 register."]
   #[inline] fn set_pccdummy35<F: FnOnce(Pccdummy35) -> Pccdummy35>(&self, f: F) -> &Self {
      let value = f(Pccdummy35(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x8c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY35 register."]
   #[inline] fn with_pccdummy35<F: FnOnce(Pccdummy35) -> Pccdummy35>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy35(::core::ptr::read_volatile((self.base() + 0x8c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FLEXCAN0 register."]
   #[inline] fn flexcan0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x90)
   }
#[doc="Get the *mut pointer for the FLEXCAN0 register."]
   #[inline] fn flexcan0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x90)
   }
#[doc="Read the FLEXCAN0 register."]
   #[inline] fn flexcan0(&self) -> Flexcan0 { 
      unsafe {
         Flexcan0(::core::ptr::read_volatile((self.base() + 0x90) as *const u32))
      }
   }
#[doc="Write the FLEXCAN0 register."]
   #[inline] fn set_flexcan0<F: FnOnce(Flexcan0) -> Flexcan0>(&self, f: F) -> &Self {
      let value = f(Flexcan0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x90) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FLEXCAN0 register."]
   #[inline] fn with_flexcan0<F: FnOnce(Flexcan0) -> Flexcan0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Flexcan0(::core::ptr::read_volatile((self.base() + 0x90) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FLEXCAN1 register."]
   #[inline] fn flexcan1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x94)
   }
#[doc="Get the *mut pointer for the FLEXCAN1 register."]
   #[inline] fn flexcan1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x94)
   }
#[doc="Read the FLEXCAN1 register."]
   #[inline] fn flexcan1(&self) -> Flexcan1 { 
      unsafe {
         Flexcan1(::core::ptr::read_volatile((self.base() + 0x94) as *const u32))
      }
   }
#[doc="Write the FLEXCAN1 register."]
   #[inline] fn set_flexcan1<F: FnOnce(Flexcan1) -> Flexcan1>(&self, f: F) -> &Self {
      let value = f(Flexcan1(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x94) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FLEXCAN1 register."]
   #[inline] fn with_flexcan1<F: FnOnce(Flexcan1) -> Flexcan1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Flexcan1(::core::ptr::read_volatile((self.base() + 0x94) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FTM3 register."]
   #[inline] fn ftm3_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x98)
   }
#[doc="Get the *mut pointer for the FTM3 register."]
   #[inline] fn ftm3_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x98)
   }
#[doc="Read the FTM3 register."]
   #[inline] fn ftm3(&self) -> Ftm3 { 
      unsafe {
         Ftm3(::core::ptr::read_volatile((self.base() + 0x98) as *const u32))
      }
   }
#[doc="Write the FTM3 register."]
   #[inline] fn set_ftm3<F: FnOnce(Ftm3) -> Ftm3>(&self, f: F) -> &Self {
      let value = f(Ftm3(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x98) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FTM3 register."]
   #[inline] fn with_ftm3<F: FnOnce(Ftm3) -> Ftm3>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ftm3(::core::ptr::read_volatile((self.base() + 0x98) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the ADC1 register."]
   #[inline] fn adc1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x9c)
   }
#[doc="Get the *mut pointer for the ADC1 register."]
   #[inline] fn adc1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x9c)
   }
#[doc="Read the ADC1 register."]
   #[inline] fn adc1(&self) -> Adc1 { 
      unsafe {
         Adc1(::core::ptr::read_volatile((self.base() + 0x9c) as *const u32))
      }
   }
#[doc="Write the ADC1 register."]
   #[inline] fn set_adc1<F: FnOnce(Adc1) -> Adc1>(&self, f: F) -> &Self {
      let value = f(Adc1(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x9c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the ADC1 register."]
   #[inline] fn with_adc1<F: FnOnce(Adc1) -> Adc1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Adc1(::core::ptr::read_volatile((self.base() + 0x9c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY40 register."]
   #[inline] fn pccdummy40_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xa0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY40 register."]
   #[inline] fn pccdummy40_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xa0)
   }
#[doc="Read the PCCDUMMY40 register."]
   #[inline] fn pccdummy40(&self) -> Pccdummy40 { 
      unsafe {
         Pccdummy40(::core::ptr::read_volatile((self.base() + 0xa0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY40 register."]
   #[inline] fn set_pccdummy40<F: FnOnce(Pccdummy40) -> Pccdummy40>(&self, f: F) -> &Self {
      let value = f(Pccdummy40(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xa0) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY40 register."]
   #[inline] fn with_pccdummy40<F: FnOnce(Pccdummy40) -> Pccdummy40>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy40(::core::ptr::read_volatile((self.base() + 0xa0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY41 register."]
   #[inline] fn pccdummy41_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xa4)
   }
#[doc="Get the *mut pointer for the PCCDUMMY41 register."]
   #[inline] fn pccdummy41_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xa4)
   }
#[doc="Read the PCCDUMMY41 register."]
   #[inline] fn pccdummy41(&self) -> Pccdummy41 { 
      unsafe {
         Pccdummy41(::core::ptr::read_volatile((self.base() + 0xa4) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY41 register."]
   #[inline] fn set_pccdummy41<F: FnOnce(Pccdummy41) -> Pccdummy41>(&self, f: F) -> &Self {
      let value = f(Pccdummy41(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xa4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY41 register."]
   #[inline] fn with_pccdummy41<F: FnOnce(Pccdummy41) -> Pccdummy41>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy41(::core::ptr::read_volatile((self.base() + 0xa4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY42 register."]
   #[inline] fn pccdummy42_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xa8)
   }
#[doc="Get the *mut pointer for the PCCDUMMY42 register."]
   #[inline] fn pccdummy42_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xa8)
   }
#[doc="Read the PCCDUMMY42 register."]
   #[inline] fn pccdummy42(&self) -> Pccdummy42 { 
      unsafe {
         Pccdummy42(::core::ptr::read_volatile((self.base() + 0xa8) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY42 register."]
   #[inline] fn set_pccdummy42<F: FnOnce(Pccdummy42) -> Pccdummy42>(&self, f: F) -> &Self {
      let value = f(Pccdummy42(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xa8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY42 register."]
   #[inline] fn with_pccdummy42<F: FnOnce(Pccdummy42) -> Pccdummy42>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy42(::core::ptr::read_volatile((self.base() + 0xa8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FLEXCAN2 register."]
   #[inline] fn flexcan2_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xac)
   }
#[doc="Get the *mut pointer for the FLEXCAN2 register."]
   #[inline] fn flexcan2_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xac)
   }
#[doc="Read the FLEXCAN2 register."]
   #[inline] fn flexcan2(&self) -> Flexcan2 { 
      unsafe {
         Flexcan2(::core::ptr::read_volatile((self.base() + 0xac) as *const u32))
      }
   }
#[doc="Write the FLEXCAN2 register."]
   #[inline] fn set_flexcan2<F: FnOnce(Flexcan2) -> Flexcan2>(&self, f: F) -> &Self {
      let value = f(Flexcan2(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xac) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FLEXCAN2 register."]
   #[inline] fn with_flexcan2<F: FnOnce(Flexcan2) -> Flexcan2>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Flexcan2(::core::ptr::read_volatile((self.base() + 0xac) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPSPI0 register."]
   #[inline] fn lpspi0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xb0)
   }
#[doc="Get the *mut pointer for the LPSPI0 register."]
   #[inline] fn lpspi0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xb0)
   }
#[doc="Read the LPSPI0 register."]
   #[inline] fn lpspi0(&self) -> Lpspi0 { 
      unsafe {
         Lpspi0(::core::ptr::read_volatile((self.base() + 0xb0) as *const u32))
      }
   }
#[doc="Write the LPSPI0 register."]
   #[inline] fn set_lpspi0<F: FnOnce(Lpspi0) -> Lpspi0>(&self, f: F) -> &Self {
...
#[doc="Modify the LPSPI0 register."]
   #[inline] fn with_lpspi0<F: FnOnce(Lpspi0) -> Lpspi0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpspi0(::core::ptr::read_volatile((self.base() + 0xb0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPSPI1 register."]
   #[inline] fn lpspi1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xb4)
   }
#[doc="Get the *mut pointer for the LPSPI1 register."]
   #[inline] fn lpspi1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xb4)
   }
#[doc="Read the LPSPI1 register."]
   #[inline] fn lpspi1(&self) -> Lpspi1 { 
      unsafe {
         Lpspi1(::core::ptr::read_volatile((self.base() + 0xb4) as *const u32))
      }
   }
#[doc="Write the LPSPI1 register."]
   #[inline] fn set_lpspi1<F: FnOnce(Lpspi1) -> Lpspi1>(&self, f: F) -> &Self {
...
#[doc="Modify the LPSPI1 register."]
   #[inline] fn with_lpspi1<F: FnOnce(Lpspi1) -> Lpspi1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpspi1(::core::ptr::read_volatile((self.base() + 0xb4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPSPI2 register."]
   #[inline] fn lpspi2_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xb8)
   }
#[doc="Get the *mut pointer for the LPSPI2 register."]
   #[inline] fn lpspi2_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xb8)
   }
#[doc="Read the LPSPI2 register."]
   #[inline] fn lpspi2(&self) -> Lpspi2 { 
      unsafe {
         Lpspi2(::core::ptr::read_volatile((self.base() + 0xb8) as *const u32))
      }
   }
#[doc="Write the LPSPI2 register."]
   #[inline] fn set_lpspi2<F: FnOnce(Lpspi2) -> Lpspi2>(&self, f: F) -> &Self {
      let value = f(Lpspi2(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xb8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPSPI2 register."]
   #[inline] fn with_lpspi2<F: FnOnce(Lpspi2) -> Lpspi2>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpspi2(::core::ptr::read_volatile((self.base() + 0xb8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY47 register."]
   #[inline] fn pccdummy47_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xbc)
   }
#[doc="Get the *mut pointer for the PCCDUMMY47 register."]
   #[inline] fn pccdummy47_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xbc)
   }
#[doc="Read the PCCDUMMY47 register."]
   #[inline] fn pccdummy47(&self) -> Pccdummy47 { 
      unsafe {
         Pccdummy47(::core::ptr::read_volatile((self.base() + 0xbc) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY47 register."]
   #[inline] fn set_pccdummy47<F: FnOnce(Pccdummy47) -> Pccdummy47>(&self, f: F) -> &Self {
      let value = f(Pccdummy47(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xbc) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY47 register."]
   #[inline] fn with_pccdummy47<F: FnOnce(Pccdummy47) -> Pccdummy47>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy47(::core::ptr::read_volatile((self.base() + 0xbc) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY48 register."]
   #[inline] fn pccdummy48_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xc0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY48 register."]
   #[inline] fn pccdummy48_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xc0)
   }
#[doc="Read the PCCDUMMY48 register."]
   #[inline] fn pccdummy48(&self) -> Pccdummy48 { 
      unsafe {
         Pccdummy48(::core::ptr::read_volatile((self.base() + 0xc0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY48 register."]
   #[inline] fn set_pccdummy48<F: FnOnce(Pccdummy48) -> Pccdummy48>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY48 register."]
   #[inline] fn with_pccdummy48<F: FnOnce(Pccdummy48) -> Pccdummy48>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy48(::core::ptr::read_volatile((self.base() + 0xc0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PDB1 register."]
   #[inline] fn pdb1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xc4)
   }
#[doc="Get the *mut pointer for the PDB1 register."]
   #[inline] fn pdb1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xc4)
   }
#[doc="Read the PDB1 register."]
   #[inline] fn pdb1(&self) -> Pdb1 { 
      unsafe {
         Pdb1(::core::ptr::read_volatile((self.base() + 0xc4) as *const u32))
      }
   }
#[doc="Write the PDB1 register."]
   #[inline] fn set_pdb1<F: FnOnce(Pdb1) -> Pdb1>(&self, f: F) -> &Self {
      let value = f(Pdb1(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xc4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PDB1 register."]
   #[inline] fn with_pdb1<F: FnOnce(Pdb1) -> Pdb1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pdb1(::core::ptr::read_volatile((self.base() + 0xc4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the CRC register."]
   #[inline] fn crc_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xc8)
   }
#[doc="Get the *mut pointer for the CRC register."]
   #[inline] fn crc_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xc8)
   }
#[doc="Read the CRC register."]
   #[inline] fn crc(&self) -> Crc { 
      unsafe {
         Crc(::core::ptr::read_volatile((self.base() + 0xc8) as *const u32))
      }
   }
#[doc="Write the CRC register."]
   #[inline] fn set_crc<F: FnOnce(Crc) -> Crc>(&self, f: F) -> &Self {
      let value = f(Crc(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xc8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the CRC register."]
   #[inline] fn with_crc<F: FnOnce(Crc) -> Crc>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Crc(::core::ptr::read_volatile((self.base() + 0xc8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY51 register."]
   #[inline] fn pccdummy51_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xcc)
   }
#[doc="Get the *mut pointer for the PCCDUMMY51 register."]
   #[inline] fn pccdummy51_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xcc)
   }
#[doc="Read the PCCDUMMY51 register."]
   #[inline] fn pccdummy51(&self) -> Pccdummy51 { 
      unsafe {
         Pccdummy51(::core::ptr::read_volatile((self.base() + 0xcc) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY51 register."]
   #[inline] fn set_pccdummy51<F: FnOnce(Pccdummy51) -> Pccdummy51>(&self, f: F) -> &Self {
      let value = f(Pccdummy51(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xcc) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY51 register."]
   #[inline] fn with_pccdummy51<F: FnOnce(Pccdummy51) -> Pccdummy51>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy51(::core::ptr::read_volatile((self.base() + 0xcc) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY52 register."]
   #[inline] fn pccdummy52_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xd0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY52 register."]
   #[inline] fn pccdummy52_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xd0)
   }
#[doc="Read the PCCDUMMY52 register."]
   #[inline] fn pccdummy52(&self) -> Pccdummy52 { 
      unsafe {
         Pccdummy52(::core::ptr::read_volatile((self.base() + 0xd0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY52 register."]
   #[inline] fn set_pccdummy52<F: FnOnce(Pccdummy52) -> Pccdummy52>(&self, f: F) -> &Self {
      let value = f(Pccdummy52(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xd0) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY52 register."]
   #[inline] fn with_pccdummy52<F: FnOnce(Pccdummy52) -> Pccdummy52>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy52(::core::ptr::read_volatile((self.base() + 0xd0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY53 register."]
   #[inline] fn pccdummy53_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xd4)
   }
#[doc="Get the *mut pointer for the PCCDUMMY53 register."]
   #[inline] fn pccdummy53_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xd4)
   }
#[doc="Read the PCCDUMMY53 register."]
   #[inline] fn pccdummy53(&self) -> Pccdummy53 { 
      unsafe {
         Pccdummy53(::core::ptr::read_volatile((self.base() + 0xd4) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY53 register."]
   #[inline] fn set_pccdummy53<F: FnOnce(Pccdummy53) -> Pccdummy53>(&self, f: F) -> &Self {
      let value = f(Pccdummy53(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xd4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY53 register."]
   #[inline] fn with_pccdummy53<F: FnOnce(Pccdummy53) -> Pccdummy53>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy53(::core::ptr::read_volatile((self.base() + 0xd4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PDB0 register."]
   #[inline] fn pdb0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xd8)
   }
#[doc="Get the *mut pointer for the PDB0 register."]
   #[inline] fn pdb0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xd8)
   }
#[doc="Read the PDB0 register."]
   #[inline] fn pdb0(&self) -> Pdb0 { 
      unsafe {
         Pdb0(::core::ptr::read_volatile((self.base() + 0xd8) as *const u32))
      }
   }
#[doc="Write the PDB0 register."]
   #[inline] fn set_pdb0<F: FnOnce(Pdb0) -> Pdb0>(&self, f: F) -> &Self {
      let value = f(Pdb0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xd8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PDB0 register."]
   #[inline] fn with_pdb0<F: FnOnce(Pdb0) -> Pdb0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pdb0(::core::ptr::read_volatile((self.base() + 0xd8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPIT register."]
   #[inline] fn lpit_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xdc)
   }
#[doc="Get the *mut pointer for the LPIT register."]
   #[inline] fn lpit_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xdc)
   }
#[doc="Read the LPIT register."]
   #[inline] fn lpit(&self) -> Lpit { 
      unsafe {
         Lpit(::core::ptr::read_volatile((self.base() + 0xdc) as *const u32))
      }
   }
#[doc="Write the LPIT register."]
   #[inline] fn set_lpit<F: FnOnce(Lpit) -> Lpit>(&self, f: F) -> &Self {
      let value = f(Lpit(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xdc) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPIT register."]
   #[inline] fn with_lpit<F: FnOnce(Lpit) -> Lpit>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpit(::core::ptr::read_volatile((self.base() + 0xdc) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FTM0 register."]
   #[inline] fn ftm0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xe0)
   }
#[doc="Get the *mut pointer for the FTM0 register."]
   #[inline] fn ftm0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xe0)
   }
#[doc="Read the FTM0 register."]
   #[inline] fn ftm0(&self) -> Ftm0 { 
      unsafe {
         Ftm0(::core::ptr::read_volatile((self.base() + 0xe0) as *const u32))
      }
   }
#[doc="Write the FTM0 register."]
   #[inline] fn set_ftm0<F: FnOnce(Ftm0) -> Ftm0>(&self, f: F) -> &Self {
      let value = f(Ftm0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xe0) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FTM0 register."]
   #[inline] fn with_ftm0<F: FnOnce(Ftm0) -> Ftm0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ftm0(::core::ptr::read_volatile((self.base() + 0xe0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FTM1 register."]
   #[inline] fn ftm1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xe4)
   }
#[doc="Get the *mut pointer for the FTM1 register."]
   #[inline] fn ftm1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xe4)
   }
#[doc="Read the FTM1 register."]
   #[inline] fn ftm1(&self) -> Ftm1 { 
      unsafe {
         Ftm1(::core::ptr::read_volatile((self.base() + 0xe4) as *const u32))
      }
   }
#[doc="Write the FTM1 register."]
   #[inline] fn set_ftm1<F: FnOnce(Ftm1) -> Ftm1>(&self, f: F) -> &Self {
      let value = f(Ftm1(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xe4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FTM1 register."]
   #[inline] fn with_ftm1<F: FnOnce(Ftm1) -> Ftm1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ftm1(::core::ptr::read_volatile((self.base() + 0xe4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FTM2 register."]
   #[inline] fn ftm2_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xe8)
   }
#[doc="Get the *mut pointer for the FTM2 register."]
   #[inline] fn ftm2_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xe8)
   }
#[doc="Read the FTM2 register."]
   #[inline] fn ftm2(&self) -> Ftm2 { 
      unsafe {
         Ftm2(::core::ptr::read_volatile((self.base() + 0xe8) as *const u32))
      }
   }
#[doc="Write the FTM2 register."]
   #[inline] fn set_ftm2<F: FnOnce(Ftm2) -> Ftm2>(&self, f: F) -> &Self {
      let value = f(Ftm2(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xe8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the FTM2 register."]
   #[inline] fn with_ftm2<F: FnOnce(Ftm2) -> Ftm2>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ftm2(::core::ptr::read_volatile((self.base() + 0xe8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the ADC0 register."]
   #[inline] fn adc0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xec)
   }
#[doc="Get the *mut pointer for the ADC0 register."]
   #[inline] fn adc0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xec)
   }
#[doc="Read the ADC0 register."]
   #[inline] fn adc0(&self) -> Adc0 { 
      unsafe {
         Adc0(::core::ptr::read_volatile((self.base() + 0xec) as *const u32))
      }
   }
#[doc="Write the ADC0 register."]
   #[inline] fn set_adc0<F: FnOnce(Adc0) -> Adc0>(&self, f: F) -> &Self {
      let value = f(Adc0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xec) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the ADC0 register."]
   #[inline] fn with_adc0<F: FnOnce(Adc0) -> Adc0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Adc0(::core::ptr::read_volatile((self.base() + 0xec) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY60 register."]
   #[inline] fn pccdummy60_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xf0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY60 register."]
   #[inline] fn pccdummy60_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xf0)
   }
#[doc="Read the PCCDUMMY60 register."]
   #[inline] fn pccdummy60(&self) -> Pccdummy60 { 
      unsafe {
         Pccdummy60(::core::ptr::read_volatile((self.base() + 0xf0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY60 register."]
   #[inline] fn set_pccdummy60<F: FnOnce(Pccdummy60) -> Pccdummy60>(&self, f: F) -> &Self {
      let value = f(Pccdummy60(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xf0) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY60 register."]
   #[inline] fn with_pccdummy60<F: FnOnce(Pccdummy60) -> Pccdummy60>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy60(::core::ptr::read_volatile((self.base() + 0xf0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the RTC register."]
   #[inline] fn rtc_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xf4)
   }
#[doc="Get the *mut pointer for the RTC register."]
   #[inline] fn rtc_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xf4)
   }
#[doc="Read the RTC register."]
   #[inline] fn rtc(&self) -> Rtc { 
      unsafe {
         Rtc(::core::ptr::read_volatile((self.base() + 0xf4) as *const u32))
      }
   }
#[doc="Write the RTC register."]
   #[inline] fn set_rtc<F: FnOnce(Rtc) -> Rtc>(&self, f: F) -> &Self {
      let value = f(Rtc(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xf4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the RTC register."]
   #[inline] fn with_rtc<F: FnOnce(Rtc) -> Rtc>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Rtc(::core::ptr::read_volatile((self.base() + 0xf4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY62 register."]
   #[inline] fn pccdummy62_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xf8)
   }
#[doc="Get the *mut pointer for the PCCDUMMY62 register."]
   #[inline] fn pccdummy62_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xf8)
   }
#[doc="Read the PCCDUMMY62 register."]
   #[inline] fn pccdummy62(&self) -> Pccdummy62 { 
      unsafe {
         Pccdummy62(::core::ptr::read_volatile((self.base() + 0xf8) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY62 register."]
   #[inline] fn set_pccdummy62<F: FnOnce(Pccdummy62) -> Pccdummy62>(&self, f: F) -> &Self {
      let value = f(Pccdummy62(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xf8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY62 register."]
   #[inline] fn with_pccdummy62<F: FnOnce(Pccdummy62) -> Pccdummy62>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy62(::core::ptr::read_volatile((self.base() + 0xf8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY63 register."]
   #[inline] fn pccdummy63_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0xfc)
   }
#[doc="Get the *mut pointer for the PCCDUMMY63 register."]
   #[inline] fn pccdummy63_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0xfc)
   }
#[doc="Read the PCCDUMMY63 register."]
   #[inline] fn pccdummy63(&self) -> Pccdummy63 { 
      unsafe {
         Pccdummy63(::core::ptr::read_volatile((self.base() + 0xfc) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY63 register."]
   #[inline] fn set_pccdummy63<F: FnOnce(Pccdummy63) -> Pccdummy63>(&self, f: F) -> &Self {
      let value = f(Pccdummy63(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0xfc) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY63 register."]
   #[inline] fn with_pccdummy63<F: FnOnce(Pccdummy63) -> Pccdummy63>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy63(::core::ptr::read_volatile((self.base() + 0xfc) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPTMR0 register."]
   #[inline] fn lptmr0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x100)
   }
#[doc="Get the *mut pointer for the LPTMR0 register."]
   #[inline] fn lptmr0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x100)
   }
#[doc="Read the LPTMR0 register."]
   #[inline] fn lptmr0(&self) -> Lptmr0 { 
      unsafe {
         Lptmr0(::core::ptr::read_volatile((self.base() + 0x100) as *const u32))
      }
   }
#[doc="Write the LPTMR0 register."]
   #[inline] fn set_lptmr0<F: FnOnce(Lptmr0) -> Lptmr0>(&self, f: F) -> &Self {
      let value = f(Lptmr0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x100) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPTMR0 register."]
   #[inline] fn with_lptmr0<F: FnOnce(Lptmr0) -> Lptmr0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lptmr0(::core::ptr::read_volatile((self.base() + 0x100) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY65 register."]
   #[inline] fn pccdummy65_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x104)
   }
#[doc="Get the *mut pointer for the PCCDUMMY65 register."]
   #[inline] fn pccdummy65_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x104)
   }
#[doc="Read the PCCDUMMY65 register."]
   #[inline] fn pccdummy65(&self) -> Pccdummy65 { 
      unsafe {
         Pccdummy65(::core::ptr::read_volatile((self.base() + 0x104) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY65 register."]
   #[inline] fn set_pccdummy65<F: FnOnce(Pccdummy65) -> Pccdummy65>(&self, f: F) -> &Self {
      let value = f(Pccdummy65(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x104) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY65 register."]
   #[inline] fn with_pccdummy65<F: FnOnce(Pccdummy65) -> Pccdummy65>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy65(::core::ptr::read_volatile((self.base() + 0x104) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY66 register."]
   #[inline] fn pccdummy66_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x108)
   }
#[doc="Get the *mut pointer for the PCCDUMMY66 register."]
   #[inline] fn pccdummy66_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x108)
   }
#[doc="Read the PCCDUMMY66 register."]
   #[inline] fn pccdummy66(&self) -> Pccdummy66 { 
      unsafe {
         Pccdummy66(::core::ptr::read_volatile((self.base() + 0x108) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY66 register."]
   #[inline] fn set_pccdummy66<F: FnOnce(Pccdummy66) -> Pccdummy66>(&self, f: F) -> &Self {
      let value = f(Pccdummy66(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x108) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY66 register."]
   #[inline] fn with_pccdummy66<F: FnOnce(Pccdummy66) -> Pccdummy66>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy66(::core::ptr::read_volatile((self.base() + 0x108) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY67 register."]
   #[inline] fn pccdummy67_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x10c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY67 register."]
   #[inline] fn pccdummy67_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x10c)
   }
#[doc="Read the PCCDUMMY67 register."]
   #[inline] fn pccdummy67(&self) -> Pccdummy67 { 
      unsafe {
         Pccdummy67(::core::ptr::read_volatile((self.base() + 0x10c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY67 register."]
   #[inline] fn set_pccdummy67<F: FnOnce(Pccdummy67) -> Pccdummy67>(&self, f: F) -> &Self {
      let value = f(Pccdummy67(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x10c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY67 register."]
   #[inline] fn with_pccdummy67<F: FnOnce(Pccdummy67) -> Pccdummy67>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy67(::core::ptr::read_volatile((self.base() + 0x10c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY68 register."]
   #[inline] fn pccdummy68_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x110)
   }
#[doc="Get the *mut pointer for the PCCDUMMY68 register."]
   #[inline] fn pccdummy68_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x110)
   }
#[doc="Read the PCCDUMMY68 register."]
   #[inline] fn pccdummy68(&self) -> Pccdummy68 { 
      unsafe {
         Pccdummy68(::core::ptr::read_volatile((self.base() + 0x110) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY68 register."]
   #[inline] fn set_pccdummy68<F: FnOnce(Pccdummy68) -> Pccdummy68>(&self, f: F) -> &Self {
      let value = f(Pccdummy68(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x110) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY68 register."]
   #[inline] fn with_pccdummy68<F: FnOnce(Pccdummy68) -> Pccdummy68>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy68(::core::ptr::read_volatile((self.base() + 0x110) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY69 register."]
   #[inline] fn pccdummy69_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x114)
   }
#[doc="Get the *mut pointer for the PCCDUMMY69 register."]
   #[inline] fn pccdummy69_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x114)
   }
#[doc="Read the PCCDUMMY69 register."]
   #[inline] fn pccdummy69(&self) -> Pccdummy69 { 
      unsafe {
         Pccdummy69(::core::ptr::read_volatile((self.base() + 0x114) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY69 register."]
   #[inline] fn set_pccdummy69<F: FnOnce(Pccdummy69) -> Pccdummy69>(&self, f: F) -> &Self {
      let value = f(Pccdummy69(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x114) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY69 register."]
   #[inline] fn with_pccdummy69<F: FnOnce(Pccdummy69) -> Pccdummy69>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy69(::core::ptr::read_volatile((self.base() + 0x114) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY70 register."]
   #[inline] fn pccdummy70_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x118)
   }
#[doc="Get the *mut pointer for the PCCDUMMY70 register."]
   #[inline] fn pccdummy70_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x118)
   }
#[doc="Read the PCCDUMMY70 register."]
   #[inline] fn pccdummy70(&self) -> Pccdummy70 { 
      unsafe {
         Pccdummy70(::core::ptr::read_volatile((self.base() + 0x118) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY70 register."]
   #[inline] fn set_pccdummy70<F: FnOnce(Pccdummy70) -> Pccdummy70>(&self, f: F) -> &Self {
      let value = f(Pccdummy70(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x118) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY70 register."]
   #[inline] fn with_pccdummy70<F: FnOnce(Pccdummy70) -> Pccdummy70>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy70(::core::ptr::read_volatile((self.base() + 0x118) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY71 register."]
   #[inline] fn pccdummy71_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x11c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY71 register."]
   #[inline] fn pccdummy71_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x11c)
   }
#[doc="Read the PCCDUMMY71 register."]
   #[inline] fn pccdummy71(&self) -> Pccdummy71 { 
      unsafe {
         Pccdummy71(::core::ptr::read_volatile((self.base() + 0x11c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY71 register."]
   #[inline] fn set_pccdummy71<F: FnOnce(Pccdummy71) -> Pccdummy71>(&self, f: F) -> &Self {
      let value = f(Pccdummy71(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x11c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY71 register."]
   #[inline] fn with_pccdummy71<F: FnOnce(Pccdummy71) -> Pccdummy71>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy71(::core::ptr::read_volatile((self.base() + 0x11c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY72 register."]
   #[inline] fn pccdummy72_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x120)
   }
#[doc="Get the *mut pointer for the PCCDUMMY72 register."]
   #[inline] fn pccdummy72_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x120)
   }
#[doc="Read the PCCDUMMY72 register."]
   #[inline] fn pccdummy72(&self) -> Pccdummy72 { 
      unsafe {
         Pccdummy72(::core::ptr::read_volatile((self.base() + 0x120) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY72 register."]
   #[inline] fn set_pccdummy72<F: FnOnce(Pccdummy72) -> Pccdummy72>(&self, f: F) -> &Self {
      let value = f(Pccdummy72(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x120) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY72 register."]
   #[inline] fn with_pccdummy72<F: FnOnce(Pccdummy72) -> Pccdummy72>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy72(::core::ptr::read_volatile((self.base() + 0x120) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PORTA register."]
   #[inline] fn porta_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x124)
   }
#[doc="Get the *mut pointer for the PORTA register."]
   #[inline] fn porta_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x124)
   }
#[doc="Read the PORTA register."]
   #[inline] fn porta(&self) -> Porta { 
      unsafe {
         Porta(::core::ptr::read_volatile((self.base() + 0x124) as *const u32))
      }
   }
#[doc="Write the PORTA register."]
   #[inline] fn set_porta<F: FnOnce(Porta) -> Porta>(&self, f: F) -> &Self {
      let value = f(Porta(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x124) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PORTA register."]
   #[inline] fn with_porta<F: FnOnce(Porta) -> Porta>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Porta(::core::ptr::read_volatile((self.base() + 0x124) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PORTB register."]
   #[inline] fn portb_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x128)
   }
#[doc="Get the *mut pointer for the PORTB register."]
   #[inline] fn portb_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x128)
   }
#[doc="Read the PORTB register."]
   #[inline] fn portb(&self) -> Portb { 
      unsafe {
         Portb(::core::ptr::read_volatile((self.base() + 0x128) as *const u32))
      }
   }
#[doc="Write the PORTB register."]
   #[inline] fn set_portb<F: FnOnce(Portb) -> Portb>(&self, f: F) -> &Self {
      let value = f(Portb(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x128) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PORTB register."]
   #[inline] fn with_portb<F: FnOnce(Portb) -> Portb>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Portb(::core::ptr::read_volatile((self.base() + 0x128) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PORTC register."]
   #[inline] fn portc_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x12c)
   }
#[doc="Get the *mut pointer for the PORTC register."]
   #[inline] fn portc_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x12c)
   }
#[doc="Read the PORTC register."]
   #[inline] fn portc(&self) -> Portc { 
      unsafe {
         Portc(::core::ptr::read_volatile((self.base() + 0x12c) as *const u32))
      }
   }
#[doc="Write the PORTC register."]
   #[inline] fn set_portc<F: FnOnce(Portc) -> Portc>(&self, f: F) -> &Self {
      let value = f(Portc(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x12c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PORTC register."]
   #[inline] fn with_portc<F: FnOnce(Portc) -> Portc>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Portc(::core::ptr::read_volatile((self.base() + 0x12c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PORTD register."]
   #[inline] fn portd_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x130)
   }
#[doc="Get the *mut pointer for the PORTD register."]
   #[inline] fn portd_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x130)
   }
#[doc="Read the PORTD register."]
   #[inline] fn portd(&self) -> Portd { 
      unsafe {
         Portd(::core::ptr::read_volatile((self.base() + 0x130) as *const u32))
      }
   }
#[doc="Write the PORTD register."]
   #[inline] fn set_portd<F: FnOnce(Portd) -> Portd>(&self, f: F) -> &Self {
      let value = f(Portd(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x130) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PORTD register."]
   #[inline] fn with_portd<F: FnOnce(Portd) -> Portd>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Portd(::core::ptr::read_volatile((self.base() + 0x130) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PORTE register."]
   #[inline] fn porte_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x134)
   }
#[doc="Get the *mut pointer for the PORTE register."]
   #[inline] fn porte_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x134)
   }
#[doc="Read the PORTE register."]
   #[inline] fn porte(&self) -> Porte { 
      unsafe {
         Porte(::core::ptr::read_volatile((self.base() + 0x134) as *const u32))
      }
   }
#[doc="Write the PORTE register."]
   #[inline] fn set_porte<F: FnOnce(Porte) -> Porte>(&self, f: F) -> &Self {
      let value = f(Porte(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x134) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PORTE register."]
   #[inline] fn with_porte<F: FnOnce(Porte) -> Porte>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Porte(::core::ptr::read_volatile((self.base() + 0x134) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY78 register."]
   #[inline] fn pccdummy78_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x138)
   }
#[doc="Get the *mut pointer for the PCCDUMMY78 register."]
   #[inline] fn pccdummy78_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x138)
   }
#[doc="Read the PCCDUMMY78 register."]
   #[inline] fn pccdummy78(&self) -> Pccdummy78 { 
      unsafe {
         Pccdummy78(::core::ptr::read_volatile((self.base() + 0x138) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY78 register."]
   #[inline] fn set_pccdummy78<F: FnOnce(Pccdummy78) -> Pccdummy78>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY78 register."]
   #[inline] fn with_pccdummy78<F: FnOnce(Pccdummy78) -> Pccdummy78>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy78(::core::ptr::read_volatile((self.base() + 0x138) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY79 register."]
   #[inline] fn pccdummy79_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x13c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY79 register."]
   #[inline] fn pccdummy79_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x13c)
   }
#[doc="Read the PCCDUMMY79 register."]
   #[inline] fn pccdummy79(&self) -> Pccdummy79 { 
      unsafe {
         Pccdummy79(::core::ptr::read_volatile((self.base() + 0x13c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY79 register."]
   #[inline] fn set_pccdummy79<F: FnOnce(Pccdummy79) -> Pccdummy79>(&self, f: F) -> &Self {
      let value = f(Pccdummy79(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x13c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY79 register."]
   #[inline] fn with_pccdummy79<F: FnOnce(Pccdummy79) -> Pccdummy79>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy79(::core::ptr::read_volatile((self.base() + 0x13c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY80 register."]
   #[inline] fn pccdummy80_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x140)
   }
#[doc="Get the *mut pointer for the PCCDUMMY80 register."]
   #[inline] fn pccdummy80_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x140)
   }
#[doc="Read the PCCDUMMY80 register."]
   #[inline] fn pccdummy80(&self) -> Pccdummy80 { 
      unsafe {
         Pccdummy80(::core::ptr::read_volatile((self.base() + 0x140) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY80 register."]
   #[inline] fn set_pccdummy80<F: FnOnce(Pccdummy80) -> Pccdummy80>(&self, f: F) -> &Self {
      let value = f(Pccdummy80(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x140) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY80 register."]
   #[inline] fn with_pccdummy80<F: FnOnce(Pccdummy80) -> Pccdummy80>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy80(::core::ptr::read_volatile((self.base() + 0x140) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY81 register."]
   #[inline] fn pccdummy81_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x144)
   }
#[doc="Get the *mut pointer for the PCCDUMMY81 register."]
   #[inline] fn pccdummy81_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x144)
   }
#[doc="Read the PCCDUMMY81 register."]
   #[inline] fn pccdummy81(&self) -> Pccdummy81 { 
      unsafe {
         Pccdummy81(::core::ptr::read_volatile((self.base() + 0x144) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY81 register."]
   #[inline] fn set_pccdummy81<F: FnOnce(Pccdummy81) -> Pccdummy81>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY81 register."]
   #[inline] fn with_pccdummy81<F: FnOnce(Pccdummy81) -> Pccdummy81>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy81(::core::ptr::read_volatile((self.base() + 0x144) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY82 register."]
   #[inline] fn pccdummy82_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x148)
   }
#[doc="Get the *mut pointer for the PCCDUMMY82 register."]
   #[inline] fn pccdummy82_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x148)
   }
#[doc="Read the PCCDUMMY82 register."]
   #[inline] fn pccdummy82(&self) -> Pccdummy82 { 
      unsafe {
         Pccdummy82(::core::ptr::read_volatile((self.base() + 0x148) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY82 register."]
   #[inline] fn set_pccdummy82<F: FnOnce(Pccdummy82) -> Pccdummy82>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY82 register."]
   #[inline] fn with_pccdummy82<F: FnOnce(Pccdummy82) -> Pccdummy82>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy82(::core::ptr::read_volatile((self.base() + 0x148) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY83 register."]
   #[inline] fn pccdummy83_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x14c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY83 register."]
   #[inline] fn pccdummy83_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x14c)
   }
#[doc="Read the PCCDUMMY83 register."]
   #[inline] fn pccdummy83(&self) -> Pccdummy83 { 
      unsafe {
         Pccdummy83(::core::ptr::read_volatile((self.base() + 0x14c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY83 register."]
   #[inline] fn set_pccdummy83<F: FnOnce(Pccdummy83) -> Pccdummy83>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY83 register."]
   #[inline] fn with_pccdummy83<F: FnOnce(Pccdummy83) -> Pccdummy83>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy83(::core::ptr::read_volatile((self.base() + 0x14c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY84 register."]
   #[inline] fn pccdummy84_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x150)
   }
#[doc="Get the *mut pointer for the PCCDUMMY84 register."]
   #[inline] fn pccdummy84_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x150)
   }
#[doc="Read the PCCDUMMY84 register."]
   #[inline] fn pccdummy84(&self) -> Pccdummy84 { 
      unsafe {
         Pccdummy84(::core::ptr::read_volatile((self.base() + 0x150) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY84 register."]
   #[inline] fn set_pccdummy84<F: FnOnce(Pccdummy84) -> Pccdummy84>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY84 register."]
   #[inline] fn with_pccdummy84<F: FnOnce(Pccdummy84) -> Pccdummy84>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy84(::core::ptr::read_volatile((self.base() + 0x150) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY85 register."]
   #[inline] fn pccdummy85_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x154)
   }
#[doc="Get the *mut pointer for the PCCDUMMY85 register."]
   #[inline] fn pccdummy85_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x154)
   }
#[doc="Read the PCCDUMMY85 register."]
   #[inline] fn pccdummy85(&self) -> Pccdummy85 { 
      unsafe {
         Pccdummy85(::core::ptr::read_volatile((self.base() + 0x154) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY85 register."]
   #[inline] fn set_pccdummy85<F: FnOnce(Pccdummy85) -> Pccdummy85>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY85 register."]
   #[inline] fn with_pccdummy85<F: FnOnce(Pccdummy85) -> Pccdummy85>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy85(::core::ptr::read_volatile((self.base() + 0x154) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY86 register."]
   #[inline] fn pccdummy86_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x158)
   }
#[doc="Get the *mut pointer for the PCCDUMMY86 register."]
   #[inline] fn pccdummy86_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x158)
   }
#[doc="Read the PCCDUMMY86 register."]
   #[inline] fn pccdummy86(&self) -> Pccdummy86 { 
      unsafe {
         Pccdummy86(::core::ptr::read_volatile((self.base() + 0x158) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY86 register."]
   #[inline] fn set_pccdummy86<F: FnOnce(Pccdummy86) -> Pccdummy86>(&self, f: F) -> &Self {
      let value = f(Pccdummy86(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x158) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY86 register."]
   #[inline] fn with_pccdummy86<F: FnOnce(Pccdummy86) -> Pccdummy86>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy86(::core::ptr::read_volatile((self.base() + 0x158) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY87 register."]
   #[inline] fn pccdummy87_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x15c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY87 register."]
   #[inline] fn pccdummy87_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x15c)
   }
#[doc="Read the PCCDUMMY87 register."]
   #[inline] fn pccdummy87(&self) -> Pccdummy87 { 
      unsafe {
         Pccdummy87(::core::ptr::read_volatile((self.base() + 0x15c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY87 register."]
   #[inline] fn set_pccdummy87<F: FnOnce(Pccdummy87) -> Pccdummy87>(&self, f: F) -> &Self {
      let value = f(Pccdummy87(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x15c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY87 register."]
   #[inline] fn with_pccdummy87<F: FnOnce(Pccdummy87) -> Pccdummy87>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy87(::core::ptr::read_volatile((self.base() + 0x15c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY88 register."]
   #[inline] fn pccdummy88_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x160)
   }
#[doc="Get the *mut pointer for the PCCDUMMY88 register."]
   #[inline] fn pccdummy88_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x160)
   }
#[doc="Read the PCCDUMMY88 register."]
   #[inline] fn pccdummy88(&self) -> Pccdummy88 { 
      unsafe {
         Pccdummy88(::core::ptr::read_volatile((self.base() + 0x160) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY88 register."]
   #[inline] fn set_pccdummy88<F: FnOnce(Pccdummy88) -> Pccdummy88>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY88 register."]
   #[inline] fn with_pccdummy88<F: FnOnce(Pccdummy88) -> Pccdummy88>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy88(::core::ptr::read_volatile((self.base() + 0x160) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY89 register."]
   #[inline] fn pccdummy89_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x164)
   }
#[doc="Get the *mut pointer for the PCCDUMMY89 register."]
   #[inline] fn pccdummy89_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x164)
   }
#[doc="Read the PCCDUMMY89 register."]
   #[inline] fn pccdummy89(&self) -> Pccdummy89 { 
      unsafe {
         Pccdummy89(::core::ptr::read_volatile((self.base() + 0x164) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY89 register."]
   #[inline] fn set_pccdummy89<F: FnOnce(Pccdummy89) -> Pccdummy89>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY89 register."]
   #[inline] fn with_pccdummy89<F: FnOnce(Pccdummy89) -> Pccdummy89>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy89(::core::ptr::read_volatile((self.base() + 0x164) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the FLEXIO register."]
   #[inline] fn flexio_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x168)
   }
#[doc="Get the *mut pointer for the FLEXIO register."]
   #[inline] fn flexio_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x168)
   }
#[doc="Read the FLEXIO register."]
   #[inline] fn flexio(&self) -> Flexio { 
      unsafe {
         Flexio(::core::ptr::read_volatile((self.base() + 0x168) as *const u32))
      }
   }
#[doc="Write the FLEXIO register."]
   #[inline] fn set_flexio<F: FnOnce(Flexio) -> Flexio>(&self, f: F) -> &Self {
...
#[doc="Modify the FLEXIO register."]
   #[inline] fn with_flexio<F: FnOnce(Flexio) -> Flexio>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Flexio(::core::ptr::read_volatile((self.base() + 0x168) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY91 register."]
   #[inline] fn pccdummy91_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x16c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY91 register."]
   #[inline] fn pccdummy91_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x16c)
   }
#[doc="Read the PCCDUMMY91 register."]
   #[inline] fn pccdummy91(&self) -> Pccdummy91 { 
      unsafe {
         Pccdummy91(::core::ptr::read_volatile((self.base() + 0x16c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY91 register."]
   #[inline] fn set_pccdummy91<F: FnOnce(Pccdummy91) -> Pccdummy91>(&self, f: F) -> &Self {
      let value = f(Pccdummy91(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x16c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY91 register."]
   #[inline] fn with_pccdummy91<F: FnOnce(Pccdummy91) -> Pccdummy91>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy91(::core::ptr::read_volatile((self.base() + 0x16c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY92 register."]
   #[inline] fn pccdummy92_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x170)
   }
#[doc="Get the *mut pointer for the PCCDUMMY92 register."]
   #[inline] fn pccdummy92_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x170)
   }
#[doc="Read the PCCDUMMY92 register."]
   #[inline] fn pccdummy92(&self) -> Pccdummy92 { 
      unsafe {
         Pccdummy92(::core::ptr::read_volatile((self.base() + 0x170) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY92 register."]
   #[inline] fn set_pccdummy92<F: FnOnce(Pccdummy92) -> Pccdummy92>(&self, f: F) -> &Self {
      let value = f(Pccdummy92(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x170) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY92 register."]
   #[inline] fn with_pccdummy92<F: FnOnce(Pccdummy92) -> Pccdummy92>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy92(::core::ptr::read_volatile((self.base() + 0x170) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY93 register."]
   #[inline] fn pccdummy93_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x174)
   }
#[doc="Get the *mut pointer for the PCCDUMMY93 register."]
   #[inline] fn pccdummy93_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x174)
   }
#[doc="Read the PCCDUMMY93 register."]
   #[inline] fn pccdummy93(&self) -> Pccdummy93 { 
      unsafe {
         Pccdummy93(::core::ptr::read_volatile((self.base() + 0x174) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY93 register."]
   #[inline] fn set_pccdummy93<F: FnOnce(Pccdummy93) -> Pccdummy93>(&self, f: F) -> &Self {
      let value = f(Pccdummy93(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x174) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY93 register."]
   #[inline] fn with_pccdummy93<F: FnOnce(Pccdummy93) -> Pccdummy93>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy93(::core::ptr::read_volatile((self.base() + 0x174) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY94 register."]
   #[inline] fn pccdummy94_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x178)
   }
#[doc="Get the *mut pointer for the PCCDUMMY94 register."]
   #[inline] fn pccdummy94_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x178)
   }
#[doc="Read the PCCDUMMY94 register."]
   #[inline] fn pccdummy94(&self) -> Pccdummy94 { 
      unsafe {
         Pccdummy94(::core::ptr::read_volatile((self.base() + 0x178) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY94 register."]
   #[inline] fn set_pccdummy94<F: FnOnce(Pccdummy94) -> Pccdummy94>(&self, f: F) -> &Self {
      let value = f(Pccdummy94(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x178) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY94 register."]
   #[inline] fn with_pccdummy94<F: FnOnce(Pccdummy94) -> Pccdummy94>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy94(::core::ptr::read_volatile((self.base() + 0x178) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY95 register."]
   #[inline] fn pccdummy95_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x17c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY95 register."]
   #[inline] fn pccdummy95_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x17c)
   }
#[doc="Read the PCCDUMMY95 register."]
   #[inline] fn pccdummy95(&self) -> Pccdummy95 { 
      unsafe {
         Pccdummy95(::core::ptr::read_volatile((self.base() + 0x17c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY95 register."]
   #[inline] fn set_pccdummy95<F: FnOnce(Pccdummy95) -> Pccdummy95>(&self, f: F) -> &Self {
      let value = f(Pccdummy95(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x17c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY95 register."]
   #[inline] fn with_pccdummy95<F: FnOnce(Pccdummy95) -> Pccdummy95>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy95(::core::ptr::read_volatile((self.base() + 0x17c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY96 register."]
   #[inline] fn pccdummy96_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x180)
   }
#[doc="Get the *mut pointer for the PCCDUMMY96 register."]
   #[inline] fn pccdummy96_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x180)
   }
#[doc="Read the PCCDUMMY96 register."]
   #[inline] fn pccdummy96(&self) -> Pccdummy96 { 
      unsafe {
         Pccdummy96(::core::ptr::read_volatile((self.base() + 0x180) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY96 register."]
   #[inline] fn set_pccdummy96<F: FnOnce(Pccdummy96) -> Pccdummy96>(&self, f: F) -> &Self {
      let value = f(Pccdummy96(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x180) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY96 register."]
   #[inline] fn with_pccdummy96<F: FnOnce(Pccdummy96) -> Pccdummy96>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy96(::core::ptr::read_volatile((self.base() + 0x180) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the EWM register."]
   #[inline] fn ewm_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x184)
   }
#[doc="Get the *mut pointer for the EWM register."]
   #[inline] fn ewm_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x184)
   }
#[doc="Read the EWM register."]
   #[inline] fn ewm(&self) -> Ewm { 
      unsafe {
         Ewm(::core::ptr::read_volatile((self.base() + 0x184) as *const u32))
      }
   }
#[doc="Write the EWM register."]
   #[inline] fn set_ewm<F: FnOnce(Ewm) -> Ewm>(&self, f: F) -> &Self {
      let value = f(Ewm(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x184) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the EWM register."]
   #[inline] fn with_ewm<F: FnOnce(Ewm) -> Ewm>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Ewm(::core::ptr::read_volatile((self.base() + 0x184) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY98 register."]
   #[inline] fn pccdummy98_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x188)
   }
#[doc="Get the *mut pointer for the PCCDUMMY98 register."]
   #[inline] fn pccdummy98_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x188)
   }
#[doc="Read the PCCDUMMY98 register."]
   #[inline] fn pccdummy98(&self) -> Pccdummy98 { 
      unsafe {
         Pccdummy98(::core::ptr::read_volatile((self.base() + 0x188) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY98 register."]
   #[inline] fn set_pccdummy98<F: FnOnce(Pccdummy98) -> Pccdummy98>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY98 register."]
   #[inline] fn with_pccdummy98<F: FnOnce(Pccdummy98) -> Pccdummy98>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy98(::core::ptr::read_volatile((self.base() + 0x188) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY99 register."]
   #[inline] fn pccdummy99_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x18c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY99 register."]
   #[inline] fn pccdummy99_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x18c)
   }
#[doc="Read the PCCDUMMY99 register."]
   #[inline] fn pccdummy99(&self) -> Pccdummy99 { 
      unsafe {
         Pccdummy99(::core::ptr::read_volatile((self.base() + 0x18c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY99 register."]
   #[inline] fn set_pccdummy99<F: FnOnce(Pccdummy99) -> Pccdummy99>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY99 register."]
   #[inline] fn with_pccdummy99<F: FnOnce(Pccdummy99) -> Pccdummy99>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy99(::core::ptr::read_volatile((self.base() + 0x18c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY100 register."]
   #[inline] fn pccdummy100_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x190)
   }
#[doc="Get the *mut pointer for the PCCDUMMY100 register."]
   #[inline] fn pccdummy100_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x190)
   }
#[doc="Read the PCCDUMMY100 register."]
   #[inline] fn pccdummy100(&self) -> Pccdummy100 { 
      unsafe {
         Pccdummy100(::core::ptr::read_volatile((self.base() + 0x190) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY100 register."]
   #[inline] fn set_pccdummy100<F: FnOnce(Pccdummy100) -> Pccdummy100>(&self, f: F) -> &Self {
      let value = f(Pccdummy100(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x190) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY100 register."]
   #[inline] fn with_pccdummy100<F: FnOnce(Pccdummy100) -> Pccdummy100>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy100(::core::ptr::read_volatile((self.base() + 0x190) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY101 register."]
   #[inline] fn pccdummy101_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x194)
   }
#[doc="Get the *mut pointer for the PCCDUMMY101 register."]
   #[inline] fn pccdummy101_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x194)
   }
#[doc="Read the PCCDUMMY101 register."]
   #[inline] fn pccdummy101(&self) -> Pccdummy101 { 
      unsafe {
         Pccdummy101(::core::ptr::read_volatile((self.base() + 0x194) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY101 register."]
   #[inline] fn set_pccdummy101<F: FnOnce(Pccdummy101) -> Pccdummy101>(&self, f: F) -> &Self {
      let value = f(Pccdummy101(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x194) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY101 register."]
   #[inline] fn with_pccdummy101<F: FnOnce(Pccdummy101) -> Pccdummy101>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy101(::core::ptr::read_volatile((self.base() + 0x194) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPI2C0 register."]
   #[inline] fn lpi2c0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x198)
   }
#[doc="Get the *mut pointer for the LPI2C0 register."]
   #[inline] fn lpi2c0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x198)
   }
#[doc="Read the LPI2C0 register."]
   #[inline] fn lpi2c0(&self) -> Lpi2c0 { 
      unsafe {
         Lpi2c0(::core::ptr::read_volatile((self.base() + 0x198) as *const u32))
      }
   }
#[doc="Write the LPI2C0 register."]
   #[inline] fn set_lpi2c0<F: FnOnce(Lpi2c0) -> Lpi2c0>(&self, f: F) -> &Self {
      let value = f(Lpi2c0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x198) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPI2C0 register."]
   #[inline] fn with_lpi2c0<F: FnOnce(Lpi2c0) -> Lpi2c0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpi2c0(::core::ptr::read_volatile((self.base() + 0x198) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY103 register."]
   #[inline] fn pccdummy103_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x19c)
   }
#[doc="Get the *mut pointer for the PCCDUMMY103 register."]
   #[inline] fn pccdummy103_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x19c)
   }
#[doc="Read the PCCDUMMY103 register."]
   #[inline] fn pccdummy103(&self) -> Pccdummy103 { 
      unsafe {
         Pccdummy103(::core::ptr::read_volatile((self.base() + 0x19c) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY103 register."]
   #[inline] fn set_pccdummy103<F: FnOnce(Pccdummy103) -> Pccdummy103>(&self, f: F) -> &Self {
      let value = f(Pccdummy103(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x19c) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY103 register."]
   #[inline] fn with_pccdummy103<F: FnOnce(Pccdummy103) -> Pccdummy103>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy103(::core::ptr::read_volatile((self.base() + 0x19c) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY104 register."]
   #[inline] fn pccdummy104_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1a0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY104 register."]
   #[inline] fn pccdummy104_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1a0)
   }
#[doc="Read the PCCDUMMY104 register."]
   #[inline] fn pccdummy104(&self) -> Pccdummy104 { 
      unsafe {
         Pccdummy104(::core::ptr::read_volatile((self.base() + 0x1a0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY104 register."]
   #[inline] fn set_pccdummy104<F: FnOnce(Pccdummy104) -> Pccdummy104>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY104 register."]
   #[inline] fn with_pccdummy104<F: FnOnce(Pccdummy104) -> Pccdummy104>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy104(::core::ptr::read_volatile((self.base() + 0x1a0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY105 register."]
   #[inline] fn pccdummy105_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1a4)
   }
#[doc="Get the *mut pointer for the PCCDUMMY105 register."]
   #[inline] fn pccdummy105_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1a4)
   }
#[doc="Read the PCCDUMMY105 register."]
   #[inline] fn pccdummy105(&self) -> Pccdummy105 { 
      unsafe {
         Pccdummy105(::core::ptr::read_volatile((self.base() + 0x1a4) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY105 register."]
   #[inline] fn set_pccdummy105<F: FnOnce(Pccdummy105) -> Pccdummy105>(&self, f: F) -> &Self {
      let value = f(Pccdummy105(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1a4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY105 register."]
   #[inline] fn with_pccdummy105<F: FnOnce(Pccdummy105) -> Pccdummy105>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy105(::core::ptr::read_volatile((self.base() + 0x1a4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPUART0 register."]
   #[inline] fn lpuart0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1a8)
   }
#[doc="Get the *mut pointer for the LPUART0 register."]
   #[inline] fn lpuart0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1a8)
   }
#[doc="Read the LPUART0 register."]
   #[inline] fn lpuart0(&self) -> Lpuart0 { 
      unsafe {
         Lpuart0(::core::ptr::read_volatile((self.base() + 0x1a8) as *const u32))
      }
   }
#[doc="Write the LPUART0 register."]
   #[inline] fn set_lpuart0<F: FnOnce(Lpuart0) -> Lpuart0>(&self, f: F) -> &Self {
      let value = f(Lpuart0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1a8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPUART0 register."]
   #[inline] fn with_lpuart0<F: FnOnce(Lpuart0) -> Lpuart0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpuart0(::core::ptr::read_volatile((self.base() + 0x1a8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPUART1 register."]
   #[inline] fn lpuart1_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1ac)
   }
#[doc="Get the *mut pointer for the LPUART1 register."]
   #[inline] fn lpuart1_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1ac)
   }
#[doc="Read the LPUART1 register."]
   #[inline] fn lpuart1(&self) -> Lpuart1 { 
      unsafe {
         Lpuart1(::core::ptr::read_volatile((self.base() + 0x1ac) as *const u32))
      }
   }
#[doc="Write the LPUART1 register."]
   #[inline] fn set_lpuart1<F: FnOnce(Lpuart1) -> Lpuart1>(&self, f: F) -> &Self {
      let value = f(Lpuart1(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1ac) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPUART1 register."]
   #[inline] fn with_lpuart1<F: FnOnce(Lpuart1) -> Lpuart1>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpuart1(::core::ptr::read_volatile((self.base() + 0x1ac) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the LPUART2 register."]
   #[inline] fn lpuart2_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1b0)
   }
#[doc="Get the *mut pointer for the LPUART2 register."]
   #[inline] fn lpuart2_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1b0)
   }
#[doc="Read the LPUART2 register."]
   #[inline] fn lpuart2(&self) -> Lpuart2 { 
      unsafe {
         Lpuart2(::core::ptr::read_volatile((self.base() + 0x1b0) as *const u32))
      }
   }
#[doc="Write the LPUART2 register."]
   #[inline] fn set_lpuart2<F: FnOnce(Lpuart2) -> Lpuart2>(&self, f: F) -> &Self {
      let value = f(Lpuart2(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1b0) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the LPUART2 register."]
   #[inline] fn with_lpuart2<F: FnOnce(Lpuart2) -> Lpuart2>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Lpuart2(::core::ptr::read_volatile((self.base() + 0x1b0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY109 register."]
   #[inline] fn pccdummy109_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1b4)
   }
#[doc="Get the *mut pointer for the PCCDUMMY109 register."]
   #[inline] fn pccdummy109_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1b4)
   }
#[doc="Read the PCCDUMMY109 register."]
   #[inline] fn pccdummy109(&self) -> Pccdummy109 { 
      unsafe {
         Pccdummy109(::core::ptr::read_volatile((self.base() + 0x1b4) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY109 register."]
   #[inline] fn set_pccdummy109<F: FnOnce(Pccdummy109) -> Pccdummy109>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY109 register."]
   #[inline] fn with_pccdummy109<F: FnOnce(Pccdummy109) -> Pccdummy109>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy109(::core::ptr::read_volatile((self.base() + 0x1b4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY110 register."]
   #[inline] fn pccdummy110_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1b8)
   }
#[doc="Get the *mut pointer for the PCCDUMMY110 register."]
   #[inline] fn pccdummy110_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1b8)
   }
#[doc="Read the PCCDUMMY110 register."]
   #[inline] fn pccdummy110(&self) -> Pccdummy110 { 
      unsafe {
         Pccdummy110(::core::ptr::read_volatile((self.base() + 0x1b8) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY110 register."]
   #[inline] fn set_pccdummy110<F: FnOnce(Pccdummy110) -> Pccdummy110>(&self, f: F) -> &Self {
      let value = f(Pccdummy110(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1b8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY110 register."]
   #[inline] fn with_pccdummy110<F: FnOnce(Pccdummy110) -> Pccdummy110>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy110(::core::ptr::read_volatile((self.base() + 0x1b8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY111 register."]
   #[inline] fn pccdummy111_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1bc)
   }
#[doc="Get the *mut pointer for the PCCDUMMY111 register."]
   #[inline] fn pccdummy111_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1bc)
   }
#[doc="Read the PCCDUMMY111 register."]
   #[inline] fn pccdummy111(&self) -> Pccdummy111 { 
      unsafe {
         Pccdummy111(::core::ptr::read_volatile((self.base() + 0x1bc) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY111 register."]
   #[inline] fn set_pccdummy111<F: FnOnce(Pccdummy111) -> Pccdummy111>(&self, f: F) -> &Self {
...
#[doc="Modify the PCCDUMMY111 register."]
   #[inline] fn with_pccdummy111<F: FnOnce(Pccdummy111) -> Pccdummy111>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy111(::core::ptr::read_volatile((self.base() + 0x1bc) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY112 register."]
   #[inline] fn pccdummy112_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1c0)
   }
#[doc="Get the *mut pointer for the PCCDUMMY112 register."]
   #[inline] fn pccdummy112_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1c0)
   }
#[doc="Read the PCCDUMMY112 register."]
   #[inline] fn pccdummy112(&self) -> Pccdummy112 { 
      unsafe {
         Pccdummy112(::core::ptr::read_volatile((self.base() + 0x1c0) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY112 register."]
   #[inline] fn set_pccdummy112<F: FnOnce(Pccdummy112) -> Pccdummy112>(&self, f: F) -> &Self {
      let value = f(Pccdummy112(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1c0) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY112 register."]
   #[inline] fn with_pccdummy112<F: FnOnce(Pccdummy112) -> Pccdummy112>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy112(::core::ptr::read_volatile((self.base() + 0x1c0) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY113 register."]
   #[inline] fn pccdummy113_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1c4)
   }
#[doc="Get the *mut pointer for the PCCDUMMY113 register."]
   #[inline] fn pccdummy113_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1c4)
   }
#[doc="Read the PCCDUMMY113 register."]
   #[inline] fn pccdummy113(&self) -> Pccdummy113 { 
      unsafe {
         Pccdummy113(::core::ptr::read_volatile((self.base() + 0x1c4) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY113 register."]
   #[inline] fn set_pccdummy113<F: FnOnce(Pccdummy113) -> Pccdummy113>(&self, f: F) -> &Self {
      let value = f(Pccdummy113(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1c4) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY113 register."]
   #[inline] fn with_pccdummy113<F: FnOnce(Pccdummy113) -> Pccdummy113>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy113(::core::ptr::read_volatile((self.base() + 0x1c4) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the PCCDUMMY114 register."]
   #[inline] fn pccdummy114_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1c8)
   }
#[doc="Get the *mut pointer for the PCCDUMMY114 register."]
   #[inline] fn pccdummy114_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1c8)
   }
#[doc="Read the PCCDUMMY114 register."]
   #[inline] fn pccdummy114(&self) -> Pccdummy114 { 
      unsafe {
         Pccdummy114(::core::ptr::read_volatile((self.base() + 0x1c8) as *const u32))
      }
   }
#[doc="Write the PCCDUMMY114 register."]
   #[inline] fn set_pccdummy114<F: FnOnce(Pccdummy114) -> Pccdummy114>(&self, f: F) -> &Self {
      let value = f(Pccdummy114(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1c8) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the PCCDUMMY114 register."]
   #[inline] fn with_pccdummy114<F: FnOnce(Pccdummy114) -> Pccdummy114>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Pccdummy114(::core::ptr::read_volatile((self.base() + 0x1c8) as *const u32))
      };
      let value = f(tmp);
...
#[doc="Get the *const pointer for the CMP0 register."]
   #[inline] fn cmp0_ptr(&self) -> *const u32 { 
       <Self as Base>::addr(&self, 0x1cc)
   }
#[doc="Get the *mut pointer for the CMP0 register."]
   #[inline] fn cmp0_mut(&self) -> *mut u32 { 
       <Self as Base>::addr(&self, 0x1cc)
   }
#[doc="Read the CMP0 register."]
   #[inline] fn cmp0(&self) -> Cmp0 { 
      unsafe {
         Cmp0(::core::ptr::read_volatile((self.base() + 0x1cc) as *const u32))
      }
   }
#[doc="Write the CMP0 register."]
   #[inline] fn set_cmp0<F: FnOnce(Cmp0) -> Cmp0>(&self, f: F) -> &Self {
      let value = f(Cmp0(0));
      unsafe {
         ::core::ptr::write_volatile((self.base() + 0x1cc) as *mut u32, value.0);
      }
      self
   }
#[doc="Modify the CMP0 register."]
   #[inline] fn with_cmp0<F: FnOnce(Cmp0) -> Cmp0>(&self, f: F) -> &Self {
      let tmp = unsafe {
         Cmp0(::core::ptr::read_volatile((self.base() + 0x1cc) as *const u32))
      };
      let value = f(tmp);
