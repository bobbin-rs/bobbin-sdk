...
impl LinkGpioPin<super::gpio::Pb14 > for Ptb14 {
   fn gpio_pin(&self) -> super::gpio::Pb14  { super::gpio::PB14 }
}

impl LinkGpioPin<super::gpio::Pb15 > for Ptb15 {
   fn gpio_pin(&self) -> super::gpio::Pb15  { super::gpio::PB15 }
}
...
impl LinkGpioPin<super::gpio::Pd16 > for Ptd16 {
   fn gpio_pin(&self) -> super::gpio::Pd16  { super::gpio::PD16 }
}

impl LinkGpioPin<super::gpio::Pd17 > for Ptd17 {
   fn gpio_pin(&self) -> super::gpio::Pd17  { super::gpio::PD17 }
}
...
impl LinkGpioPin<super::gpio::Pe13 > for Pte13 {
   fn gpio_pin(&self) -> super::gpio::Pe13  { super::gpio::PE13 }
}

impl LinkGpioPin<super::gpio::Pe14 > for Pte14 {
   fn gpio_pin(&self) -> super::gpio::Pe14  { super::gpio::PE14 }
}

impl LinkGpioPin<super::gpio::Pe15 > for Pte15 {
   fn gpio_pin(&self) -> super::gpio::Pe15  { super::gpio::PE15 }
}

impl LinkGpioPin<super::gpio::Pe16 > for Pte16 {
   fn gpio_pin(&self) -> super::gpio::Pe16  { super::gpio::PE16 }
}
