...
// PeripheralGroup { name: "DMAC", peripherals: [Peripheral { derived_from: None, group_name: None, name: "DMAC", address: 1090537472, size: None, access: None, reset_value: None, reset_mask: None, description: Some("Direct Memory Access Controller"), modules: [], features: [], links: [], interrupts: [Interrupt { name: "DMAC", types: ["DMA"], value: 6, description: None }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "DMAC_CH0", index: Some(0), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH1", index: Some(1), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH2", index: Some(2), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH3", index: Some(3), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH4", index: Some(4), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH5", index: Some(5), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH6", index: Some(6), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH7", index: Some(7), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH8", index: Some(8), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH9", index: Some(9), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH10", index: Some(10), description: None, signals: [], interrupts: [] }, Channel { name: "DMAC_CH11", index: Some(11), description: None, signals: [], interrupts: [] }], dim: None, dim_increment: None, dim_index: None }], prototype: Some(Peripheral { derived_from: None, group_name: Some("DMAC"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "ACTIVE", offset: 48, size: Some(32), access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("Active Channel and Levels"), fields: [Field { name: "LVLEX", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Level n Channel Trigger Request Executing"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }, Field { name: "ID", bit_offset: 8, bit_width: 5, access: Some(ReadOnly), description: Some("Active Channel ID"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ABUSY", bit_offset: 15, bit_width: 1, access: Some(ReadOnly), description: Some("Active Channel Busy"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BTCNT", bit_offset: 16, bit_width: 16, access: Some(ReadOnly), description: Some("Active Channel Block Transfer Count"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BASEADDR", offset: 52, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Descriptor Memory Section Base Address"), fields: [Field { name: "BASEADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Descriptor Memory Base Address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BUSYCH", offset: 40, size: Some(32), access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("Busy Channels"), fields: [Field { name: "BUSYCH", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Busy Channel n"), enumerated_values: [], links: [], dim: Some(12), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHCTRLA", offset: 64, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("Channel Control A"), fields: [Field { name: "SWRST", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel Software Reset"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ENABLE", bit_offset: 1, bit_width: 1, access: None, description: Some("Channel Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHCTRLB", offset: 68, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Channel Control B"), fields: [Field { name: "EVACT", bit_offset: 0, bit_width: 3, access: None, description: Some("Event Input Action"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NOACT"), description: Some("No action") }, EnumeratedValue { value: "0x1", name: Some("TRIG"), description: Some("Transfer and periodic transfer trigger") }, EnumeratedValue { value: "0x2", name: Some("CTRIG"), description: Some("Conditional transfer trigger") }, EnumeratedValue { value: "0x3", name: Some("CBLOCK"), description: Some("Conditional block transfer") }, EnumeratedValue { value: "0x4", name: Some("SUSPEND"), description: Some("Channel suspend operation") }, EnumeratedValue { value: "0x5", name: Some("RESUME"), description: Some("Channel resume operation") }, EnumeratedValue { value: "0x6", name: Some("SSKIP"), description: Some("Skip next block suspend action") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EVIE", bit_offset: 3, bit_width: 1, access: None, description: Some("Channel Event Input Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EVOE", bit_offset: 4, bit_width: 1, access: None, description: Some("Channel Event Output Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LVL", bit_offset: 5, bit_width: 2, access: None, description: Some("Channel Arbitration Level"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRIGSRC", bit_offset: 8, bit_width: 6, access: None, description: Some("Peripheral Trigger Source"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("DISABLE"), description: Some("Only software/event triggers") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRIGACT", bit_offset: 22, bit_width: 2, access: None, description: Some("Trigger Action"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("BLOCK"), description: Some("One trigger required for each block transfer") }, EnumeratedValue { value: "0x2", name: Some("BEAT"), description: Some("One trigger required for each beat transfer") }, EnumeratedValue { value: "0x3", name: Some("TRANSACTION"), description: Some("One trigger required for each transaction") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMD", bit_offset: 24, bit_width: 2, access: None, description: Some("Software Command"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NOACT"), description: Some("No action") }, EnumeratedValue { value: "0x1", name: Some("SUSPEND"), description: Some("Channel suspend operation") }, EnumeratedValue { value: "0x2", name: Some("RESUME"), description: Some("Channel resume operation") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHID", offset: 63, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("Channel ID"), fields: [Field { name: "ID", bit_offset: 0, bit_width: 4, access: None, description: Some("Channel ID"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHINTENCLR", offset: 76, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("Channel Interrupt Enable Clear"), fields: [Field { name: "TERR", bit_offset: 0, bit_width: 1, access: None, description: Some("Transfer Error Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCMPL", bit_offset: 1, bit_width: 1, access: None, description: Some("Transfer Complete Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SUSP", bit_offset: 2, bit_width: 1, access: None, description: Some("Channel Suspend Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHINTENSET", offset: 77, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("Channel Interrupt Enable Set"), fields: [Field { name: "TERR", bit_offset: 0, bit_width: 1, access: None, description: Some("Transfer Error Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCMPL", bit_offset: 1, bit_width: 1, access: None, description: Some("Transfer Complete Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SUSP", bit_offset: 2, bit_width: 1, access: None, description: Some("Channel Suspend Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHINTFLAG", offset: 78, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("Channel Interrupt Flag Status and Clear"), fields: [Field { name: "TERR", bit_offset: 0, bit_width: 1, access: None, description: Some("Transfer Error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCMPL", bit_offset: 1, bit_width: 1, access: None, description: Some("Transfer Complete"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SUSP", bit_offset: 2, bit_width: 1, access: None, description: Some("Channel Suspend"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHSTATUS", offset: 79, size: Some(8), access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("Channel Status"), fields: [Field { name: "PEND", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Channel Pending"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BUSY", bit_offset: 1, bit_width: 1, access: Some(ReadOnly), description: Some("Channel Busy"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FERR", bit_offset: 2, bit_width: 1, access: Some(ReadOnly), description: Some("Fetch Error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CRCCHKSUM", offset: 8, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("CRC Checksum"), fields: [Field { name: "CRCCHKSUM", bit_offset: 0, bit_width: 32, access: None, description: Some("CRC Checksum"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CRCCTRL", offset: 2, size: Some(16), access: None, reset_value: None, reset_mask: None, description: Some("CRC Control"), fields: [Field { name: "CRCBEATSIZE", bit_offset: 0, bit_width: 2, access: None, description: Some("CRC Beat Size"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("BYTE"), description: Some("Byte bus access") }, EnumeratedValue { value: "0x1", name: Some("HWORD"), description: Some("Half-word bus access") }, EnumeratedValue { value: "0x2", name: Some("WORD"), description: Some("Word bus access") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCPOLY", bit_offset: 2, bit_width: 2, access: None, description: Some("CRC Polynomial Type"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("CRC16"), description: Some("CRC-16 (CRC-CCITT)") }, EnumeratedValue { value: "0x1", name: Some("CRC32"), description: Some("CRC32 (IEEE 802.3)") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCSRC", bit_offset: 8, bit_width: 6, access: None, description: Some("CRC Input Source"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NOACT"), description: Some("No action") }, EnumeratedValue { value: "0x1", name: Some("IO"), description: Some("I/O interface") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CRCDATAIN", offset: 4, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("CRC Data Input"), fields: [Field { name: "CRCDATAIN", bit_offset: 0, bit_width: 32, access: None, description: Some("CRC Data Input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CRCSTATUS", offset: 12, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("CRC Status"), fields: [Field { name: "CRCBUSY", bit_offset: 0, bit_width: 1, access: None, description: Some("CRC Module Busy"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCZERO", bit_offset: 1, bit_width: 1, access: Some(ReadOnly), description: Some("CRC Zero"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CTRL", offset: 0, size: Some(16), access: None, reset_value: None, reset_mask: None, description: Some("Control"), fields: [Field { name: "SWRST", bit_offset: 0, bit_width: 1, access: None, description: Some("Software Reset"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAENABLE", bit_offset: 1, bit_width: 1, access: None, description: Some("DMA Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CRCENABLE", bit_offset: 2, bit_width: 1, access: None, description: Some("CRC Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LVLEN", bit_offset: 8, bit_width: 1, access: None, description: Some("Priority Level n Enable"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DBGCTRL", offset: 13, size: Some(8), access: None, reset_value: None, reset_mask: None, description: Some("Debug Control"), fields: [Field { name: "DBGRUN", bit_offset: 0, bit_width: 1, access: None, description: Some("Debug Run"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "INTPEND", offset: 32, size: Some(16), access: None, reset_value: None, reset_mask: None, description: Some("Interrupt Pending"), fields: [Field { name: "ID", bit_offset: 0, bit_width: 4, access: None, description: Some("Channel ID"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TERR", bit_offset: 8, bit_width: 1, access: None, description: Some("Transfer Error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCMPL", bit_offset: 9, bit_width: 1, access: None, description: Some("Transfer Complete"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SUSP", bit_offset: 10, bit_width: 1, access: None, description: Some("Channel Suspend"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FERR", bit_offset: 13, bit_width: 1, access: Some(ReadOnly), description: Some("Fetch Error"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BUSY", bit_offset: 14, bit_width: 1, access: Some(ReadOnly), description: Some("Busy"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "PEND", bit_offset: 15, bit_width: 1, access: Some(ReadOnly), description: Some("Pending"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "INTSTATUS", offset: 36, size: Some(32), access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("Interrupt Status"), fields: [Field { name: "CHINT", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Channel n Pending Interrupt"), enumerated_values: [], links: [], dim: Some(12), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PENDCH", offset: 44, size: Some(32), access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("Pending Channels"), fields: [Field { name: "PENDCH", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Pending Channel n"), enumerated_values: [], links: [], dim: Some(12), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PRICTRL", offset: 20, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Priority Control 0"), fields: [Field { name: "LVLPRI", bit_offset: 0, bit_width: 4, access: None, description: Some("Level n Channel Priority Number"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(8), dim_index: None }, Field { name: "RRLVLEN", bit_offset: 7, bit_width: 1, access: None, description: Some("Level 0 Round-Robin Scheduling Enable"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(8), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SWTRIGCTRL", offset: 16, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Software Trigger Control"), fields: [Field { name: "SWTRIG", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel n Software Trigger"), enumerated_values: [], links: [], dim: Some(12), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "WRBADDR", offset: 56, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Write-Back Memory Section Base Address"), fields: [Field { name: "WRBADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Write-Back Memory Base Address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [Descriptor { name: "TRANSFER", size: Some(16), registers: [Register { name: "BTCTRL", offset: 0, size: Some(16), access: None, reset_value: None, reset_mask: None, description: Some("Block Transfer Control"), fields: [Field { name: "VALID", bit_offset: 0, bit_width: 1, access: None, description: Some("Descriptor Valid"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EVOSEL", bit_offset: 1, bit_width: 2, access: None, description: Some("Event Output Selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BLOCKACT", bit_offset: 3, bit_width: 2, access: None, description: Some("Block Action"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "BEATSIZE", bit_offset: 8, bit_width: 2, access: None, description: Some("Beat Size"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SRCINC", bit_offset: 10, bit_width: 1, access: None, description: Some("Source Address Increment Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DSTINC", bit_offset: 11, bit_width: 1, access: None, description: Some("Destination Address Increment Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "STEPSEL", bit_offset: 12, bit_width: 1, access: None, description: Some("Step Selection"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "STEPSIZE", bit_offset: 13, bit_width: 3, access: None, description: Some("Address Increment Step Size"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "BTCNT", offset: 2, size: Some(16), access: None, reset_value: None, reset_mask: None, description: Some("Block Transfer Count"), fields: [Field { name: "BTCNT", bit_offset: 0, bit_width: 16, access: None, description: Some("Block Transfer Count"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SRCADDR", offset: 4, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Block Transfer Source Address"), fields: [Field { name: "SRCADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Transfer Source Address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DSTADDR", offset: 8, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Block Transfer Source Address"), fields: [Field { name: "DSTADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Transfer Destination Address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DESCADDR", offset: 12, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("Block Transfer Destination Address"), fields: [Field { name: "DESCADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Next Descriptor Address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], description: Some("DMAC Block Transfer Descriptor") }], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: Some("Direct Memory Access Controller") }
...
#[doc="Read the ACTIVE register."]
   #[inline] pub fn active(&self) -> Active { 
      unsafe {
         Active(::core::ptr::read_volatile((self.0 + 0x30) as *const u32))
      }
   }
...
#[doc="Read the BASEADDR register."]
   #[inline] pub fn baseaddr(&self) -> Baseaddr { 
      unsafe {
         Baseaddr(::core::ptr::read_volatile((self.0 + 0x34) as *const u32))
      }
   }
...
#[doc="Read the BUSYCH register."]
   #[inline] pub fn busych(&self) -> Busych { 
      unsafe {
         Busych(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
...
#[doc="Read the CHCTRLA register."]
   #[inline] pub fn chctrla(&self) -> Chctrla { 
      unsafe {
         Chctrla(::core::ptr::read_volatile((self.0 + 0x40) as *const u8))
      }
   }
#[doc="Write the CHCTRLA register."]
   #[inline] pub fn set_chctrla<F: FnOnce(Chctrla) -> Chctrla>(&self, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x40) as *mut u8, value.0);
      }
      self
   }
...
#[doc="Read the CHCTRLB register."]
   #[inline] pub fn chctrlb(&self) -> Chctrlb { 
      unsafe {
         Chctrlb(::core::ptr::read_volatile((self.0 + 0x44) as *const u32))
      }
   }
...
#[doc="Read the CHID register."]
   #[inline] pub fn chid(&self) -> Chid { 
      unsafe {
         Chid(::core::ptr::read_volatile((self.0 + 0x3f) as *const u8))
      }
   }
#[doc="Write the CHID register."]
   #[inline] pub fn set_chid<F: FnOnce(Chid) -> Chid>(&self, f: F) -> &Self {
      let value = f(Chid(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x3f) as *mut u8, value.0);
      }
      self
   }
...
#[doc="Read the CHINTENCLR register."]
   #[inline] pub fn chintenclr(&self) -> Chintenclr { 
      unsafe {
         Chintenclr(::core::ptr::read_volatile((self.0 + 0x4c) as *const u8))
      }
   }
#[doc="Write the CHINTENCLR register."]
   #[inline] pub fn set_chintenclr<F: FnOnce(Chintenclr) -> Chintenclr>(&self, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x4c) as *mut u8, value.0);
      }
      self
   }
...
#[doc="Read the CHINTENSET register."]
   #[inline] pub fn chintenset(&self) -> Chintenset { 
      unsafe {
         Chintenset(::core::ptr::read_volatile((self.0 + 0x4d) as *const u8))
      }
   }
#[doc="Write the CHINTENSET register."]
   #[inline] pub fn set_chintenset<F: FnOnce(Chintenset) -> Chintenset>(&self, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x4d) as *mut u8, value.0);
      }
      self
   }
...
#[doc="Read the CHINTFLAG register."]
   #[inline] pub fn chintflag(&self) -> Chintflag { 
      unsafe {
         Chintflag(::core::ptr::read_volatile((self.0 + 0x4e) as *const u8))
      }
   }
#[doc="Write the CHINTFLAG register."]
   #[inline] pub fn set_chintflag<F: FnOnce(Chintflag) -> Chintflag>(&self, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x4e) as *mut u8, value.0);
      }
      self
   }
...
#[doc="Read the CHSTATUS register."]
   #[inline] pub fn chstatus(&self) -> Chstatus { 
      unsafe {
         Chstatus(::core::ptr::read_volatile((self.0 + 0x4f) as *const u8))
      }
   }
...
#[doc="Read the CRCCHKSUM register."]
   #[inline] pub fn crcchksum(&self) -> Crcchksum { 
      unsafe {
         Crcchksum(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the CRCCTRL register."]
   #[inline] pub fn crcctrl(&self) -> Crcctrl { 
      unsafe {
         Crcctrl(::core::ptr::read_volatile((self.0 + 0x2) as *const u16))
      }
   }
...
#[doc="Read the CRCDATAIN register."]
   #[inline] pub fn crcdatain(&self) -> Crcdatain { 
      unsafe {
         Crcdatain(::core::ptr::read_volatile((self.0 + 0x4) as *const u32))
      }
   }
...
#[doc="Read the CRCSTATUS register."]
   #[inline] pub fn crcstatus(&self) -> Crcstatus { 
      unsafe {
         Crcstatus(::core::ptr::read_volatile((self.0 + 0xc) as *const u8))
      }
   }
...
#[doc="Read the CTRL register."]
   #[inline] pub fn ctrl(&self) -> Ctrl { 
      unsafe {
         Ctrl(::core::ptr::read_volatile((self.0 + 0x0) as *const u16))
      }
   }
...
#[doc="Read the DBGCTRL register."]
   #[inline] pub fn dbgctrl(&self) -> Dbgctrl { 
      unsafe {
         Dbgctrl(::core::ptr::read_volatile((self.0 + 0xd) as *const u8))
      }
   }
...
#[doc="Read the INTPEND register."]
   #[inline] pub fn intpend(&self) -> Intpend { 
      unsafe {
         Intpend(::core::ptr::read_volatile((self.0 + 0x20) as *const u16))
      }
   }
...
#[doc="Read the INTSTATUS register."]
   #[inline] pub fn intstatus(&self) -> Intstatus { 
      unsafe {
         Intstatus(::core::ptr::read_volatile((self.0 + 0x24) as *const u32))
      }
   }
...
#[doc="Read the PENDCH register."]
   #[inline] pub fn pendch(&self) -> Pendch { 
      unsafe {
         Pendch(::core::ptr::read_volatile((self.0 + 0x2c) as *const u32))
      }
   }
...
#[doc="Read the PRICTRL register."]
   #[inline] pub fn prictrl(&self) -> Prictrl { 
      unsafe {
         Prictrl(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the SWTRIGCTRL register."]
   #[inline] pub fn swtrigctrl(&self) -> Swtrigctrl { 
      unsafe {
         Swtrigctrl(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the WRBADDR register."]
   #[inline] pub fn wrbaddr(&self) -> Wrbaddr { 
      unsafe {
         Wrbaddr(::core::ptr::read_volatile((self.0 + 0x38) as *const u32))
      }
   }
