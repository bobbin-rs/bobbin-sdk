...
impl Fpu {
  #[inline]
  pub fn cpacr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xd88) as *const u32
  }
  #[inline]
  pub fn cpacr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn fpccr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xf34) as *const u32
  }
  #[inline]
  pub fn fpccr_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn fpcar_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xf38) as *const u32
  }
  #[inline]
  pub fn fpcar_mut(&self) -> *mut u32 { 
  ...
  #[inline]
  pub fn fpdscr_ptr(&self) -> *const u32 { 
     ((self.0 as usize) + 0xf3c) as *const u32
  }
  #[inline]
  pub fn fpdscr_mut(&self) -> *mut u32 { 
