...
// Standard Clock Mode
// Core Clock: 72MHz = 0x0 (Divide by 1)
// System Clock: 72MHz = 0x0 (Divide by 1)
// Bus Clock: 36MHz = 0x1 (Divide by 2)
// FlexBus Clock: 24MHz = 0x2 (Divide by 3)
// Flash Clock: 24MHz = = 0x2 (Divide by 3)
...
pub fn setup_osc() {
    unsafe {
        ...
        SIM.with_clkdiv1(|r| r.set_outdiv1(0x0).set_outdiv2(0x1).set_outdiv3(0x2).set_outdiv4(0x2));
    }
}
...
pub fn set_mode_pbe() {
    unsafe {
        ...
        m.set_c5(mcg::C5(0).set_prdiv0(0x7));

        /* MCG_C6: LOLIE0=0,PLLS=1,CME0=0,VDIV0=0 */
        //MCG_C6 = MCG_C6_PLLS_MASK;

        // PLL Multiply by 36
        m.set_c6(mcg::C6(0).set_plls(1).set_vdiv0(0b01100));
...
pub fn set_mode_pee() {
    unsafe {
        ...
        // PRDIV0 = 0x3 (Divide by 8)
        m.set_c5(mcg::C5(0).set_prdiv0(0x7));

        /* MCG_C6: LOLIE0=0,PLLS=1,CME0=0,VDIV0=0 */
        // MCG_C6 = MCG_C6_PLLS_MASK;

        // VDIV = 0b01100 (Multiply Factor 36)
