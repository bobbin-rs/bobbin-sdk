...
// PeripheralGroup { name: "TIMER", peripherals: [Peripheral { derived_from: None, group_name: None, name: "TIMER0", address: 1073938432, size: None, access: None, reset_value: None, reset_mask: None, description: Some("Register map for TIMER0 peripheral"), modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER0A", index: Some(0), description: None, signals: [Signal { name: "T0CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER0A", types: ["TIMER"], value: 19, description: None }] }, Channel { name: "TIMER0B", index: Some(1), description: None, signals: [Signal { name: "T0CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER0B", types: ["TIMER"], value: 20, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER1", address: 1073942528, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER1A", index: Some(0), description: None, signals: [Signal { name: "T1CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER1A", types: ["TIMER"], value: 21, description: None }] }, Channel { name: "TIMER1B", index: Some(1), description: None, signals: [Signal { name: "T1CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER1B", types: ["TIMER"], value: 22, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER2", address: 1073946624, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER2A", index: Some(0), description: None, signals: [Signal { name: "T2CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER2A", types: ["TIMER"], value: 23, description: None }] }, Channel { name: "TIMER2B", index: Some(1), description: None, signals: [Signal { name: "T2CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER2B", types: ["TIMER"], value: 24, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER3", address: 1073950720, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER3A", index: Some(0), description: None, signals: [Signal { name: "T3CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER3A", types: ["TIMER"], value: 35, description: None }] }, Channel { name: "TIMER3B", index: Some(1), description: None, signals: [Signal { name: "T3CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER3B", types: ["TIMER"], value: 36, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER4", address: 1073954816, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER4A", index: Some(0), description: None, signals: [Signal { name: "T4CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER4A", types: ["TIMER"], value: 63, description: None }] }, Channel { name: "TIMER4B", index: Some(1), description: None, signals: [Signal { name: "T4CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER4B", types: ["TIMER"], value: 64, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER5", address: 1073958912, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER5A", index: Some(0), description: None, signals: [Signal { name: "T5CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER5A", types: ["TIMER"], value: 65, description: None }] }, Channel { name: "TIMER5B", index: Some(1), description: None, signals: [Signal { name: "T5CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER5B", types: ["TIMER"], value: 66, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER6", address: 1074659328, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER6A", index: Some(0), description: None, signals: [Signal { name: "T6CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER6A", types: ["TIMER"], value: 98, description: None }] }, Channel { name: "TIMER6B", index: Some(1), description: None, signals: [Signal { name: "T6CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER6B", types: ["TIMER"], value: 99, description: None }] }], dim: None, dim_increment: None, dim_index: None }, Peripheral { derived_from: None, group_name: None, name: "TIMER7", address: 1074663424, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "TIMER7A", index: Some(0), description: None, signals: [Signal { name: "T7CCP0", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER7A", types: ["TIMER"], value: 100, description: None }] }, Channel { name: "TIMER7B", index: Some(1), description: None, signals: [Signal { name: "T7CCP1", types: ["CCP"], description: None }], interrupts: [Interrupt { name: "TIMER7B", types: ["TIMER"], value: 101, description: None }] }], dim: None, dim_increment: None, dim_index: None }], prototype: Some(Peripheral { derived_from: None, group_name: Some("TIMER"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CFG", offset: 0, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Configuration"), fields: [Field { name: "CFG", bit_offset: 0, bit_width: 3, access: None, description: Some("GPTM Configuration"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("32_BIT_TIMER"), description: Some("For a 16/32-bit timer, this value selects the 32-bit timer configuration") }, EnumeratedValue { value: "0x1", name: Some("32_BIT_RTC"), description: Some("For a 16/32-bit timer, this value selects the 32-bit real-time clock (RTC) counter configuration") }, EnumeratedValue { value: "0x4", name: Some("16_BIT"), description: Some("For a 16/32-bit timer, this value selects the 16-bit timer configuration") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TMR", offset: 4, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Mode"), fields: [Field { name: "TMR", bit_offset: 0, bit_width: 2, access: None, description: Some("GPTM Timer n Mode"), enumerated_values: [EnumeratedValue { value: "0x1", name: Some("TAMR_1_SHOT"), description: Some("One-Shot Timer mode") }, EnumeratedValue { value: "0x2", name: Some("TAMR_PERIOD"), description: Some("Periodic Timer mode") }, EnumeratedValue { value: "0x3", name: Some("TAMR_CAP"), description: Some("Capture mode") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCMR", bit_offset: 2, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMS", bit_offset: 3, bit_width: 1, access: None, description: Some("GPTM Timer n Alternate Mode Select"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCDIR", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM Timer n Count Direction"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TMIE", bit_offset: 5, bit_width: 1, access: None, description: Some("GPTM Timer n Match Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TWOT", bit_offset: 6, bit_width: 1, access: None, description: Some("GPTM Timer n Wait-on-Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TSNAPS", bit_offset: 7, bit_width: 1, access: None, description: Some("GPTM Timer n Snap-Shot Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TILD", bit_offset: 8, bit_width: 1, access: None, description: Some("GPTM Timer n Interval Load Write"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TPWMIE", bit_offset: 9, bit_width: 1, access: None, description: Some("GPTM Timer n PWM Interrupt Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TMRSU", bit_offset: 10, bit_width: 1, access: None, description: Some("GPTM Timer n Match Register Update"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TPLO", bit_offset: 11, bit_width: 1, access: None, description: Some("GPTM Timer n PWM Legacy Operation"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCINTD", bit_offset: 12, bit_width: 1, access: None, description: Some("One-shot/Periodic Interrupt Disable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TCACT", bit_offset: 13, bit_width: 3, access: None, description: Some("Timer Compare Action Select"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("TCACT_NONE"), description: Some("Disable compare operations") }, EnumeratedValue { value: "0x1", name: Some("TCACT_TOGGLE"), description: Some("Toggle State on Time-Out") }, EnumeratedValue { value: "0x2", name: Some("TCACT_CLRTO"), description: Some("Clear CCP on Time-Out") }, EnumeratedValue { value: "0x3", name: Some("TCACT_SETTO"), description: Some("Set CCP on Time-Out") }, EnumeratedValue { value: "0x4", name: Some("TCACT_SETTOGTO"), description: Some("Set CCP immediately and toggle on Time-Out") }, EnumeratedValue { value: "0x5", name: Some("TCACT_CLRTOGTO"), description: Some("Clear CCP immediately and toggle on Time-Out") }, EnumeratedValue { value: "0x6", name: Some("TCACT_SETCLRTO"), description: Some("Set CCP immediately and clear on Time-Out") }, EnumeratedValue { value: "0x7", name: Some("TCACT_CLRSETTO"), description: Some("Clear CCP immediately and set on Time-Out") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "CTL", offset: 12, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Control"), fields: [Field { name: "TEN", bit_offset: 0, bit_width: 1, access: None, description: Some("GPTM Timer n Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "TSTALL", bit_offset: 1, bit_width: 1, access: None, description: Some("GPTM Timer n Stall Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "TEVENT", bit_offset: 2, bit_width: 2, access: None, description: Some("GPTM Timer n Event Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("TAEVENT_POS"), description: Some("Positive edge") }, EnumeratedValue { value: "0x1", name: Some("TAEVENT_NEG"), description: Some("Negative edge") }, EnumeratedValue { value: "0x3", name: Some("TAEVENT_BOTH"), description: Some("Both edges") }], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCEN", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM RTC Stall Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TOTE", bit_offset: 5, bit_width: 1, access: None, description: Some("GPTM Timer n Output Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "TPWML", bit_offset: 6, bit_width: 1, access: None, description: Some("GPTM Timer n PWM Output Level"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SYNC", offset: 16, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Synchronize"), fields: [Field { name: "SYNCT", bit_offset: 0, bit_width: 2, access: None, description: Some("Synchronize GPTM Timer n"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("SYNCT0_NONE"), description: Some("GPTM0 is not affected") }, EnumeratedValue { value: "0x1", name: Some("SYNCT0_TA"), description: Some("A timeout event for Timer A of GPTMn is triggered") }, EnumeratedValue { value: "0x2", name: Some("SYNCT0_TB"), description: Some("A timeout event for Timer B of GPTMn is triggered") }, EnumeratedValue { value: "0x3", name: Some("SYNCT0_TATB"), description: Some("A timeout event for both Timer A and Timer B of GPTMn is triggered") }], links: [], dim: Some(8), dim_increment: Some(2), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "IMR", offset: 24, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Interrupt Mask"), fields: [Field { name: "TTOIM", bit_offset: 0, bit_width: 1, access: None, description: Some("GPTM Timer n Time-Out Interrupt Mask"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CMIM", bit_offset: 1, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode Match Interrupt Mask"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CEIM", bit_offset: 2, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode Event Interrupt Mask"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCIM", bit_offset: 3, bit_width: 1, access: None, description: Some("GPTM RTC Interrupt Mask"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TMIM", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM Timer n Match Interrupt Mask"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "DMAIM", bit_offset: 5, bit_width: 1, access: None, description: Some("GPTM Timer n DMA Done Interrupt Mask"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RIS", offset: 28, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Raw Interrupt Status"), fields: [Field { name: "TTORIS", bit_offset: 0, bit_width: 1, access: None, description: Some("GPTM Timer n Time-Out Raw Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CMRIS", bit_offset: 1, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode Match Raw Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CERIS", bit_offset: 2, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode Event Raw Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCRIS", bit_offset: 3, bit_width: 1, access: None, description: Some("GPTM RTC Raw Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMRIS", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM Timer A Match Raw Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMARIS", bit_offset: 5, bit_width: 1, access: None, description: Some("GPTM Timer n DMA Done Raw Interrupt Status"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "TBMRIS", bit_offset: 11, bit_width: 1, access: None, description: Some("GPTM Timer B Match Raw Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "MIS", offset: 32, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Masked Interrupt Status"), fields: [Field { name: "TTOMIS", bit_offset: 0, bit_width: 1, access: None, description: Some("GPTM Timer n Time-Out Masked Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CMMIS", bit_offset: 1, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode Match Masked Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CEMIS", bit_offset: 2, bit_width: 1, access: None, description: Some("GPTM Timer n Capture Mode Event Masked Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCMIS", bit_offset: 3, bit_width: 1, access: None, description: Some("GPTM RTC Masked Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMMIS", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM Timer A Match Masked Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAMIS", bit_offset: 5, bit_width: 1, access: None, description: Some("GPTM Timer n DMA Done Masked Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "TBMMIS", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM Timer B Match Masked Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ICR", offset: 36, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("GPTM Interrupt Clear"), fields: [Field { name: "TTOCINT", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM Timer n Time-Out Raw Interrupt"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CMCINT", bit_offset: 1, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM Timer n Capture Mode Match Interrupt Clear"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CECINT", bit_offset: 2, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM Timer n Capture Mode Event Interrupt Clear"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCCINT", bit_offset: 3, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM RTC Interrupt Clear"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TAMCINT", bit_offset: 4, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM Timer A Match Interrupt Clear"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMAINT", bit_offset: 5, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM Timer n DMA Done Interrupt Clear"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "TBMCINT", bit_offset: 11, bit_width: 1, access: Some(WriteOnly), description: Some("GPTM Timer B Match Interrupt Clear"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TILR", offset: 40, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Interval Load"), fields: [Field { name: "TILR", bit_offset: 0, bit_width: 32, access: None, description: None, enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "TMTCHR", offset: 48, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Match"), fields: [Field { name: "TMTCHR", bit_offset: 0, bit_width: 32, access: None, description: None, enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "TPR", offset: 56, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Prescale"), fields: [Field { name: "TPSR", bit_offset: 0, bit_width: 8, access: None, description: Some("GPTM Timer n Prescale"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "TPMR", offset: 64, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Prescale Match"), fields: [Field { name: "TPSMR", bit_offset: 0, bit_width: 8, access: None, description: Some("GPTM Timer n Prescale Match"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "TR", offset: 72, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n"), fields: [Field { name: "TR", bit_offset: 0, bit_width: 32, access: None, description: None, enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "TV", offset: 80, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Value"), fields: [Field { name: "TV", bit_offset: 0, bit_width: 32, access: None, description: None, enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "RTCPD", offset: 88, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM RTC Predivide"), fields: [Field { name: "RTCPD", bit_offset: 0, bit_width: 16, access: None, description: Some("RTC Predivide Counter Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "TPS", offset: 92, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Timer n Prescale Snapshot"), fields: [Field { name: "PSS", bit_offset: 0, bit_width: 16, access: None, description: Some("GPTM Timer n Prescaler Snapshot"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(2), dim_increment: Some(4), dim_index: None }, Register { name: "DMAEV", offset: 108, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM DMA Event"), fields: [Field { name: "TTODMAEN", bit_offset: 0, bit_width: 1, access: None, description: Some("GPTM n Time-Out Event DMA Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CMDMAEN", bit_offset: 1, bit_width: 1, access: None, description: Some("GPTM n Capture Match Event DMA Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CEDMAEN", bit_offset: 2, bit_width: 1, access: None, description: Some("GPTM n Capture Event DMA Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCDMAEN", bit_offset: 3, bit_width: 1, access: None, description: Some("GPTM RTC Match Event DMA Trigger Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TMDMAEN", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM n Mode Match Event DMA Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ADCEV", offset: 112, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM ADC Event"), fields: [Field { name: "TTOADCEN", bit_offset: 0, bit_width: 1, access: None, description: Some("GPTM n Time-Out Event ADC Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CMADCEN", bit_offset: 1, bit_width: 1, access: None, description: Some("GPTM n Capture Match Event ADC Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "CEADCEN", bit_offset: 2, bit_width: 1, access: None, description: Some("GPTM Capture Event ADC Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }, Field { name: "RTCADCEN", bit_offset: 3, bit_width: 1, access: None, description: Some("GPTM RTC Match Event ADC Trigger Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TMADCEN", bit_offset: 4, bit_width: 1, access: None, description: Some("GPTM n Mode Match Event ADC Trigger Enable"), enumerated_values: [], links: [], dim: Some(2), dim_increment: Some(8), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PP", offset: 4032, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Peripheral Properties"), fields: [Field { name: "SIZE", bit_offset: 0, bit_width: 4, access: None, description: Some("Count Size"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("SIZE_16"), description: Some("Timer A and Timer B counters are 16 bits each with an 8-bit prescale counter") }, EnumeratedValue { value: "0x1", name: Some("SIZE_32"), description: Some("Timer A and Timer B counters are 32 bits each with a 16-bit prescale counter") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CHAIN", bit_offset: 4, bit_width: 1, access: None, description: Some("Chain with Other Timers"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SYNCCNT", bit_offset: 5, bit_width: 1, access: None, description: Some("Synchronize Start"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ALTCLK", bit_offset: 6, bit_width: 1, access: None, description: Some("Alternate Clock Source"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CC", offset: 4040, size: None, access: None, reset_value: None, reset_mask: None, description: Some("GPTM Clock Configuration"), fields: [Field { name: "ALTCLK", bit_offset: 0, bit_width: 1, access: None, description: Some("Alternate Clock Source"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the TMR register."]
   #[inline] pub fn tmr<I: Into<bits::R2>>(&self, index: I) -> Tmr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tmr(::core::ptr::read_volatile((self.0 + 0x4 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TMR register."]
   #[inline] pub fn set_tmr<I: Into<bits::R2>, F: FnOnce(Tmr) -> Tmr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tmr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x4 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CTL register."]
   #[inline] pub fn ctl(&self) -> Ctl { 
      unsafe {
         Ctl(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the SYNC register."]
   #[inline] pub fn sync(&self) -> Sync { 
      unsafe {
         Sync(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the IMR register."]
   #[inline] pub fn imr(&self) -> Imr { 
      unsafe {
         Imr(::core::ptr::read_volatile((self.0 + 0x18) as *const u32))
      }
   }
...
#[doc="Read the RIS register."]
   #[inline] pub fn ris(&self) -> Ris { 
      unsafe {
         Ris(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the MIS register."]
   #[inline] pub fn mis(&self) -> Mis { 
      unsafe {
         Mis(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the TILR register."]
   #[inline] pub fn tilr<I: Into<bits::R2>>(&self, index: I) -> Tilr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tilr(::core::ptr::read_volatile((self.0 + 0x28 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TILR register."]
   #[inline] pub fn set_tilr<I: Into<bits::R2>, F: FnOnce(Tilr) -> Tilr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tilr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x28 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the TMTCHR register."]
   #[inline] pub fn tmtchr<I: Into<bits::R2>>(&self, index: I) -> Tmtchr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tmtchr(::core::ptr::read_volatile((self.0 + 0x30 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TMTCHR register."]
   #[inline] pub fn set_tmtchr<I: Into<bits::R2>, F: FnOnce(Tmtchr) -> Tmtchr>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x30 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the TPR register."]
   #[inline] pub fn tpr<I: Into<bits::R2>>(&self, index: I) -> Tpr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tpr(::core::ptr::read_volatile((self.0 + 0x38 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TPR register."]
   #[inline] pub fn set_tpr<I: Into<bits::R2>, F: FnOnce(Tpr) -> Tpr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tpr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x38 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the TPMR register."]
   #[inline] pub fn tpmr<I: Into<bits::R2>>(&self, index: I) -> Tpmr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tpmr(::core::ptr::read_volatile((self.0 + 0x40 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TPMR register."]
   #[inline] pub fn set_tpmr<I: Into<bits::R2>, F: FnOnce(Tpmr) -> Tpmr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tpmr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x40 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the TR register."]
   #[inline] pub fn tr<I: Into<bits::R2>>(&self, index: I) -> Tr { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tr(::core::ptr::read_volatile((self.0 + 0x48 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TR register."]
   #[inline] pub fn set_tr<I: Into<bits::R2>, F: FnOnce(Tr) -> Tr>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tr(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x48 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the TV register."]
   #[inline] pub fn tv<I: Into<bits::R2>>(&self, index: I) -> Tv { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tv(::core::ptr::read_volatile((self.0 + 0x50 + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TV register."]
   #[inline] pub fn set_tv<I: Into<bits::R2>, F: FnOnce(Tv) -> Tv>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tv(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x50 + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the RTCPD register."]
   #[inline] pub fn rtcpd(&self) -> Rtcpd { 
      unsafe {
         Rtcpd(::core::ptr::read_volatile((self.0 + 0x58) as *const u32))
      }
   }
...
#[doc="Read the TPS register."]
   #[inline] pub fn tps<I: Into<bits::R2>>(&self, index: I) -> Tps { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         Tps(::core::ptr::read_volatile((self.0 + 0x5c + (index << 2)) as *const u32))
      }
   }
#[doc="Write the TPS register."]
   #[inline] pub fn set_tps<I: Into<bits::R2>, F: FnOnce(Tps) -> Tps>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(Tps(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x5c + (index << 2)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the DMAEV register."]
   #[inline] pub fn dmaev(&self) -> Dmaev { 
      unsafe {
         Dmaev(::core::ptr::read_volatile((self.0 + 0x6c) as *const u32))
      }
   }
...
#[doc="Read the ADCEV register."]
   #[inline] pub fn adcev(&self) -> Adcev { 
      unsafe {
         Adcev(::core::ptr::read_volatile((self.0 + 0x70) as *const u32))
      }
   }
