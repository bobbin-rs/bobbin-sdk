...
// PeripheralGroup { name: "UDMA", peripherals: [Peripheral { derived_from: None, group_name: None, name: "UDMA", address: 1074786304, size: None, access: None, reset_value: None, reset_mask: None, description: Some("Register map for UDMA peripheral"), modules: [], features: [], links: [], interrupts: [Interrupt { name: "UDMA", types: [], value: 44, description: None }, Interrupt { name: "UDMAERR", types: [], value: 45, description: None }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "UDMA_CH0", index: Some(0), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH1", index: Some(1), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH2", index: Some(2), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH3", index: Some(3), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH4", index: Some(4), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH5", index: Some(5), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH6", index: Some(6), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH7", index: Some(7), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH8", index: Some(8), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH9", index: Some(9), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH10", index: Some(10), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH11", index: Some(11), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH12", index: Some(12), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH13", index: Some(13), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH14", index: Some(14), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH15", index: Some(15), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH16", index: Some(16), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH17", index: Some(17), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH18", index: Some(18), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH19", index: Some(19), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH20", index: Some(20), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH21", index: Some(21), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH22", index: Some(22), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH23", index: Some(23), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH24", index: Some(24), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH25", index: Some(25), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH26", index: Some(26), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH27", index: Some(27), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH28", index: Some(28), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH29", index: Some(29), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH30", index: Some(30), description: None, signals: [], interrupts: [] }, Channel { name: "UDMA_CH31", index: Some(31), description: None, signals: [], interrupts: [] }], dim: None, dim_increment: None, dim_index: None }], prototype: Some(Peripheral { derived_from: None, group_name: Some("UDM"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "STAT", offset: 0, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Status"), fields: [Field { name: "MASTEN", bit_offset: 0, bit_width: 1, access: None, description: Some("Master Enable Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "STATE", bit_offset: 4, bit_width: 4, access: None, description: Some("Control State Machine Status"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("IDLE"), description: Some("Idle") }, EnumeratedValue { value: "0x1", name: Some("RD_CTRL"), description: Some("Reading channel controller data") }, EnumeratedValue { value: "0x2", name: Some("RD_SRCENDP"), description: Some("Reading source end pointer") }, EnumeratedValue { value: "0x3", name: Some("RD_DSTENDP"), description: Some("Reading destination end pointer") }, EnumeratedValue { value: "0x4", name: Some("RD_SRCDAT"), description: Some("Reading source data") }, EnumeratedValue { value: "0x5", name: Some("WR_DSTDAT"), description: Some("Writing destination data") }, EnumeratedValue { value: "0x6", name: Some("WAIT"), description: Some("Waiting for uDMA request to clear") }, EnumeratedValue { value: "0x7", name: Some("WR_CTRL"), description: Some("Writing channel controller data") }, EnumeratedValue { value: "0x8", name: Some("STALL"), description: Some("Stalled") }, EnumeratedValue { value: "0x9", name: Some("DONE"), description: Some("Done") }, EnumeratedValue { value: "0xa", name: Some("UNDEF"), description: Some("Undefined") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DMACHANS", bit_offset: 16, bit_width: 5, access: None, description: Some("Available uDMA Channels Minus 1"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CFG", offset: 4, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Configuration"), fields: [Field { name: "MASTEN", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Controller Master Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CTLBASE", offset: 8, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Control Base Pointer"), fields: [Field { name: "ADDR", bit_offset: 10, bit_width: 22, access: None, description: Some("Channel Control Base Address"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALTBASE", offset: 12, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Alternate Channel Control Base Pointer"), fields: [Field { name: "ADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Alternate Channel Address Pointer"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "WAITSTAT", offset: 16, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Wait-on-Request Status"), fields: [Field { name: "WAITREQ", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Wait Status"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SWREQ", offset: 20, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Channel Software Request"), fields: [Field { name: "SWREQ", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Channel [n] Software Request"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "USEBURSTSET", offset: 24, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Useburst Set"), fields: [Field { name: "SET", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Useburst Set"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "USEBURSTCLR", offset: 28, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Channel Useburst Clear"), fields: [Field { name: "CLR", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Channel [n] Useburst Clear"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "REQMASKSET", offset: 32, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Request Mask Set"), fields: [Field { name: "SET", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Request Mask Set"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "REQMASKCLR", offset: 36, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Channel Request Mask Clear"), fields: [Field { name: "CLR", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Channel [n] Request Mask Clear"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ENASET", offset: 40, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Enable Set"), fields: [Field { name: "SET", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Enable Set"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ENACLR", offset: 44, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Channel Enable Clear"), fields: [Field { name: "CLR", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Clear Channel [n] Enable Clear"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALTSET", offset: 48, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Primary Alternate Set"), fields: [Field { name: "SET", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Alternate Set"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ALTCLR", offset: 52, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Channel Primary Alternate Clear"), fields: [Field { name: "CLR", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Channel [n] Alternate Clear"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PRIOSET", offset: 56, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Priority Set"), fields: [Field { name: "SET", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Priority Set"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PRIOCLR", offset: 60, size: None, access: Some(WriteOnly), reset_value: None, reset_mask: None, description: Some("DMA Channel Priority Clear"), fields: [Field { name: "CLR", bit_offset: 0, bit_width: 1, access: Some(WriteOnly), description: Some("Channel [n] Priority Clear"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ERRCLR", offset: 76, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Bus Error Clear"), fields: [Field { name: "ERRCLR", bit_offset: 0, bit_width: 1, access: None, description: Some("uDMA Bus Error Status"), enumerated_values: [], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHASGN", offset: 1280, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Assignment"), fields: [Field { name: "CHASGN", bit_offset: 0, bit_width: 1, access: None, description: Some("Channel [n] Assignment Select"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("PRIMARY"), description: Some("Use the primary channel assignment") }, EnumeratedValue { value: "0x1", name: Some("SECONDARY"), description: Some("Use the secondary channel assignment") }], links: [], dim: Some(32), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHMAP0", offset: 1296, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Map Select 0"), fields: [Field { name: "CHSEL", bit_offset: 0, bit_width: 4, access: None, description: Some("uDMA Channel n Source Select"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHMAP1", offset: 1300, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Map Select 1"), fields: [Field { name: "CHSEL", bit_offset: 0, bit_width: 4, access: None, description: Some("uDMA Channel n Source Select"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHMAP2", offset: 1304, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Map Select 2"), fields: [Field { name: "CHSEL", bit_offset: 0, bit_width: 4, access: None, description: Some("uDMA Channel n Source Select"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHMAP3", offset: 1308, size: None, access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Map Select 3"), fields: [Field { name: "CHSEL", bit_offset: 0, bit_width: 4, access: None, description: Some("uDMA Channel n Source Select"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(4), dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [Descriptor { name: "CHDESC", size: Some(16), registers: [Register { name: "SRCENDP", offset: 0, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Source Address End Pointer"), fields: [Field { name: "ADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Source Address End Pointer. This field points to the last address of the μDMA transfer source (inclusive). If the source address is not incrementing (the SRCINC field in the DMACHCTL register is 0x3), then this field points at the source location itself (such as a peripheral data register)."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "DSTENDP", offset: 4, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Destination Address End Pointer"), fields: [Field { name: "ADDR", bit_offset: 0, bit_width: 32, access: None, description: Some("Destination Address End Pointer. This field points to the last address of the μDMA transfer destination (inclusive). If the destination address is not incrementing (the DSTINC field in the DMACHCTL register is 0x3), then this field points at the destination location itself (such as a peripheral data register)."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CHCTL", offset: 8, size: Some(32), access: None, reset_value: None, reset_mask: None, description: Some("DMA Channel Control Word"), fields: [Field { name: "DSTINC", bit_offset: 30, bit_width: 2, access: None, description: Some("Destination Address Increment. This field configures the destination address increment. The address increment value must be equal or greater than the value of the destination size (DSTSIZE)."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DSTSIZE", bit_offset: 28, bit_width: 2, access: None, description: Some("Destination Data Size. This field configures the destination item data size."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SRCINC", bit_offset: 26, bit_width: 2, access: None, description: Some("Source Address Increment. This field configures the source address increment. The address increment value must be equal or greater than the value of the source size (SRCSIZE)."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SRCSIZE", bit_offset: 24, bit_width: 2, access: None, description: Some("Source Data Size. This field configures the source item data size."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DSTPROTO", bit_offset: 21, bit_width: 1, access: None, description: Some("Destination Privilege Access. This bit controls the privilege access protection for destination data writes."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "SRCPROTO", bit_offset: 18, bit_width: 1, access: None, description: Some("Source Privilege Access. This bit controls the privilege access protection for source data reads."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ARBSIZE", bit_offset: 14, bit_width: 4, access: None, description: Some("Arbitration Size. This field configures the number of transfers that can occur before the μDMA controller re-arbitrates."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "XFERSIZE", bit_offset: 4, bit_width: 10, access: None, description: Some("Transfer Size (minus 1). This field configures the total number of items to transfer. The value of this field is 1 less than the number to transfer (value 0 means transfer 1 item). The maximum value for this 10-bit field is 1023 which represents a transfer size of 1024 items."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "NXTUSEBURST", bit_offset: 3, bit_width: 1, access: None, description: Some("Next Useburst. This field controls whether the Useburst SET[n] bit is automatically set for the last transfer of a peripheral scatter-gather operation. Normally, for the last transfer, if the number of remaining items to transfer is less than the arbitration size, the μDMA controller uses single transfers to complete the transaction. If this bit is set, then the controller uses a burst transfer to complete the last transfer."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "XFERMODE", bit_offset: 0, bit_width: 3, access: None, description: Some("μDMA Transfer Mode. This field configures the operating mode of the μDMA cycle. Refer to “Transfer Modes” on page 685 for a detailed explanation of transfer modes. Because this register is in system RAM, it has no reset value. Therefore, this field should be initialized to 0 before the channel is enabled."), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], description: Some("DMA Descriptor") }], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the STAT register."]
   #[inline] pub fn stat(&self) -> Stat { 
      unsafe {
         Stat(::core::ptr::read_volatile((self.0 + 0x0) as *const u32))
      }
   }
...
#[doc="Read the CTLBASE register."]
   #[inline] pub fn ctlbase(&self) -> Ctlbase { 
      unsafe {
         Ctlbase(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the ALTBASE register."]
   #[inline] pub fn altbase(&self) -> Altbase { 
      unsafe {
         Altbase(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the WAITSTAT register."]
   #[inline] pub fn waitstat(&self) -> Waitstat { 
      unsafe {
         Waitstat(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the USEBURSTSET register."]
   #[inline] pub fn useburstset(&self) -> Useburstset { 
      unsafe {
         Useburstset(::core::ptr::read_volatile((self.0 + 0x18) as *const u32))
      }
   }
...
#[doc="Read the REQMASKSET register."]
   #[inline] pub fn reqmaskset(&self) -> Reqmaskset { 
      unsafe {
         Reqmaskset(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the ENASET register."]
   #[inline] pub fn enaset(&self) -> Enaset { 
      unsafe {
         Enaset(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
...
#[doc="Read the ALTSET register."]
   #[inline] pub fn altset(&self) -> Altset { 
      unsafe {
         Altset(::core::ptr::read_volatile((self.0 + 0x30) as *const u32))
      }
   }
...
#[doc="Read the PRIOSET register."]
   #[inline] pub fn prioset(&self) -> Prioset { 
      unsafe {
         Prioset(::core::ptr::read_volatile((self.0 + 0x38) as *const u32))
      }
   }
...
#[doc="Read the ERRCLR register."]
   #[inline] pub fn errclr(&self) -> Errclr { 
      unsafe {
         Errclr(::core::ptr::read_volatile((self.0 + 0x4c) as *const u32))
      }
   }
...
#[doc="Read the CHASGN register."]
   #[inline] pub fn chasgn(&self) -> Chasgn { 
      unsafe {
         Chasgn(::core::ptr::read_volatile((self.0 + 0x500) as *const u32))
      }
   }
...
#[doc="Read the CHMAP0 register."]
   #[inline] pub fn chmap0(&self) -> Chmap0 { 
      unsafe {
         Chmap0(::core::ptr::read_volatile((self.0 + 0x510) as *const u32))
      }
   }
...
#[doc="Read the CHMAP1 register."]
   #[inline] pub fn chmap1(&self) -> Chmap1 { 
      unsafe {
         Chmap1(::core::ptr::read_volatile((self.0 + 0x514) as *const u32))
      }
   }
...
#[doc="Read the CHMAP2 register."]
   #[inline] pub fn chmap2(&self) -> Chmap2 { 
      unsafe {
         Chmap2(::core::ptr::read_volatile((self.0 + 0x518) as *const u32))
      }
   }
...
#[doc="Read the CHMAP3 register."]
   #[inline] pub fn chmap3(&self) -> Chmap3 { 
      unsafe {
         Chmap3(::core::ptr::read_volatile((self.0 + 0x51c) as *const u32))
      }
   }
