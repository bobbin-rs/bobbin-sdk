...
// PeripheralGroup { name: "PWM", peripherals: [Peripheral { derived_from: None, group_name: None, name: "PWM0", address: 1073905664, size: None, access: None, reset_value: None, reset_mask: None, description: Some("Register map for PWM0 peripheral"), modules: [], features: [], links: [], interrupts: [Interrupt { name: "PWM0_FAULT", types: [], value: 9, description: None }], clusters: [], registers: [], descriptors: [], signals: [], pins: [], channels: [Channel { name: "PWM0_CH0", index: Some(0), description: None, signals: [Signal { name: "M0PWM0", types: ["PWM"], description: None }], interrupts: [Interrupt { name: "PWM0_CH0", types: [], value: 10, description: None }] }, Channel { name: "PWM0_CH1", index: Some(1), description: None, signals: [Signal { name: "M0PWM1", types: ["PWM"], description: None }], interrupts: [Interrupt { name: "PWM0_CH1", types: [], value: 11, description: None }] }, Channel { name: "PWM0_CH2", index: Some(2), description: None, signals: [Signal { name: "M0PWM2", types: ["PWM"], description: None }], interrupts: [Interrupt { name: "PWM0_CH2", types: [], value: 12, description: None }] }, Channel { name: "PWM0_CH3", index: Some(3), description: None, signals: [Signal { name: "M0PWM3", types: ["PWM"], description: None }], interrupts: [Interrupt { name: "PWM0_CH3", types: [], value: 43, description: None }] }], dim: None, dim_increment: None, dim_index: None }], prototype: Some(Peripheral { derived_from: None, group_name: Some("PWM"), name: "", address: 0, size: None, access: None, reset_value: None, reset_mask: None, description: None, modules: [], features: [], links: [], interrupts: [], clusters: [], registers: [Register { name: "CTL", offset: 0, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Master Control"), fields: [Field { name: "GLOBALSYNC", bit_offset: 0, bit_width: 1, access: None, description: Some("Update PWM Generator n"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "SYNC", offset: 4, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Time Base Sync"), fields: [Field { name: "SYNC", bit_offset: 0, bit_width: 1, access: None, description: Some("Reset Generator n Counter"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ENABLE", offset: 8, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Output Enable"), fields: [Field { name: "PWMEN", bit_offset: 0, bit_width: 1, access: None, description: Some("MnPWMn Output Enable"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "INVERT", offset: 12, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Output Inversion"), fields: [Field { name: "PWMINV", bit_offset: 0, bit_width: 1, access: None, description: Some("Invert MnPWMn Signal"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "FAULT", offset: 16, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Output Fault"), fields: [Field { name: "FAULT", bit_offset: 0, bit_width: 1, access: None, description: Some("MnPWMn Fault"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "INTEN", offset: 20, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Interrupt Enable"), fields: [Field { name: "INTPWM", bit_offset: 0, bit_width: 1, access: None, description: Some("PWMn Interrupt Enable"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }, Field { name: "INTFAULT", bit_offset: 16, bit_width: 1, access: None, description: Some("Interrupt Fault 0"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "RIS", offset: 24, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Raw Interrupt Status"), fields: [Field { name: "INTPWM", bit_offset: 0, bit_width: 1, access: None, description: Some("PWM0 Interrupt Asserted"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }, Field { name: "INTFAULT", bit_offset: 16, bit_width: 1, access: None, description: Some("Interrupt Fault PWM 0"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ISC", offset: 28, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Interrupt Status and Clear"), fields: [Field { name: "INTPWM", bit_offset: 0, bit_width: 1, access: None, description: Some("PWMn Interrupt Status"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }, Field { name: "INTFAULT", bit_offset: 16, bit_width: 1, access: None, description: Some("FAULTn Interrupt Asserted"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "STATUS", offset: 32, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Status"), fields: [Field { name: "FAULT", bit_offset: 0, bit_width: 1, access: None, description: Some("Generator n Fault Status"), enumerated_values: [], links: [], dim: Some(4), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "FAULTVAL", offset: 36, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Fault Condition Value"), fields: [Field { name: "FAULTVAL", bit_offset: 0, bit_width: 1, access: None, description: Some("MnPWM0 Fault Value"), enumerated_values: [], links: [], dim: Some(8), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "ENUPD", offset: 40, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Enable Update"), fields: [Field { name: "ENUPD", bit_offset: 0, bit_width: 2, access: None, description: Some("MnPWMn Enable Update Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("IMM"), description: Some("Immediate") }, EnumeratedValue { value: "0x2", name: Some("LSYNC"), description: Some("Locally Synchronized") }, EnumeratedValue { value: "0x3", name: Some("GSYNC"), description: Some("Globally Synchronized") }], links: [], dim: Some(8), dim_increment: Some(1), dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CH_CTL", offset: 64, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWMn Control"), fields: [Field { name: "ENABLE", bit_offset: 0, bit_width: 1, access: None, description: Some("PWM Block Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MODE", bit_offset: 1, bit_width: 1, access: None, description: Some("Counter Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DEBUG", bit_offset: 2, bit_width: 1, access: None, description: Some("Debug Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LOADUPD", bit_offset: 3, bit_width: 1, access: None, description: Some("Load Register Update Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMPAUPD", bit_offset: 4, bit_width: 1, access: None, description: Some("Comparator A Update Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "CMPBUPD", bit_offset: 5, bit_width: 1, access: None, description: Some("Comparator B Update Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "GENAUPD", bit_offset: 6, bit_width: 2, access: None, description: Some("PWMnGENA Update Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("I"), description: Some("Immediate") }, EnumeratedValue { value: "0x2", name: Some("LS"), description: Some("Locally Synchronized") }, EnumeratedValue { value: "0x3", name: Some("GS"), description: Some("Globally Synchronized") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "GENBUPD", bit_offset: 8, bit_width: 2, access: None, description: Some("PWMnGENB Update Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("I"), description: Some("Immediate") }, EnumeratedValue { value: "0x2", name: Some("LS"), description: Some("Locally Synchronized") }, EnumeratedValue { value: "0x3", name: Some("GS"), description: Some("Globally Synchronized") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DBCTLUPD", bit_offset: 10, bit_width: 2, access: None, description: Some("PWMnDBCTL Update Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("I"), description: Some("Immediate") }, EnumeratedValue { value: "0x2", name: Some("LS"), description: Some("Locally Synchronized") }, EnumeratedValue { value: "0x3", name: Some("GS"), description: Some("Globally Synchronized") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DBRISEUPD", bit_offset: 12, bit_width: 2, access: None, description: Some("PWMnDBRISE Update Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("I"), description: Some("Immediate") }, EnumeratedValue { value: "0x2", name: Some("LS"), description: Some("Locally Synchronized") }, EnumeratedValue { value: "0x3", name: Some("GS"), description: Some("Globally Synchronized") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DBFALLUPD", bit_offset: 14, bit_width: 2, access: None, description: Some("PWMnDBFALL Update Mode"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("I"), description: Some("Immediate") }, EnumeratedValue { value: "0x2", name: Some("LS"), description: Some("Locally Synchronized") }, EnumeratedValue { value: "0x3", name: Some("GS"), description: Some("Globally Synchronized") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FLTSRC", bit_offset: 16, bit_width: 1, access: None, description: Some("Fault Condition Source"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "MINFLTPER", bit_offset: 17, bit_width: 1, access: None, description: Some("Minimum Fault Period"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "LATCH", bit_offset: 18, bit_width: 1, access: None, description: Some("Latch Fault Input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_INTEN", offset: 68, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Interrupt and Trigger Enable"), fields: [Field { name: "INTCNTZERO", bit_offset: 0, bit_width: 1, access: None, description: Some("Interrupt for Counter=0"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCNTLOAD", bit_offset: 1, bit_width: 1, access: None, description: Some("Interrupt for Counter=PWMnLOAD"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPAU", bit_offset: 2, bit_width: 1, access: None, description: Some("Interrupt for Counter=PWMnCMPA Up"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPAD", bit_offset: 3, bit_width: 1, access: None, description: Some("Interrupt for Counter=PWMnCMPA Down"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPBU", bit_offset: 4, bit_width: 1, access: None, description: Some("Interrupt for Counter=PWMnCMPB Up"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPBD", bit_offset: 5, bit_width: 1, access: None, description: Some("Interrupt for Counter=PWMnCMPB Down"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRCNTZERO", bit_offset: 8, bit_width: 1, access: None, description: Some("Trigger for Counter=0"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRCNTLOAD", bit_offset: 9, bit_width: 1, access: None, description: Some("Trigger for Counter=PWMnLOAD"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRCMPAU", bit_offset: 10, bit_width: 1, access: None, description: Some("Trigger for Counter=PWMnCMPA Up"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRCMPAD", bit_offset: 11, bit_width: 1, access: None, description: Some("Trigger for Counter=PWMnCMPA Down"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRCMPBU", bit_offset: 12, bit_width: 1, access: None, description: Some("Trigger for Counter=PWMnCMPB Up"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "TRCMPBD", bit_offset: 13, bit_width: 1, access: None, description: Some("Trigger for Counter=PWMnCMPB Down"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_RIS", offset: 72, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Raw Interrupt Status"), fields: [Field { name: "INTCNTZERO", bit_offset: 0, bit_width: 1, access: None, description: Some("Counter=0 Interrupt Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCNTLOAD", bit_offset: 1, bit_width: 1, access: None, description: Some("Counter=Load Interrupt Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPAU", bit_offset: 2, bit_width: 1, access: None, description: Some("Comparator A Up Interrupt Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPAD", bit_offset: 3, bit_width: 1, access: None, description: Some("Comparator A Down Interrupt Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPBU", bit_offset: 4, bit_width: 1, access: None, description: Some("Comparator B Up Interrupt Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPBD", bit_offset: 5, bit_width: 1, access: None, description: Some("Comparator B Down Interrupt Status"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_ISC", offset: 76, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Interrupt Status and Clear"), fields: [Field { name: "INTCNTZERO", bit_offset: 0, bit_width: 1, access: None, description: Some("Counter=0 Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCNTLOAD", bit_offset: 1, bit_width: 1, access: None, description: Some("Counter=Load Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPAU", bit_offset: 2, bit_width: 1, access: None, description: Some("Comparator A Up Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPAD", bit_offset: 3, bit_width: 1, access: None, description: Some("Comparator A Down Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPBU", bit_offset: 4, bit_width: 1, access: None, description: Some("Comparator B Up Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "INTCMPBD", bit_offset: 5, bit_width: 1, access: None, description: Some("Comparator B Down Interrupt"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_LOAD", offset: 80, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Load"), fields: [Field { name: "LOAD", bit_offset: 0, bit_width: 16, access: None, description: Some("Counter Load Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_COUNT", offset: 84, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Counter"), fields: [Field { name: "COUNT", bit_offset: 0, bit_width: 16, access: None, description: Some("Counter Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_CMPA", offset: 88, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Compare A"), fields: [Field { name: "CMPA", bit_offset: 0, bit_width: 16, access: None, description: Some("Comparator A Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_CMPB", offset: 92, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Compare B"), fields: [Field { name: "CMPB", bit_offset: 0, bit_width: 16, access: None, description: Some("Comparator B Value"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_GENA", offset: 96, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Generator A Control"), fields: [Field { name: "ACTZERO", bit_offset: 0, bit_width: 2, access: None, description: Some("Action for Counter=0"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmA") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmA Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmA High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTLOAD", bit_offset: 2, bit_width: 2, access: None, description: Some("Action for Counter=LOAD"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmA") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmA Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmA High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPAU", bit_offset: 4, bit_width: 2, access: None, description: Some("Action for Comparator A Up"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmA") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmA Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmA High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPAD", bit_offset: 6, bit_width: 2, access: None, description: Some("Action for Comparator A Down"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmA") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmA Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmA High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPBU", bit_offset: 8, bit_width: 2, access: None, description: Some("Action for Comparator B Up"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmA") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmA Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmA High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPBD", bit_offset: 10, bit_width: 2, access: None, description: Some("Action for Comparator B Down"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmA") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmA Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmA High") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_GENB", offset: 100, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Generator B Control"), fields: [Field { name: "ACTZERO", bit_offset: 0, bit_width: 2, access: None, description: Some("Action for Counter=0"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmB") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmB Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmB High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTLOAD", bit_offset: 2, bit_width: 2, access: None, description: Some("Action for Counter=LOAD"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmB") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmB Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmB High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPAU", bit_offset: 4, bit_width: 2, access: None, description: Some("Action for Comparator A Up"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmB") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmB Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmB High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPAD", bit_offset: 6, bit_width: 2, access: None, description: Some("Action for Comparator A Down"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmB") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmB Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmB High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPBU", bit_offset: 8, bit_width: 2, access: None, description: Some("Action for Comparator B Up"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmB") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmB Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmB High") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ACTCMPBD", bit_offset: 10, bit_width: 2, access: None, description: Some("Action for Comparator B Down"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("NONE"), description: Some("Do nothing") }, EnumeratedValue { value: "0x1", name: Some("INV"), description: Some("Invert pwmB") }, EnumeratedValue { value: "0x2", name: Some("ZERO"), description: Some("Drive pwmB Low") }, EnumeratedValue { value: "0x3", name: Some("ONE"), description: Some("Drive pwmB High") }], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_DBCTL", offset: 104, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Dead-Band Control"), fields: [Field { name: "ENABLE", bit_offset: 0, bit_width: 1, access: None, description: Some("Dead-Band Generator Enable"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_DBRISE", offset: 108, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Dead-Band Rising-Edge Delay"), fields: [Field { name: "DELAY", bit_offset: 0, bit_width: 12, access: None, description: Some("Dead-Band Rise Delay"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_DBFALL", offset: 112, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Dead-Band Falling-Edge-Delay"), fields: [Field { name: "DELAY", bit_offset: 0, bit_width: 12, access: None, description: Some("Dead-Band Fall Delay"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_FLTSRC0", offset: 116, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Fault Source 0"), fields: [Field { name: "FAULT0", bit_offset: 0, bit_width: 1, access: None, description: Some("Fault0 Input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT1", bit_offset: 1, bit_width: 1, access: None, description: Some("Fault1 Input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT2", bit_offset: 2, bit_width: 1, access: None, description: Some("Fault2 Input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT3", bit_offset: 3, bit_width: 1, access: None, description: Some("Fault3 Input"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_FLTSRC1", offset: 120, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Fault Source 1"), fields: [Field { name: "DCMP0", bit_offset: 0, bit_width: 1, access: None, description: Some("Digital Comparator 0"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP1", bit_offset: 1, bit_width: 1, access: None, description: Some("Digital Comparator 1"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP2", bit_offset: 2, bit_width: 1, access: None, description: Some("Digital Comparator 2"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP3", bit_offset: 3, bit_width: 1, access: None, description: Some("Digital Comparator 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP4", bit_offset: 4, bit_width: 1, access: None, description: Some("Digital Comparator 4"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP5", bit_offset: 5, bit_width: 1, access: None, description: Some("Digital Comparator 5"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP6", bit_offset: 6, bit_width: 1, access: None, description: Some("Digital Comparator 6"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP7", bit_offset: 7, bit_width: 1, access: None, description: Some("Digital Comparator 7"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_MINFLTPER", offset: 124, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Minimum Fault Period"), fields: [Field { name: "MINFLTPER", bit_offset: 0, bit_width: 16, access: None, description: Some("Minimum Fault Period"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(64), dim_index: None }, Register { name: "CH_FLTSEN", offset: 2048, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Fault Pin Logic Sense"), fields: [Field { name: "FAULT0", bit_offset: 0, bit_width: 1, access: None, description: Some("Fault0 Sense"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT1", bit_offset: 1, bit_width: 1, access: None, description: Some("Fault1 Sense"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT2", bit_offset: 2, bit_width: 1, access: None, description: Some("Fault2 Sense"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT3", bit_offset: 3, bit_width: 1, access: None, description: Some("Fault3 Sense"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(128), dim_index: None }, Register { name: "CH_FLTSTAT0", offset: 2052, size: None, access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("PWM Fault Status 0"), fields: [Field { name: "FAULT0", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Fault Input 0"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT1", bit_offset: 1, bit_width: 1, access: Some(ReadOnly), description: Some("Fault Input 1"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT2", bit_offset: 2, bit_width: 1, access: Some(ReadOnly), description: Some("Fault Input 2"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FAULT3", bit_offset: 3, bit_width: 1, access: Some(ReadOnly), description: Some("Fault Input 3"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: Some(4), dim_increment: Some(128), dim_index: None }, Register { name: "CH_FLTSTAT1", offset: 2056, size: None, access: Some(ReadOnly), reset_value: None, reset_mask: None, description: Some("PWM Fault Status 1"), fields: [Field { name: "DCMP0", bit_offset: 0, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 0 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP1", bit_offset: 1, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 1 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP2", bit_offset: 2, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 2 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP3", bit_offset: 3, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 3 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP4", bit_offset: 4, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 4 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP5", bit_offset: 5, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 5 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP6", bit_offset: 6, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 6 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "DCMP7", bit_offset: 7, bit_width: 1, access: Some(ReadOnly), description: Some("Digital Comparator 7 Trigger"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "PP", offset: 4032, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Peripheral Properties"), fields: [Field { name: "GCNT", bit_offset: 0, bit_width: 4, access: None, description: Some("Generators"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "FCNT", bit_offset: 4, bit_width: 4, access: None, description: Some("Fault Inputs (per PWM unit)"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ESYNC", bit_offset: 8, bit_width: 1, access: None, description: Some("Extended Synchronization"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "EFAULT", bit_offset: 9, bit_width: 1, access: None, description: Some("Extended Fault"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "ONE", bit_offset: 10, bit_width: 1, access: None, description: Some("One-Shot Mode"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }, Register { name: "CC", offset: 4040, size: None, access: None, reset_value: None, reset_mask: None, description: Some("PWM Clock Configuration"), fields: [Field { name: "PWMDIV", bit_offset: 0, bit_width: 3, access: None, description: Some("PWM Clock Divider"), enumerated_values: [EnumeratedValue { value: "0x0", name: Some("DIV2"), description: Some("/2") }, EnumeratedValue { value: "0x1", name: Some("DIV4"), description: Some("/4") }, EnumeratedValue { value: "0x2", name: Some("DIV8"), description: Some("/8") }, EnumeratedValue { value: "0x3", name: Some("DIV16"), description: Some("/16") }, EnumeratedValue { value: "0x4", name: Some("DIV32"), description: Some("/32") }, EnumeratedValue { value: "0x5", name: Some("DIV64"), description: Some("/64") }], links: [], dim: None, dim_increment: None, dim_index: None }, Field { name: "USEPWM", bit_offset: 8, bit_width: 1, access: None, description: Some("Use PWM Clock Divisor"), enumerated_values: [], links: [], dim: None, dim_increment: None, dim_index: None }], dim: None, dim_increment: None, dim_index: None }], descriptors: [], signals: [], pins: [], channels: [], dim: None, dim_increment: None, dim_index: None }), modules: [], has_pins: false, has_channels: true, description: None }
...
#[doc="Read the CTL register."]
   #[inline] pub fn ctl(&self) -> Ctl { 
      unsafe {
         Ctl(::core::ptr::read_volatile((self.0 + 0x0) as *const u32))
      }
   }
...
#[doc="Read the SYNC register."]
   #[inline] pub fn sync(&self) -> Sync { 
      unsafe {
         Sync(::core::ptr::read_volatile((self.0 + 0x4) as *const u32))
      }
   }
...
#[doc="Read the ENABLE register."]
   #[inline] pub fn enable(&self) -> Enable { 
      unsafe {
         Enable(::core::ptr::read_volatile((self.0 + 0x8) as *const u32))
      }
   }
...
#[doc="Read the INVERT register."]
   #[inline] pub fn invert(&self) -> Invert { 
      unsafe {
         Invert(::core::ptr::read_volatile((self.0 + 0xc) as *const u32))
      }
   }
...
#[doc="Read the FAULT register."]
   #[inline] pub fn fault(&self) -> Fault { 
      unsafe {
         Fault(::core::ptr::read_volatile((self.0 + 0x10) as *const u32))
      }
   }
...
#[doc="Read the INTEN register."]
   #[inline] pub fn inten(&self) -> Inten { 
      unsafe {
         Inten(::core::ptr::read_volatile((self.0 + 0x14) as *const u32))
      }
   }
...
#[doc="Read the ISC register."]
   #[inline] pub fn isc(&self) -> Isc { 
      unsafe {
         Isc(::core::ptr::read_volatile((self.0 + 0x1c) as *const u32))
      }
   }
...
#[doc="Read the STATUS register."]
   #[inline] pub fn status(&self) -> Status { 
      unsafe {
         Status(::core::ptr::read_volatile((self.0 + 0x20) as *const u32))
      }
   }
...
#[doc="Read the FAULTVAL register."]
   #[inline] pub fn faultval(&self) -> Faultval { 
      unsafe {
         Faultval(::core::ptr::read_volatile((self.0 + 0x24) as *const u32))
      }
   }
...
#[doc="Read the ENUPD register."]
   #[inline] pub fn enupd(&self) -> Enupd { 
      unsafe {
         Enupd(::core::ptr::read_volatile((self.0 + 0x28) as *const u32))
      }
   }
...
#[doc="Read the CH_CTL register."]
   #[inline] pub fn ch_ctl<I: Into<bits::R4>>(&self, index: I) -> ChCtl { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChCtl(::core::ptr::read_volatile((self.0 + 0x40 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_CTL register."]
   #[inline] pub fn set_ch_ctl<I: Into<bits::R4>, F: FnOnce(ChCtl) -> ChCtl>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(ChCtl(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x40 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_INTEN register."]
   #[inline] pub fn ch_inten<I: Into<bits::R4>>(&self, index: I) -> ChInten { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChInten(::core::ptr::read_volatile((self.0 + 0x44 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_INTEN register."]
   #[inline] pub fn set_ch_inten<I: Into<bits::R4>, F: FnOnce(ChInten) -> ChInten>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x44 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_RIS register."]
   #[inline] pub fn ch_ris<I: Into<bits::R4>>(&self, index: I) -> ChRis { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChRis(::core::ptr::read_volatile((self.0 + 0x48 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_RIS register."]
   #[inline] pub fn set_ch_ris<I: Into<bits::R4>, F: FnOnce(ChRis) -> ChRis>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(ChRis(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x48 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_ISC register."]
   #[inline] pub fn ch_isc<I: Into<bits::R4>>(&self, index: I) -> ChIsc { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChIsc(::core::ptr::read_volatile((self.0 + 0x4c + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_ISC register."]
   #[inline] pub fn set_ch_isc<I: Into<bits::R4>, F: FnOnce(ChIsc) -> ChIsc>(&self, index: I, f: F) -> &Self {
      ...
      let value = f(ChIsc(0));
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x4c + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_LOAD register."]
   #[inline] pub fn ch_load<I: Into<bits::R4>>(&self, index: I) -> ChLoad { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChLoad(::core::ptr::read_volatile((self.0 + 0x50 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_LOAD register."]
   #[inline] pub fn set_ch_load<I: Into<bits::R4>, F: FnOnce(ChLoad) -> ChLoad>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x50 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_COUNT register."]
   #[inline] pub fn ch_count<I: Into<bits::R4>>(&self, index: I) -> ChCount { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChCount(::core::ptr::read_volatile((self.0 + 0x54 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_COUNT register."]
   #[inline] pub fn set_ch_count<I: Into<bits::R4>, F: FnOnce(ChCount) -> ChCount>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x54 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_CMPA register."]
   #[inline] pub fn ch_cmpa<I: Into<bits::R4>>(&self, index: I) -> ChCmpa { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChCmpa(::core::ptr::read_volatile((self.0 + 0x58 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_CMPA register."]
   #[inline] pub fn set_ch_cmpa<I: Into<bits::R4>, F: FnOnce(ChCmpa) -> ChCmpa>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x58 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_CMPB register."]
   #[inline] pub fn ch_cmpb<I: Into<bits::R4>>(&self, index: I) -> ChCmpb { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChCmpb(::core::ptr::read_volatile((self.0 + 0x5c + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_CMPB register."]
   #[inline] pub fn set_ch_cmpb<I: Into<bits::R4>, F: FnOnce(ChCmpb) -> ChCmpb>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x5c + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_GENA register."]
   #[inline] pub fn ch_gena<I: Into<bits::R4>>(&self, index: I) -> ChGena { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChGena(::core::ptr::read_volatile((self.0 + 0x60 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_GENA register."]
   #[inline] pub fn set_ch_gena<I: Into<bits::R4>, F: FnOnce(ChGena) -> ChGena>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x60 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_GENB register."]
   #[inline] pub fn ch_genb<I: Into<bits::R4>>(&self, index: I) -> ChGenb { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChGenb(::core::ptr::read_volatile((self.0 + 0x64 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_GENB register."]
   #[inline] pub fn set_ch_genb<I: Into<bits::R4>, F: FnOnce(ChGenb) -> ChGenb>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x64 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_DBCTL register."]
   #[inline] pub fn ch_dbctl<I: Into<bits::R4>>(&self, index: I) -> ChDbctl { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChDbctl(::core::ptr::read_volatile((self.0 + 0x68 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_DBCTL register."]
   #[inline] pub fn set_ch_dbctl<I: Into<bits::R4>, F: FnOnce(ChDbctl) -> ChDbctl>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x68 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_DBRISE register."]
   #[inline] pub fn ch_dbrise<I: Into<bits::R4>>(&self, index: I) -> ChDbrise { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChDbrise(::core::ptr::read_volatile((self.0 + 0x6c + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_DBRISE register."]
   #[inline] pub fn set_ch_dbrise<I: Into<bits::R4>, F: FnOnce(ChDbrise) -> ChDbrise>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x6c + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_DBFALL register."]
   #[inline] pub fn ch_dbfall<I: Into<bits::R4>>(&self, index: I) -> ChDbfall { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChDbfall(::core::ptr::read_volatile((self.0 + 0x70 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_DBFALL register."]
   #[inline] pub fn set_ch_dbfall<I: Into<bits::R4>, F: FnOnce(ChDbfall) -> ChDbfall>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x70 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_FLTSRC0 register."]
   #[inline] pub fn ch_fltsrc0<I: Into<bits::R4>>(&self, index: I) -> ChFltsrc0 { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChFltsrc0(::core::ptr::read_volatile((self.0 + 0x74 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_FLTSRC0 register."]
   #[inline] pub fn set_ch_fltsrc0<I: Into<bits::R4>, F: FnOnce(ChFltsrc0) -> ChFltsrc0>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x74 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_FLTSRC1 register."]
   #[inline] pub fn ch_fltsrc1<I: Into<bits::R4>>(&self, index: I) -> ChFltsrc1 { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChFltsrc1(::core::ptr::read_volatile((self.0 + 0x78 + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_FLTSRC1 register."]
   #[inline] pub fn set_ch_fltsrc1<I: Into<bits::R4>, F: FnOnce(ChFltsrc1) -> ChFltsrc1>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x78 + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_MINFLTPER register."]
   #[inline] pub fn ch_minfltper<I: Into<bits::R4>>(&self, index: I) -> ChMinfltper { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChMinfltper(::core::ptr::read_volatile((self.0 + 0x7c + (index * 64)) as *const u32))
      }
   }
#[doc="Write the CH_MINFLTPER register."]
   #[inline] pub fn set_ch_minfltper<I: Into<bits::R4>, F: FnOnce(ChMinfltper) -> ChMinfltper>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x7c + (index * 64)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_FLTSEN register."]
   #[inline] pub fn ch_fltsen<I: Into<bits::R4>>(&self, index: I) -> ChFltsen { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChFltsen(::core::ptr::read_volatile((self.0 + 0x800 + (index * 128)) as *const u32))
      }
   }
#[doc="Write the CH_FLTSEN register."]
   #[inline] pub fn set_ch_fltsen<I: Into<bits::R4>, F: FnOnce(ChFltsen) -> ChFltsen>(&self, index: I, f: F) -> &Self {
      ...
      unsafe {
         ::core::ptr::write_volatile((self.0 + 0x800 + (index * 128)) as *mut u32, value.0);
      }
      self
   }
...
#[doc="Read the CH_FLTSTAT0 register."]
   #[inline] pub fn ch_fltstat0<I: Into<bits::R4>>(&self, index: I) -> ChFltstat0 { 
      ...
      let index: usize = index.value() as usize;
      unsafe {
         ChFltstat0(::core::ptr::read_volatile((self.0 + 0x804 + (index * 128)) as *const u32))
      }
   }
...
#[doc="Read the CH_FLTSTAT1 register."]
   #[inline] pub fn ch_fltstat1(&self) -> ChFltstat1 { 
      unsafe {
         ChFltstat1(::core::ptr::read_volatile((self.0 + 0x808) as *const u32))
      }
   }
